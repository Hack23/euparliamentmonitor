...
| **EP MCP Server** | Version          | Latest release  | ✅ 1.3.9        |
...
**Technology Stack**: Node.js 26, TypeScript 6.0.3, Vitest 4.1.4, Playwright 1.59.1, gh-aw v0.71.3, AWS S3 + CloudFront, GitHub Pages (fallback), EP MCP 1.3.9, WB MCP 1.0.1, IMF REST SDMX 3.0  
