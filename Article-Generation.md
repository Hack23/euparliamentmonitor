...
| 7 | `pestle-context` → PESTLE & Context | [`pestle-analysis.md`](./analysis/templates/pestle-analysis.md) · [`historical-baseline.md`](./analysis/templates/historical-baseline.md) · [`historical-parallels.md`](./analysis/templates/historical-parallels.md) *(extended)* · [`comparative-international.md`](./analysis/templates/comparative-international.md) *(extended)* | PESTLE 6-axis + comparative anchor. |
...
| 15 | `deep-analysis` → Deep Analysis | [`deep-analysis.md`](./analysis/templates/deep-analysis.md) · [`intelligence-assessment.md`](./analysis/templates/intelligence-assessment.md) *(extended)* · [`implementation-feasibility.md`](./analysis/templates/implementation-feasibility.md) *(extended)* · [`media-framing-analysis.md`](./analysis/templates/media-framing-analysis.md) *(extended)* | Long-form 4 000–10 000 word Economist-style prose; ≥3 mermaid diagrams mandatory. |
...
| 17 | `extended-intel` → Extended Intelligence | All [`extended/*.md`](./analysis/templates/) not consumed by sections 7-15 | Optional long-form, crisis, breaking-deep depth. |
