...
| **L4 — Debunking** (truth-sandwich) | Correct after exposure | Public *errata register* with retraction velocity (target: <48h from credible challenge); never delete, always annotate | [analysis/README.md](analysis/README.md) errata workflow |
