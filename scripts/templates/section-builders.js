...
export { buildTimelineSection } from './sections/timeline.js';
export { buildComparisonTable } from './sections/comparison.js';
export { buildKeyFiguresBar } from './sections/key-figures.js';
export { buildResponsiveBannerPicture, buildResponsiveIconLinks, buildResponsiveSocialImageMeta, buildPageBanner, } from './sections/banner.js';
export { buildSiteHeader } from './sections/header.js';
export { buildSiteFooter } from './sections/footer.js';
