...
export class ProcedureSeenCache {
     ...
     */
    upsert(procedureId, dateLastActivity) {
        const existing = this.entries.get(procedureId);
        if (existing?.dateLastActivity === dateLastActivity)
            return;
     ...
     */
    getDateLastActivity(procedureId) {
...
//# sourceMappingURL=procedure-seen-cache.js.map