 ...
 * (`european-parliament-mcp-server@1.3.3`). The news workflows, prompt
 ...
 *
 * Maps EP MCP Server v1.3.3 structured error codes and generic HTTP/network
...
export class EuropeanParliamentMCPClient extends MCPConnection {
     ...
     * `european-parliament-mcp-server@1.3.3`.
     *
     * **Upstream date-filter contract (v1.2.14+, active on the pinned v1.3.3 server):** the upstream server
     ...
     *
     * No local post-filter is applied here. The repository is pinned to v1.3.3, so the
