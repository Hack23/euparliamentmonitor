...
import { getCuratedTitle, getCuratedDescription, } from '../../generators/political-intelligence-descriptions.js';
 ...
 */
export function getStemIcon(stem) {
 ...
 */
export function extractTradecraftLinks(html, expectedPrefix) {
    const out = [];
    let cursor = 0;
 ...
 */
export function renderTradecraftCard(link, lang, ctaLabel) {
 ...
 */
export function getViewMethodologyLabel(lang) {
    const labels = {
        en: 'View methodology',
        sv: 'Visa metodologi',
        da: 'Se metode',
