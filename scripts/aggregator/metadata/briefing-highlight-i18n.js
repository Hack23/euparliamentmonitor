 ...
 */
export const STRATEGIC_SECTION_HEADINGS_BY_LANG = Object.freeze({
    en: [],
    sv: [
        'strategisk rubrik',
 ...
 */
export const TOP_FINDINGS_HEADINGS_BY_LANG = Object.freeze({
    en: [],
    sv: [
        'viktiga händelser',
 ...
 */
export const READER_BRIEFING_HEADINGS_BY_LANG = Object.freeze({
    en: [],
    sv: [
        'läsarbriefing',
 ...
 */
export function resolveHeadingNeedles(map, baseEnglish, lang) {
    const localised = map[lang] ?? [];
    if (lang === 'en' || localised.length === 0)
        return baseEnglish;
 ...
 */
export function resolveBoilerplatePatterns(baseEnglish, lang) {
    const localised = BOILERPLATE_STEM_PATTERNS_BY_LANG[lang] ?? [];
    if (lang === 'en' || localised.length === 0)
        return baseEnglish;
    return [...baseEnglish, ...localised];
}
//# sourceMappingURL=briefing-highlight-i18n.js.map