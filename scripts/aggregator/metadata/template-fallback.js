...
import { deriveElectionCycleLabel, deriveMonthLabel, deriveQuarterLabel, deriveReportingWindowForWeekInReview, deriveTermLabel, deriveWeekRange, deriveYearLabel, } from './date-labels.js';
import { humanizeSlug } from './slug.js';
/** Localized labels used to enrich short or duplicate-prone meta descriptions. */
export const SEO_CONTEXT_LABELS = {
    en: {
        context: 'Context',
        date: 'Published',
        run: 'analysis run',
