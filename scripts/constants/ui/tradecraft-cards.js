...
export const TRADECRAFT_HEADING_LABELS = {
...
export const TRADECRAFT_INTRO_LABELS = {
...
export const TRADECRAFT_METHODOLOGIES_LABELS = {
    en: 'Methodologies',
    sv: 'Metoder',
    da: 'Metoder',
    no: 'Metoder',
...
export const TRADECRAFT_TEMPLATES_LABELS = {
...
export const ANALYSIS_INDEX_HEADING_LABELS = {
    en: 'Analysis Index',
    sv: 'Analysindex',
    da: 'Analyseindeks',
    no: 'Analyseindeks',
 ...
 */
export const ANALYSIS_INDEX_INTRO_LABELS = {
...
export const ANALYSIS_INDEX_COL_SECTION_LABELS = {
    en: 'Section',
    sv: 'Avsnitt',
    da: 'Afsnit',
    no: 'Seksjon',
...
export const ANALYSIS_INDEX_COL_ARTIFACT_LABELS = {
    en: 'Artifact',
    sv: 'Artefakt',
    da: 'Artefakt',
    no: 'Artefakt',
...
export const ANALYSIS_INDEX_COL_PATH_LABELS = {
    en: 'Path',
    sv: 'Sökväg',
    da: 'Sti',
    no: 'Sti',
...
export const VIEW_SOURCE_MARKDOWN_LABELS = {
...
//# sourceMappingURL=tradecraft-cards.js.map