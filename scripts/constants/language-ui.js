...
export const AI_SECTION_CONTENT = {
    en: {
        ...
        quote: 'Real-time European Parliament monitoring powered by 8 autonomous AI agents delivering investigative political intelligence in 14 languages.',
        description: 'EU Parliament Monitor autonomously generates deep political analysis at machine speed. Every article is researched, written, and localized by AI agents operating on live European Parliament data via the MCP Server.',
    ...
    sv: {
        ...
        quote: 'Realtidsövervakning av Europaparlamentet driven av 8 autonoma AI-agenter som levererar politisk underrättelseanalys på 14 språk.',
        description: 'EU Parliament Monitor genererar autonomt djup politisk analys i maskinhastighet. Varje artikel forskas, skrivs och lokaliseras av AI-agenter som arbetar med Europaparlamentets livedata via MCP-servern.',
    ...
    da: {
        ...
        quote: 'Realtidsovervågning af Europa-Parlamentet drevet af 8 autonome AI-agenter, der leverer politisk efterretningsanalyse på 14 sprog.',
        description: 'EU Parliament Monitor genererer autonomt dybdegående politisk analyse med maskinhastighed. Hver artikel researches, skrives og lokaliseres af AI-agenter, der opererer på Europa-Parlamentets livedata via MCP-serveren.',
        featureAgents: NORDIC_AGENTS,
    ...
    no: {
        ...
        quote: 'Sanntidsovervåking av Europaparlamentet drevet av 8 autonome AI-agenter som leverer politisk etterretningsanalyse på 14 språk.',
        description: 'EU Parliament Monitor genererer autonomt dyptgående politisk analyse i maskinhastighet. Hver artikkel forskes, skrives og lokaliseres av AI-agenter som opererer på Europaparlamentets sanntidsdata via MCP-serveren.',
        featureAgents: NORDIC_AGENTS,
        ...
        quote: 'Euroopan parlamentin reaaliaikainen seuranta 8 autonomisen tekoälyagentin avulla, jotka tuottavat poliittista tiedusteluanalyysiä 14 kielellä.',
        description: 'EU Parliament Monitor tuottaa autonomisesti syvällistä poliittista analyysiä konenopeudella. Jokainen artikkeli tutkitaan, kirjoitetaan ja lokalisoidaan tekoälyagenteilla, jotka käyttävät Euroopan parlamentin reaaliaikaista dataa MCP-palvelimen kautta.',
    ...
    de: {
        ...
        quote: 'Echtzeit-Überwachung des Europäischen Parlaments durch 8 autonome KI-Agenten, die investigative politische Analysen in 14 Sprachen liefern.',
        description: 'EU Parliament Monitor generiert autonom tiefgreifende politische Analysen in Maschinengeschwindigkeit. Jeder Artikel wird von KI-Agenten recherchiert, verfasst und lokalisiert, die mit Echtdaten des Europäischen Parlaments über den MCP-Server arbeiten.',
    ...
    fr: {
        ...
        quote: "Surveillance en temps réel du Parlement européen par 8 agents IA autonomes fournissant des analyses politiques d'investigation en 14 langues.",
        description: "EU Parliament Monitor génère de manière autonome des analyses politiques approfondies à la vitesse machine. Chaque article est recherché, rédigé et localisé par des agents IA opérant sur les données en direct du Parlement européen via le serveur MCP.",
    ...
    es: {
        ...
        quote: 'Monitoreo en tiempo real del Parlamento Europeo impulsado por 8 agentes de IA autónomos que proporcionan inteligencia política investigativa en 14 idiomas.',
        description: 'EU Parliament Monitor genera de forma autónoma análisis político profundo a velocidad de máquina. Cada artículo es investigado, escrito y localizado por agentes de IA que operan con datos en vivo del Parlamento Europeo a través del servidor MCP.',
    ...
    nl: {
        ...
        quote: 'Realtime monitoring van het Europees Parlement aangedreven door 8 autonome AI-agenten die onderzoeksjournalistieke politieke analyses leveren in 14 talen.',
        description: 'EU Parliament Monitor genereert autonoom diepgaande politieke analyses op machinesnelheid. Elk artikel wordt onderzocht, geschreven en gelokaliseerd door AI-agenten die werken met live data van het Europees Parlement via de MCP-server.',
    ...
    ar: {
        ...
        quote: 'مراقبة البرلمان الأوروبي في الوقت الفعلي بواسطة 8 وكلاء ذكاء اصطناعي مستقلين يقدمون تحليلات سياسية استقصائية بـ 14 لغة.',
        description: 'يقوم EU Parliament Monitor بإنشاء تحليلات سياسية عميقة بشكل مستقل بسرعة الآلة. يتم البحث في كل مقال وكتابته وتوطينه بواسطة وكلاء الذكاء الاصطناعي العاملين على بيانات البرلمان الأوروبي المباشرة عبر خادم MCP.',
    ...
    he: {
        ...
        quote: 'ניטור בזמן אמת של הפרלמנט האירופי באמצעות 8 סוכני בינה מלאכותית אוטונומיים המספקים ניתוח מודיעיני פוליטי חוקר ב-14 שפות.',
        description: 'EU Parliament Monitor מייצר באופן אוטונומי ניתוח פוליטי מעמיק במהירות מכונה. כל מאמר נחקר, נכתב ומותאם על ידי סוכני AI הפועלים על נתונים חיים של הפרלמנט האירופי דרך שרת MCP.',
    ...
    ja: {
        ...
        quote: '8つの自律型AIエージェントによる欧州議会のリアルタイム監視。14言語で調査報道レベルの政治分析を提供します。',
        description: 'EU Parliament Monitorは機械速度で深い政治分析を自律的に生成します。すべての記事はMCPサーバー経由で欧州議会のライブデータを使用するAIエージェントによって調査、執筆、ローカライズされます。',
    ...
    ko: {
        ...
        quote: '8개의 자율 AI 에이전트가 14개 언어로 탐사 보도 수준의 정치 분석을 제공하는 유럽 의회 실시간 모니터링.',
        description: 'EU Parliament Monitor는 기계 속도로 심층 정치 분석을 자율적으로 생성합니다. 모든 기사는 MCP 서버를 통해 유럽 의회 실시간 데이터로 작동하는 AI 에이전트에 의해 조사, 작성 및 현지화됩니다.',
    ...
    zh: {
        heading: 'AI驱动的议会情报',
        quote: '8个自主AI代理驱动的欧洲议会实时监控，以14种语言提供调查性政治分析。',
        description: 'EU Parliament Monitor以机器速度自主生成深度政治分析。每篇文章均由通过MCP服务器使用欧洲议会实时数据的AI代理进行研究、撰写和本地化。',
