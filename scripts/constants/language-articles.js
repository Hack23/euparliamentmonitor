...
export const BREAKING_STRINGS = {
    en: {
        ...
        breakingWhyAnomalies: 'Voting anomalies and coalition shifts signal realignment of political forces within Parliament. These developments may alter the legislative calculus for pending files.',
        breakingWhyNormal: 'Parliamentary activity reflects the ongoing legislative cycle. Adopted texts create binding EU law, while procedure updates indicate the trajectory of upcoming legislation.',
        ...
        breakingNeutralReason: 'Opposition groups are monitoring developments and may propose amendments in subsequent readings.',
        breakingOutlookActiveFn: (date) => `Following the parliamentary session of ${date}, expect continued legislative momentum across key committees.`,
        breakingOutlookTransitionalFn: (date) => `The parliamentary calendar following ${date} suggests a transitional period as committees rebalance legislative priorities.`,
        breakingLegalObligationsConsequence: 'New legal obligations enter into force for EU member states and regulated entities.',
        breakingProcedureConsequence: 'Legislative trajectory altered; upcoming committee votes and plenary sessions will be pivotal.',
        breakingImpactPoliticalAnomalies: 'Unusual voting patterns suggest internal party tensions or cross-group negotiations on key dossiers.',
        breakingImpactPoliticalNormalFn: (count) => `${count} legislative texts reflect the current parliamentary majority's legislative priorities.`,
        breakingImpactEconomic: 'New regulations may affect business operations, market access, and compliance costs across the EU.',
        breakingImpactSocial: "Legislative changes could affect citizens' rights, public services, and social standards across member states.",
        breakingImpactLegalFn: (count) => `${count} new legal instruments create binding obligations for EU member states and stakeholders.`,
        breakingImpactGeopoliticalCoalition: 'Coalition dynamics within the Parliament signal shifts in EU external policy positions and priorities.',
        breakingImpactGeopoliticalNormal: "Parliamentary decisions shape the EU's international standing and its relationships with third countries.",
        breakingMistakeActor: 'Political Group Whips',
        breakingMistakeDescription: 'Risk of insufficient scrutiny of complex legislative texts in accelerated procedures.',
        breakingMistakeAlternative: 'Extend committee deliberation periods and commission independent legal analysis for contentious provisions.',
    ...
    sv: {
        ...
        breakingWhyAnomalies: 'Röstningsanomalier och koalitionsförändringar signalerar en omgruppering av politiska krafter inom parlamentet. Dessa händelser kan förändra den lagstiftande kalkylen för pågående ärenden.',
        breakingWhyNormal: 'Parlamentarisk aktivitet återspeglar den pågående lagstiftningscykeln. Antagna texter skapar bindande EU-rätt, medan procedureruppdateringar indikerar riktningen för kommande lagstiftning.',
        ...
        breakingNeutralReason: 'Oppositionsgrupperna övervakar händelseutvecklingen och kan föreslå ändringar i efterföljande behandlingar.',
        breakingOutlookActiveFn: (date) => `Efter den parlamentariska sessionen ${date} väntas fortsatt lagstiftningsdynamik i centrala utskott.`,
        breakingOutlookTransitionalFn: (date) => `Den parlamentariska kalendern efter ${date} tyder på en övergångsperiod när utskotten ombalanserar lagstiftningsprioriteringarna.`,
        breakingLegalObligationsConsequence: 'Nya rättsliga skyldigheter träder i kraft för EU:s medlemsstater och berörda aktörer.',
        breakingProcedureConsequence: 'Lagstiftningsinriktningen förändras; kommande utskottsomröstningar och plenarsammanträden blir avgörande.',
        breakingImpactPoliticalAnomalies: 'Ovanliga röstningsönster tyder på interna partispänningar eller förhandlingar mellan grupper om centrala ärenden.',
        breakingImpactPoliticalNormalFn: (count) => `${count} lagstiftningstexter återspeglar den nuvarande parlamentsmajoritetens lagstiftningsprioriteringar.`,
        breakingImpactEconomic: 'Nya förordningar kan påverka företagsverksamhet, marknadstillträde och regelefterlevnadskostnader i EU.',
        breakingImpactSocial: 'Lagändringar kan påverka medborgarnas rättigheter, offentliga tjänster och sociala standarder i medlemsstaterna.',
        breakingImpactLegalFn: (count) => `${count} nya rättsliga instrument skapar bindande skyldigheter för EU:s medlemsstater och intressenter.`,
        breakingImpactGeopoliticalCoalition: 'Koalitionsdynamiken inom parlamentet signalerar förändringar i EU:s utrikespolitiska ståndpunkter och prioriteringar.',
        breakingImpactGeopoliticalNormal: 'Parlamentariska beslut formar EU:s internationella ställning och relationerna med tredjeländer.',
        breakingMistakeActor: 'Partigruppernas piskare',
        breakingMistakeDescription: 'Risk för otillräcklig granskning av komplexa lagstiftningstexter i accelererade förfaranden.',
        breakingMistakeAlternative: 'Förläng utskottens överläggningsperioder och beställ oberoende juridisk analys för kontroversiella bestämmelser.',
    ...
    da: {
        ...
        breakingWhyAnomalies: 'Afstemningsanomalier og koalitionsforskydninger signalerer en omgruppering af politiske kræfter i parlamentet. Disse begivenheder kan ændre den lovgivningsmæssige kalkule for verserende sager.',
        breakingWhyNormal: 'Parlamentarisk aktivitet afspejler den igangværende lovgivningscyklus. Vedtagne tekster skaber bindende EU-ret, mens procedureopdateringer angiver retningen for kommende lovgivning.',
        ...
        breakingNeutralActor: 'Oppositionsgrupper',
        breakingNeutralReason: 'Oppositionsgrupper følger udviklingen og kan foreslå ændringsforslag ved efterfølgende behandlinger.',
        breakingOutlookActiveFn: (date) => `Efter den parlamentariske session den ${date} forventes fortsat lovgivningsdynamik i centrale udvalg.`,
        breakingOutlookTransitionalFn: (date) => `Den parlamentariske kalender efter ${date} tyder på en overgangsperiode, mens udvalgene ombalancerer lovgivningsprioriteterne.`,
        breakingLegalObligationsConsequence: "Nye retlige forpligtelser træder i kraft for EU's medlemsstater og berørte aktører.",
        breakingProcedureConsequence: 'Lovgivningsindsatsen ændres; kommende udvalgsafstemninger og plenarmøder bliver afgørende.',
        breakingImpactPoliticalAnomalies: 'Usædvanlige afstemningsm\u00f8nstre tyder på interne partispændinger eller forhandlinger på tværs af grupper om centrale sager.',
        breakingImpactPoliticalNormalFn: (count) => `${count} lovgivningstekster afspejler det nuværende parlamentariske flertals lovgivningsprioriteter.`,
        breakingImpactEconomic: 'Nye regler kan påvirke erhvervslivet, markedsadgang og efterlevelsesomkostninger i EU.',
        breakingImpactSocial: 'Lovændringer kan påvirke borgernes rettigheder, offentlige tjenester og sociale standarder i medlemsstaterne.',
        breakingImpactLegalFn: (count) => `${count} nye retlige instrumenter skaber bindende forpligtelser for EU's medlemsstater og interessenter.`,
        breakingImpactGeopoliticalCoalition: "Koalitionsdynamikken i parlamentet signalerer forskydninger i EU's udenrigspolitiske positioner og prioriteter.",
        breakingImpactGeopoliticalNormal: "Parlamentariske beslutninger former EU's internationale position og forholdet til tredjelande.",
        breakingMistakeActor: 'Partigruppernes piskere',
        breakingMistakeDescription: 'Risiko for utilstrækkelig granskning af komplekse lovgivningstekster i accelererede procedurer.',
        breakingMistakeAlternative: 'Forlæng udvalgenes drøftelsesperioder og bestil uafhængig juridisk analyse for kontroversielle bestemmelser.',
    ...
    no: {
        ...
        breakingWhyAnomalies: 'Avstemningsavvik og koalisjonsforskyvninger signaliserer en omgruppering av politiske krefter i parlamentet. Disse hendelsene kan endre den lovgivningsmessige kalkylen for pågående saker.',
        breakingWhyNormal: 'Parlamentarisk aktivitet gjenspeiler den pågående lovgivningssyklusen. Vedtatte tekster skaper bindende EU-rett, mens prosedyreoppdateringer indikerer retningen for kommende lovgivning.',
        ...
        breakingNeutralReason: 'Opposisjonsgrupper overvåker utviklingen og kan foreslå endringer i etterfølgende behandlinger.',
        breakingOutlookActiveFn: (date) => `Etter den parlamentariske sesjonen ${date} forventes fortsatt lovgivningsdynamikk i sentrale komiteer.`,
        breakingOutlookTransitionalFn: (date) => `Den parlamentariske kalenderen etter ${date} tyder på en overgangsperiode når komiteene ombalanserer lovgivningsprioriteringene.`,
        breakingLegalObligationsConsequence: 'Nye rettslige forpliktelser trer i kraft for EUs medlemsstater og berørte aktører.',
        breakingProcedureConsequence: 'Lovgivningsforløpet endres; kommende komitéavstemninger og plenarmøter vil være avgjørende.',
        breakingImpactPoliticalAnomalies: 'Uvanlige avstemningsmønstre tyder på interne partispenninger eller forhandlinger på tvers av grupper om sentrale saker.',
        breakingImpactPoliticalNormalFn: (count) => `${count} lovgivningstekster gjenspeiler det nåværende parlamentariske flertalls lovgivingsprioriteter.`,
        breakingImpactEconomic: 'Nye forskrifter kan påvirke næringsvirksomhet, markedsadgang og etterlevelseskostnader i EU.',
        breakingImpactSocial: 'Lovendringer kan påvirke borgernes rettigheter, offentlige tjenester og sosiale standarder i medlemsstatene.',
        breakingImpactLegalFn: (count) => `${count} nye rettslige instrumenter skaper bindende forpliktelser for EUs medlemsstater og interessenter.`,
        breakingImpactGeopoliticalCoalition: 'Koalisjonsdynamikken i parlamentet signaliserer skifter i EUs utenrikspolitiske posisjoner og prioriteringer.',
        breakingImpactGeopoliticalNormal: 'Parlamentariske beslutninger former EUs internasjonale posisjon og forholdet til tredjeland.',
        breakingMistakeActor: 'Partigruppers innpisker',
        breakingMistakeDescription: 'Risiko for utilstrekkelig granskning av komplekse lovgivningstekster i akselererte prosedyrer.',
        breakingMistakeAlternative: 'Forleng komiteens drøftingsperioder og bestill uavhengig juridisk analyse for kontroversielle bestemmelser.',
        ...
        breakingWhyAnomalies: 'Äänestyspoikkeamat ja koalitiomuutokset viittaavat poliittisten voimien uudelleenryhmittymiseen parlamentissa. Nämä tapahtumat saattavat muuttaa vireillä olevien asioiden lainsäädännöllistä laskentaa.',
        breakingWhyNormal: 'Parlamentaarinen toiminta heijastaa käynnissä olevaa lainsäädäntösykliä. Hyväksytyt tekstit luovat sitovaa EU-oikeutta, kun taas menettelypäivitykset osoittavat tulevan lainsäädännön suunnan.',
        ...
        breakingNeutralReason: 'Oppositioryhmät seuraavat kehitystä ja voivat ehdottaa muutoksia myöhemmissä käsittelyissä.',
        breakingOutlookActiveFn: (date) => `Parlamentaarisen istunnon ${date} jälkeen odotetaan jatkuvaa lainsäädäntövauhtia keskeisillä valiokunnilla.`,
        breakingOutlookTransitionalFn: (date) => `Parlamentaarinen kalenteri ${date} jälkeen viittaa siirtymäkauteen, kun valiokunnat tasapainottavat lainsäädäntöprioriteetit uudelleen.`,
        breakingLegalObligationsConsequence: 'Uudet oikeudelliset velvoitteet tulevat voimaan EU:n jäsenvaltioille ja säännellyille toimijoille.',
        breakingProcedureConsequence: 'Lainsäädäntöpolku muuttuu; tulevat valiokuntaäänestykset ja täysistunnot ovat ratkaisevia.',
        breakingImpactPoliticalAnomalies: 'Epätavalliset äänestysmallit viittaavat sisäisiin puoluejännitteisiin tai ryhmien välisiin neuvotteluihin keskeisistä asiakirjoista.',
        breakingImpactPoliticalNormalFn: (count) => `${count} lainsäädäntötekstiä heijastaa nykyisen parlamentaarisen enemmistön lainsäädäntöprioriteetit.`,
        breakingImpactEconomic: 'Uudet asetukset voivat vaikuttaa yritysten toimintaan, markkinapääsyyn ja vaatimustenmukaisuuskustannuksiin EU:ssa.',
        breakingImpactSocial: 'Lakimuutokset voivat vaikuttaa kansalaisten oikeuksiin, julkisiin palveluihin ja sosiaalisiin standardeihin jäsenvaltioissa.',
        breakingImpactLegalFn: (count) => `${count} uutta oikeudellista välinettä luo sitovia velvoitteita EU:n jäsenvaltioille ja sidosryhmille.`,
        breakingImpactGeopoliticalCoalition: 'Koalitiodynamiikka parlamentissa viestii muutoksista EU:n ulkopoliittisissa kannoissa ja prioriteeteissa.',
        breakingImpactGeopoliticalNormal: 'Parlamentaariset päätökset muovaavat EU:n kansainvälistä asemaa ja sen suhteita kolmansiin maihin.',
        breakingMistakeActor: 'Ryhmien parlamenttipiiskurit',
        breakingMistakeDescription: 'Riski monimutkaisten lainsäädäntötekstien riittämättömälle tarkastukselle nopeutetuissa menettelyissä.',
        breakingMistakeAlternative: 'Pidennä valiokuntien harkinta-aikoja ja tilaa riippumaton oikeudellinen analyysi kiistanalaisia säännöksiä varten.',
    ...
    de: {
        ...
        breakingWhyAnomalies: 'Abstimmungsanomalien und Koalitionsverschiebungen signalisieren eine Neuausrichtung politischer Kräfte im Parlament. Diese Entwicklungen könnten die gesetzgeberische Kalkulation für laufende Akten verändern.',
        breakingWhyNormal: 'Parlamentarische Aktivitäten spiegeln den laufenden Gesetzgebungszyklus wider. Angenommene Texte schaffen bindendes EU-Recht, während Verfahrensupdates die Richtung der kommenden Gesetzgebung anzeigen.',
        ...
        breakingNeutralReason: 'Oppositionsgruppen beobachten die Entwicklungen und können in nachfolgenden Lesungen Änderungsanträge einbringen.',
        breakingOutlookActiveFn: (date) => `Im Anschluss an die parlamentarische Sitzung vom ${date} ist in den zentralen Ausschüssen weiterer Gesetzgebungsschwung zu erwarten.`,
        breakingOutlookTransitionalFn: (date) => `Der parlamentarische Kalender nach dem ${date} deutet auf eine Übergangsphase hin, in der Ausschüsse ihre Gesetzgebungsprioritäten neu ausbalancieren.`,
        breakingLegalObligationsConsequence: 'Neue rechtliche Verpflichtungen treten für EU-Mitgliedstaaten und regulierte Akteure in Kraft.',
        breakingProcedureConsequence: 'Der Gesetzgebungsweg ändert sich; bevorstehende Ausschussabstimmungen und Plenartagungen werden entscheidend sein.',
        breakingImpactPoliticalAnomalies: 'Ungewöhnliche Abstimmungsmuster deuten auf interne Parteispannungen oder fraktionsübergreifende Verhandlungen zu Schlüsseldossiers hin.',
        breakingImpactPoliticalNormalFn: (count) => `${count} Gesetzestexte spiegeln die Gesetzgebungsprioritäten der aktuellen parlamentarischen Mehrheit wider.`,
        breakingImpactEconomic: 'Neue Vorschriften können Geschäftsbetrieb, Marktzugang und Compliance-Kosten in der EU beeinflussen.',
        breakingImpactSocial: 'Gesetzesänderungen könnten Bürgerrechte, öffentliche Dienste und Sozialstandards in den Mitgliedstaaten beeinflussen.',
        breakingImpactLegalFn: (count) => `${count} neue Rechtsinstrumente schaffen verbindliche Verpflichtungen für EU-Mitgliedstaaten und Interessenträger.`,
        breakingImpactGeopoliticalCoalition: 'Die Koalitionsdynamik im Parlament signalisiert Verschiebungen in den außenpolitischen Positionen und Prioritäten der EU.',
        breakingImpactGeopoliticalNormal: 'Parlamentarische Entscheidungen prägen die internationale Stellung der EU und ihre Beziehungen zu Drittländern.',
        breakingMistakeActor: 'Fraktionsgeschäftsführer',
        breakingMistakeDescription: 'Risiko einer unzureichenden Prüfung komplexer Gesetzestexte in beschleunigten Verfahren.',
        breakingMistakeAlternative: 'Ausschussberatungszeiten verlängern und unabhängige Rechtsanalysen für streitige Bestimmungen in Auftrag geben.',
    ...
    fr: {
        ...
        breakingWhyAnomalies: 'Les anomalies de vote et les changements de coalition signalent une recomposition des forces politiques au sein du Parlement. Ces développements pourraient modifier les calculs législatifs des dossiers en cours.',
        breakingWhyNormal: "L'activité parlementaire reflète le cycle législatif en cours. Les textes adoptés créent du droit européen contraignant, tandis que les mises à jour procédurales indiquent la trajectoire de la législation à venir.",
        ...
        breakingNeutralReason: "Les groupes d'opposition suivent les développements et peuvent proposer des amendements lors des lectures suivantes.",
        breakingOutlookActiveFn: (date) => `À la suite de la session parlementaire du ${date}, un élan législatif continu est attendu dans les commissions clés.`,
        breakingOutlookTransitionalFn: (date) => `Le calendrier parlementaire après le ${date} suggère une période de transition tandis que les commissions rééquilibrent leurs priorités législatives.`,
        breakingLegalObligationsConsequence: "De nouvelles obligations juridiques entrent en vigueur pour les États membres de l'UE et les entités réglementées.",
        breakingProcedureConsequence: 'La trajectoire législative est modifiée\u00a0; les prochains votes en commission et les sessions plénières seront décisifs.',
        breakingImpactPoliticalAnomalies: 'Des schémas de vote inhabituels suggèrent des tensions internes aux partis ou des négociations inter-groupes sur des dossiers clés.',
        breakingImpactPoliticalNormalFn: (count) => `${count} textes législatifs reflètent les priorités législatives de la majorité parlementaire actuelle.`,
        breakingImpactEconomic: "De nouvelles réglementations peuvent affecter les opérations commerciales, l'accès aux marchés et les coûts de conformité dans l'UE.",
        breakingImpactSocial: 'Les changements législatifs pourraient affecter les droits des citoyens, les services publics et les normes sociales dans les États membres.',
        breakingImpactLegalFn: (count) => `${count} nouveaux instruments juridiques créent des obligations contraignantes pour les États membres de l'UE et les parties prenantes.`,
        breakingImpactGeopoliticalCoalition: "La dynamique de coalition au sein du Parlement signale des changements dans les positions et priorités de politique étrangère de l'UE.",
        breakingImpactGeopoliticalNormal: "Les décisions parlementaires façonnent la position internationale de l'UE et ses relations avec les pays tiers.",
        breakingMistakeActor: 'Chefs de file des groupes politiques',
        breakingMistakeDescription: "Risque d'examen insuffisant des textes législatifs complexes dans les procédures accélérées.",
        breakingMistakeAlternative: 'Prolonger les périodes de délibération en commission et commander des analyses juridiques indépendantes pour les dispositions controversées.',
    ...
    es: {
        ...
        breakingWhyAnomalies: 'Las anomalías de votación y los cambios en la coalición señalan una recomposición de fuerzas políticas dentro del Parlamento. Estos desarrollos pueden alterar el cálculo legislativo de los expedientes pendientes.',
        breakingWhyNormal: 'La actividad parlamentaria refleja el ciclo legislativo en curso. Los textos adoptados crean derecho vinculante de la UE, mientras que las actualizaciones de procedimientos indican la trayectoria de la legislación venidera.',
        ...
        breakingNeutralReason: 'Los grupos de oposición están monitoreando los desarrollos y pueden proponer enmiendas en lecturas posteriores.',
        breakingOutlookActiveFn: (date) => `Tras la sesión parlamentaria del ${date}, se espera un impulso legislativo continuo en las comisiones clave.`,
        breakingOutlookTransitionalFn: (date) => `El calendario parlamentario posterior al ${date} sugiere un período de transición a medida que las comisiones reequilibran las prioridades legislativas.`,
        breakingLegalObligationsConsequence: 'Nuevas obligaciones jurídicas entran en vigor para los Estados miembros de la UE y las entidades reguladas.',
        breakingProcedureConsequence: 'La trayectoria legislativa se altera; los próximos votos en comisión y las sesiones plenarias serán fundamentales.',
        breakingImpactPoliticalAnomalies: 'Patrones de votación inusuales sugieren tensiones internas en los partidos o negociaciones entre grupos sobre expedientes clave.',
        breakingImpactPoliticalNormalFn: (count) => `${count} textos legislativos reflejan las prioridades legislativas de la mayoría parlamentaria actual.`,
        breakingImpactEconomic: 'Los nuevos reglamentos pueden afectar las operaciones empresariales, el acceso al mercado y los costos de cumplimiento en la UE.',
        breakingImpactSocial: 'Los cambios legislativos podrían afectar los derechos de los ciudadanos, los servicios públicos y los estándares sociales en los Estados miembros.',
        breakingImpactLegalFn: (count) => `${count} nuevos instrumentos jurídicos crean obligaciones vinculantes para los Estados miembros de la UE y las partes interesadas.`,
        breakingImpactGeopoliticalCoalition: 'La dinámica de coalición dentro del Parlamento señala cambios en las posiciones y prioridades de política exterior de la UE.',
        breakingImpactGeopoliticalNormal: 'Las decisiones parlamentarias configuran la posición internacional de la UE y sus relaciones con terceros países.',
        breakingMistakeActor: 'Jefes de delegación de grupos políticos',
        breakingMistakeDescription: 'Riesgo de escrutinio insuficiente de textos legislativos complejos en procedimientos acelerados.',
        breakingMistakeAlternative: 'Ampliar los períodos de deliberación en comisión y encargar análisis jurídicos independientes para las disposiciones controvertidas.',
    ...
    nl: {
        ...
        breakingWhyAnomalies: 'Stemanomalieën en coalitieverschuivingen signaleren een hergroepering van politieke krachten binnen het Parlement. Deze ontwikkelingen kunnen de wetgevende berekening voor lopende dossiers wijzigen.',
        breakingWhyNormal: 'Parlementaire activiteit weerspiegelt de lopende wetgevingscyclus. Aangenomen teksten creëren bindend EU-recht, terwijl procedurebijwerkingen de richting van komende wetgeving aangeven.',
        ...
        breakingNeutralReason: 'Oppositiegroepen volgen de ontwikkelingen en kunnen bij volgende lezingen amendementen voorstellen.',
        breakingOutlookActiveFn: (date) => `Na de parlementaire zitting van ${date} wordt verdere wetgevingsdynamiek in kerncommissies verwacht.`,
        breakingOutlookTransitionalFn: (date) => `De parlementaire kalender na ${date} suggereert een transitieperiode terwijl commissies wetgevingsprioriteiten opnieuw in evenwicht brengen.`,
        breakingLegalObligationsConsequence: 'Nieuwe wettelijke verplichtingen treden in werking voor EU-lidstaten en gereguleerde entiteiten.',
        breakingProcedureConsequence: 'De wetgevingsweg verandert; komende commissiestemmingen en plenaire vergaderingen zullen cruciaal zijn.',
        breakingImpactPoliticalAnomalies: 'Ongewone stempatronen wijzen op interne partijspanningen of onderhandelingen tussen groepen over sleuteldossiers.',
        breakingImpactPoliticalNormalFn: (count) => `${count} wetgevingsteksten weerspiegelen de wetgevingsprioriteiten van de huidige parlementaire meerderheid.`,
        breakingImpactEconomic: 'Nieuwe regelgeving kan zakelijke activiteiten, markttoegang en nalevingskosten in de EU beïnvloeden.',
        breakingImpactSocial: 'Wetswijzigingen kunnen de rechten van burgers, openbare diensten en sociale normen in de lidstaten beïnvloeden.',
        breakingImpactLegalFn: (count) => `${count} nieuwe juridische instrumenten scheppen bindende verplichtingen voor EU-lidstaten en belanghebbenden.`,
        breakingImpactGeopoliticalCoalition: 'Coalitiedynamiek in het Parlement signaleert verschuivingen in de buitenlandse beleidsposities en prioriteiten van de EU.',
        breakingImpactGeopoliticalNormal: 'Parlementaire beslissingen bepalen de internationale positie van de EU en haar relaties met derde landen.',
        breakingMistakeActor: 'Fractiedisciplineurs',
        breakingMistakeDescription: 'Risico op onvoldoende controle van complexe wetgevingsteksten in versnelde procedures.',
        breakingMistakeAlternative: 'Verleng commissieberaadslagingsperioden en bestel onafhankelijke juridische analyses voor omstreden bepalingen.',
    ...
    ar: {
        ...
        breakingWhyAnomalies: 'تشير شذوذات التصويت وتحولات الائتلاف إلى إعادة توازن القوى السياسية داخل البرلمان. قد تؤثر هذه التطورات على الحسابات التشريعية للملفات المعلقة.',
        breakingWhyNormal: 'يعكس النشاط البرلماني الدورة التشريعية الجارية. تنشئ النصوص المعتمدة قانونًا أوروبيًا ملزمًا، فيما تشير تحديثات الإجراءات إلى مسار التشريعات القادمة.',
        ...
        breakingNeutralReason: 'تراقب مجموعات المعارضة التطورات ويمكنها اقتراح تعديلات في القراءات اللاحقة.',
        breakingOutlookActiveFn: (date) => `في أعقاب الجلسة البرلمانية في ${date}، يُتوقع استمرار الزخم التشريعي في اللجان الرئيسية.`,
        breakingOutlookTransitionalFn: (date) => `يشير التقويم البرلماني بعد ${date} إلى مرحلة انتقالية مع إعادة اللجان لتوازن أولوياتها التشريعية.`,
        breakingLegalObligationsConsequence: 'تدخل التزامات قانونية جديدة حيز التنفيذ للدول الأعضاء في الاتحاد الأوروبي والكيانات الخاضعة للتنظيم.',
        breakingProcedureConsequence: 'يتغير المسار التشريعي؛ ستكون تصويتات اللجان وجلسات الاجتماعات العامة القادمة محورية.',
        breakingImpactPoliticalAnomalies: 'تشير أنماط التصويت غير المعتادة إلى توترات داخل الأحزاب أو مفاوضات بين المجموعات حول الملفات الرئيسية.',
        breakingImpactPoliticalNormalFn: (count) => `تعكس ${count} نصًا تشريعيًا الأولويات التشريعية للأغلبية البرلمانية الحالية.`,
        breakingImpactEconomic: 'قد تؤثر اللوائح الجديدة على العمليات التجارية والوصول إلى الأسواق وتكاليف الامتثال في الاتحاد الأوروبي.',
        breakingImpactSocial: 'قد تؤثر التغييرات التشريعية على حقوق المواطنين والخدمات العامة والمعايير الاجتماعية في الدول الأعضاء.',
        breakingImpactLegalFn: (count) => `تنشئ ${count} صكًا قانونيًا جديدًا التزامات ملزمة للدول الأعضاء في الاتحاد الأوروبي وأصحاب المصلحة.`,
        breakingImpactGeopoliticalCoalition: 'تشير ديناميات الائتلاف داخل البرلمان إلى تحولات في مواقف وأولويات السياسة الخارجية للاتحاد الأوروبي.',
        breakingImpactGeopoliticalNormal: 'تشكّل القرارات البرلمانية المكانة الدولية للاتحاد الأوروبي وعلاقاته مع الدول الثالثة.',
        breakingMistakeActor: 'مسؤولو الانضباط الحزبي',
        breakingMistakeDescription: 'خطر عدم كفاية التدقيق في النصوص التشريعية المعقدة في الإجراءات المعجّلة.',
        breakingMistakeAlternative: 'تمديد فترات مداولات اللجان وطلب تحليل قانوني مستقل للأحكام الخلافية.',
    ...
    he: {
        ...
        breakingWhyAnomalies: 'חריגות הצבעה ושינויים בקואליציה מסמנים ארגון מחדש של הכוחות הפוליטיים בפרלמנט. התפתחויות אלו עשויות לשנות את התחשיב החקיקתי לתיקים הממתינים.',
        breakingWhyNormal: 'הפעילות הפרלמנטרית משקפת את מחזור החקיקה השוטף. טקסטים שאומצו יוצרים חוק אירופי מחייב, בעוד שעדכוני הליכים מצביעים על מסלול החקיקה הקרובה.',
        ...
        breakingNeutralReason: 'קבוצות האופוזיציה עוקבות אחר ההתפתחויות ועשויות להציע תיקונים בקריאות הבאות.',
        breakingOutlookActiveFn: (date) => `בעקבות הישיבה הפרלמנטרית של ${date}, צפוי מומנטום חקיקתי מתמשך בוועדות המרכזיות.`,
        breakingOutlookTransitionalFn: (date) => `לוח הזמנים הפרלמנטרי לאחר ${date} מרמז על תקופת מעבר בה הוועדות מאזנות מחדש את סדרי העדיפויות החקיקתיים.`,
        breakingLegalObligationsConsequence: 'חובות משפטיות חדשות נכנסות לתוקף עבור מדינות החברות באיחוד האירופי וגורמים מוסדרים.',
        breakingProcedureConsequence: 'מסלול החקיקה משתנה; הצבעות ועדה ומושבי מליאה קרובים יהיו מכריעים.',
        breakingImpactPoliticalAnomalies: 'דפוסי הצבעה חריגים מרמזים על מתחים פנים-מפלגתיים או משא ומתן בין-קבוצתי על תיקים מרכזיים.',
        breakingImpactPoliticalNormalFn: (count) => `${count} טקסטים חקיקתיים משקפים את סדרי העדיפויות החקיקתיים של הרוב הפרלמנטרי הנוכחי.`,
        breakingImpactEconomic: 'תקנות חדשות עשויות להשפיע על פעילות עסקית, גישה לשוק ועלויות ציות ברחבי האיחוד האירופי.',
        breakingImpactSocial: 'שינויים חקיקתיים עשויים להשפיע על זכויות אזרחים, שירותים ציבוריים ותקנים חברתיים במדינות החברות.',
        breakingImpactLegalFn: (count) => `${count} מכשירים משפטיים חדשים יוצרים חובות מחייבות למדינות החברות באיחוד האירופי ולבעלי עניין.`,
        breakingImpactGeopoliticalCoalition: 'דינמיקת הקואליציה בפרלמנט מסמנת שינויים בעמדות ובסדרי העדיפויות של המדיניות החוץ-אירופית.',
        breakingImpactGeopoliticalNormal: 'החלטות פרלמנטריות מעצבות את מעמדה הבינלאומי של האיחוד האירופי ואת יחסיו עם מדינות שלישיות.',
        breakingMistakeActor: 'מנהיגי הסיעות',
        breakingMistakeDescription: 'סיכון לבחינה בלתי מספקת של טקסטים חקיקתיים מורכבים בהליכים מואצים.',
        breakingMistakeAlternative: 'הארכת תקופות הדיון בוועדות והזמנת ניתוח משפטי עצמאי עבור הוראות שנויות במחלוקת.',
    ...
    ja: {
        ...
        breakingWhyAnomalies: '投票の異常と連立の変動が、議会内の政治的勢力の再編を示しています。これらの動向は、係属中の案件の立法的計算を変える可能性があります。',
        breakingWhyNormal: '議会活動は進行中の立法サイクルを反映しています。採択されたテキストは拘束力のあるEU法を生み出し、手続き更新は今後の法律の方向性を示します。',
        breakingWinnerActor: '立法多数派',
        breakingWinnerReasonFn: (count) => `${count}件の立法テキストが議会プロセスで進められました。`,
        breakingNeutralActor: '野党グループ',
        breakingNeutralReason: '野党グループは動向を監視しており、後続の審議で修正案を提案する可能性があります。',
        breakingOutlookActiveFn: (date) => `${date}の議会会期後、主要な委員会で立法の勢いが続くことが期待されます。`,
        breakingOutlookTransitionalFn: (date) => `${date}以降の議会日程は、委員会が立法上の優先事項を再調整する移行期間を示唆しています。`,
        breakingLegalObligationsConsequence: 'EU加盟国および規制対象事業体に対し、新たな法的義務が発効します。',
        breakingProcedureConsequence: '立法の経路が変わります；今後の委員会投票と本会議が鍵となります。',
        breakingImpactPoliticalAnomalies: '異例の投票パターンは、党内の緊張または主要案件に関するグループ間の交渉を示唆しています。',
        breakingImpactPoliticalNormalFn: (count) => `${count}件の立法テキストは、現在の議会多数派の立法優先事項を反映しています。`,
        breakingImpactEconomic: '新規制は、EU全体のビジネス運営、市場アクセス、コンプライアンスコストに影響を与える可能性があります。',
        breakingImpactSocial: '法制上の変更は、加盟国における市民の権利、公共サービス、社会基準に影響を与える可能性があります。',
        breakingImpactLegalFn: (count) => `${count}件の新たな法的手段が、EU加盟国および利害関係者に対して拘束力のある義務を生み出します。`,
        breakingImpactGeopoliticalCoalition: '議会内の連立力学は、EUの対外政策の立場と優先事項の変化を示しています。',
        breakingImpactGeopoliticalNormal: '議会の決定は、EUの国際的地位と第三国との関係を形成します。',
        breakingMistakeActor: '会派院内幹事',
        breakingMistakeDescription: '迅速化された手続きにおける複雑な立法テキストの精査が不十分になるリスク。',
        breakingMistakeAlternative: '委員会の審議期間を延長し、論争的な条項については独立した法的分析を委託してください。',
    ...
    ko: {
        ...
        breakingWhyAnomalies: '투표 이상과 연합 변동은 의회 내 정치적 세력의 재편을 나타냅니다. 이러한 발전은 계류 중인 안건에 대한 입법적 계산을 변경할 수 있습니다.',
        breakingWhyNormal: '의회 활동은 진행 중인 입법 주기를 반영합니다. 채택된 텍스트는 구속력 있는 EU 법을 생성하고, 절차 업데이트는 다가올 입법의 방향을 나타냅니다.',
        breakingWinnerActor: '입법 다수파',
        breakingWinnerReasonFn: (count) => `${count}건의 입법 텍스트가 의회 절차를 통해 진행되었습니다.`,
        breakingNeutralActor: '야당 그룹',
        breakingNeutralReason: '야당 그룹은 동향을 모니터링하고 있으며 후속 심의에서 수정안을 제안할 수 있습니다.',
        breakingOutlookActiveFn: (date) => `${date} 의회 회기 이후 주요 위원회에서 지속적인 입법 모멘텀이 예상됩니다.`,
        breakingOutlookTransitionalFn: (date) => `${date} 이후의 의회 일정은 위원회가 입법 우선순위를 재조정하는 전환 기간을 시사합니다.`,
        breakingLegalObligationsConsequence: 'EU 회원국 및 규제 대상 기업에 새로운 법적 의무가 발효됩니다.',
        breakingProcedureConsequence: '입법 경로가 변경됩니다; 앞으로 있을 위원회 투표와 본회의 회기가 중요합니다.',
        breakingImpactPoliticalAnomalies: '비정상적인 투표 패턴은 주요 안건에 대한 당내 긴장 또는 그룹 간 협상을 시사합니다.',
        breakingImpactPoliticalNormalFn: (count) => `${count}건의 입법 텍스트는 현재 의회 다수파의 입법 우선순위를 반영합니다.`,
        breakingImpactEconomic: '새로운 규정은 EU 전반에서 기업 운영, 시장 접근 및 규정 준수 비용에 영향을 미칠 수 있습니다.',
        breakingImpactSocial: '입법 변경은 회원국의 시민 권리, 공공 서비스 및 사회적 기준에 영향을 미칠 수 있습니다.',
        breakingImpactLegalFn: (count) => `${count}건의 새로운 법적 수단이 EU 회원국과 이해 관계자에게 구속력 있는 의무를 부여합니다.`,
        breakingImpactGeopoliticalCoalition: '의회 내 연합 역학은 EU 외교 정책 입장과 우선순위의 변화를 나타냅니다.',
        ...
        breakingMistakeAlternative: '위원회 심의 기간을 연장하고 논쟁적인 조항에 대해 독립적인 법적 분석을 의뢰하십시오.',
    ...
    zh: {
        ...
        breakingWhyAnomalies: '投票异常和联盟变动表明议会内部政治力量正在重新排列。这些动态可能改变待处理议案的立法计算。',
        breakingWhyNormal: '议会活动反映了正在进行的立法周期。通过的文本创造了具有约束力的欧盟法律，而程序更新则表明了即将出台的立法方向。',
        breakingWinnerActor: '立法多数派',
        ...
        breakingOutlookActiveFn: (date) => `在${date}议会会议之后，预计主要委员会的立法势头将持续推进。`,
        breakingOutlookTransitionalFn: (date) => `${date}之后的议会日程表明，随着各委员会重新平衡立法优先事项，将进入过渡期。`,
        breakingLegalObligationsConsequence: '欧盟成员国和受监管实体将面临新的法律义务。',
        breakingProcedureConsequence: '立法路径已发生变化；即将举行的委员会投票和全体会议至关重要。',
        breakingImpactPoliticalAnomalies: '不寻常的投票模式表明党内存在紧张局势，或各团体就关键议案进行跨党派谈判。',
        breakingImpactPoliticalNormalFn: (count) => `${count}项立法文本反映了当前议会多数派的立法优先事项。`,
        breakingImpactEconomic: '新法规可能影响欧盟各地的商业运营、市场准入和合规成本。',
        breakingImpactSocial: '立法变化可能影响成员国公民的权利、公共服务和社会标准。',
        breakingImpactLegalFn: (count) => `${count}项新法律文书为欧盟成员国和利益相关者创造了具有约束力的义务。`,
        breakingImpactGeopoliticalCoalition: '议会内部的联盟动态表明欧盟对外政策立场和优先事项正在发生转变。',
...
export const COMMITTEE_ANALYSIS_CONTENT_STRINGS = {
    en: {
        ...
        impactPolitical: 'Committee chairs wield significant agenda-setting power. Active committees ({active}/{total}) are shaping the legislative pipeline for the current session.',
        impactPoliticalNone: 'Committee chairs wield significant agenda-setting power. No committees have published recent documents in this reporting window; the legislative pipeline is under development.',
        impactEconomic: 'Committee outputs on economic affairs, industry, and trade directly affect EU regulatory environments and business competitiveness.',
        impactSocial: "Social affairs, employment, and civil liberties committees produce legislation that directly impacts citizens' daily lives.",
        impactLegal: '{docs} documents in various stages of committee consideration will eventually create or modify EU law.',
        impactGeopolitical: 'Foreign affairs and international trade committee activities signal evolving EU diplomatic and trade priorities.',
        actionProcessed: '{abbr} processed {n} document(s)',
        actionConsequence: 'Legislative proposals advance to next stage; affected stakeholders should prepare for implementation',
        ...
        adoptedTextsSummarySingular: 'The European Parliament adopted 1 text in a recent session, spanning environmental, economic, security, civil liberties, and agricultural policy domains.',
    ...
    sv: {
        ...
        impactPolitical: 'Utskottsordföranden har betydande dagordningsmakt. Aktiva utskott ({active}/{total}) formar den lagstiftande pipeline för innevarande session.',
        impactPoliticalNone: 'Utskottsordföranden har betydande dagordningsmakt. Inga utskott har publicerat aktuella dokument under detta rapportfönster; den lagstiftande pipeline är under uppbyggnad.',
        impactEconomic: 'Utskottens arbete inom ekonomi, industri och handel påverkar direkt EU:s regleringsmiljöer och affärskonkurrenskraft.',
        impactSocial: 'Utskott för sociala frågor, sysselsättning och medborgerliga friheter producerar lagstiftning som direkt påverkar medborgarnas dagliga liv.',
        impactLegal: '{docs} dokument i olika stadier av utskottsprövning kommer slutligen att skapa eller ändra EU-lagstiftning.',
        impactGeopolitical: 'Utskottsaktiviteter för utrikesfrågor och internationell handel signalerar föränderliga diplomatiska och handelsmässiga EU-prioriteringar.',
        actionProcessed: '{abbr} behandlade {n} dokument',
        actionConsequence: 'Lagstiftningsförslag går vidare till nästa steg; berörda intressenter bör förbereda sig för genomförande',
        mistakeDescription: 'Inga aktuella dokument producerade — lagstiftningsefterskott kan hålla på att utvecklas',
        ...
        adoptedTextsSummarySingular: 'Europaparlamentet antog 1 text under den senaste sessionen inom miljö-, ekonomi-, säkerhets-, medborgerliga friheter- och jordbrukspolitiska områden.',
    ...
    da: {
        ...
        impactPolitical: 'Udvalgsformænd har betydelig dagsordensættende magt. Aktive udvalg ({active}/{total}) former den lovgivningsmæssige pipeline for den aktuelle session.',
        impactPoliticalNone: 'Udvalgsformænd har betydelig dagsordensættende magt. Ingen udvalg har offentliggjort nylige dokumenter i dette rapportvindue; den lovgivningsmæssige pipeline er under opbygning.',
        impactEconomic: "Udvalgsresultater inden for økonomi, industri og handel påvirker direkte EU's reguleringsmiljøer og erhvervskonkurrenceevne.",
        impactSocial: 'Udvalg for sociale anliggender, beskæftigelse og borgerlige friheder producerer lovgivning, der direkte påvirker borgernes daglige liv.',
        impactLegal: '{docs} dokumenter i forskellige stadier af udvalgsbehandling vil i sidste ende skabe eller ændre EU-lovgivning.',
        impactGeopolitical: 'Udvalgsaktiviteter for udenrigsanliggender og international handel signalerer udviklende EU-diplomatiske og handelsmæssige prioriteter.',
        actionProcessed: '{abbr} behandlede {n} dokument(er)',
        actionConsequence: 'Lovgivningsforslag skrider frem til næste trin; berørte interessenter bør forberede sig på gennemførelse',
        mistakeDescription: 'Ingen nylige dokumenter produceret — lovgivningsmæssig efterslæb kan være under udvikling',
        ...
        adoptedTextsSummarySingular: 'Europa-Parlamentet vedtog 1 tekst under den seneste session inden for miljø-, økonomi-, sikkerheds-, borgerrettigheds- og landbrugspolitiske områder.',
    ...
    no: {
        ...
        impactPolitical: 'Komitéledere har betydelig dagsordensmakt. Aktive komiteer ({active}/{total}) former den lovgivende pipeline for den nåværende sesjonen.',
        impactPoliticalNone: 'Komitéledere har betydelig dagsordensmakt. Ingen komiteer har publisert nylige dokumenter i dette rapportvinduet; den lovgivende pipeline er under utvikling.',
        impactEconomic: 'Komitéresultater innen økonomi, industri og handel påvirker direkte EUs reguleringsmiljøer og næringskonkurranse.',
        impactSocial: 'Komiteer for sosiale anliggender, sysselsetting og sivile friheter produserer lovgivning som direkte påvirker borgernes daglige liv.',
        impactLegal: '{docs} dokumenter i ulike stadier av komitébehandling vil til slutt skape eller endre EU-lovgivning.',
        impactGeopolitical: 'Komitéaktiviteter for utenriksanliggender og internasjonal handel signaliserer utviklende EU-diplomatiske og handelsmessige prioriteringer.',
        actionProcessed: '{abbr} behandlet {n} dokument(er)',
        actionConsequence: 'Lovgivningsforslag går videre til neste trinn; berørte interessenter bør forberede seg på implementering',
        mistakeDescription: 'Ingen nylige dokumenter produsert — lovgivende etterslep kan være under utvikling',
        ...
        adoptedTextsSummarySingular: 'Europaparlamentet vedtok 1 tekst under den siste sesjonen innen miljø-, økonomi-, sikkerhets-, borgerrettighets- og landbrukspolitiske områder.',
        ...
        impactPolitical: 'Valiokuntien puheenjohtajilla on merkittävä esityslistalle asettamisen valta. Aktiiviset valiokunnat ({active}/{total}) muovaavat nykyisen istuntokauden lainsäädäntöprosessia.',
        impactPoliticalNone: 'Valiokuntien puheenjohtajilla on merkittävä esityslistalle asettamisen valta. Yksikään valiokunta ei ole julkaissut viimeaikaisia asiakirjoja tänä raportointijaksona; lainsäädäntöprosessi on kehitysvaiheessa.',
        impactEconomic: 'Valiokuntien tuotokset talous-, teollisuus- ja kauppa-asioissa vaikuttavat suoraan EU:n sääntelymiljöihin ja liiketoiminnan kilpailukykyyn.',
        impactSocial: 'Sosiaali-, työllisyys- ja kansalaisvapauksien valiokunnat tuottavat lainsäädäntöä, joka vaikuttaa suoraan kansalaisten jokapäiväiseen elämään.',
        impactLegal: '{docs} asiakirjaa eri vaiheissa valiokuntakäsittelyä tulee lopulta luomaan tai muuttamaan EU:n lainsäädäntöä.',
        impactGeopolitical: 'Ulkoasioiden ja kansainvälisen kaupan valiokuntien toiminta merkitsee EU:n kehittyvien diplomatia- ja kauppaprioriteetien muutoksia.',
        actionProcessed: '{abbr} käsitteli {n} asiakirja(a)',
        actionConsequence: 'Lainsäädäntöehdotukset etenevät seuraavaan vaiheeseen; asianomaisten sidosryhmien tulisi valmistautua täytäntöönpanoon',
        mistakeDescription: 'Ei viimeaikaisia asiakirjoja tuotettu — lainsäädäntörästejä saattaa olla kehittymässä',
        ...
        adoptedTextsSummarySingular: 'Euroopan parlamentti hyväksyi 1 tekstin viimeisimmässä istunnossaan ympäristö-, talous-, turvallisuus-, kansalaisvapauksien ja maatalouspolitiikan aloilla.',
    ...
    de: {
        ...
        impactPolitical: 'Ausschussvorsitzende haben erhebliche Tagesordnungsmacht. Aktive Ausschüsse ({active}/{total}) gestalten den Gesetzgebungsprozess der laufenden Session.',
        impactPoliticalNone: 'Ausschussvorsitzende haben erhebliche Tagesordnungsmacht. Kein Ausschuss hat in diesem Berichtszeitraum aktuelle Dokumente veröffentlicht; der Gesetzgebungsprozess ist im Aufbau.',
        impactEconomic: 'Ausschussergebnisse in Wirtschafts-, Industrie- und Handelsfragen beeinflussen direkt das EU-Regulierungsumfeld und die Wettbewerbsfähigkeit.',
        impactSocial: 'Ausschüsse für Soziales, Beschäftigung und bürgerliche Freiheiten erarbeiten Gesetze, die das tägliche Leben der Bürger direkt betreffen.',
        impactLegal: '{docs} Dokumente in verschiedenen Stadien der Ausschussbehandlung werden schließlich EU-Recht schaffen oder ändern.',
        impactGeopolitical: 'Ausschussaktivitäten in Außen- und Handelsfragen signalisieren die Entwicklung diplomatischer und handelspolitischer Prioritäten der EU.',
        actionProcessed: '{abbr} hat {n} Dokument(e) bearbeitet',
        actionConsequence: 'Gesetzgebungsvorschläge schreiten zur nächsten Stufe voran; betroffene Interessenträger sollten sich auf die Umsetzung vorbereiten',
        mistakeDescription: 'Keine aktuellen Dokumente erstellt — Gesetzgebungsrückstand könnte sich entwickeln',
        ...
        adoptedTextsSummarySingular: 'Das Europäische Parlament hat in der letzten Sitzungsperiode 1 Text in den Bereichen Umwelt-, Wirtschafts-, Sicherheits-, Bürgerrechte- und Agrarpolitik verabschiedet.',
    ...
    fr: {
        ...
        impactPolitical: "Les présidents de commission exercent un pouvoir considérable sur la définition de l'ordre du jour. Les commissions actives ({active}/{total}) façonnent le pipeline législatif de la session en cours.",
        impactPoliticalNone: "Les présidents de commission exercent un pouvoir considérable sur la définition de l'ordre du jour. Aucune commission n'a publié de documents récents au cours de cette période ; le pipeline législatif est en cours de développement.",
        impactEconomic: "Les résultats des commissions sur les affaires économiques, industrielles et commerciales affectent directement les environnements réglementaires de l'UE et la compétitivité des entreprises.",
        impactSocial: "Les commissions chargées des affaires sociales, de l'emploi et des libertés civiles produisent des lois qui ont un impact direct sur la vie quotidienne des citoyens.",
        impactLegal: "{docs} documents à différents stades d'examen en commission créeront ou modifieront à terme le droit de l'UE.",
        impactGeopolitical: "Les activités des commissions chargées des affaires étrangères et du commerce international signalent l'évolution des priorités diplomatiques et commerciales de l'UE.",
        actionProcessed: '{abbr} a traité {n} document(s)',
        actionConsequence: "Les propositions législatives progressent vers l'étape suivante ; les parties prenantes concernées doivent se préparer à la mise en œuvre",
        mistakeDescription: 'Aucun document récent produit — un arriéré législatif pourrait se développer',
        ...
        adoptedTextsSummarySingular: "Le Parlement européen a adopté 1 texte lors d'une session récente, couvrant les domaines de la politique environnementale, économique, sécuritaire, des libertés civiles et agricole.",
    ...
    es: {
        ...
        impactPolitical: 'Los presidentes de comisión ejercen un poder considerable en la fijación del orden del día. Las comisiones activas ({active}/{total}) están configurando el proceso legislativo para la sesión actual.',
        impactPoliticalNone: 'Los presidentes de comisión ejercen un poder considerable en la fijación del orden del día. Ninguna comisión ha publicado documentos recientes en este período de informe; el proceso legislativo está en desarrollo.',
        impactEconomic: 'Los resultados de las comisiones en materia económica, industrial y comercial afectan directamente a los entornos regulatorios de la UE y la competitividad empresarial.',
        impactSocial: 'Las comisiones de asuntos sociales, empleo y libertades civiles producen legislación que afecta directamente a la vida cotidiana de los ciudadanos.',
        impactLegal: '{docs} documentos en diversas etapas de consideración en comisión crearán o modificarán eventualmente el derecho de la UE.',
        impactGeopolitical: 'Las actividades de las comisiones de asuntos exteriores y comercio internacional señalan la evolución de las prioridades diplomáticas y comerciales de la UE.',
        actionProcessed: '{abbr} procesó {n} documento(s)',
        actionConsequence: 'Las propuestas legislativas avanzan a la siguiente etapa; las partes interesadas afectadas deben prepararse para la implementación',
        mistakeDescription: 'No se han producido documentos recientes — puede estar desarrollándose un retraso legislativo',
        ...
        adoptedTextsSummarySingular: 'El Parlamento Europeo adoptó 1 texto en una sesión reciente, abarcando los dominios de la política medioambiental, económica, de seguridad, de libertades civiles y agrícola.',
    ...
    nl: {
        ...
        impactPolitical: 'Commissievoorzitters hebben aanzienlijke agendavormende macht. Actieve commissies ({active}/{total}) bepalen de wetgevende pipeline voor de huidige zitting.',
        impactPoliticalNone: 'Commissievoorzitters hebben aanzienlijke agendavormende macht. Geen enkele commissie heeft in dit rapportagevenster recente documenten gepubliceerd; de wetgevende pipeline is in ontwikkeling.',
        impactEconomic: 'Commissieresultaten op het gebied van economische zaken, industrie en handel beïnvloeden direct de EU-regelgevingsomgevingen en het bedrijfsconcurrentievermogen.',
        impactSocial: 'Commissies voor sociale zaken, werkgelegenheid en burgerlijke vrijheden produceren wetgeving die direct invloed heeft op het dagelijks leven van burgers.',
        impactLegal: '{docs} documenten in verschillende stadia van commissiebehandeling zullen uiteindelijk EU-recht creëren of wijzigen.',
        impactGeopolitical: 'Commissieactiviteiten inzake buitenlandse zaken en internationale handel duiden op de ontwikkeling van diplomatieke en handelsmatige EU-prioriteiten.',
        actionProcessed: '{abbr} verwerkte {n} document(en)',
        actionConsequence: 'Wetgevingsvoorstellen ronden de volgende stap af; betrokken belanghebbenden dienen zich voor te bereiden op implementatie',
        mistakeDescription: 'Geen recente documenten geproduceerd — wetgevingsachterstand kan zich ontwikkelen',
        ...
        adoptedTextsSummarySingular: 'Het Europees Parlement nam 1 tekst aan in een recente plenaire vergadering over milieu-, economisch, veiligheids-, burgerlijke vrijheden- en landbouwbeleid.',
    ...
    ar: {
        ...
        impactPolitical: 'يتمتع رؤساء اللجان بسلطة تحديد جدول الأعمال. تُشكّل اللجان النشطة ({active}/{total}) مسار التشريع للدورة الحالية.',
        impactPoliticalNone: 'يتمتع رؤساء اللجان بسلطة تحديد جدول الأعمال. لم تنشر أيٌّ من اللجان وثائق حديثة خلال هذه الفترة؛ مسار التشريع قيد التطوير.',
        impactEconomic: 'تؤثر مخرجات اللجان في الشؤون الاقتصادية والصناعية والتجارية مباشرةً على بيئات اللوائح التنظيمية الأوروبية وتنافسية الأعمال.',
        impactSocial: 'تُنتج لجان الشؤون الاجتماعية والتوظيف والحريات المدنية تشريعات تؤثر مباشرةً على الحياة اليومية للمواطنين.',
        impactLegal: 'ستُنشئ {docs} وثيقة في مراحل مختلفة من الدراسة باللجان أو تُعدّل القانون الأوروبي في نهاية المطاف.',
        impactGeopolitical: 'تُشير أنشطة لجان الشؤون الخارجية والتجارة الدولية إلى تطور الأولويات الدبلوماسية والتجارية للاتحاد الأوروبي.',
        actionProcessed: 'عالجت لجنة {abbr} {n} وثيقة/وثائق',
        actionConsequence: 'تتقدم المقترحات التشريعية إلى المرحلة التالية؛ ينبغي على أصحاب المصلحة المعنيين الاستعداد للتنفيذ',
        ...
        adoptedTextsSummarySingular: 'اعتمد البرلمان الأوروبي نصاً واحداً في جلسة أخيرة، يشمل مجالات السياسات البيئية والاقتصادية والأمنية والحريات المدنية والزراعية.',
    ...
    he: {
        ...
        impactPolitical: 'לראשי ועדות יש כוח קביעת סדר יום משמעותי. ועדות פעילות ({active}/{total}) מעצבות את צינור החקיקה לפגישה הנוכחית.',
        impactPoliticalNone: 'לראשי ועדות יש כוח קביעת סדר יום משמעותי. אף ועדה לא פרסמה מסמכים אחרונים בחלון דיווח זה; צינור החקיקה נמצא בשלב פיתוח.',
        impactEconomic: 'תפוקות הוועדות בענייני כלכלה, תעשייה ומסחר משפיעות ישירות על סביבות הרגולציה של האיחוד האירופי ועל תחרותיות העסקים.',
        impactSocial: 'ועדות ענייני חברה, תעסוקה וחירויות אזרחיות מייצרות חקיקה המשפיעה ישירות על חייהם היומיומיים של האזרחים.',
        impactLegal: '{docs} מסמכים בשלבים שונים של דיון ועדה יצרו או ישנו בסופו של דבר את חוק האיחוד האירופי.',
        impactGeopolitical: 'פעילויות ועדות ענייני החוץ והסחר הבינלאומי מצביעות על התפתחות עדיפויות דיפלומטיות ומסחריות של האיחוד האירופי.',
        ...
        adoptedTextsSummarySingular: 'הפרלמנט האירופי אישר טקסט אחד בפגישה האחרונה, הכולל תחומי מדיניות סביבתית, כלכלית, ביטחונית, חירויות אזרחיות וחקלאית.',
    ...
    ja: {
        ...
        impactPolitical: '委員会委員長は重要な議題設定権を持っています。活発な委員会({active}/{total})が現会期の立法パイプラインを形成しています。',
        impactPoliticalNone: '委員会委員長は重要な議題設定権を持っています。この報告期間中に最近の文書を公開した委員会はありません。立法パイプラインは開発中です。',
        impactEconomic: '経済、産業、貿易問題に関する委員会の成果物はEU規制環境とビジネス競争力に直接影響します。',
        impactSocial: '社会問題、雇用、市民の自由を担当する委員会は、市民の日常生活に直接影響する法律を制定しています。',
        impactLegal: '委員会審議のさまざまな段階にある{docs}文書は、最終的にEU法を創設または改正することになります。',
        impactGeopolitical: '外交問題と国際貿易の委員会活動は、EUの外交・貿易優先事項の変化を示しています。',
        actionProcessed: '{abbr}が{n}文書を処理しました',
        actionConsequence: '立法提案が次の段階に進みます。関係するステークホルダーは実施に向けて準備が必要です',
        ...
        adoptedTextsSummarySingular: '欧州議会は最近の会期に1件のテキストを採択し、環境、経済、安全保障、市民的自由、農業政策の分野をカバーしています。',
    ...
    ko: {
        ...
        impactPolitical: '위원회 의장들은 의사일정 설정에 상당한 권한을 가집니다. 활동적인 위원회({active}/{total})가 현 회기의 입법 파이프라인을 형성하고 있습니다.',
        impactPoliticalNone: '위원회 의장들은 의사일정 설정에 상당한 권한을 가집니다. 이 보고 기간에 최근 문서를 발행한 위원회가 없습니다. 입법 파이프라인은 개발 중입니다.',
        impactEconomic: '경제, 산업, 무역 문제에 관한 위원회 결과물은 EU 규제 환경과 기업 경쟁력에 직접적인 영향을 미칩니다.',
        impactSocial: '사회 문제, 고용, 시민 자유 위원회는 시민들의 일상생활에 직접적인 영향을 미치는 법률을 제정합니다.',
        impactLegal: '위원회 심의의 다양한 단계에 있는 {docs}개 문서는 궁극적으로 EU 법률을 만들거나 수정할 것입니다.',
        impactGeopolitical: '외교 문제 및 국제 무역 위원회 활동은 EU의 외교 및 무역 우선순위의 변화를 나타냅니다.',
        actionProcessed: '{abbr}에서 {n}개 문서 처리',
        actionConsequence: '입법 제안이 다음 단계로 진행됩니다. 영향을 받는 이해관계자들은 이행을 준비해야 합니다',
        ...
        adoptedTextsSummarySingular: '유럽 의회는 최근 회기에서 환경, 경제, 안보, 시민 자유 및 농업 정책 분야에 걸쳐 1개의 텍스트를 채택했습니다.',
    ...
    zh: {
        ...
        impactPolitical: '委员会主席在制定议程方面拥有重要权力。活跃委员会({active}/{total})正在为当前会期塑造立法管道。',
        impactPoliticalNone: '委员会主席在制定议程方面拥有重要权力。在此报告期间没有委员会发布近期文件；立法管道处于开发阶段。',
        ...
        adoptedTextsSummarySingular: '欧洲议会在最近一届会议上通过了1项文本，涵盖环境、经济、安全、公民自由和农业政策领域。',
