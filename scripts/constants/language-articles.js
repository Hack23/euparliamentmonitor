...
export const PROPOSITIONS_ANALYSIS_CONTENT_STRINGS = {
    en: {
        ...
        whatNoProposals: 'Legislative pipeline assessment as of {date}: Health score {pct}%, throughput rate {throughput}. No new proposals detected in this period.',
        ...
        whyStrong: 'The legislative pipeline operates at {pct}% health with a throughput of {throughput} procedures, indicating strong institutional capacity to process pending proposals. Political group coordination and committee efficiency drive this productive legislative tempo.',
        whyModerate: 'Pipeline health at {pct}% with throughput of {throughput} reflects moderate legislative processing capacity. Some procedures face delays at committee or trilogue stages, requiring enhanced political coordination.',
        whyWeak: 'Legislative pipeline health at {pct}% with throughput of {throughput} signals significant processing challenges. Bottlenecked procedures and political disagreements are constraining legislative output.',
        impactPolitical: 'Legislative pipeline at {pct}% health shapes political group bargaining dynamics.',
        ...
        impactEconomic: '{throughput} procedures in the pipeline carry potential economic regulatory implications.',
        ...
        impactSocial: 'Pipeline processing capacity directly affects the pace of social policy legislation reaching citizens. Current throughput of {throughput} procedures shapes the timeline for rights-related legislation.',
        impactLegal: 'Legislative pipeline at {pct}% health influences the volume and pace of new EU legal instruments entering the official journal, with implications for national transposition deadlines.',
        impactGeopolitical: "EU legislative output capacity at {pct}% health affects the Parliament's credibility and influence in international negotiations and trade discussions.",
        outlookGood: 'Legislative pipeline at {pct}% health with throughput of {throughput} positions the Parliament for continued productive output. Likely scenario: sustained legislative momentum with efficient committee-to-plenary progression. Possible scenario: new Commission proposals may strain processing capacity.',
        outlookConcern: 'Pipeline health at {pct}% requires attention from legislative coordinators. Likely scenario: selective prioritisation of key files to improve throughput. Possible scenario: political impasse on contentious files may further reduce pipeline efficiency.',
        mistakeDescription: 'Pipeline health dropped to {pct}%',
        mistakeAlternative: 'Earlier intervention through prioritised scheduling and pre-negotiation sessions between political groups could have maintained pipeline health above 50%.',
        actionHealth: 'Pipeline health at {pct}%',
        actionThroughput: 'Throughput rate at {throughput}',
        consequenceStrong: 'Strong pipeline health ({pct}%) indicates efficient legislative processing capacity, affecting the pace of regulatory and policy adoption.',
        consequenceModerate: 'Moderate pipeline health ({pct}%) indicates moderate legislative processing capacity, affecting the pace of regulatory and policy adoption.',
        consequenceWeak: 'Weak pipeline health ({pct}%) indicates constrained legislative processing capacity, affecting the pace of regulatory and policy adoption.',
        consequenceThroughputHigh: 'Throughput of {throughput} procedures reflects productive legislative output.',
        consequenceThroughputMedium: 'Throughput of {throughput} procedures indicates moderate processing capacity.',
        consequenceThroughputLow: 'Throughput of {throughput} procedures signals potential bottleneck conditions requiring attention from committee coordinators.',
        stakeholderWinnerActor: 'Parliament presidency',
        stakeholderWinnerReason: 'Pipeline health at {pct}% demonstrates effective legislative coordination by the Parliament presidency, enabling timely processing of priority files.',
        stakeholderLoserActor: 'Pending legislation sponsors',
        stakeholderLoserReason: 'Pipeline health at {pct}% means pending legislation faces delays, disadvantaging sponsors whose proposals require timely adoption to address policy needs.',
    ...
    sv: {
        ...
        whatNoProposals: 'Lagstiftningspipelinebedömning per {date}: Hälsopoäng {pct}%, genomströmningshastighet {throughput}. Inga nya förslag upptäckta under denna period.',
        ...
        whyStrong: 'Lagstiftningspipelinen fungerar med {pct}% hälsa och en genomströmning på {throughput} förfaranden, vilket indikerar stark institutionell kapacitet att bearbeta väntande förslag. Politisk gruppsamordning och utskottseffektivitet driver detta produktiva lagstiftningstempo.',
        whyModerate: 'Pipelinens hälsa på {pct}% med genomströmning på {throughput} återspeglar måttlig lagstiftningsbearbetningskapacitet. Vissa förfaranden möter förseningar vid utskotts- eller trilogstadiet, vilket kräver förstärkt politisk samordning.',
        whyWeak: 'Lagstiftningspipelinens hälsa på {pct}% med genomströmning på {throughput} signalerar betydande bearbetningsutmaningar. Blockerade förfaranden och politiska meningsskiljaktigheter begränsar lagstiftningsproduktionen.',
        impactPolitical: 'Lagstiftningspipelinen på {pct}% hälsa formar politiska gruppers förhandlingsdynamik.',
        impactPoliticalStrong: 'Stark genomströmning möjliggör koalitionsbyggande kring prioriterade ärenden.',
        impactPoliticalWeak: 'Flaskhalstryck kan tvinga fram kompromissförhandlingar.',
        impactEconomic: '{throughput} förfaranden i pipelinen medför potentiella ekonomiska regleringskonsekvenser.',
        impactEconomicStrong: 'Effektiv bearbetning stödjer förutsägbara affärsplaneringshorisoner.',
        impactEconomicWeak: 'Försenade förfaranden skapar regulatorisk osäkerhet för berörda sektorer.',
        impactSocial: 'Pipelinens bearbetningskapacitet påverkar direkt takten för socialpolitisk lagstiftning som når medborgarna. Nuvarande genomströmning på {throughput} förfaranden formar tidslinjen för rättighetsrelaterad lagstiftning.',
        impactLegal: 'Lagstiftningspipelinen på {pct}% hälsa påverkar volymen och takten för nya EU-rättsliga instrument som publiceras i EU:s officiella tidning, med konsekvenser för nationella genomförandefrister.',
        impactGeopolitical: 'EU:s lagstiftningskapacitet på {pct}% hälsa påverkar parlamentets trovärdighet och inflytande i internationella förhandlingar och handelsdiskussioner.',
        outlookGood: 'Lagstiftningspipelinen på {pct}% hälsa med genomströmning på {throughput} positionerar parlamentet för fortsatt produktiv output. Sannolikt scenario: bibehållen lagstiftningsmomentum med effektiv progression från utskott till plenum. Möjligt scenario: nya kommissionsförslag kan belasta bearbetningskapaciteten.',
        outlookConcern: 'Pipelinens hälsa på {pct}% kräver uppmärksamhet från lagstiftningssamordnare. Sannolikt scenario: selektiv prioritering av nyckelärenden för att förbättra genomströmningen. Möjligt scenario: politiskt dödläge i kontroversiella ärenden kan ytterligare minska pipelinens effektivitet.',
        mistakeDescription: 'Pipelinens hälsa sjönk till {pct}%',
        mistakeAlternative: 'Tidigare ingripande genom prioriterad schemaläggning och förförhandlingssessioner mellan politiska grupper kunde ha upprätthållit pipelinens hälsa över 50%.',
        actionHealth: 'Pipelinens hälsa på {pct}%',
        actionThroughput: 'Genomströmningshastighet på {throughput}',
        consequenceStrong: 'Stark pipelinehälsa ({pct}%) indikerar effektiv lagstiftningsbearbetningskapacitet som påverkar takten för reglerings- och policyantagen.',
        consequenceModerate: 'Måttlig pipelinehälsa ({pct}%) indikerar måttlig lagstiftningsbearbetningskapacitet som påverkar takten för reglerings- och policyantagen.',
        consequenceWeak: 'Svag pipelinehälsa ({pct}%) indikerar begränsad lagstiftningsbearbetningskapacitet som påverkar takten för reglerings- och policyantagen.',
        consequenceThroughputHigh: 'Genomströmning på {throughput} förfaranden återspeglar produktiv lagstiftningsproduktion.',
        consequenceThroughputMedium: 'Genomströmning på {throughput} förfaranden indikerar måttlig bearbetningskapacitet.',
        consequenceThroughputLow: 'Genomströmning på {throughput} förfaranden signalerar potentiella flaskhalsförhållanden som kräver uppmärksamhet från utskottssamordnare.',
        stakeholderWinnerActor: 'Parlamentets presidium',
        stakeholderWinnerReason: 'Pipelinens hälsa på {pct}% visar effektiv lagstiftningssamordning av parlamentets presidium, vilket möjliggör snabb behandling av prioriterade ärenden.',
        stakeholderLoserActor: 'Sponsorer av väntande lagstiftning',
        stakeholderLoserReason: 'Pipelinens hälsa på {pct}% innebär att väntande lagstiftning möter förseningar, vilket missgynnar sponsorer vars förslag kräver snabb antagning.',
    ...
    da: {
        ...
        whatNoProposals: 'Lovgivningspipelinevurdering pr. {date}: Sundhedsscore {pct}%, gennemstrømningshastighed {throughput}. Ingen nye forslag opdaget i denne periode.',
        ...
        whyStrong: 'Lovgivningspipelinen opererer med {pct}% sundhed og en gennemstrømning på {throughput} procedurer, hvilket indikerer stærk institutionel kapacitet.',
        whyModerate: 'Pipelinesundhed på {pct}% med gennemstrømning på {throughput} afspejler moderat lovgivningsmæssig behandlingskapacitet.',
        whyWeak: 'Lovgivningspipelinesundhed på {pct}% med gennemstrømning på {throughput} signalerer betydelige behandlingsudfordringer.',
        impactPolitical: 'Lovgivningspipelinen på {pct}% sundhed former politiske gruppers forhandlingsdynamik.',
        impactPoliticalStrong: 'Stærk gennemstrømning muliggør koalitionsbygning om prioriterede filer.',
        impactPoliticalWeak: 'Flaskehals kan fremtvinge kompromisforhandlinger.',
        impactEconomic: '{throughput} procedurer i pipelinen medfører potentielle økonomiske reguleringskonsekvenser.',
        impactEconomicStrong: 'Effektiv behandling understøtter forudsigelige forretningsplanlægningshorisonter.',
        impactEconomicWeak: 'Forsinkede procedurer skaber regulatorisk usikkerhed for berørte sektorer.',
        impactSocial: 'Pipelinens behandlingskapacitet påvirker direkte tempoet for socialpolitisk lovgivning, der når borgerne. Nuværende gennemstrømning på {throughput} procedurer former tidslinjen.',
        impactLegal: 'Lovgivningspipelinen på {pct}% sundhed påvirker mængden og tempoet af nye EU-retslige instrumenter, der indgår i EU-Tidende.',
        impactGeopolitical: "EU's lovgivningskapacitet på {pct}% sundhed påvirker Parlamentets troværdighed i internationale forhandlinger.",
        outlookGood: 'Lovgivningspipelinen på {pct}% sundhed med gennemstrømning på {throughput} positionerer Parlamentet for fortsat produktiv output.',
        ...
        mistakeAlternative: 'Tidligere indgriben gennem prioriteret planlægning og forforhandlingssessioner mellem politiske grupper kunne have opretholdt pipelinesundheden over 50%.',
        actionHealth: 'Pipelinesundhed på {pct}%',
        actionThroughput: 'Gennemstrømningshastighed på {throughput}',
        consequenceStrong: 'Stærk pipelinesundhed ({pct}%) indikerer effektiv lovgivningsmæssig behandlingskapacitet.',
        consequenceModerate: 'Moderat pipelinesundhed ({pct}%) indikerer moderat lovgivningsmæssig behandlingskapacitet.',
        consequenceWeak: 'Svag pipelinesundhed ({pct}%) indikerer begrænset lovgivningsmæssig behandlingskapacitet.',
        consequenceThroughputHigh: 'Gennemstrømning på {throughput} procedurer afspejler produktiv lovgivningsmæssig output.',
        consequenceThroughputMedium: 'Gennemstrømning på {throughput} procedurer indikerer moderat behandlingskapacitet.',
        consequenceThroughputLow: 'Gennemstrømning på {throughput} procedurer signalerer potentielle flaskehalse.',
        stakeholderWinnerActor: 'Parlamentets præsidium',
        stakeholderWinnerReason: 'Pipelinesundhed på {pct}% demonstrerer effektiv lovgivningsmæssig koordinering.',
        stakeholderLoserActor: 'Sponsorer af afventende lovgivning',
        stakeholderLoserReason: 'Pipelinesundhed på {pct}% betyder, at afventende lovgivning står over for forsinkelser.',
    ...
    no: {
        ...
        whatNoProposals: 'Lovgivningspipelinevurdering per {date}: Helsepoeng {pct}%, gjennomstrømningshastighet {throughput}. Ingen nye forslag oppdaget i denne perioden.',
        ...
        whyStrong: 'Lovgivningspipelinen opererer med {pct}% helse og en gjennomstrømning på {throughput} prosedyrer, noe som indikerer sterk institusjonell kapasitet.',
        whyModerate: 'Pipelinehelse på {pct}% med gjennomstrømning på {throughput} gjenspeiler moderat lovgivningsmessig behandlingskapasitet.',
        whyWeak: 'Lovgivningspipelinens helse på {pct}% med gjennomstrømning på {throughput} signaliserer betydelige behandlingsutfordringer.',
        impactPolitical: 'Lovgivningspipelinen på {pct}% helse former politiske gruppers forhandlingsdynamikk.',
        impactPoliticalStrong: 'Sterk gjennomstrømning muliggjør koalisjonsbygging rundt prioriterte saker.',
        impactPoliticalWeak: 'Flaskehals kan fremtvinge kompromissforhandlinger.',
        impactEconomic: '{throughput} prosedyrer i pipelinen medfører potensielle økonomiske reguleringskonsekvenser.',
        impactEconomicStrong: 'Effektiv behandling støtter forutsigbare forretningsplanleggingshorisonter.',
        impactEconomicWeak: 'Forsinkede prosedyrer skaper regulatorisk usikkerhet for berørte sektorer.',
        impactSocial: 'Pipelinens behandlingskapasitet påvirker direkte tempoet for sosialpolitisk lovgivning. Nåværende gjennomstrømning på {throughput} prosedyrer former tidslinjen.',
        impactLegal: 'Lovgivningspipelinen på {pct}% helse påvirker volumet og tempoet for nye EU-rettslige instrumenter.',
        impactGeopolitical: 'EUs lovgivningskapasitet på {pct}% helse påvirker Parlamentets troverdighet i internasjonale forhandlinger.',
        outlookGood: 'Lovgivningspipelinen på {pct}% helse med gjennomstrømning på {throughput} posisjonerer Parlamentet for fortsatt produktiv output.',
        ...
        mistakeAlternative: 'Tidligere inngripen gjennom prioritert planlegging kunne ha opprettholdt pipelinens helse over 50%.',
        actionHealth: 'Pipelinehelse på {pct}%',
        actionThroughput: 'Gjennomstrømningshastighet på {throughput}',
        consequenceStrong: 'Sterk pipelinehelse ({pct}%) indikerer effektiv lovgivningsmessig behandlingskapasitet.',
        consequenceModerate: 'Moderat pipelinehelse ({pct}%) indikerer moderat lovgivningsmessig behandlingskapasitet.',
        consequenceWeak: 'Svak pipelinehelse ({pct}%) indikerer begrenset lovgivningsmessig behandlingskapasitet.',
        consequenceThroughputHigh: 'Gjennomstrømning på {throughput} prosedyrer gjenspeiler produktiv lovgivningsmessig output.',
        consequenceThroughputMedium: 'Gjennomstrømning på {throughput} prosedyrer indikerer moderat behandlingskapasitet.',
        consequenceThroughputLow: 'Gjennomstrømning på {throughput} prosedyrer signaliserer potensielle flaskehalser.',
        stakeholderWinnerActor: 'Parlamentets presidium',
        stakeholderWinnerReason: 'Pipelinehelse på {pct}% demonstrerer effektiv lovgivningsmessig koordinering.',
        stakeholderLoserActor: 'Sponsorer av ventende lovgivning',
        stakeholderLoserReason: 'Pipelinehelse på {pct}% betyr at ventende lovgivning møter forsinkelser.',
        ...
        whatNoProposals: 'Lainsäädäntöputken arviointi {date}: Terveyspistemäärä {pct}%, läpimenoaste {throughput}. Ei uusia ehdotuksia havaittu tällä kaudella.',
        ...
        whyStrong: 'Lainsäädäntöputki toimii {pct}% terveydellä ja {throughput} menettelyjen läpimenolla, mikä osoittaa vahvaa institutionaalista kapasiteettia.',
        whyModerate: 'Putkilinjan terveys {pct}% ja läpimeno {throughput} heijastaa kohtalaista lainsäädännöllistä käsittelykapasiteettia.',
        whyWeak: 'Lainsäädäntöputken terveys {pct}% ja läpimeno {throughput} signaloi merkittäviä käsittelyhaasteita.',
        impactPolitical: 'Lainsäädäntöputki {pct}% terveydellä muokkaa poliittisten ryhmien neuvotteludynamiikkaa.',
        impactPoliticalStrong: 'Vahva läpimeno mahdollistaa koalitionrakentamisen prioriteettitiedostojen ympärille.',
        impactPoliticalWeak: 'Pullonkaulapaine voi pakottaa kompromissineuvotteluja.',
        impactEconomic: '{throughput} menettelyä putkessa aiheuttaa mahdollisia taloudellisia sääntelyvaikutuksia.',
        impactEconomicStrong: 'Tehokas käsittely tukee ennakoitavia liiketoiminnan suunnitteluhorisontteja.',
        impactEconomicWeak: 'Viivästyneet menettelyt luovat sääntelyepävarmuutta asianomaisille sektoreille.',
        impactSocial: 'Putkilinjan käsittelykapasiteetti vaikuttaa suoraan sosiaalipolitiikan lainsäädännön tahtiin. Nykyinen läpimeno {throughput} menettelyä muokkaa aikataulua.',
        impactLegal: 'Lainsäädäntöputki {pct}% terveydellä vaikuttaa uusien EU:n oikeudellisten välineiden määrään ja tahtiin.',
        impactGeopolitical: 'EU:n lainsäädäntökapasiteetti {pct}% terveydellä vaikuttaa parlamentin uskottavuuteen kansainvälisissä neuvotteluissa.',
        outlookGood: 'Lainsäädäntöputki {pct}% terveydellä ja {throughput} läpimenolla asemoi parlamentin jatkuvaan tuottavaan tuotantoon.',
        ...
        mistakeAlternative: 'Aikaisempi puuttuminen priorisoidulla aikataulutuksella olisi voinut ylläpitää putkilinjan terveyttä yli 50%.',
        actionHealth: 'Putkilinjan terveys {pct}%',
        actionThroughput: 'Läpimenoaste {throughput}',
        consequenceStrong: 'Vahva putkilinjan terveys ({pct}%) osoittaa tehokasta lainsäädännöllistä käsittelykapasiteettia.',
        consequenceModerate: 'Kohtalainen putkilinjan terveys ({pct}%) osoittaa kohtalaista lainsäädännöllistä käsittelykapasiteettia.',
        consequenceWeak: 'Heikko putkilinjan terveys ({pct}%) osoittaa rajoitettua lainsäädännöllistä käsittelykapasiteettia.',
        consequenceThroughputHigh: '{throughput} menettelyn läpimeno heijastaa tuottavaa lainsäädännöllistä tuotantoa.',
        consequenceThroughputMedium: '{throughput} menettelyn läpimeno osoittaa kohtalaista käsittelykapasiteettia.',
        consequenceThroughputLow: '{throughput} menettelyn läpimeno signaloi mahdollisia pullonkauloja.',
        stakeholderWinnerActor: 'Parlamentin puhemiehistö',
        stakeholderWinnerReason: 'Putkilinjan terveys {pct}% osoittaa tehokasta lainsäädännöllistä koordinointia.',
        stakeholderLoserActor: 'Odottavan lainsäädännön sponsorit',
        stakeholderLoserReason: 'Putkilinjan terveys {pct}% tarkoittaa, että odottava lainsäädäntö kohtaa viivästyksiä.',
    ...
    de: {
        ...
        whatNoProposals: 'Bewertung der Gesetzgebungspipeline am {date}: Gesundheitswert {pct}%, Durchsatzrate {throughput}. Keine neuen Vorschläge in diesem Zeitraum festgestellt.',
        ...
        whenCumulative: 'Der Gesundheitszustand der Pipeline spiegelt den kumulativen Gesetzgebungsfortschritt wider',
        whyStrong: 'Die Gesetzgebungspipeline arbeitet mit {pct}% Gesundheit und einem Durchsatz von {throughput} Verfahren, was auf eine starke institutionelle Kapazität hinweist.',
        whyModerate: 'Die Pipeline-Gesundheit von {pct}% mit einem Durchsatz von {throughput} spiegelt eine moderate gesetzgeberische Verarbeitungskapazität wider.',
        whyWeak: 'Die Gesundheit der Gesetzgebungspipeline von {pct}% mit einem Durchsatz von {throughput} signalisiert erhebliche Verarbeitungsherausforderungen.',
        impactPolitical: 'Die Gesetzgebungspipeline mit {pct}% Gesundheit prägt die Verhandlungsdynamik der Fraktionen.',
        impactPoliticalStrong: 'Starker Durchsatz ermöglicht Koalitionsbildung bei Prioritätsdossiers.',
        impactPoliticalWeak: 'Engpassdruck kann Kompromissverhandlungen erzwingen.',
        impactEconomic: '{throughput} Verfahren in der Pipeline bergen potenzielle wirtschaftliche Regulierungsfolgen.',
        impactEconomicStrong: 'Effiziente Verarbeitung unterstützt vorhersehbare Geschäftsplanungshorizonte.',
        impactEconomicWeak: 'Verzögerte Verfahren schaffen regulatorische Unsicherheit für betroffene Sektoren.',
        impactSocial: 'Die Verarbeitungskapazität der Pipeline beeinflusst direkt das Tempo der Sozialgesetzgebung. Der aktuelle Durchsatz von {throughput} Verfahren prägt den Zeitplan.',
        impactLegal: 'Die Gesetzgebungspipeline mit {pct}% Gesundheit beeinflusst Umfang und Tempo neuer EU-Rechtsinstrumente.',
        impactGeopolitical: 'Die EU-Gesetzgebungskapazität mit {pct}% Gesundheit beeinflusst die Glaubwürdigkeit des Parlaments in internationalen Verhandlungen.',
        outlookGood: 'Die Gesetzgebungspipeline mit {pct}% Gesundheit und Durchsatz von {throughput} positioniert das Parlament für eine weiterhin produktive Leistung.',
        outlookConcern: 'Die Pipeline-Gesundheit von {pct}% erfordert Aufmerksamkeit der Gesetzgebungskoordinatoren.',
        mistakeDescription: 'Pipeline-Gesundheit fiel auf {pct}%',
        mistakeAlternative: 'Früheres Eingreifen durch priorisierte Terminplanung hätte die Pipeline-Gesundheit über 50% halten können.',
        actionHealth: 'Pipeline-Gesundheit bei {pct}%',
        actionThroughput: 'Durchsatzrate bei {throughput}',
        consequenceStrong: 'Starke Pipeline-Gesundheit ({pct}%) zeigt effiziente gesetzgeberische Verarbeitungskapazität.',
        consequenceModerate: 'Moderate Pipeline-Gesundheit ({pct}%) zeigt moderate gesetzgeberische Verarbeitungskapazität.',
        consequenceWeak: 'Schwache Pipeline-Gesundheit ({pct}%) zeigt eingeschränkte gesetzgeberische Verarbeitungskapazität.',
        consequenceThroughputHigh: 'Durchsatz von {throughput} Verfahren spiegelt produktive gesetzgeberische Leistung wider.',
        consequenceThroughputMedium: 'Durchsatz von {throughput} Verfahren zeigt moderate Verarbeitungskapazität.',
        consequenceThroughputLow: 'Durchsatz von {throughput} Verfahren signalisiert potenzielle Engpässe.',
        stakeholderWinnerActor: 'Parlamentspräsidium',
        stakeholderWinnerReason: 'Pipeline-Gesundheit von {pct}% demonstriert effektive gesetzgeberische Koordinierung.',
        stakeholderLoserActor: 'Sponsoren ausstehender Gesetzgebung',
        stakeholderLoserReason: 'Pipeline-Gesundheit von {pct}% bedeutet Verzögerungen für ausstehende Gesetzgebung.',
    ...
    fr: {
        ...
        whatNoProposals: 'Évaluation du pipeline législatif au {date}: Score de santé {pct}%, taux de débit {throughput}. Aucune nouvelle proposition détectée durant cette période.',
        ...
        whyStrong: 'Le pipeline législatif fonctionne à {pct}% de santé avec un débit de {throughput} procédures, indiquant une forte capacité institutionnelle.',
        whyModerate: 'La santé du pipeline à {pct}% avec un débit de {throughput} reflète une capacité de traitement législatif modérée.',
        whyWeak: 'La santé du pipeline législatif à {pct}% avec un débit de {throughput} signale des défis de traitement significatifs.',
        impactPolitical: 'Le pipeline législatif à {pct}% de santé façonne la dynamique de négociation des groupes politiques.',
        impactPoliticalStrong: 'Un fort débit permet la construction de coalitions sur les dossiers prioritaires.',
        impactPoliticalWeak: 'La pression des goulots peut imposer des négociations de compromis.',
        impactEconomic: '{throughput} procédures dans le pipeline comportent des implications réglementaires économiques potentielles.',
        impactEconomicStrong: "Un traitement efficace soutient des horizons de planification d'entreprise prévisibles.",
        impactEconomicWeak: 'Les procédures retardées créent une incertitude réglementaire pour les secteurs concernés.',
        impactSocial: 'La capacité de traitement du pipeline affecte directement le rythme de la législation sociale. Le débit actuel de {throughput} procédures façonne le calendrier.',
        impactLegal: "Le pipeline législatif à {pct}% de santé influence le volume et le rythme des nouveaux instruments juridiques de l'UE.",
        impactGeopolitical: "La capacité législative de l'UE à {pct}% de santé affecte la crédibilité du Parlement dans les négociations internationales.",
        outlookGood: 'Le pipeline législatif à {pct}% de santé avec un débit de {throughput} positionne le Parlement pour une production continue.',
        outlookConcern: 'La santé du pipeline à {pct}% nécessite une attention des coordinateurs législatifs.',
        mistakeDescription: 'La santé du pipeline est tombée à {pct}%',
        mistakeAlternative: 'Une intervention plus précoce par une programmation prioritaire aurait pu maintenir la santé du pipeline au-dessus de 50%.',
        actionHealth: 'Santé du pipeline à {pct}%',
        actionThroughput: 'Taux de débit à {throughput}',
        consequenceStrong: 'Une forte santé du pipeline ({pct}%) indique une capacité de traitement législatif efficace.',
        consequenceModerate: 'Une santé modérée du pipeline ({pct}%) indique une capacité de traitement législatif modérée.',
        consequenceWeak: 'Une faible santé du pipeline ({pct}%) indique une capacité de traitement législatif contrainte.',
        consequenceThroughputHigh: 'Un débit de {throughput} procédures reflète une production législative productive.',
        consequenceThroughputMedium: 'Un débit de {throughput} procédures indique une capacité de traitement modérée.',
        consequenceThroughputLow: "Un débit de {throughput} procédures signale des goulots d'étranglement potentiels.",
        stakeholderWinnerActor: 'Présidence du Parlement',
        stakeholderWinnerReason: 'La santé du pipeline à {pct}% démontre une coordination législative efficace.',
        stakeholderLoserActor: 'Promoteurs de la législation en attente',
        stakeholderLoserReason: 'La santé du pipeline à {pct}% signifie des retards pour la législation en attente.',
    ...
    es: {
        ...
        whatNoProposals: 'Evaluación del pipeline legislativo a {date}: Puntuación de salud {pct}%, tasa de rendimiento {throughput}. No se detectaron nuevas propuestas en este período.',
        ...
        whyStrong: 'El pipeline legislativo opera con {pct}% de salud y un rendimiento de {throughput} procedimientos, indicando una fuerte capacidad institucional.',
        whyModerate: 'La salud del pipeline al {pct}% con rendimiento de {throughput} refleja una capacidad de procesamiento legislativo moderada.',
        whyWeak: 'La salud del pipeline legislativo al {pct}% con rendimiento de {throughput} señala desafíos significativos de procesamiento.',
        impactPolitical: 'El pipeline legislativo al {pct}% de salud configura la dinámica de negociación de los grupos políticos.',
        impactPoliticalStrong: 'Un fuerte rendimiento permite la construcción de coaliciones en expedientes prioritarios.',
        impactPoliticalWeak: 'La presión de los cuellos de botella puede forzar negociaciones de compromiso.',
        impactEconomic: '{throughput} procedimientos en el pipeline conllevan implicaciones regulatorias económicas potenciales.',
        impactEconomicStrong: 'Un procesamiento eficiente apoya horizontes de planificación empresarial predecibles.',
        impactEconomicWeak: 'Los procedimientos retrasados crean incertidumbre regulatoria para los sectores afectados.',
        impactSocial: 'La capacidad de procesamiento del pipeline afecta directamente el ritmo de la legislación social. El rendimiento actual de {throughput} procedimientos configura el cronograma.',
        impactLegal: 'El pipeline legislativo al {pct}% de salud influye en el volumen y ritmo de los nuevos instrumentos jurídicos de la UE.',
        impactGeopolitical: 'La capacidad legislativa de la UE al {pct}% de salud afecta la credibilidad del Parlamento en negociaciones internacionales.',
        outlookGood: 'El pipeline legislativo al {pct}% de salud con rendimiento de {throughput} posiciona al Parlamento para una producción continua.',
        outlookConcern: 'La salud del pipeline al {pct}% requiere atención de los coordinadores legislativos.',
        mistakeDescription: 'La salud del pipeline cayó al {pct}%',
        mistakeAlternative: 'Una intervención más temprana mediante programación priorizada podría haber mantenido la salud del pipeline por encima del 50%.',
        actionHealth: 'Salud del pipeline al {pct}%',
        actionThroughput: 'Tasa de rendimiento en {throughput}',
        consequenceStrong: 'Una fuerte salud del pipeline ({pct}%) indica una capacidad de procesamiento legislativo eficiente.',
        consequenceModerate: 'Una salud moderada del pipeline ({pct}%) indica una capacidad de procesamiento legislativo moderada.',
        consequenceWeak: 'Una salud débil del pipeline ({pct}%) indica una capacidad de procesamiento legislativo restringida.',
        consequenceThroughputHigh: 'Un rendimiento de {throughput} procedimientos refleja una producción legislativa productiva.',
        consequenceThroughputMedium: 'Un rendimiento de {throughput} procedimientos indica una capacidad de procesamiento moderada.',
        consequenceThroughputLow: 'Un rendimiento de {throughput} procedimientos señala posibles cuellos de botella.',
        stakeholderWinnerActor: 'Presidencia del Parlamento',
        stakeholderWinnerReason: 'La salud del pipeline al {pct}% demuestra una coordinación legislativa efectiva.',
        stakeholderLoserActor: 'Promotores de legislación pendiente',
        stakeholderLoserReason: 'La salud del pipeline al {pct}% significa retrasos para la legislación pendiente.',
    ...
    nl: {
        ...
        whatNoProposals: 'Wetgevingspijplijnbeoordeling per {date}: Gezondheidsscore {pct}%, doorvoersnelheid {throughput}. Geen nieuwe voorstellen gedetecteerd in deze periode.',
        ...
        whenCumulative: 'De gezondheid van de pijplijn weerspiegelt de cumulatieve wetgevingsvoortgang',
        whyStrong: 'De wetgevingspijplijn functioneert met {pct}% gezondheid en een doorvoer van {throughput} procedures, wat wijst op sterke institutionele capaciteit.',
        whyModerate: 'De pijplijngezondheid van {pct}% met een doorvoer van {throughput} weerspiegelt een matige wetgevende verwerkingscapaciteit.',
        whyWeak: 'De gezondheid van de wetgevingspijplijn van {pct}% met een doorvoer van {throughput} signaleert aanzienlijke verwerkingsuitdagingen.',
        impactPolitical: 'De wetgevingspijplijn met {pct}% gezondheid vormt de onderhandelingsdynamiek van de politieke fracties.',
        impactPoliticalStrong: 'Sterke doorvoer maakt coalitievorming rond prioritaire dossiers mogelijk.',
        impactPoliticalWeak: 'Knelpuntdruk kan compromisonderhandelingen afdwingen.',
        impactEconomic: '{throughput} procedures in de pijplijn hebben potentiële economische regelgevingsgevolgen.',
        impactEconomicStrong: 'Efficiënte verwerking ondersteunt voorspelbare bedrijfsplanningshorizonten.',
        impactEconomicWeak: 'Vertraagde procedures creëren regelgevingsonzekerheid voor getroffen sectoren.',
        impactSocial: 'De verwerkingscapaciteit van de pijplijn beïnvloedt rechtstreeks het tempo van het sociaal beleid. De huidige doorvoer van {throughput} procedures bepaalt het tijdschema.',
        impactLegal: 'De wetgevingspijplijn met {pct}% gezondheid beïnvloedt het volume en tempo van nieuwe EU-rechtsinstrumenten.',
        impactGeopolitical: 'De EU-wetgevingscapaciteit met {pct}% gezondheid beïnvloedt de geloofwaardigheid van het Parlement in internationale onderhandelingen.',
        outlookGood: 'De wetgevingspijplijn met {pct}% gezondheid en doorvoer van {throughput} positioneert het Parlement voor aanhoudende productieve output.',
        outlookConcern: 'De pijplijngezondheid van {pct}% vereist aandacht van wetgevingscoördinatoren.',
        mistakeDescription: 'Pijplijngezondheid daalde naar {pct}%',
        mistakeAlternative: 'Eerdere interventie door geprioriteerde planning had de pijplijngezondheid boven 50% kunnen houden.',
        actionHealth: 'Pijplijngezondheid op {pct}%',
        actionThroughput: 'Doorvoersnelheid op {throughput}',
        consequenceStrong: 'Sterke pijplijngezondheid ({pct}%) duidt op efficiënte wetgevende verwerkingscapaciteit.',
        consequenceModerate: 'Matige pijplijngezondheid ({pct}%) duidt op matige wetgevende verwerkingscapaciteit.',
        consequenceWeak: 'Zwakke pijplijngezondheid ({pct}%) duidt op beperkte wetgevende verwerkingscapaciteit.',
        consequenceThroughputHigh: 'Doorvoer van {throughput} procedures weerspiegelt productieve wetgevende output.',
        consequenceThroughputMedium: 'Doorvoer van {throughput} procedures duidt op matige verwerkingscapaciteit.',
        consequenceThroughputLow: 'Doorvoer van {throughput} procedures signaleert potentiële knelpunten.',
        stakeholderWinnerActor: 'Parlementspresidium',
        stakeholderWinnerReason: 'Pijplijngezondheid van {pct}% demonstreert effectieve wetgevende coördinatie.',
        stakeholderLoserActor: 'Sponsoren van hangende wetgeving',
        stakeholderLoserReason: 'Pijplijngezondheid van {pct}% betekent vertragingen voor hangende wetgeving.',
    ...
    ar: {
        ...
        whatNoProposals: 'تقييم خط أنابيب التشريع في {date}: درجة الصحة {pct}%، معدل الإنتاجية {throughput}. لم يتم الكشف عن مقترحات جديدة في هذه الفترة.',
        ...
        whyStrong: 'يعمل خط أنابيب التشريع بصحة {pct}% وإنتاجية {throughput} إجراء، مما يشير إلى قدرة مؤسسية قوية.',
        whyModerate: 'صحة خط الأنابيب عند {pct}% مع إنتاجية {throughput} تعكس قدرة معالجة تشريعية معتدلة.',
        whyWeak: 'صحة خط أنابيب التشريع عند {pct}% مع إنتاجية {throughput} تشير إلى تحديات معالجة كبيرة.',
        impactPolitical: 'خط أنابيب التشريع بصحة {pct}% يشكل ديناميكيات التفاوض بين المجموعات السياسية.',
        ...
        impactSocial: 'تؤثر قدرة معالجة خط الأنابيب مباشرة على وتيرة التشريعات الاجتماعية. الإنتاجية الحالية البالغة {throughput} إجراء تشكل الجدول الزمني.',
        impactLegal: 'خط أنابيب التشريع بصحة {pct}% يؤثر على حجم ووتيرة الصكوك القانونية الجديدة للاتحاد الأوروبي.',
        impactGeopolitical: 'القدرة التشريعية للاتحاد الأوروبي بصحة {pct}% تؤثر على مصداقية البرلمان في المفاوضات الدولية.',
        outlookGood: 'خط أنابيب التشريع بصحة {pct}% وإنتاجية {throughput} يضع البرلمان في موقع لاستمرار الإنتاج.',
        outlookConcern: 'صحة خط الأنابيب عند {pct}% تتطلب اهتمام منسقي التشريع.',
        mistakeDescription: 'انخفضت صحة خط الأنابيب إلى {pct}%',
        mistakeAlternative: 'التدخل المبكر من خلال الجدولة ذات الأولوية كان يمكن أن يحافظ على صحة خط الأنابيب فوق 50%.',
    ...
    he: {
        ...
        whatNoProposals: 'הערכת צינור חקיקה נכון ל-{date}: ציון בריאות {pct}%, קצב תפוקה {throughput}. לא זוהו הצעות חדשות בתקופה זו.',
        ...
        whyStrong: 'צינור החקיקה פועל בבריאות {pct}% עם תפוקה של {throughput} הליכים, המצביע על יכולת מוסדית חזקה.',
        whyModerate: 'בריאות הצינור ב-{pct}% עם תפוקה של {throughput} משקפת יכולת עיבוד חקיקתית מתונה.',
        whyWeak: 'בריאות צינור החקיקה ב-{pct}% עם תפוקה של {throughput} מסמנת אתגרי עיבוד משמעותיים.',
        impactPolitical: 'צינור החקיקה בבריאות {pct}% מעצב את דינמיקת המשא ומתן של הקבוצות הפוליטיות.',
        ...
        impactSocial: 'יכולת העיבוד של הצינור משפיעה ישירות על קצב החקיקה החברתית. התפוקה הנוכחית של {throughput} הליכים מעצבת את לוח הזמנים.',
        impactLegal: 'צינור החקיקה בבריאות {pct}% משפיע על היקף וקצב המכשירים המשפטיים החדשים של האיחוד.',
        impactGeopolitical: 'יכולת החקיקה של האיחוד בבריאות {pct}% משפיעה על אמינות הפרלמנט במשא ומתן בינלאומי.',
        outlookGood: 'צינור החקיקה בבריאות {pct}% עם תפוקה של {throughput} ממקם את הפרלמנט להמשך תפוקה פרודוקטיבית.',
        outlookConcern: 'בריאות הצינור ב-{pct}% דורשת תשומת לב מרכזי חקיקה.',
        mistakeDescription: 'בריאות הצינור ירדה ל-{pct}%',
        mistakeAlternative: 'התערבות מוקדמת יותר באמצעות תזמון מועדף הייתה יכולה לשמר את בריאות הצינור מעל 50%.',
    ...
    ja: {
        ...
        whatNoProposals: '{date}時点の立法パイプライン評価：健全性スコア{pct}%、スループット率{throughput}。この期間に新規提案は検出されませんでした。',
        ...
        whyStrong: '立法パイプラインは健全性{pct}%、スループット{throughput}手続きで運用されており、強力な制度的処理能力を示しています。',
        whyModerate: 'パイプライン健全性{pct}%、スループット{throughput}は中程度の立法処理能力を反映しています。',
        whyWeak: '立法パイプライン健全性{pct}%、スループット{throughput}は重大な処理課題を示しています。',
        ...
        impactSocial: 'パイプラインの処理能力は社会政策立法の進行速度に直接影響します。現在の{throughput}手続きのスループットがスケジュールを形成しています。',
        impactLegal: '健全性{pct}%の立法パイプラインは、EU官報に掲載される新しいEU法的文書の量とペースに影響を与えます。',
        impactGeopolitical: '健全性{pct}%のEU立法能力は、国際交渉における議会の信頼性に影響を与えます。',
        outlookGood: '健全性{pct}%、スループット{throughput}の立法パイプラインは、議会を継続的に生産的な状態に位置づけています。',
        outlookConcern: 'パイプライン健全性{pct}%は立法コーディネーターの注意を必要としています。',
        mistakeDescription: 'パイプラインの健全性が{pct}%に低下',
        mistakeAlternative: '優先的なスケジューリングによる早期介入により、パイプラインの健全性を50%以上に維持できた可能性があります。',
        actionHealth: 'パイプライン健全性{pct}%',
        actionThroughput: 'スループット率{throughput}',
        consequenceStrong: '強力なパイプライン健全性（{pct}%）は効率的な立法処理能力を示しています。',
        consequenceModerate: '中程度のパイプライン健全性（{pct}%）は中程度の立法処理能力を示しています。',
        consequenceWeak: '弱いパイプライン健全性（{pct}%）は制約された立法処理能力を示しています。',
        consequenceThroughputHigh: '{throughput}手続きのスループットは生産的な立法成果を反映しています。',
        consequenceThroughputMedium: '{throughput}手続きのスループットは中程度の処理能力を示しています。',
        consequenceThroughputLow: '{throughput}手続きのスループットは潜在的なボトルネックを示唆しています。',
    ...
    ko: {
        ...
        whatNoProposals: '{date} 기준 입법 파이프라인 평가: 건강 점수 {pct}%, 처리율 {throughput}. 이 기간 동안 새로운 제안이 감지되지 않았습니다.',
        ...
        whyStrong: '입법 파이프라인이 건강 {pct}%, 처리량 {throughput} 절차로 운영되어 강력한 제도적 역량을 나타냅니다.',
        whyModerate: '파이프라인 건강 {pct}%, 처리량 {throughput}은 보통의 입법 처리 역량을 반영합니다.',
        ...
        impactSocial: '파이프라인의 처리 역량은 사회 정책 입법의 속도에 직접 영향을 미칩니다. 현재 {throughput} 절차의 처리율이 일정을 형성합니다.',
        impactLegal: '건강 {pct}%의 입법 파이프라인은 EU 관보에 게재되는 새로운 EU 법적 문서의 양과 속도에 영향을 미칩니다.',
        impactGeopolitical: '건강 {pct}%의 EU 입법 역량은 국제 협상에서 의회의 신뢰도에 영향을 미칩니다.',
        outlookGood: '건강 {pct}%, 처리량 {throughput}의 입법 파이프라인은 의회를 지속적으로 생산적인 위치에 놓습니다.',
        outlookConcern: '파이프라인 건강 {pct}%는 입법 조정관의 주의가 필요합니다.',
        mistakeDescription: '파이프라인 건강이 {pct}%로 하락',
        mistakeAlternative: '우선 일정 조정을 통한 조기 개입으로 파이프라인 건강을 50% 이상으로 유지할 수 있었습니다.',
    ...
    zh: {
        ...
        whatNoProposals: '{date}立法管道评估：健康分数{pct}%，吞吐率{throughput}。本期间未检测到新提案。',
        ...
        impactSocial: '管道的处理能力直接影响社会政策立法的速度。当前{throughput}程序的吞吐量塑造了时间表。',
...
export const STAKEHOLDER_REASONING_STRINGS = {
    en: {
        politicalGroups: 'This parliamentary activity on "{topic}" has {impact} implications for political group dynamics, affecting coalition-building strategies and inter-group negotiation positions.',
        civilSociety: 'Civil society organisations monitoring "{topic}" face {impact} impact on transparency, democratic participation, and citizens\' rights advocacy.',
        industry: 'Industry and business stakeholders observe {impact} regulatory implications from "{topic}", affecting compliance requirements and market conditions.',
        nationalGovts: 'National governments assess {impact} impact from "{topic}" on subsidiarity, implementation requirements, and member state policy alignment.',
        citizens: 'EU citizens experience {impact} consequences from "{topic}" in terms of rights, services, and democratic representation.',
        euInstitutions: 'EU institutional dynamics show {impact} effects from "{topic}", influencing inter-institutional relations between Parliament, Commission, and Council.',
        impactSignificant: 'significant',
        impactModerate: 'moderate',
        impactLimited: 'limited',
        genericFallback: 'This parliamentary activity on "{topic}" has {impact} implications for stakeholders involved in EU legislative processes.',
    },
    sv: {
        politicalGroups: 'Denna parlamentariska aktivitet om "{topic}" har {impact} konsekvenser för politiska gruppers dynamik, vilket påverkar koalitionsbyggande och förhandlingspositioner.',
        civilSociety: 'Civilsamhällesorganisationer som övervakar "{topic}" påverkas {impact} gällande transparens, demokratiskt deltagande och medborgarrättsarbete.',
        industry: 'Bransch- och företagsintressenter observerar {impact} regulatoriska konsekvenser av "{topic}", vilket påverkar efterlevnadskrav och marknadsförhållanden.',
        nationalGovts: 'Nationella regeringar bedömer {impact} påverkan från "{topic}" på subsidiaritet, genomförandekrav och medlemsstaternas policysamstämmighet.',
        citizens: 'EU-medborgare upplever {impact} konsekvenser av "{topic}" gällande rättigheter, tjänster och demokratisk representation.',
        euInstitutions: 'EU:s institutionella dynamik visar {impact} effekter av "{topic}", vilket påverkar interinstitutionella relationer mellan parlament, kommission och råd.',
        impactSignificant: 'betydande',
        impactModerate: 'måttliga',
        impactLimited: 'begränsade',
        genericFallback: 'Denna parlamentariska aktivitet om "{topic}" har {impact} konsekvenser för intressenter involverade i EU:s lagstiftningsprocesser.',
    },
    da: {
        politicalGroups: 'Denne parlamentariske aktivitet om "{topic}" har {impact} konsekvenser for politiske gruppers dynamik.',
        civilSociety: 'Civilsamfundsorganisationer, der overvåger "{topic}", står over for {impact} indvirkning på gennemsigtighed og demokratisk deltagelse.',
        industry: 'Erhvervs- og industriinteressenter observerer {impact} reguleringsmæssige konsekvenser af "{topic}".',
        nationalGovts: 'Nationale regeringer vurderer {impact} indvirkning fra "{topic}" på subsidiaritet og gennemførelseskrav.',
        citizens: 'EU-borgere oplever {impact} konsekvenser af "{topic}" med hensyn til rettigheder og demokratisk repræsentation.',
        ...
        genericFallback: 'Denne parlamentariske aktivitet om "{topic}" har {impact} konsekvenser for interessenter involveret i EU\'s lovgivningsprocesser.',
    },
    no: {
        politicalGroups: 'Denne parlamentariske aktiviteten om "{topic}" har {impact} konsekvenser for politiske gruppers dynamikk.',
        civilSociety: 'Sivilsamfunnsorganisasjoner som overvåker "{topic}" møter {impact} påvirkning på åpenhet og demokratisk deltakelse.',
        industry: 'Bransje- og næringslivsinteressenter observerer {impact} regulatoriske konsekvenser av "{topic}".',
        nationalGovts: 'Nasjonale regjeringer vurderer {impact} påvirkning fra "{topic}" på subsidiaritet og gjennomføringskrav.',
        citizens: 'EU-borgere opplever {impact} konsekvenser av "{topic}" med hensyn til rettigheter og demokratisk representasjon.',
        euInstitutions: 'EUs institusjonelle dynamikk viser {impact} effekter av "{topic}".',
        impactSignificant: 'betydelige',
        impactModerate: 'moderate',
        impactLimited: 'begrensede',
        genericFallback: 'Denne parlamentariske aktiviteten om "{topic}" har {impact} konsekvenser for interessenter involvert i EUs lovgivningsprosesser.',
    },
    fi: {
        politicalGroups: 'Tämä parlamentaarinen toiminta aiheesta "{topic}" vaikuttaa {impact} poliittisten ryhmien dynamiikkaan.',
        civilSociety: 'Kansalaisyhteiskunnan organisaatiot, jotka seuraavat "{topic}", kohtaavat {impact} vaikutuksia avoimuuteen ja demokraattiseen osallistumiseen.',
        industry: 'Teollisuus- ja yrityssidosryhmät havaitsevat {impact} sääntelyn vaikutuksia aiheesta "{topic}".',
        nationalGovts: 'Kansalliset hallitukset arvioivat {impact} vaikutuksia aiheesta "{topic}" toissijaisuuteen ja täytäntöönpanovaatimuksiin.',
        citizens: 'EU-kansalaiset kokevat {impact} seurauksia aiheesta "{topic}" oikeuksien ja demokraattisen edustuksen osalta.',
        ...
        genericFallback: 'Tämä parlamentaarinen toiminta aiheesta "{topic}" vaikuttaa {impact} EU:n lainsäädäntöprosesseihin osallistuviin sidosryhmiin.',
    },
    de: {
        politicalGroups: 'Diese parlamentarische Aktivität zu "{topic}" hat {impact} Auswirkungen auf die Dynamik der Fraktionen.',
        civilSociety: 'Zivilgesellschaftliche Organisationen, die "{topic}" beobachten, sehen sich {impact} Auswirkungen auf Transparenz und demokratische Teilhabe gegenüber.',
        industry: 'Wirtschafts- und Industrieakteure beobachten {impact} regulatorische Auswirkungen von "{topic}".',
        nationalGovts: 'Nationale Regierungen bewerten {impact} Auswirkungen von "{topic}" auf Subsidiarität und Umsetzungsanforderungen.',
        citizens: 'EU-Bürger erfahren {impact} Auswirkungen von "{topic}" auf Rechte und demokratische Vertretung.',
        ...
        genericFallback: 'Diese parlamentarische Aktivität zu "{topic}" hat {impact} Auswirkungen auf die an EU-Gesetzgebungsprozessen beteiligten Interessengruppen.',
    },
    fr: {
        politicalGroups: 'Cette activité parlementaire sur "{topic}" a des implications {impact} pour la dynamique des groupes politiques.',
        civilSociety: 'Les organisations de la société civile surveillant "{topic}" font face à un impact {impact} sur la transparence et la participation démocratique.',
        industry: 'Les acteurs industriels et économiques observent des implications réglementaires {impact} de "{topic}".',
        nationalGovts: 'Les gouvernements nationaux évaluent un impact {impact} de "{topic}" sur la subsidiarité et les exigences de mise en œuvre.',
        citizens: 'Les citoyens de l\'UE subissent des conséquences {impact} de "{topic}" en termes de droits et de représentation démocratique.',
        euInstitutions: 'La dynamique institutionnelle de l\'UE montre des effets {impact} de "{topic}".',
        impactSignificant: 'significatives',
        impactModerate: 'modérées',
        impactLimited: 'limitées',
        genericFallback: 'Cette activité parlementaire sur "{topic}" a des implications {impact} pour les parties prenantes impliquées dans les processus législatifs de l\'UE.',
    },
    es: {
        politicalGroups: 'Esta actividad parlamentaria sobre "{topic}" tiene implicaciones {impact} para la dinámica de los grupos políticos.',
        civilSociety: 'Las organizaciones de la sociedad civil que monitorean "{topic}" enfrentan un impacto {impact} en la transparencia y la participación democrática.',
        industry: 'Los actores industriales y empresariales observan implicaciones regulatorias {impact} de "{topic}".',
        nationalGovts: 'Los gobiernos nacionales evalúan un impacto {impact} de "{topic}" sobre la subsidiariedad y los requisitos de implementación.',
        citizens: 'Los ciudadanos de la UE experimentan consecuencias {impact} de "{topic}" en términos de derechos y representación democrática.',
        ...
        genericFallback: 'Esta actividad parlamentaria sobre "{topic}" tiene implicaciones {impact} para las partes interesadas involucradas en los procesos legislativos de la UE.',
    },
    nl: {
        politicalGroups: 'Deze parlementaire activiteit over "{topic}" heeft {impact} gevolgen voor de dynamiek van de politieke fracties.',
        civilSociety: 'Maatschappelijke organisaties die "{topic}" monitoren, ondervinden {impact} impact op transparantie en democratische participatie.',
        industry: 'Bedrijfs- en industriebelanghebbenden observeren {impact} regelgevingsgevolgen van "{topic}".',
        nationalGovts: 'Nationale regeringen beoordelen {impact} impact van "{topic}" op subsidiariteit en uitvoeringsverplichtingen.',
        citizens: 'EU-burgers ervaren {impact} gevolgen van "{topic}" voor rechten en democratische vertegenwoordiging.',
        ...
        genericFallback: 'Deze parlementaire activiteit over "{topic}" heeft {impact} implicaties voor belanghebbenden betrokken bij EU-wetgevingsprocessen.',
    },
    ar: {
        politicalGroups: 'هذا النشاط البرلماني حول "{topic}" له تأثيرات {impact} على ديناميكيات المجموعات السياسية.',
        civilSociety: 'تواجه منظمات المجتمع المدني التي تراقب "{topic}" تأثيراً {impact} على الشفافية والمشاركة الديمقراطية.',
        industry: 'يلاحظ أصحاب المصلحة في الصناعة والأعمال آثاراً تنظيمية {impact} من "{topic}".',
        nationalGovts: 'تقيّم الحكومات الوطنية تأثيراً {impact} من "{topic}" على مبدأ التبعية ومتطلبات التنفيذ.',
        citizens: 'يواجه مواطنو الاتحاد الأوروبي عواقب {impact} من "{topic}" فيما يتعلق بالحقوق والتمثيل الديمقراطي.',
        ...
        genericFallback: 'هذا النشاط البرلماني حول "{topic}" له تداعيات {impact} على أصحاب المصلحة المشاركين في العمليات التشريعية للاتحاد الأوروبي.',
    },
    he: {
        politicalGroups: 'פעילות פרלמנטרית זו בנושא "{topic}" יש לה השלכות {impact} על דינמיקת הקבוצות הפוליטיות.',
        civilSociety: 'ארגוני חברה אזרחית העוקבים אחר "{topic}" מתמודדים עם השפעה {impact} על שקיפות והשתתפות דמוקרטית.',
        industry: 'בעלי עניין בתעשייה ובעסקים מבחינים בהשלכות רגולטוריות {impact} של "{topic}".',
        nationalGovts: 'ממשלות לאומיות מעריכות השפעה {impact} של "{topic}" על עקרון הסובסידיאריות ודרישות יישום.',
        ...
        genericFallback: 'פעילות פרלמנטרית זו בנושא "{topic}" יש לה השלכות {impact} על בעלי עניין המעורבים בתהליכי החקיקה של האיחוד האירופי.',
    },
    ja: {
        politicalGroups: '「{topic}」に関するこの議会活動は、政治グループの力学に{impact}影響を及ぼしています。',
        civilSociety: '「{topic}」を監視する市民社会組織は、透明性と民主的参加に対する{impact}影響に直面しています。',
        industry: '産業界および企業の利害関係者は、「{topic}」による{impact}規制上の影響を観察しています。',
        nationalGovts: '各国政府は、「{topic}」による補完性と実施要件への{impact}影響を評価しています。',
        ...
        impactModerate: '中程度の',
        impactLimited: '限定的な',
        genericFallback: '"{topic}"に関するこの議会活動は、EU立法プロセスに関与する利害関係者に{impact}影響を及ぼします。',
    },
    ko: {
        politicalGroups: '"{topic}"에 관한 이 의회 활동은 정치 그룹 역학에 {impact} 영향을 미칩니다.',
        civilSociety: '"{topic}"를 모니터링하는 시민 사회 조직은 투명성과 민주적 참여에 대한 {impact} 영향에 직면합니다.',
        industry: '산업계 및 기업 이해관계자는 "{topic}"로 인한 {impact} 규제 영향을 관찰합니다.',
        nationalGovts: '국가 정부는 "{topic}"로 인한 보충성 원칙과 시행 요건에 대한 {impact} 영향을 평가합니다.',
        ...
        impactModerate: '보통의',
        impactLimited: '제한적인',
        genericFallback: '"{topic}"에 관한 이 의회 활동은 EU 입법 과정에 관여하는 이해관계자에게 {impact} 영향을 미칩니다.',
    },
    zh: {
...
export const VOTING_ANALYSIS_CONTENT_STRINGS = {
    en: {
...
export const PROSPECTIVE_ANALYSIS_CONTENT_STRINGS = {
    en: {
...
export const BREAKING_ANALYSIS_CONTENT_STRINGS = {
    en: {
...
export const COMMITTEE_ANALYSIS_CONTENT_STRINGS = {
    en: {
        ...
        adoptedTextsSummary: 'The European Parliament adopted {count} texts in recent sessions, spanning environmental, economic, security, civil liberties, and agricultural policy domains.',
    ...
    sv: {
        ...
        adoptedTextsSummary: 'Europaparlamentet antog {count} texter under de senaste sessionerna inom miljö-, ekonomi-, säkerhets-, medborgerliga friheter- och jordbrukspolitiska områden.',
    ...
    da: {
        ...
        adoptedTextsSummary: 'Europa-Parlamentet vedtog {count} tekster under de seneste sessioner inden for miljø-, økonomi-, sikkerheds-, borgerrettigheds- og landbrugspolitiske områder.',
    ...
    no: {
        ...
        adoptedTextsSummary: 'Europaparlamentet vedtok {count} tekster under de siste sesjonene innen miljø-, økonomi-, sikkerhets-, borgerrettighets- og landbrukspolitiske områder.',
        ...
        adoptedTextsSummary: 'Euroopan parlamentti hyväksyi {count} tekstiä viimeisimmissä istunnoissaan ympäristö-, talous-, turvallisuus-, kansalaisvapauksien ja maatalouspolitiikan aloilla.',
        adoptedTextsSummarySingular: 'Euroopan parlamentti hyväksyi 1 tekstin äskettäisessä istunnossaan.',
    ...
    de: {
        ...
        adoptedTextsSummary: 'Das Europäische Parlament hat in den letzten Sitzungsperioden {count} Texte in den Bereichen Umwelt-, Wirtschafts-, Sicherheits-, Bürgerrechte- und Agrarpolitik verabschiedet.',
        adoptedTextsSummarySingular: 'Das Europäische Parlament hat in einer aktuellen Sitzungsperiode 1 Text verabschiedet.',
    ...
    fr: {
        ...
        adoptedTextsSummary: 'Le Parlement européen a adopté {count} textes lors des sessions récentes, couvrant les domaines de la politique environnementale, économique, sécuritaire, des libertés civiles et agricole.',
        adoptedTextsSummarySingular: "Le Parlement européen a adopté 1 texte lors d'une session récente.",
