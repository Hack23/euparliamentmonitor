...
export const BREAKING_STRINGS = {
    en: {
        ...
        breakingWhyAnomalies: '[AI_ANALYSIS_REQUIRED: voting anomalies and coalition shifts detected]',
        breakingWhyNormal: '[AI_ANALYSIS_REQUIRED: standard parliamentary activity analysis]',
        ...
        breakingNeutralReason: '[AI_ANALYSIS_REQUIRED: opposition group assessment]',
        breakingOutlookActiveFn: (date) => `[AI_ANALYSIS_REQUIRED: active session outlook for ${date}]`,
        breakingOutlookTransitionalFn: (date) => `[AI_ANALYSIS_REQUIRED: transitional period outlook for ${date}]`,
        breakingLegalObligationsConsequence: '[AI_ANALYSIS_REQUIRED: legal consequence of adopted texts]',
        breakingProcedureConsequence: '[AI_ANALYSIS_REQUIRED: procedural trajectory consequence]',
        breakingImpactPoliticalAnomalies: '[AI_ANALYSIS_REQUIRED: political impact of voting anomalies]',
        breakingImpactPoliticalNormalFn: (count) => `[AI_ANALYSIS_REQUIRED: political impact — ${count} legislative texts]`,
        breakingImpactEconomic: '[AI_ANALYSIS_REQUIRED: economic impact assessment]',
        breakingImpactSocial: "[AI_ANALYSIS_REQUIRED: social impact assessment]",
        breakingImpactLegalFn: (count) => `[AI_ANALYSIS_REQUIRED: legal impact — ${count} new instruments]`,
        breakingImpactGeopoliticalCoalition: '[AI_ANALYSIS_REQUIRED: geopolitical impact — coalition dynamics]',
        breakingImpactGeopoliticalNormal: "[AI_ANALYSIS_REQUIRED: geopolitical impact assessment]",
        breakingMistakeActor: 'Political Group Whips',
        breakingMistakeDescription: '[AI_ANALYSIS_REQUIRED: risk assessment for accelerated procedures]',
        breakingMistakeAlternative: '[AI_ANALYSIS_REQUIRED: alternative procedural strategy]',
...
export const COMMITTEE_ANALYSIS_CONTENT_STRINGS = {
    en: {
        ...
        productivityLow: 'low',
        why: '[AI_ANALYSIS_REQUIRED: committee productivity analysis — {pct}% active rate, {descriptor} productivity]',
        ...
        stakeholderNoDocs: '[AI_ANALYSIS_REQUIRED: committee inactivity assessment]',
        impactPolitical: '[AI_ANALYSIS_REQUIRED: political impact — {active}/{total} active committees]',
        impactPoliticalNone: '[AI_ANALYSIS_REQUIRED: political impact — no active committees in reporting window]',
        impactEconomic: '[AI_ANALYSIS_REQUIRED: economic impact of committee outputs]',
        impactSocial: "[AI_ANALYSIS_REQUIRED: social impact of committee work]",
        impactLegal: '[AI_ANALYSIS_REQUIRED: legal impact — {docs} documents in committee consideration]',
        impactGeopolitical: '[AI_ANALYSIS_REQUIRED: geopolitical impact of committee activities]',
        actionProcessed: '{abbr} processed {n} document(s)',
        actionConsequence: '[AI_ANALYSIS_REQUIRED: consequence of committee document processing]',
        mistakeDescription: '[AI_ANALYSIS_REQUIRED: committee inactivity assessment]',
        mistakeAlternative: '[AI_ANALYSIS_REQUIRED: alternative strategy for inactive committee]',
        outlookGood: '[AI_ANALYSIS_REQUIRED: positive outlook — {n} of {total} committees actively producing]',
        outlookConcern: '[AI_ANALYSIS_REQUIRED: concern outlook — low committee output]',
