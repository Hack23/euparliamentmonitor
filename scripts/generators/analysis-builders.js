 ...
 * @returns AI marker
 */
function buildVotingWhyText(_patterns, _polarization) {
  return AI_MARKER;
}
 ...
 * @returns AI marker
 */
function buildPropositionsWhy(_healthScore, _throughput) {
  return AI_MARKER;
}
/**
 ...
 */
function buildPropositionsImpact(_healthScore, _throughput) {
  return {
    political: AI_MARKER,
    economic: AI_MARKER,
    social: AI_MARKER,
