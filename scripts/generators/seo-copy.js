...
const SITEMAP_OVERLAYS = {
    sv: { breadcrumbHome: 'Hem', breadcrumbCurrent: 'Webbplatskarta', breadcrumbAriaLabel: 'Brödsmulor', faqHeading: 'Om webbplatskartan' },
    da: { breadcrumbHome: 'Hjem', breadcrumbCurrent: 'Sitemap', breadcrumbAriaLabel: 'Brødkrumme', faqHeading: 'Om dette sitemap' },
    no: { breadcrumbHome: 'Hjem', breadcrumbCurrent: 'Nettstedskart', breadcrumbAriaLabel: 'Brødsmulesti', faqHeading: 'Om nettstedskartet' },
    fi: { breadcrumbHome: 'Etusivu', breadcrumbCurrent: 'Sivukartta', breadcrumbAriaLabel: 'Murupolku', faqHeading: 'Tietoa sivukartasta' },
    de: { breadcrumbHome: 'Startseite', breadcrumbCurrent: 'Seitenübersicht', breadcrumbAriaLabel: 'Brotkrümelnavigation', faqHeading: 'Über diese Seitenübersicht' },
    fr: { breadcrumbHome: 'Accueil', breadcrumbCurrent: 'Plan du site', breadcrumbAriaLabel: "Fil d'Ariane", faqHeading: 'À propos du plan du site' },
    es: { breadcrumbHome: 'Inicio', breadcrumbCurrent: 'Mapa del sitio', breadcrumbAriaLabel: 'Ruta de navegación', faqHeading: 'Acerca de este mapa del sitio' },
    nl: { breadcrumbHome: 'Startpagina', breadcrumbCurrent: 'Sitemap', breadcrumbAriaLabel: 'Kruimelpad', faqHeading: 'Over deze sitemap' },
    ar: { breadcrumbHome: 'الرئيسية', breadcrumbCurrent: 'خريطة الموقع', breadcrumbAriaLabel: 'مسار التنقل', faqHeading: 'حول خريطة الموقع' },
    he: { breadcrumbHome: 'דף הבית', breadcrumbCurrent: 'מפת אתר', breadcrumbAriaLabel: 'נתיב ניווט', faqHeading: 'אודות מפת האתר' },
    ja: { breadcrumbHome: 'ホーム', breadcrumbCurrent: 'サイトマップ', breadcrumbAriaLabel: 'パンくずリスト', faqHeading: 'サイトマップについて' },
    ko: { breadcrumbHome: '홈', breadcrumbCurrent: '사이트맵', breadcrumbAriaLabel: '경로', faqHeading: '사이트맵 안내' },
    zh: { breadcrumbHome: '首页', breadcrumbCurrent: '网站地图', breadcrumbAriaLabel: '面包屑导航', faqHeading: '关于本网站地图' },
};
const PI_OVERLAYS = {
    sv: { breadcrumbHome: 'Hem', breadcrumbCurrent: 'Politisk underrättelse', breadcrumbAriaLabel: 'Brödsmulor', faqHeading: 'Om körningarna' },
    da: { breadcrumbHome: 'Hjem', breadcrumbCurrent: 'Politisk efterretning', breadcrumbAriaLabel: 'Brødkrumme', faqHeading: 'Om kørslerne' },
    no: { breadcrumbHome: 'Hjem', breadcrumbCurrent: 'Politisk etterretning', breadcrumbAriaLabel: 'Brødsmulesti', faqHeading: 'Om kjøringene' },
    fi: { breadcrumbHome: 'Etusivu', breadcrumbCurrent: 'Poliittinen tiedustelu', breadcrumbAriaLabel: 'Murupolku', faqHeading: 'Tietoa ajoista' },
    de: { breadcrumbHome: 'Startseite', breadcrumbCurrent: 'Politische Aufklärung', breadcrumbAriaLabel: 'Brotkrümelnavigation', faqHeading: 'Über die Analyseläufe' },
    fr: { breadcrumbHome: 'Accueil', breadcrumbCurrent: 'Renseignement politique', breadcrumbAriaLabel: "Fil d'Ariane", faqHeading: "À propos des exécutions d'analyse" },
    es: { breadcrumbHome: 'Inicio', breadcrumbCurrent: 'Inteligencia política', breadcrumbAriaLabel: 'Ruta de navegación', faqHeading: 'Acerca de las ejecuciones' },
    nl: { breadcrumbHome: 'Startpagina', breadcrumbCurrent: 'Politieke inlichtingen', breadcrumbAriaLabel: 'Kruimelpad', faqHeading: 'Over de analyseruns' },
    ar: { breadcrumbHome: 'الرئيسية', breadcrumbCurrent: 'الاستخبارات السياسية', breadcrumbAriaLabel: 'مسار التنقل', faqHeading: 'حول عمليات التحليل' },
    he: { breadcrumbHome: 'דף הבית', breadcrumbCurrent: 'מודיעין פוליטי', breadcrumbAriaLabel: 'נתיב ניווט', faqHeading: 'אודות הרצות הניתוח' },
    ja: { breadcrumbHome: 'ホーム', breadcrumbCurrent: '政治インテリジェンス', breadcrumbAriaLabel: 'パンくずリスト', faqHeading: '解析実行について' },
    ko: { breadcrumbHome: '홈', breadcrumbCurrent: '정치 인텔리전스', breadcrumbAriaLabel: '경로', faqHeading: '분석 실행 안내' },
    zh: { breadcrumbHome: '首页', breadcrumbCurrent: '政治情报', breadcrumbAriaLabel: '面包屑导航', faqHeading: '关于分析运行' },
};
