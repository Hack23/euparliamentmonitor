...
const NEWS_INDEX_OVERLAYS = {
    ...
    da: {
        keywords: 'Europa-Parlamentet, EU-nyheder, medlemmer, plenarmøder, AI-journalistik, parlamentarisk efterretning, EU-politik, Hack23',
    ...
    no: {
        keywords: 'Europaparlamentet, EU-nyheter, parlamentsmedlemmer, plenarsesjoner, AI-journalistikk, parlamentarisk etterretning, EU-politikk, Hack23',
        ...
        keywords: 'Euroopan parlamentti, EU-uutiset, parlamentin jäsenet, täysistunnot, AI-journalismi, parlamentaarinen tiedustelu, EU-politiikka, Hack23',
    ...
    ar: {
        keywords: 'البرلمان الأوروبي, أخبار الاتحاد الأوروبي, نواب البرلمان الأوروبي, الجلسات العامة, الصحافة بالذكاء الاصطناعي, الاستخبارات البرلمانية, سياسة الاتحاد الأوروبي, Hack23',
    ...
    he: {
        keywords: 'הפרלמנט האירופי, חדשות האיחוד האירופי, חברי פרלמנט, מליאות, עיתונאות בינה מלאכותית, מודיעין פרלמנטרי, מדיניות האיחוד האירופי, Hack23',
    ...
    ja: {
        keywords: '欧州議会, EUニュース, 欧州議会議員, 本会議, AIジャーナリズム, 議会情報分析, EU政策, Hack23',
...
const SITEMAP_OVERLAYS = {
    sv: {
        keywords: 'webbplatskarta, EU-parlamentsmonitor, arkiv, nyhetsindex, parlamentariska artiklar, transparens, RSS, Hack23',
    ...
    da: {
        keywords: 'sitemap, EU Parliament Monitor, arkiv, nyhedsindeks, parlamentariske artikler, transparens, RSS, Hack23',
    ...
    no: {
        keywords: 'nettstedskart, EU Parliament Monitor, arkiv, nyhetsindeks, parlamentariske artikler, transparens, RSS, Hack23',
        ...
        keywords: 'sivukartta, EU-parlamenttimonitori, arkisto, uutishakemisto, parlamentaariset artikkelit, läpinäkyvyys, RSS, Hack23',
    ...
    de: {
        keywords: 'Seitenübersicht, EU Parliament Monitor, Archiv, Nachrichtenindex, parlamentarische Artikel, Transparenz, RSS, Hack23',
    ...
    fr: {
        keywords: 'plan du site, EU Parliament Monitor, archives, index actualités, articles parlementaires, transparence, RSS, Hack23',
    ...
    es: {
        keywords: 'mapa del sitio, EU Parliament Monitor, archivo, índice de noticias, artículos parlamentarios, transparencia, RSS, Hack23',
    ...
    nl: {
        keywords: 'sitemap, EU Parliament Monitor, archief, nieuwsindex, parlementaire artikelen, transparantie, RSS, Hack23',
    ...
    ar: {
        keywords: 'خريطة الموقع, مراقب البرلمان الأوروبي, أرشيف, فهرس الأخبار, مقالات برلمانية, الشفافية, RSS, Hack23',
    ...
    he: {
        keywords: 'מפת אתר, מוניטור הפרלמנט האירופי, ארכיון, אינדקס חדשות, מאמרים פרלמנטריים, שקיפות, RSS, Hack23',
    ...
    ja: {
        keywords: 'サイトマップ, EU議会モニター, アーカイブ, ニュースインデックス, 議会記事, 透明性, RSS, Hack23',
