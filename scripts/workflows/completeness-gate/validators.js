 ...
 */
import { PLACEHOLDER_PATTERNS, META_DOC_HINT_RE, WEP_BAND_RE, ADMIRALTY_RE, BLUF_RE, READER_BLOCK_RE, SAT_LIST_RE, MCP_TOOL_RE, IMF_FIGURE_CLAIM_RE, WB_ECONOMIC_INDICATOR_CODE_RE, WB_ECONOMIC_CLAIM_RE, DIAGRAM_DIRS, DEFAULT_MIN_LINES, } from './constants.js';
 ...
 */
export function hasMermaid(content) {
 ...
 */
export function hasWepBand(content) {
 ...
 */
export function hasAdmiraltyGrade(content) {
 ...
 */
export function hasBluf(content) {
 ...
 */
export function hasReaderBlock(content) {
 ...
 */
export function countSatBullets(content) {
 ...
 */
export function hasImfFigureClaim(content) {
 ...
 */
export function findWbEconomicIndicator(content) {
 ...
 */
export function hasWbEconomicClaim(content) {
 ...
 */
export function resolveDataModeReduction(dataMode) {
    if (!dataMode) {
        return 1.0;
    }
 ...
 */
export function createEmptyResult(relativePath) {
    return {
        relativePath,
        lines: 0,
        issues: [],
