...
import { A_ACTOR_MAP, A_COALITION, A_COMMISSION_WP, A_COMPARATIVE_INTL, A_DEEP_ANALYSIS_EXISTING, A_DEVILS_ADVOCATE, A_EXEC_BRIEF, A_FORCES, A_FORWARD_PROJECTION, A_HISTORICAL_PARALLELS, A_IMPACT, A_INDEX, A_INTEL_ASSESSMENT, A_MANDATE_SCORECARD, A_MCP_AUDIT, A_MEDIA_FRAMING, A_PESTLE, A_PIPELINE_FORECAST, A_PRESIDENCY_TRIO, A_QUANT_SWOT, A_REFLECTION, A_RISK_MATRIX, A_SCENARIO, A_SEAT_PROJECTION, A_SIGNIFICANCE, A_STAKEHOLDER, A_SYNTHESIS, A_TERM_ARC, A_THREAT, ELECTORAL_EXTRA, LONG_HORIZON_PROSPECTIVE_EXTRA, PROSPECTIVE_MANDATORY, RETROSPECTIVE_MANDATORY, STANDARD_FEEDS, } from './artifact-paths.js';
