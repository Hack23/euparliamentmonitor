...
The April 28–29 Strasbourg plenary (attendance 663 / 92.2 % — among the highest of EP10) adopted **12 texts** dominated by three concurrent political headlines: (i) **simultaneous immunity waivers** against three right-flank MEPs — Patryk Jaki and Daniel Obajtek (ECR / Poland) and Diana Iovanovici Şoşoacă (ESN / Romania), the densest single-session cluster of JURI immunity outputs in the current term; (ii) the **2027 EU budget guidelines** (TA-10-2026-0112) opening the annual budget cycle with defence-readiness, cohesion, competitiveness, and climate-transition floors; (iii) a regulatory bundle covering **GHG accounting for transport services** and **companion-animal welfare and traceability**. The aggregate signal: the EP's mainstream majority (EPP + S&D + Renew = ~397 seats vs 361 majority threshold) is willing to operate the rule-of-law toolkit against MEPs of right-flank groups while keeping budgetary and regulatory agendas on schedule. *Confidence: HIGH on substance; MODERATE on roll-call breakdowns (4–6-week EP publication delay).*

### Three Decisions Riding On This Week

1. **The immunity-waiver cluster sets a structural precedent for EP-domestic-judiciary coordination.** Three waivers in one session, all targeting right-flank MEPs facing home-country judicial proceedings, demonstrates that the JURI Committee is operationally aligned with Polish and Romanian prosecutorial authorities and willing to act in concert. This is consequential because it converts the EP's rhetorical rule-of-law doctrine into a *procedural reflex*. ECR's internal cohesion is the variable most sensitive to this precedent — the group must choose between defending colleagues facing plausible criminal proceedings (alienating its centrist Polish faction) or acquiescing (alienating its activist wing). *Confidence: HIGH on the pattern; MODERATE on ECR's strategic response.*

2. **The 2027 budget guidelines formally lock the EP into a defence-plus-climate fiscal posture.** TA-0112 is the EP's opening salvo in the 2027 cycle and signals continuity with the post-ReArm Europe debate: elevated defence-readiness spending, sustained Ukraine support, cohesion floor protection, and climate-transition envelopes preserved. The strategic question is whether the EPP-S&D-Renew working majority can defend this composite line against (a) ECR/PfE pressure to cut climate spending and (b) S&D/Greens pressure to expand social envelopes. *Confidence: HIGH.*

3. **The Şoşoacă waiver is the EP's clearest enforcement of behavioural norms inside the chamber.** Şoşoacă has been excluded from multiple group affiliations over the term and the waiver advances proceedings related to Romanian judicial processes. Operationally, the waiver is procedural; reputationally, it is a marker of how far the EP will go in supporting national authorities against an MEP whose behaviour has consistently breached chamber decorum. The precedent value is high for any future case involving NI or marginal-group MEPs. *Confidence: HIGH on the procedural fact; LOW on broader generalisation.*

### 60-Second Read

The April plenary is an institutional-discipline week. Three immunity waivers, the budget cycle opener, a GHG-transport regulatory act, and a companion-animal welfare law — none of these are dramatic on their own, but read together they show the EP's mainstream coalition exercising the **full institutional toolkit**: budgetary authority, rule-of-law enforcement, sectoral regulation, and welfare policy. Importantly, the **EPP supports each of the four flagship votes**, including the immunity waivers — confirming that the EPP's institutionalist wing dominates when the file is procedural / rule-of-law rather than economic-regulatory.

The political-arithmetic context remains the same: 719 MEPs, 9 groups, EPP at 25.7 %, no durable supermajority. The EPP + S&D + Renew bloc (~397) is comfortably above 361 majority on rule-of-law and institutional files; it is *contested* on environmental and economic-regulatory files (the prior week's DMA-substance EPP cohesion at ~50 %). This week's flagship votes are procedural / institutional, which is precisely the territory where the bloc is most stable.

The **rule-of-law signal** sent by three right-flank waivers in one session has strategic resonance beyond Strasbourg. Polish and Romanian prosecutorial cooperation with the JURI Committee marks the maturation of EU-domestic judicial coordination architecture. Watch whether Hungarian authorities follow with a comparable request in 2026 H2 — that would be the structural test of whether this is a Polish-Romanian anomaly or a new EU norm.

### Risk Snapshot (next 6 months)

| # | Risk | Likelihood | Impact | Net |
|---|------|-----------:|------:|----:|
| 1 | ECR group fractures on subsequent immunity-related votes | MED | MED–HIGH | **Watch** |
| 2 | 2027 budget conciliation breaks on defence vs. cohesion balance | MED | HIGH | **Top** |
| 3 | National authorities use EP precedent to escalate against other MEPs | LOW–MED | MED | **Watch** |
| 4 | ESN / PfE coordinated counter-action in EP rules of procedure | LOW | MED | Watch |
| 5 | GHG-transport accounting triggers transport-sector lobbying counter-offensive | MED | MED | Watch |

### Forward Triggers (next 2–6 weeks)

- **Council 2027 draft budget (July):** distance from TA-0112 floors is the conciliation-difficulty leading indicator.
- **JURI committee agenda:** any Hungarian-origin or German-origin immunity request would significantly expand the precedent.
- **ECR group statement post-Jaki / Obajtek:** silence vs. counter-offensive reveals strategic positioning.
- **EU-Iceland PNR formal entry-into-force:** carries the LIBE-template conditions into the EU's external data-sharing toolkit.
- **EPP statement on enforcement vs. substance:** if the EPP signals openness to revisiting Q3 DMA substantive amendments, the cohesion gap is structural; if it doubles down, this week's institutional unity is the dominant frame.

### ACH — Three Competing Readings

| Hypothesis | Supporting evidence | Disconfirming evidence | Assessment |
|---|---|---|---|
| H1: Institutional-mainstream week (rule-of-law, budget, regulation in unison) | 663 attendance, EPP support across all flagship votes | DMA substance split two weeks earlier | **Strongly supported** |
| H2: Politically motivated targeting of right-flank MEPs | Three waivers, same ideological direction | Each waiver is procedurally separate, originates with national authorities | **Weakly supported** |
| H3: Routine procedural housekeeping | Most adopted texts are technical / annual | Three immunity waivers in one session is statistically anomalous | **Partially supported** — technical wrapping around politically loaded core |

### Source Quality (Admiralty grading)

- EP Open Data Portal — adopted texts (TA-10-2026-0105 / 0106 / 0108 / 0112 / 0115 / 0119 / 0120 / 0122 + plenary attendance): **A1**
- Polish and Romanian judicial-proceedings context: **B2** (public press / official statements)
- Coalition-arithmetic estimates (EPP+S&D+Renew 397 / 361 threshold): **A2**
- Forward-looking ECR cohesion projections: **C3**

### Provenance

- Run: motions analysis for window 2026-04-23 → 2026-04-30
- Primary artifacts read for this brief: `intelligence/synthesis-summary.md`, `classification/actor-mapping.md`, `risk-scoring/risk-matrix.md`, `extended/media-framing-analysis.md`.
- Data currency: 30 April 2026.
- Compliance: EP Open Data Portal feeds only; ~25 % of cohesion figures are estimates owing to 4–6-week roll-call publication delay; flagged explicitly above. GDPR-compliant.

---

*Analytical neutrality: this brief reports observable procedural facts and coalition-arithmetic. Confidence levels and competing hypotheses are explicit.*
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","edgeLabelBackground":"#1e1e1e"}}}%%
graph TD
    subgraph Mainstream_Majority["Mainstream Majority (397+ seats, ~55%)"]
        EPP["🔵 EPP\n185 seats\nWeber"]
        SD["🔴 S&D\n135 seats"]
        Renew["🟡 Renew\n77 seats"]
        Greens["🟢 Greens/EFA\n53 seats"]
    ...
    subgraph Far_Right_Bloc["Far-Right Opposition (193 seats, ~27%)"]
        PfE["🟤 PfE\n85 seats"]
        ECR["🔶 ECR\n81 seats\nJaki/Obajtek"]
        ESN["⚫ ESN\n27 seats\nŞoşoacă"]
    end
    subgraph Non_Aligned["Non-Aligned"]
        NI["⬜ NI\n30 seats"]
    end
    subgraph Subjects["Immunity Subjects"]
        Jaki["❌ Jaki\nECR/PL"]
        Obajtek["❌ Obajtek\nECR/PL"]
        Sosoacă["❌ Şoşoacă\nESN/RO"]
    end
    subgraph Judicial["National Judicial Authorities"]
        PolishProse["🏛 Polish\nProsecution"]
        RomanianProse["🏛 Romanian\nProsecution"]
    end
    EPP -->|"anchor coalition"| SD
    SD -->|"stable majority"| Renew
    Renew -->|"bridge votes"| EPP
    EPP -.->|"case-by-case"| Greens
    ECR -->|"members"| Jaki
    ECR -->|"members"| Obajtek
    ESN -->|"member"| Sosoacă
    Mainstream_Majority ==>|"VOTED TO WAIVE\n3 immunities"| Jaki
    Mainstream_Majority ==>|"VOTED TO WAIVE\n3 immunities"| Obajtek
    Mainstream_Majority ==>|"VOTED TO WAIVE\n3 immunities"| Sosoacă
    Jaki -->|"proceedings\nenabled"| PolishProse
    Obajtek -->|"proceedings\nenabled"| PolishProse
    Sosoacă -->|"proceedings\nenabled"| RomanianProse
```
...
quadrantChart
    title Impact Matrix: Political Significance vs. Immediate Impact
    x-axis Low Immediate Impact --> High Immediate Impact
    y-axis Low Political Significance --> High Political Significance
    quadrant-1 High Priority — Monitor Closely
    quadrant-2 Strategic Watch
    quadrant-3 Standard Processing
    quadrant-4 Tactical Significance
    Immunity_Jaki: [0.9, 0.85]
    Immunity_Obajtek: [0.88, 0.80]
    Immunity_Şoşoacă: [0.82, 0.78]
    Budget_2027: [0.75, 0.90]
    GHG_Transport: [0.65, 0.70]
    Animal_Welfare: [0.70, 0.45]
    RoP_Amendment: [0.45, 0.55]
    EIB_Control: [0.40, 0.50]
    PNR_Iceland: [0.30, 0.40]
    Tourism: [0.35, 0.25]
```
...
quadrantChart
    ...
    quadrant-1 High Priority — Manage Actively
    quadrant-2 Monitor — Low Prob, High Impact
    quadrant-3 Low Priority
    quadrant-4 Monitor — High Prob, Low Impact
    R07_ECR_2029_Gains: [0.40, 0.80]
    R04_Budget_Trilogue: [0.50, 0.55]
    R03_Sosoacă_Narrative: [0.45, 0.35]
    R05_GHG_Challenge: [0.25, 0.50]
    R06_Coalition_Fracture: [0.20, 0.55]
    R01_Legal_Challenge: [0.20, 0.35]
    R02_Polish_Court_Collapse: [0.15, 0.50]
    R08_Operational: [0.10, 0.80]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","edgeLabelBackground":"#1e1e1e"}}}%%
flowchart LR
    subgraph Gainers["Political Capital GAINERS"]
        EPP_cap["🔵 EPP\n+2 units\nRule-of-law credibility"]
        SD_cap["🔴 S&D\n+1 unit\nDemocratic credentials"]
        Renew_cap["🟡 Renew\n+1 unit\nLiberal values signal"]
    end
    subgraph Losers["Political Capital LOSERS"]
        ECR_cap["🔶 ECR Group\n-4 units\nPiS accountability crisis"]
        Jaki_cap["❌ Jaki\n-5 personal\nProceedings enabled"]
        Obajtek_cap["❌ Obajtek\n-5 personal\nProceedings enabled"]
        Sosoacă_cap["❌ Şoşoacă\n-3 EP\n+1 domestic base"]
    end
    subgraph Neutral["Neutral / Marginal"]
        PfE_cap["🟤 PfE\n~0 change"]
        Left_cap["🟠 Left\n+0.5"]
        Greens_cap["🟢 Greens\n+0.5"]
    end
    ImmunityVotes["Immunity\nWaiver\nVotes"]
    ImmunityVotes --> EPP_cap
    ImmunityVotes --> SD_cap
    ImmunityVotes --> Renew_cap
    ImmunityVotes --> ECR_cap
    ImmunityVotes --> Jaki_cap
    ImmunityVotes --> Obajtek_cap
    ImmunityVotes --> Sosoacă_cap
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","edgeLabelBackground":"#1e1e1e"}}}%%
flowchart TD
    A["📥 April 28-29 Plenary\n12 Items Adopted\n✅ HIGH Velocity"] --> B["Immunity Proceedings\nIn national courts\n🟢 No EP impact"]
    A --> C["2027 Budget\nEP Position Set\n→ Council Conciliation\n🟡 Medium Velocity\nQ3-Q4 2026"]
    A --> D["GHG Transport\nAdopted\n→ Commission Implementation\n🟡 Delegated acts pending"]
    C --> E["Budget Trilogue\nRisk: Council conservatism\n🟡 3-6 month process"]
    D --> F["Implementation Acts\nRisk: Industry lobbying\n🟡 18-month window"]
    G["Upcoming Pipeline\nReArm Europe (SAFE)\nFit-for-55 items\nNature Restoration impl."] --> H["May 2026 Plenary\n🟡 Queue forming"]
    H --> I["Velocity Bottlenecks\n1. EPP deregulation push\n2. Council fiscal conservatism\n3. Coalition management overhead"]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","edgeLabelBackground":"#1e1e1e"}}}%%
graph LR
    subgraph Far_Right_Threat_Network["Far-Right Threat Network"]
        ECR["🔶 ECR Group\nProcedural challenges\nNarrative warfare"]
        PfE["🟤 PfE Group\nHungarian media amplify\nOrbán support"]
        ESN["⚫ ESN Group\nŞoşoacă solidarity"]
        Jaki["❌ Patryk Jaki\nECR/PL — proceedings enabled"]
        Obajtek["❌ Daniel Obajtek\nECR/PL — proceedings enabled"]
        Sosoacă["❌ Diana Şoşoacă\nESN/RO — ECHR challenge"]
    end
    subgraph Response_Network["Institutional Response"]
        EP_JURI["🏛 EP JURI\nPrecedent established"]
        EP_Legal["⚖️ EP Legal Service\nDefend procedure"]
        Commission["🇪🇺 Commission\nRule-of-law monitoring"]
        PolishCourt["🏛 Polish Courts\nJaki+Obajtek proceedings"]
        RomanianCourt["🏛 Romanian Courts\nŞoşoacă proceedings"]
    end
    ECR -->|"Parliamentary\nquestions"| EP_JURI
    PfE -->|"Media + political\nsupport"| ECR
    ESN -->|"Solidarity"| Sosoacă
    Jaki -->|"Political\nconnection"| ECR
    Obajtek -->|"Political\nconnection"| ECR
    EP_JURI -->|"Defends"| EP_Legal
    Commission -->|"Monitors"| PolishCourt
    PolishCourt -.->|"Proceeds\nagainst"| Jaki
    PolishCourt -.->|"Proceeds\nagainst"| Obajtek
    RomanianCourt -.->|"Proceeds\nagainst"| Sosoacă
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","edgeLabelBackground":"#1e1e1e"}}}%%
graph TD
    Root["ROOT: 3 Immunity Waivers Adopted\nJaki, Obajtek, Şoşoacă"]
    Root --> C1["Polish proceedings\nagainst Jaki + Obajtek\n(ENABLED)"]
    Root --> C2["Romanian proceedings\nagainst Şoşoacă\n(ENABLED)"]
    Root --> C3["ECR group credibility\non rule-of-law\n(DAMAGED)"]
    Root --> C4["EP institutional norm\nno EP immunity shield\n(REINFORCED)"]
    C1 --> C1a["PiS accountability\nprocess accelerates\nP=60%"]
    C1 --> C1b["Polish court delays\nor shelves case\nP=20%"]
    C1a --> C1a1["ECR domestic base\nin Poland erodes\n(months 6-12)"]
    C1a --> C1a2["PiS loses further\ncouncil/MEP support\n(2027-2029)"]
    C1b --> C1b1["Far-right martyr\nnarrative gains\ncredibility\n(short-term)"]
    C2 --> C2a["Şoşoacă ECHR\nchallenge filed\nP=65%"]
    C2 --> C2b["Romanian proceedings\nbegin Q3 2026\nP=50%"]
    C2a --> C2a1["Long procedural delay\n(3-7 years ECHR)"]
    C3 --> C3a["ECR struggles to attract\nnew delegations\nfrom EU govts\n(2026-2027)"]
    C4 --> C4a["Future immunity waivers\nmore straightforward\nto process"]
    C4 --> C4b["Non-EP far-right\npoliticians cannot\n'flee' to EP seat"]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","edgeLabelBackground":"#1e1e1e"}}}%%
graph TD
    Root2["ROOT: 2027 Budget Guidelines\nAdopted by EP\nDefence + climate priorities"]
    Root2 --> D1["Commission Q2 2026\ndraft budget prepared\nwith EP guidelines\nas reference"]
    Root2 --> D2["Council budget\nposition development\nQ3 2026"]
    D1 --> D1a["Commission defence\nline: ~€15-20B\n(ReArm Europe integration)"]
    D1 --> D1b["Climate/Green Deal\nlines maintained\n(Fit-for-55 continuation)"]
    D2 --> D2a["Northern states\npush fiscal conservatism\n(vs. EP ambitions)"]
    D2 --> D2b["Eastern states\nprioritize cohesion\nover defence"]
    D1a --> T1["TRILOGUE Q3-Q4 2026\nCore tension:\nDefence vs. cohesion\nvs. climate"]
    D2a --> T1
    D2b --> T1
    T1 --> T1a["Agreement before\nDec 31 deadline\nP=75%"]
    T1 --> T1b["Provisional twelfths\n(budget continuation)\nP=25%"]
    T1a --> T1a1["Budget adopted\nwith compromises\non all lines"]
    T1b --> T1b1["Jan-Feb 2027\ninstitutional friction\nCommission mediates"]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","edgeLabelBackground":"#1e1e1e"}}}%%
gantt
    title Legislative Disruption Timeline — April 2026 Motions
    dateFormat YYYY-MM-DD
    axisFormat %b-%Y
    section Immunity Cases
    Immunity waivers adopted          :milestone, m1, 2026-04-28, 0d
    National proceedings begin        :active, p1, 2026-04-29, 90d
    Procedural challenges (ECR)       :crit, c1, 2026-04-29, 30d
    Şoşoacă ECHR application          :c2, 2026-06-01, 30d
    section Budget Process
    EP Guidelines adopted             :milestone, m2, 2026-04-28, 0d
    Commission draft budget           :b1, 2026-05-01, 60d
    Council budget position           :b2, 2026-07-01, 90d
    Trilogue begins                   :crit, t1, 2026-09-01, 90d
    Budget adoption deadline          :milestone, m3, 2026-12-15, 0d
    section GHG Transport
    Regulation adopted                :milestone, m4, 2026-04-28, 0d
    Commission delegated acts         :d1, 2026-06-01, 180d
    CJEU challenge window             :c3, 2026-07-01, 180d
```
...
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-30/motions/executive-brief.md) | `executive-brief.md` |
