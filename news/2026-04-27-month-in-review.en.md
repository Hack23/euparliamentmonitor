...
source_folder: analysis/daily/2026-04-27/month-in-review
...
flowchart TB
    ...
    NAT["🏳️ National Governments\n27 Member States"]
    DEF["🛡️ Defence Industry\nAirbus/Rheinmetall/Leonardo"]
    FIN["💰 Financial Sector\nBanks/Insurers"]
    TECH["💻 Tech Industry\nAI/Digital Companies"]
    CIVIL["🏘️ Civil Society\nHousing/Labour NGOs"]
    INT["🌍 International\nNATO/US/China/Ukraine"]

    EP --> EPP & SD & PFE & ECR & REN & GRN & LEFT
    EPP --> COM
    COM --> ECB & NAT
    NAT --> DEF & FIN & TECH
    EP --> INT
...
mindmap
  root((EU Parliament\nMarch-April 2026\nPESTLE))
    P[Political]
      EPP anchored majority
      Defence cross-party consensus
      Enlargement reaffirmed
      Coalition fragmentation
    E[Economic]
      Germany recession
      Banking union reformed
      European Semester 2026
      Defence economy emerging
    S[Social]
      Housing crisis pressure
      Labour migration reform
      Gender pay gap attention
      AI social impact
    T[Technological]
      AI governance trifecta
    ...
    En[Environmental]
      ...
      Water pollutants regulation
      Defence sustainability tension
      Green transition funding gap
```
...
quadrantChart
    ...
    quadrant-4 "Medium - Manage"
    "German recession deepening": [0.45, 0.85]
    "Coalition fragmentation": [0.30, 0.80]
    "Defence implementation failure": [0.40, 0.75]
    "AI governance incoherence": [0.50, 0.55]
    "Banking resolution gap": [0.25, 0.85]
    "Housing populist backlash": [0.60, 0.70]
    "Hungarian veto enlargement": [0.70, 0.65]
    "Russian hybrid attack": [0.35, 0.80]
    "US NATO ambiguity": [0.20, 0.90]
    "PfE dissolution": [0.20, 0.70]
```
...
%%{init: {"theme":"dark"}}%%
quadrantChart
    title EU Parliament Scenario Space Q2-Q4 2026
    x-axis "Low Integration Speed" --> "High Integration Speed"
    y-axis "Low Geopolitical Stability" --> "High Geopolitical Stability"
    quadrant-1 "Aggressive Integration"
    quadrant-2 "Crisis-Driven Integration"
    quadrant-3 "Fragmented Paralysis"
    quadrant-4 "Steady Progress"
    "Scenario A: Accelerated Defence Union": [0.75, 0.35]
    "Scenario B: Managed Convergence": [0.55, 0.65]
    "Scenario C: Coalition Fracture": [0.25, 0.45]
    "Scenario D: Geopolitical Crisis Override": [0.85, 0.15]
    "Current Trajectory (April 2026)": [0.60, 0.55]
```
...
%%{init: {"theme":"dark"}}%%
quadrantChart
    title Wildcard/Black Swan Assessment Space
    x-axis "Low Probability" --> "High Probability"
    y-axis "Low Impact" --> "High Impact"
    ...
    "PfE Dissolution": [0.2, 0.8]
    "US NATO Exit": [0.1, 0.95]
    "German snap election": [0.15, 0.7]
    "China Taiwan Action": [0.08, 0.95]
    "ECB Emergency Rate Change": [0.12, 0.75]
    "EU-China Trade War": [0.25, 0.65]
    "AI Governance Crisis Incident": [0.3, 0.6]
    "EP Leadership Crisis": [0.1, 0.55]
    "UK Re-Association": [0.15, 0.5]
    "Major Bank Failure": [0.15, 0.85]
```
