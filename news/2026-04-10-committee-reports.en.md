...
keywords: ["EU Parliament Monitor", "European Parliament", "European Commission", "political intelligence", "Riksdagsmonitor", "Riksdag", "Regeringen", "EU Parliament", "committee activity", "committee report", "legislation", "Committee Reports", "2026-04-10", "Committee", "Reports", "April"]
date: 2026-04-10
...
quadrantChart
    ...
    Current Assessment: [0.85, 0.80]
    Adopted Texts Signal: [0.95, 0.85]
    Committee Output: [0.80, 0.75]
    Pipeline Signal: [0.70, 0.70]
```
...
mindmap
  root((EP Committee Power Map Q1 2026))
    Economic Powerhouse
      ECON 9.0 Rising Banking Union
      INTA 7.3 Rising Trade Defence
      BUDG 4.7 Declining EGF
    Justice and Rule of Law
      LIBE 8.0 Rising Anti-Corruption
      JURI 4.0 Stable IP Codification
    External Relations
      AFET 7.0 Stable Enlargement
      SEDE 6.3 Rising Defence
    Regulatory
      ENVI 6.7 Declining Water Pollutants
      ITRE 6.0 Stable AI Copyright
      IMCO 5.0 Stable Travel
    Social
      EMPL 5.3 Stable Workers Rights
      FEMM 5.0 Stable Gender Pay Gap
      REGI 4.5 Stable Housing Crisis
```
