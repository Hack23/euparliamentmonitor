---
title: "Synthesis Summary — EP Motions Analysis, 28 April 2026"
description: "The week ending 28 April 2026 captures the aftermath of the Parliament's most intensive plenary cluster of EP10's second year. The March 26, 2026 session adopted 12 major texts across trade, financial regulation, digital policy, anti-corruption, and institutional governance — a legislative…"
date: 2026-04-28
...
graph LR
    ...
    EPP & SD & Renew -->|Grand Coalition| BankingUnion[Banking Union]
    EPP & ECR & Renew -->|Right-Centre| AIOmnibus[AI Omnibus]
    SD & Renew & Greens & EPP -->|Progressive+| AntiCorr[Anti-Corruption]
    EPP & SD & Renew -->|Grand Coalition| Trade[Trade CM]
    PfE -.->|Oppose| BankingUnion
    PfE -.->|Oppose| AIOmnibus
    PfE -.->|Oppose| AntiCorr
    PfE -.->|Oppose| Trade
```
...
graph LR
    subgraph "Driving (→)"
    D1[Commission Pipeline 9] 
    D2[EPP Incentives 8]
    D5[Market Expectations 7]
    D3[S&D Electoral 7]
    D4[Civil Society 6]
    end
    
    subgraph "Restraining (←)"
    R1[Council Bottleneck 8]
    R2[ECR Fragmentation 7]
    R4[US Trade Shock 7]
    R3[SD AI Redlines 6]
    R5[PfE Communication 5]
    R6[Legal Challenges 4]
    end

    D1 & D2 & D3 & D4 & D5 --> EQUILIBRIUM[Current Equilibrium: High Output + Managed Tension]
    R1 & R2 & R3 & R4 & R5 & R6 --> EQUILIBRIUM
```
...
```mermaid
graph TD
    EPP[EPP 185] -->|lead rapporteur| TRADE[US Trade Countermeasures]
    EPP -->|co-lead| BU[Banking Union Trilogy]
    EPP -->|lead| AI[AI Digital Omnibus]
    SD[S&D 135] -->|co-lead| BU
    SD -->|lead| ANTICORR[Anti-Corruption Dir.]
    SD -->|support| TRADE
    RENEW[Renew 76] -->|support| AI
    RENEW -->|support| BU
    RENEW -->|support| TRADE
    ECR[ECR 79] -->|decisive vote| AI
    ECR -->|split| BU
    PFE[PfE 84] -->|oppose| TRADE
    PFE -->|oppose| BU
    PFE -->|oppose| AI
    PFE -->|oppose| ANTICORR
    GREENS[Greens 53] -->|support| ANTICORR
    GREENS -->|oppose| AI
    COM[Commission] -->|initiator| TRADE
    COM -->|initiator| BU
    COM -->|initiator| AI
    COM -->|initiator| ANTICORR
    COUNCIL[Council/Poland] -->|negotiator| BU
    COUNCIL -->|contested| ANTICORR
```
