...
keywords: ["EU Parliament Monitor", "European Parliament", "European Commission", "political intelligence", "Riksdagsmonitor", "Riksdag", "Regeringen", "EU Parliament", "committee activity", "committee report", "legislation", "Committee Reports", "2026-04-29", "Parliament", "Committee", "Reports"]
date: 2026-04-29
article_type: committee-reports
slug: 2026-04-29-committee-reports
source_folder: analysis/daily/2026-04-29/committee-reports
...
```mermaid
graph TD
    subgraph INSTITUTIONAL["🏛️ Institutional Actors — HIGH POWER"]
        COM["European Commission\n▲ Initiative monopoly\n▲ MFF proposal Q3 2026\nPosition: Neutral-centrist"]
        BUDG_CTT["BUDG Committee\n▲ MFF consent power\n▲ Annual budget authority\nPosition: Pro-higher ceiling"]
        INTA_CTT["INTA Committee\n▲ GSP lead competence\nPosition: Rules-based trade+values"]
        EIB["European Investment Bank\n▲ €88bn lending\n▲ InvestEU backbone\nPosition: Continuity/protect mandate"]
    end
    subgraph COUNCIL_ACTORS["⚡ Council Actors — HIGH POWER"]
        POLISH_PRES["Polish Presidency\nPosition: Cohesion protection\n▼ Supports higher MFF"]
        FRUGAL["Frugal Five\n(DE/NL/SE/AT/DK)\nPosition: Cap at 1.0% GNI\n▼ Block expansion"]
        RECIPIENTS["Cohesion Recipients\n(PL/HU/CZ/RO/SK)\nPosition: Protect structural funds\n▲ Expand MFF"]
    end
    subgraph INDUSTRY["🏭 Industry/Sector Actors — MEDIUM POWER"]
        IRU["IRU (Road Transport)\nPosition: Compliance flexibility on GHG\nLobbying: TRAN committee"]
        BizEU["BusinessEurope\nPosition: Trade predictability (GSP)\nLobbying: INTA, Commission"]
        TE["T&E (Transport+Environment)\nPosition: Ambitious GHG standards\nLobbying: ENVI committee"]
    end
    subgraph CIVIL["🌍 Civil Society — MEDIUM-LOW POWER"]
        BEUC["BEUC (Consumers)\nPosition: Strong pet welfare standards\nLobbying: AGRI committee"]
        DevNGOs["Development NGOs\n(Oxfam/ActionAid)\nPosition: Tougher GSP conditionality\nLobbying: INTA committee"]
        Bangladesh["Bangladesh Government\nPosition: Defend EBA access\nLobbying: Commission/bilateral"]
    end
    COM -->|"Proposal authority"| BUDG_CTT
    COM -->|"Implementation"| INTA_CTT
    BUDG_CTT -->|"Consent lever"| COM
    POLISH_PRES -->|"Cohesion alliance"| RECIPIENTS
    FRUGAL -->|"Blocking minority"| COM
    IRU -->|"Secondary legislation lobbying"| COM
    BizEU -->|"GSP implementing acts"| COM
    TE -->|"ENVI advocacy"| INTA_CTT
    DevNGOs -->|"INTA hearing influence"| INTA_CTT
    Bangladesh -->|"Government lobbying"| COM
```
...
```mermaid
flowchart LR
    subgraph DRIVERS["→ Driving Forces (Pro-expansion)"]
        D1["Ukraine reconstruction\n(€80bn+ through 2027)"]
        D2["NATO defence commitments\n(2% GDP target)"]
        D3["Green Deal investment\ngaps (€340bn/year)"]
        D4["Parliament institutional\nconsent leverage"]
        D5["Digital sovereignty\n(AI Act implementation costs)"]
    end
    subgraph RESTRAINTS["← Restraining Forces (Anti-expansion)"]
        R1["Frugal net payer\ncoalition (1.0% GNI cap)"]
        R2["EU fiscal rules\nreform pressure"]
        R3["Member state austerity\n(post-COVID consolidation)"]
        R4["ECR/PfE opposition\n(renationalisation push)"]
        R5["WTO compliance\n(GSP conditionality limits)"]
    end
    DRIVERS -->|"Shape Parliament\ninterim MFF report"| CENTER["MFF 2028-2034\nNegotiation\nOutcome"]
    RESTRAINTS -->|"Constrain Council\nmandate"| CENTER
```
...
graph LR
    ...
    subgraph COUNCIL["🏛️ Council"]
        PRES["Polish Presidency\n(Jan-Jun 2026)"]
        FRUGAL["Frugal Net Payers\n(DE/NL/SE/AT/DK)"]
        COHESION["Cohesion Net Receivers\n(PL/HU/CZ/RO/SK)"]
    end
    BUDG -->|"Interim MFF report"| COM
    BUDG -->|"2027 Guidelines"| PRES
    INTA -->|"GSP Reform"| COM
    CJ46 -->|"GHG Reg. (enacted)"| COM
    CONT -->|"Oversight"| EIB
    FRUGAL ---|"Block MFF expansion"| COHESION
    COM -->|"MFF proposal Q3 2026"| BUDG
```
...
```mermaid
graph TD
    subgraph GAINED["🟢 CAPITAL GAINED"]
        EPP_GAIN["EPP Group\n+ MFF interim leadership\n+ GSP values-based framing\n+ Coalition broker role"]
        BUDG_GAIN["BUDG Committee\n+ Institutional assertiveness\n+ Pre-emption of Commission"]
        INTA_GAIN["INTA Committee\n+ Trade-values balance\n+ Procedural competence"]
        SD_GAIN["S&D Group\n+ Social spending protection\n+ Labour conditionality win"]
    end
    subgraph NEUTRAL["→ NEUTRAL / MIXED"]
        RENEW_NEUTRAL["Renew Europe\n± Fiscal hawk vs. pro-MFF tension\n± Split on conditionality details"]
        GREENS_NEUTRAL["Greens/EFA\n- Lost on GHG ambition (trilogue)\n+ Won on MFF climate-proofing norms\n± Net mixed"]
        COMMISSION["Commission\n- Pre-empted by Parliament\n+ Gained time for own proposal"]
    end
    subgraph LOST["🔴 CAPITAL SPENT / AT RISK"]
        ECR_SPENT["ECR Group\n- Lost on MFF ceiling\n- Lost on GSP conditionality\n- Divided on cohesion vs. anti-EU stance"]
        PFE_SPENT["PfE Group\n- Consistently outvoted\n- Renationalisation agenda blocked"]
        POLISH_MEPS["5 Polish MEPs\n- Immunity waived\n- Legal exposure now active"]
    end
```
...
```mermaid
gantt
    title Legislative Pipeline Velocity — Key Files (April 2026)
    dateFormat YYYY-MM
    section MFF 2028-2034
    EP Interim Report Adopted    :done, mff1, 2026-04, 2026-04
    Commission Formal Proposal   :active, mff2, 2026-06, 2026-09
    Council First Orientation    :mff3, 2026-09, 2026-12
    Trilogue Opens              :mff4, 2027-01, 2027-06
    Final Adoption (optimistic)  :mff5, 2027-09, 2027-12
    section GSP Reform
    Regulation Adopted           :done, gsp1, 2026-04, 2026-04
    OJ Publication               :gsp2, 2026-05, 2026-05
    Entry into Force             :gsp3, 2026-06, 2026-06
    Implementing Acts            :gsp4, 2026-06, 2027-06
    section GHG Transport
    Regulation Adopted           :done, ghg1, 2026-04, 2026-04
    OJ Publication               :ghg2, 2026-05, 2026-05
    Delegated Acts (WTW method)  :ghg3, 2026-08, 2027-01
    First compliance cycle       :ghg4, 2027-01, 2028-01
    section Dogs & Cats
    Regulation Adopted           :done, pet1, 2026-04, 2026-04
    National implementation      :pet2, 2026-04, 2028-12
```
...
```mermaid
graph LR
    subgraph VECTORS["Disruption Vectors"]
        D1["Council Unanimity\nBlockage on Own Resources\nP=45% | Impact=CRITICAL"]
        D2["Commission Delays\nFormal MFF Proposal\nP=35% | Impact=HIGH"]
        D3["WTO Challenge\nGSP Conditionality\nP=25% | Impact=MEDIUM"]
        D4["Delegated Acts\nGHG Methodology Delay\nP=45% | Impact=HIGH"]
        D5["SME Compliance\nCapacity Failure (GHG)\nP=50% | Impact=MEDIUM"]
        D6["Omnibus Simplification\nPackage Rollback\nP=20% | Impact=HIGH"]
    end
    subgraph RESILIENCE["Resilience Mechanisms"]
        R1["EP Consent Procedure\n(MFF veto threat)"]
        R2["Institutional precedent\n(NGEU emergency track)"]
        R3["EU Article XX\nWTO exceptions defense"]
        R4["CSRD precedent\n(managed extension)"]
        R5["TRAN transition provisions\n(SME buffer)"]
        R6["ECJ acquis protection"]
    end
    D1 -->|"Constrained by"| R1
    D2 -->|"Constrained by"| R2
    D3 -->|"Constrained by"| R3
    D4 -->|"Mitigated by"| R4
    D5 -->|"Mitigated by"| R5
    D6 -->|"Constrained by"| R6
```
