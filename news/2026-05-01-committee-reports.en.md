...
description: "The last week of April 2026 affirmed EP10's record-setting legislative productivity pace. Published 2026-05-01, with source-linked voting, committee and legislative intelligence…"
...
source_folder: analysis/daily/2026-05-01/committee-reports
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#fff"}}}%%
mindmap
  root((EP10 Week 24-30 April 2026))
    PLATFORM GOVERNANCE
      DMA Enforcement Resolution
      IMCO oversight mandate
      Gatekeeper compliance pressure
      EPP-S&D-Renew majority
    BUDGET ARCHITECTURE
      2027 Budget Guidelines
      EP 2027 Expenditure Estimates
      Defence + green priorities
      Grand coalition consensus
    ANIMAL WELFARE MILESTONE
      Dogs and Cats Regulation
      520+ vote consensus
      EAR register by 2030
      Import standards 2029
    SECURITY AND RULE OF LAW
      Iceland PNR ratification
      Jaki immunity waiver
      Ukraine accountability tribunal
    GEOPOLITICAL POSITIONING
      Armenia democratic resilience
      Haiti trafficking condemnation
      Russia/Ukraine accountability
```
...
```mermaid
quadrantChart
  title Stakeholder Influence vs. Interest Map
  ...
  EPP Group: [0.85, 0.95]
  S&D Group: [0.80, 0.85]
  European Commission: [0.75, 0.90]
  IMCO Committee: [0.95, 0.80]
  BUDG Committee: [0.90, 0.85]
  ENVI Committee: [0.90, 0.75]
  ECR Group: [0.70, 0.65]
  EIB Management: [0.85, 0.60]
  Platform Industry: [0.90, 0.55]
  Civil Society NGOs: [0.70, 0.35]
  Member State Governments: [0.60, 0.75]
  Renew Europe: [0.65, 0.60]
  Pet Breeding Industry: [0.80, 0.25]
  Ukrainian Government: [0.70, 0.35]
```
...
%%{init: {"theme":"dark"}}%%
xychart-beta
  title "EU GDP Growth Rate (%) — IMF Projections"
  x-axis ["2022","2023","2024","2025","2026P","2027P"]
  y-axis "GDP Growth (%)" -1 --> 3
  line [3.4, 0.4, 1.0, 1.6, 1.9, 2.1]
```
...
%%{init: {"theme":"dark"}}%%
flowchart TD
    START([April 28-30 Decisions]) --> BUDGET_PATH[Budget Trilogue Path]
    START --> DMA_PATH[DMA Enforcement Path]
    START --> COALITION_PATH[Coalition Stability Path]
    
    BUDGET_PATH --> B1[SCENARIO A: EP-Council Budget Standoff\n40% probability]
    BUDGET_PATH --> B2[SCENARIO B: Early Agreement\n35% probability]
    BUDGET_PATH --> B3[SCENARIO C: Late Compromise\n25% probability]
    
    DMA_PATH --> D1[DG COMP Accepts Parliament Reporting\n45% probability]
    DMA_PATH --> D2[DG COMP Rejects, Inter-institutional Dispute\n35% probability]
    DMA_PATH --> D3[Partial Acceptance, Ambiguous Outcome\n20% probability]
    
    COALITION_PATH --> C1[Stable EPP-led flexible majority\n60% probability]
    COALITION_PATH --> C2[Budget-triggered coalition fracture\n25% probability]
    COALITION_PATH --> C3[External shock disrupts stability\n15% probability]
```
