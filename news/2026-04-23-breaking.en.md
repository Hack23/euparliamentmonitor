---
title: "*Eight days after T-0, the run undertakes a retrospective"
...
```mermaid
quadrantChart
    title T+8 Retrospective Risk Heatmap — 2026-04-23
    ...
    "Scrutiny-capacity gap institutionalises": [0.75, 0.85]
    "Implementing-acts Commission default": [0.85, 0.65]
    "Trade coalition issue-conditional drift": [0.60, 0.75]
    "EU industry supply-chain pain": [0.85, 0.80]
    "Scenario-B residual escalation": [0.30, 0.85]
    "Other March-26 trilogue stalls": [0.55, 0.65]
```
...
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-23/breaking-run-1776928781/executive-brief.md) | `executive-brief.md` |
