...
description: "The week of April 20–27, 2026 marks a pivotal legislative moment for the European Parliament: the SRMR3 bank resolution regulation published in the EU Official Journal on April 20"
keywords: ["EU Parliament Monitor", "European Parliament", "European Commission", "political intelligence", "Riksdagsmonitor", "Riksdag", "Regeringen", "EU Parliament", "legislative procedures", "proposal", "regulation", "Propositions", "2026-04-27", "Parliament", "Analysis", "week"]
date: 2026-04-27
...
```mermaid
quadrantChart
    title EP Legislative Risk Snapshot — April 2026
    ...
    US Tariff Trilogue: [0.85, 0.90]
    Anti-Corruption Directive: [0.70, 0.85]
    SRMR3 Transposition: [0.60, 0.80]
    Housing Resolution Implementation: [0.45, 0.70]
    AI Convention Ratification: [0.50, 0.65]
    Defence Projects: [0.75, 0.75]
    EP-Commission Framework: [0.30, 0.60]
```
...
```mermaid
mindmap
  root((EP10 Legislative Forces))
    Council Power
      QMV blocking capacity
      Hungary veto threat
      Poland Presidency leverage
      Germany economic weight
    MEP Bargaining
      No-confidence threat
      Coalition fragmentation
      Individual defection risk
      Cross-party alliances
    New Entrants
      PfE growth trajectory
      ESN integration potential
      Independent MEPs realignment
      Post-election group reshuffling
    Substitute Routes
      Commission delegated acts
      Enhanced cooperation
      International treaties
      Council regulations bypass
    Internal Rivalry
      EPP vs S&D agenda competition
      INTA vs ECON jurisdiction
      Committee rapporteur competition
      Presidency ambition
```
...
```mermaid
quadrantChart
    title Legislative Impact Matrix — April 2026
    x-axis Low Probability --> High Probability
    y-axis Low Impact --> High Impact
    quadrant-1 Act Now — Monitor Daily
    quadrant-2 Plan Scenarios — High Uncertainty
    quadrant-3 Backlog — Routine Track
    quadrant-4 Manage — High Likelihood Low Impact
    E3 US Tariff Trilogue: [0.78, 0.92]
    E2 Anti-Corruption Council: [0.82, 0.88]
    E1 SRMR3 Transposition: [0.98, 0.80]
    E6 Defence Projects: [0.70, 0.78]
    E5 Housing Directive: [0.45, 0.75]
    E4 Commission Followups: [0.98, 0.55]
```
...
```mermaid
quadrantChart
    title Legislative Risk Heat Map
    x-axis Low Impact --> High Impact
    y-axis Low Probability --> High Probability
    quadrant-1 Critical — Act Now
    quadrant-2 High Priority — Plan
    quadrant-3 Low Priority — Monitor
    quadrant-4 Quick Wins — Accept
    R-001 Hungary Emergency Brake: [0.90, 0.75]
    R-002 US Tariff Deadlock: [0.75, 0.55]
    R-004 EPP Fragmentation: [0.55, 0.60]
    R-005 Bandwidth Exhaustion: [0.55, 0.50]
    R-003 SRMR3 Transposition: [0.70, 0.30]
    R-006 Geopolitical Shock: [0.70, 0.25]
    R-007 ECJ Treaty Base: [0.85, 0.20]
    R-008 Renew Defections: [0.30, 0.50]
```
...
```mermaid
xychart-beta
    title "Political Capital Balance — EP10 Groups (April 2026)"
    x-axis ["EPP", "S&D", "Renew", "ECR", "PfE", "Greens", "Left", "Commission"]
    y-axis "Capital Balance (-10 to +10)" -10 --> 10
    bar [4, 6, 2, -1, -3, 3, 4, 5]
```
...
```mermaid
timeline
    title EP10 Legislative Output Pace
    2024 Q1 : EP10 formation
           : New Commission confirmation
           : Low output (institutional startup)
    2024 Q2 : AI Act implementation begins
           : Green Deal second phase
           : Output: ~15 acts
    2024 Q3 : Migration pact implementation
           : First major dossiers
           : Output: ~20 acts
    2024 Q4 : Pre-Christmas legislative push
           : Budget negotiations
           : Output: ~25 acts
    2025 Q1 : Standard pace establishes
           : Output: ~20 acts
    2025 Q4 : Full year 2025: ~78 acts
    2026 Q1 : ACCELERATION BEGINS
           : SRMR3, Anti-Corruption, US Tariffs
           : Q1 pace: 104+ acts annualized
           : +46.2% YOY
    2026 Q2 : CURRENT — AT CAPACITY
           : 3 concurrent trilogues
           : Risk: Quality/oversight gaps
```
...
```mermaid
flowchart TD
    START[EP Legislative Pipeline — April 2026] --> ANTI[Anti-Corruption Directive path]
    START --> TARIFF[US Tariffs path]
    START --> SRMR3[SRMR3 transposition path]
    
    ANTI --> COUNCIL_JHA{Council JHA Working Group}
    COUNCIL_JHA -->|Hungary cooperation| GENERAL_APPROACH[General Approach adopted]
    COUNCIL_JHA -->|Hungary invokes Art 83.3| EMERGENCY_BRAKE[Emergency Brake triggered]
    EMERGENCY_BRAKE --> EURO_COUNCIL{European Council vote}
    EURO_COUNCIL -->|Unanimity achieved| PROCEED[Proceed to trilogue]
    EURO_COUNCIL -->|Hungary blocks| DIRECTIVE_FAILED[Directive failed ❌]
    GENERAL_APPROACH --> TRILOGUE[EP-Council Trilogue]
    TRILOGUE --> ADOPTION[Directive Adopted ✅]
    
    TARIFF --> TRILOGUE2{Rounds 2-4}
    TRILOGUE2 -->|Agreement on delegation scope| REG_ADOPTED[Regulation Adopted ✅]
    TRILOGUE2 -->|Deadlock| EMERGENCY_TPR[Commission uses TPR Regulation fallback]
    EMERGENCY_TPR --> LIMITED_RESPONSE[Limited EU trade response]
    
    SRMR3 --> TRANSPOSE{27 MS Transposition}
    TRANSPOSE -->|On schedule| BANKING_UNION[Banking Union complete ✅]
    TRANSPOSE -->|Failures in 5+ MS| BANKING_GAP[Resolution architecture gaps ⚠️]
```
