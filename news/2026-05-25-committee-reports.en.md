...
```mermaid
flowchart TD
    A[EP10 Political Composition\nEPP 185 / S&D 135 / PfE 84] --> B{Committee Chair\nAllocation}
    B --> C[ITRE — EPP\nClean Industrial Deal lead]
    B --> D[ENVI — ECR\nClimate ambition moderator]
    B --> E[AFET — PfE\nUkraine policy filter]
    B --> F[BUDG — EPP\nBudget 2027 + EDIS]
    C --> G[CID: ≥144 committee meetings\nestimated Q2–Q4 2026]
    D --> H[Nature Restoration revision\nECR-led; lower ambition]
    E --> I[5 external affairs texts\nadopted despite chair]
    F --> J[Budget 2027 on track\nOctober 2026 vote]
    G --> K[RECORD OUTPUT\n2,363 meetings / 114 acts]
    H --> K
    I --> K
    J --> K
    K --> L{Paradox\nResolution}
    L --> M[Maximum fragmentation\n+ Maximum output\n= Structural resilience\nof rapporteurship system]
```
...
```mermaid
pie title Significance Distribution: EP10 Committee Activities 2026
    "TIER 2 — Significant" : 3
    "TIER 3 — Notable" : 5
    "TIER 4 — Routine" : 4
```
...
```mermaid
graph TD
    EPP[EPP 185\nPivotal group] -->|Core budget + Ukraine| SD[S&D 135]
    EPP -->|Digital + liberal agenda| RE[RE 76]
    EPP -->|ENVI tactical| ECR[ECR 79]
    SD -->|Progressive bloc| GRN[Greens 53]
    SD -->|Social agenda| GUE[GUE/NGL 46]
    ECR <-->|Merger under discussion| PFE[PfE 84]
    RE -->|Rule of law| SD
    PFE -->|Foreign policy tension| EPP
    COM[Commission] -->|All files| EPP
    COM --> SD
    COM --> RE
```
...
```mermaid
xychart-beta
    title "Force-Field Analysis: EP10 Committee Sustainability"
    x-axis ["CID Mandate", "Budget 2027", "EDIS Consensus", "Draghi", "Digital", "Design", "ECR-PfE Chairs", "Fragmentation", "EP API", "Mercosur", "Coord Costs"]
    y-axis "Force Strength" -5 --> 5
    bar [4.5, 4.0, 3.5, 3.0, 2.5, 2.0, -3.5, -3.0, -2.0, -1.5, -1.5]
```
...
| Event | Date | Type | Committee |
|-------|------|------|-----------|
| EU-Mercosur CJE opinion requested | 2026-01-22 | INTA resolution | INTA |
| Subcontracting chains resolution adopted | 2026-02-12 | Non-legislative resolution | EMPL |
| Budget 2027 guidelines adopted | 2026-03-11 | OLP (1st reading) | BUDG |
| Farm animal welfare resolution | 2026-03-11 | Non-legislative resolution | AGRI |
| DMA enforcement oversight resolution | 2026-04-23 | Non-legislative resolution | IMCO |
| Ukraine accountability resolution | 2026-04-23 | Non-legislative resolution | AFET + CONT |
| No plenary 2026-05-25 week | 2026-05-25 | Scheduled recess | All committees |
| CID rapporteur draft expected | Q3 2026 | OLP (committee stage) | ITRE |
| Budget 2027 first reading vote | October 2026 | OLP (plenary) | BUDG |
| EDIS committee stage | Ongoing | OLP | AFET/AFDE + ITRE |

### Stakeholder

Stakeholder impact analysis across adopted texts and legislative files:

| Stakeholder Group | Primary Impact | Affected Files | Impact Direction |
|------------------|---------------|---------------|----------------|
| EU industrial sector | HIGH — CID defines investment framework | CID, EDIS | POSITIVE (competitiveness subsidies) |
| EU farmers | MEDIUM — environmental regulations | Nature Restoration, CAP | MIXED (standards vs. competitiveness) |
| Big Tech platforms | HIGH — DMA enforcement intensifies | DMA oversight | NEGATIVE (regulatory compliance costs) |
| EU defence industry | HIGH — EDIS procurement transformation | EDIS | POSITIVE (market creation) |
| Environmental NGOs | MEDIUM — ENVI chair moderates | Nature Restoration, CID | NEGATIVE (lower ambition) |
| Trade unions | MEDIUM — subcontracting reform | Subcontracting resolution | POSITIVE (worker protection) |
| Ukraine (government) | HIGH — aid and accountability | Ukraine resolutions | POSITIVE (continued support) |
| EU citizens | BROAD — climate, digital, labour | CID, DMA, EMPL | MIXED |

### Impact Matrix

Priority ranking of EP10 committee files by urgency and magnitude:

| File | Urgency | Magnitude | Impact Score | Lead Committee |
|------|---------|-----------|-------------|---------------|
| Clean Industrial Deal | HIGH | CRITICAL | 9.5/10 | ITRE |
| European Defence Industrial Strategy | HIGH | CRITICAL | 9.0/10 | AFET/AFDE + ITRE |
| Budget 2027 | CRITICAL | HIGH | 8.5/10 | BUDG |
| Nature Restoration Law revision | MEDIUM | HIGH | 7.0/10 | ENVI |
| DMA enforcement oversight | HIGH | MEDIUM | 6.5/10 | IMCO |
| EU-Mercosur CJE delay | LOW (procedural freeze) | MEDIUM | 5.0/10 | INTA |
| AI Act implementing measures | MEDIUM | MEDIUM | 5.5/10 | IMCO + LIBE |
| Ukraine accountability | HIGH | MEDIUM-HIGH | 6.5/10 | AFET + CONT |
| Subcontracting chains | MEDIUM | LOW-MEDIUM | 4.0/10 | EMPL |
| Electoral Act reform | LOW | LOW-MEDIUM | 3.5/10 | AFCO |
...
- **CID** — ITRE rapporteurship; all political groups filing amendments; Q3 2026 vote expected
- **Budget 2027** — October 2026 hard deadline; Council-Parliament negotiation ongoing
- **EDIS** — Cross-bloc support but financing architecture contested

**MEDIUM HEAT** (active, not yet contested):
- **DMA enforcement** — IMCO resolution adopted; implementation monitoring ongoing
- **Ukraine accountability** — Ongoing but stable; PfE chair managing tension
- **Nature Restoration revision** — ECR chair active; NGO counter-pressure significant

**LOW HEAT** (routine or frozen):
- **EU-Mercosur** — Frozen pending CJE opinion (12-18 months)
- **Electoral Act reform** — Long ratification timeline; not urgent in 2026
- **Subcontracting** — Resolution adopted; implementation monitoring only

```mermaid
quadrantChart
    title Impact Heat Map: EP10 Legislative Files 2026
    x-axis Low Urgency --> High Urgency
    y-axis Low Magnitude --> High Magnitude
    quadrant-1 High Heat: Act Immediately
    quadrant-2 Strategic: Plan Ahead
    quadrant-3 Low Priority
    quadrant-4 Quick Action Required
    CID: [0.80, 0.95]
    Budget 2027: [0.95, 0.85]
    EDIS: [0.75, 0.90]
    Nature Restoration: [0.60, 0.75]
    DMA: [0.70, 0.65]
    EU-Mercosur: [0.25, 0.60]
    AI Act: [0.65, 0.55]
    Ukraine accountability: [0.80, 0.60]
    Subcontracting: [0.50, 0.40]
    Electoral Act: [0.30, 0.45]
```
...
| Primary Event | First-Order Cascade | Second-Order Cascade |
|--------------|--------------------|--------------------|
| CID adopted (optimistic) | EU industrial subsidies begin; ENVI climate provisions reduced | Investment flows from US to EU; industrial job security improved |
| CID delayed (pessimistic) | EU competitiveness gap vs China/US widens | Political pressure on EPP; possible government changes in DE/FR |
| EDIS adopted | EU defence procurement centralization begins | NATO-EU burden sharing renegotiated; member state arms industries consolidate |
| Budget 2027 in conflict | Continuing resolution mechanism activates | CAP + cohesion payments disrupted; Eastern MS budget crisis |
| ECR-PfE merger completes | All committee D'Hondt recalculated; new chairs allocated | ENVI + AFET + INTA + additional chairs shift right; CID content changes |
| Ukraine escalation | AFET emergency session; Budget 2027 supplementary | All committee calendars disrupted; Budget emergency revision |
...
```mermaid
graph LR
    EPP[EPP 185\nPivotal center-right] -->|CID + Budget coalition| SD[S&D 135]
    EPP -->|Tactical ENVI alliance| ECR[ECR 79]
    EPP -->|Bridge on most files| RE[RE 76]
    SD -->|Progressive coalition| GRN[Greens 53]
    SD -->|Social agenda| GUE[GUE/NGL 46]
    ECR <-->|Merger under discussion| PFE[PfE 84]
    RE -->|Rule of law| SD
    PFE -->|Ukraine moderation tension| EPP
    subgraph Majority["Majority Threshold: 361 seats"]
        M[Grand Coalition\nEPP+S&D+RE = 396\nMost reliable majority]
    end
```
...
```mermaid
graph TD
    subgraph EPP["EPP (185 seats) — Pivotal Group"]
        E1[ITRE Chair\nCID rapporteur]
        E2[ECON Chair\nCMU + fiscal rules]
    end
    subgraph SD["S&D (135 seats) — Progressive Anchor"]
        S1[EMPL Chair\nSocial legislation]
        S2[FEMM + DEVE\nRights agenda]
    end
    subgraph PfE["PfE (84 seats) — Foreign Affairs Chair"]
        P1[AFET Chair\nUkraine moderation]
    end
    subgraph ECR["ECR (79 seats) — ENVI Chair"]
        R1[ENVI Chair\nClimate moderation]
        R2[INTA Chair\nMercosur caution]
    end
    subgraph RE["RE (76 seats) — Bridge Group"]
        L1[LIBE Chair\nRule of law]
    end
    EPP -- "Coalition on CID + Budget" --> SD
    EPP -- "Tactical alliance on ENVI" --> ECR
    SD -- "Social agenda alliance" --> RE
    PfE -- "Ukraine language tension" --> EPP
    ECR -- "ECR-PfE possible merger?" --> PfE
    RE -- "Majority on rule of law" --> SD
```
...
```mermaid
quadrantChart
    title Economic Stakes by Urgency and Magnitude
    x-axis Low Urgency --> High Urgency
    y-axis Low Magnitude --> High Magnitude
    quadrant-1 Act Now
    ...
    CID Competitiveness: [0.85, 0.90]
    Budget 2027: [0.90, 0.75]
    EDIS Defence: [0.80, 0.80]
    EU-Mercosur CJE: [0.30, 0.65]
    DMA Enforcement: [0.70, 0.55]
    Subcontracting Reform: [0.50, 0.40]
    Nature Restoration: [0.60, 0.70]
```
...
```mermaid
quadrantChart
    title SWOT Scoring: EP10 Committee System 2026
    ...
    quadrant-4 Threats
    Record Activity +11.1: [0.20, 0.85]
    Institutional Design +8.7: [0.15, 0.70]
    Political Fragmentation -4.5: [0.25, 0.20]
    EP API Failure -4.0: [0.20, 0.30]
    CID-EDIS Agenda +7.3: [0.75, 0.80]
    Digital Oversight +4.4: [0.80, 0.65]
    ECR-PfE Merger -6.5: [0.85, 0.25]
    Geopolitical Shocks -3.05: [0.80, 0.35]
```
...
```mermaid
pie title Scenario Probability Distribution: EP10 Committee Outlook H2 2026
    "Base Case: Record Output, Conservative Direction (55-65%)" : 60
    "Upside: Record Output, Progressive Surge (15-20%)" : 17
    "Downside: Political Disruption Stalls Output (20-25%)" : 23
```
...
```mermaid
quadrantChart
    title Wildcard Scenarios: Probability vs Impact
    x-axis Low Probability --> High Probability
    y-axis Low Impact --> High Impact
    quadrant-1 Monitor Closely
    quadrant-2 High Consequence
    quadrant-3 Low Priority
    quadrant-4 Mitigate If Cheap
    ECR-PfE merger: [0.50, 0.85]
    Financial crisis: [0.18, 0.95]
    Ukraine escalation: [0.25, 0.90]
    AI Act crisis: [0.14, 0.75]
    EP censure: [0.08, 0.80]
    Cyberattack: [0.12, 0.65]
```
...
mindmap
    root((EP Committees\n2026-05-25))
        Political
            EPP pivot to competitiveness
            Right-bloc ENVI/AFET chairs
            PfE-ECR merger speculation
            6-group coordination challenge
        Economic
            CID: €200-400bn industrial stakes
            EDIS: 2% GDP defence target
            Budget 2027: €200bn+
            Mercosur: delayed by CJE
        Social
            6,147 questions projected +24%
            Citizens petitions at record
            Labour: subcontracting reform
            Animal welfare: cross-bloc coalition
        Technical
            EP Open Data Portal degradation
            DMA technical enforcement gap
            AI Act implementing measures
            Cybersecurity NIS2 oversight
        Legal
            CJE Mercosur opinion pending
            EP mandate constitutional scope
            Institutional balance OLP
            Rule of law conditionality
        Environmental
            ECR ENVI chair: ambition moderation
            Nature Restoration revision
            CID green-industrial balance
            Paris Agreement implementation oversight
```
...
```mermaid
xychart-beta
    title "EP Committee Activity: Key Metrics EP6-EP10 (projected)"
    x-axis ["EP6\n2004-09", "EP7\n2009-14", "EP8\n2014-19", "EP9\n2019-24", "EP10\n2026 proj"]
    y-axis "Meetings / Year" 0 --> 2500
    bar [1200, 1450, 1750, 1980, 2363]
    line [1200, 1450, 1750, 1980, 2363]
```
...
| Metric | 2024 | 2025 | 2026 (proj.) | YoY Change |
|--------|------|------|--------------|------------|
| Committee meetings | 1,680 | 1,980 | 2,363 | +19.3% |
| Legislative acts adopted | 72 | 78 | 114 | +46.2% |
| Parliamentary questions | 2,970 | 4,948 | 6,147 | +24.2% |
| Procedures active | 676 | 923 | 935 | +1.3% |
| Adopted texts | 459 | 347 | 164 (partial) | — |
...
- More complex multi-committee files (joint rapporteurships)
- Increased use of trilogue negotiations requiring committee mandates
- Greater technical depth required by digital regulation (DMA, AI Act implementation)
- Defence/security legislation requiring AFET, SEDE, and BUDG coordination
...
| Policy Area | Texts | Committee Lead | Significance |
|-------------|-------|----------------|--------------|
| Internal Market / Digital | 3 | IMCO / JURI | DMA enforcement, EU designs, Measuring Instruments |
| Economic / Monetary | 2 | ECON | Financial stability, ECB annual report |
| Trade (external) | 1 | INTA | EU-Mercosur CJE opinion request |
| Security / External Affairs | 5 | AFET / LIBE | Ukraine, Armenia, Syria, Haiti, Iceland PNR |
| Budget | 2 | BUDG | 2027 guidelines, EP 2027 estimates |
| Democracy / Rule of Law | 2 | AFCO / LIBE | Electoral Act, Lithuania broadcaster |
| Agriculture / Consumer | 1 | AGRI | Dogs/cats welfare regulation |
| Labour | 1 | EMPL | Subcontracting chains |
| Gender / Human Rights | 1 | FEMM | CSW 70 recommendation |
| Institutional / Financial | 1 | CONT | EIB annual report |
...
- **EPP** (25.7% of seats): Holds chairmanships in ECON, AGRI, AFCO, CONT, PECH
- **S&D** (18.8%): Chairs EMPL, CULT, DEVE, FEMM
- **PfE** (11.7%): Chairs AFET (highly contested allocation)
- **ECR** (11.0%): Chairs INTA, ENVI
- **RE** (10.6%): Chairs ITRE, LIBE, JURI
- **Greens/EFA** (7.4%): Chairs TRAN, REGI
- **GUE/NGL** (6.4%): Chairs PETI
...
- EPP + S&D alone = 44.5% of seats → insufficient for plenary majority but dominant in most committees
- EPP + S&D + RE = 55.1% → sufficient for most committee-stage amendments
- EPP + ECR + PfE = 47.7% → conservative majority possible in committees
- The rightward shift in committee chairmanships means legislative drafting is starting from more conservative baselines than in EP9

---

### 5. Oversight Intensity Trends
...
- Larger Commission portfolio requiring more MEP specialization
- Digital and AI regulation creating new oversight demands
- Foreign policy crises (Ukraine, Middle East, Sahel) generating reactive questioning
- ECR and PfE MEPs using parliamentary questions as opposition tool (cross-checking), raising overall count
...
| Year | Procedures Active | Completion Rate | Interpretation |
|------|------------------|-----------------|----------------|
| 2024 | 676 | 10.7% | Transition year — many procedures stalled |
| 2025 | 923 | 8.5% | EP10 committees filling pipeline |
| 2026 | 935 | 12.2% | Improving throughput |
...
| Signal | Assessment |
|--------|-----------|
| Source reliability | B — EP Open Data Portal (authoritative, intermittent 404 degradation this run) |
| Information quality | 2 — Confirmed by cross-reference between generated stats and adopted texts |
| WEP band | LIKELY (70–85%) that 2026 will record the highest committee meeting count in EP history |
| Time horizon | 2026 full year (H1 confirmed; H2 projected based on calendar) |
| Confidence in evidence | HIGH for statistics; LOW for real-time committee-level activity |
...
```mermaid
graph LR
    subgraph National["National Media Framing"]
        N1[Germany: Industrial policy\ncompetitiveness angle]
        N2[France: Sovereignty\nstrategic autonomy]
        N3[Poland: Rule of law\nconditional EU money]
        N4[Hungary: Sovereignty\ncritical of ECJ/EP]
        N5[Spain: Social cohesion\nSME protection]
    end
    subgraph Issue["Issue-Based Framing"]
        I1[Climate: Green vs.\ncompetitiveness trade-off]
        I2[Defence: NATO vs.\nEU autonomy]
        I3[Digital: Big Tech\nvs. EU regulation]
        I4[Trade: Free trade\nvs. protectionism]
    end
    subgraph EP["EP Committee Output"]
        C1[CID: ITRE lead]
        C2[EDIS: AFET/AFDE]
        C3[DMA: IMCO]
        C4[Budget 2027: BUDG]
...
```mermaid
flowchart LR
    A[Raw Data\nEP Stats + Adopted Texts] --> B[SAT 1: Key Assumptions Check]
    A --> C[SAT 2: QoI Check]
    B --> D[SAT 6: PESTLE Analysis]
    C --> D
    D --> E[SAT 3: MWC / ACH]
    D --> F[SAT 7: Force-Field]
    E --> G[SAT 4: Scenario Analysis]
    F --> G
    G --> H[SAT 5: Bayesian Update]
    H --> I[SAT 8: Stakeholder Map]
    I --> J[SAT 9: ACH Hypotheses]
    J --> K[SAT 10: 3 Scenarios + WEP]
    K --> L[SAT 11: Pre-Mortem]
    L --> M[SAT 12: Per-Threat Assumptions]
    M --> N[SAT 13: Indicators]
    N --> O[SAT 14: Red Team]
    O --> P[SAT 15: HILP Wildcards]
    P --> Q[SAT 16: What-If Analysis]
    Q --> R{Coherence\nCheck}
    R -->|Pass| S[Final Assessment\nCommittee Reports 2026-05-25]
    R -->|Fail| T[Revision Loop]
    T --> B
```
...
```mermaid
pie title EP10 Active Procedure Type Distribution (Inferred)
    "Co-decision (OLP) legislative" : 40
    "Non-legislative resolutions" : 35
    "Own-initiative reports" : 15
    "Consent/assent procedures" : 10
```
...
> - **Gate result:** `pending`
> - **Analysis tree:** [analysis/daily/2026-05-25/committee-reports](https://github.com/Hack23/euparliamentmonitor/tree/main/analysis/daily/2026-05-25/committee-reports)
> - **Manifest:** [manifest.json](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/manifest.json)
...
Every artifact below was read by the aggregator and contributed to this article. The raw [manifest.json](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/manifest.json) carries the full machine-readable list, including gate-result history.

| Section | Artifact | Path |
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/executive-brief.md) | `executive-brief.md` |
| section-synthesis | [synthesis-summary](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/synthesis-summary.md) | `intelligence/synthesis-summary.md` |
| section-significance | [significance-classification](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/classification/significance-classification.md) | `classification/significance-classification.md` |
| section-actors-forces | [actor-mapping](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/classification/actor-mapping.md) | `classification/actor-mapping.md` |
| section-actors-forces | [forces-analysis](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/classification/forces-analysis.md) | `classification/forces-analysis.md` |
| section-actors-forces | [impact-matrix](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/classification/impact-matrix.md) | `classification/impact-matrix.md` |
| section-coalitions-voting | [coalition-dynamics](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/coalition-dynamics.md) | `intelligence/coalition-dynamics.md` |
| section-coalitions-voting | [voting-patterns](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/voting-patterns.md) | `intelligence/voting-patterns.md` |
| section-stakeholder-map | [stakeholder-map](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/stakeholder-map.md) | `intelligence/stakeholder-map.md` |
| section-economic-context | [economic-context](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/economic-context.md) | `intelligence/economic-context.md` |
| section-risk | [risk-matrix](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/risk-scoring/risk-matrix.md) | `risk-scoring/risk-matrix.md` |
| section-risk | [quantitative-swot](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/risk-scoring/quantitative-swot.md) | `risk-scoring/quantitative-swot.md` |
| section-threat | [threat-model](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/threat-model.md) | `intelligence/threat-model.md` |
| section-scenarios | [scenario-forecast](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/scenario-forecast.md) | `intelligence/scenario-forecast.md` |
| section-scenarios | [wildcards-blackswans](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/wildcards-blackswans.md) | `intelligence/wildcards-blackswans.md` |
| section-pestle-context | [pestle-analysis](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/pestle-analysis.md) | `intelligence/pestle-analysis.md` |
| section-pestle-context | [historical-baseline](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/historical-baseline.md) | `intelligence/historical-baseline.md` |
| section-documents | [committee-productivity](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/existing/committee-productivity.md) | `existing/committee-productivity.md` |
| section-extended-intel | [media-framing-analysis](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/extended/media-framing-analysis.md) | `extended/media-framing-analysis.md` |
| section-mcp-reliability | [mcp-reliability-audit](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/mcp-reliability-audit.md) | `intelligence/mcp-reliability-audit.md` |
| section-quality-reflection | [analysis-index](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-25/committee-reports/intelligence/analysis-index.md) | `intelligence/analysis-index.md` |
