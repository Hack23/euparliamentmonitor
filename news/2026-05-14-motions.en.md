---
title: "EU Parliament Motions & Adopted Texts — Run 306"
description: "T10-0161/2026 — Ensuring accountability and justice in response to Russia's continued attacks against the civilian population in Ukraine (Adopted."
keywords: ["EU Parliament Monitor", "European Parliament", "European Commission", "political intelligence", "Riksdagsmonitor", "Riksdag", "Regeringen", "EU Parliament", "plenary votes", "resolutions", "voting record", "Motions", "2026-05-14", "Parliament", "Adopted", "Texts"]
date: 2026-05-14
...
mindmap
  root((April 2026 Session))
    Geopolitical
      Ukraine accountability tribunal push
      Armenia EU-association momentum
      Haiti criminal gangs urgent response
    Digital Governance
      DMA enforcement pressure on Big Tech
      Cyberbullying platform liability standards
    Budgetary
      2027 guidelines: ReArm EU prioritized
      Climate 30pct earmark secured by Greens
    Agricultural
      Livestock sustainability: food security framing
      Farm-to-Fork recalibration post-2025 elections
    Procedural
      Patryk Jaki immunity waiver: ECR-Poland fault line
      Discharge 2024 CoR: clean opinion
```
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","secondaryColor":"#7B1FA2","lineColor":"#90CAF9"}}}%%
flowchart LR
    A["Ukraine Resolution\n🔴 Geopolitical"]
    B["Armenia Resolution\n🟠 Eastern Policy"]
    C["DMA Enforcement\n🟡 Digital"]
    D["Budget Guidelines\n🔴 Institutional"]
    E["Haiti/Cyberbullying\n🟡 Human Rights"]
    
    A -->|"Special Tribunal\nmoves to Council"| F["Council May 26\nFAC Agenda"]
    B -->|"Association talks\naccelerate"| G["EaP May Summit"]
    C -->|"Commission Q3\nreport deadline"| H["Q3 2026\nDMA Progress Report"]
    D -->|"Sets autumn\nconciliation baseline"| I["Oct 2026\nBudget Trilogues"]
    E -->|"Platform liability\nprecedents"| J["DSA Review\n2027"]
```
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#2E7D32","lineColor":"#A5D6A7"}}}%%
flowchart LR
    subgraph T1["🔴 Tier 1: High Institutional Impact"]
        T1A["T10-0161/2026\nUkraine Accountability"]
        T1B["T10-0112/2026\n2027 Budget Guidelines"]
    end
    subgraph T2["🟠 Tier 2: Significant Policy Impact"]
        T2A["T10-0162/2026\nArmenia Democratic Resilience"]
        T2B["T10-0160/2026\nDMA Enforcement"]
        T2C["T10-0151/2026\nHaiti Trafficking"]
    end
    subgraph T3["🟡 Tier 3: Standard Legislative"]
        T3A["T10-0163/2026 Cyberbullying"]
        T3B["T10-0157/2026 Livestock"]
        T3C["T10-0142/2026 EU-Iceland PNR"]
        T3D["T10-0115/2026 Dog/Cat Welfare"]
        T3E["T10-0119/2026 EIB Report"]
        T3F["T10-0122/2026 Performance Instruments"]
    end
    subgraph T4["🟢 Tier 4: Routine Procedural"]
        T4A["T10-0105/2026 Jaki Immunity"]
        T4B["T10-0132/2026 CoR Discharge"]
    end
```
...
graph LR
    ...
    EPP -->|"Budget + Defence"| SD
    EPP -->|"Digital markets"| RENEW
    SD -->|"Social-climate"| GREENS
    RENEW -->|"Digital governance"| GREENS
    ECR -->|"Ukraine hawkish"| EPP
    ECR -.->|"Sovereignty objection"| PFE
    GUE -.->|"Selective"| SD
```
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","secondaryColor":"#2E7D32","tertiaryColor":"#FF9800"}}}%%
quadrantChart
    title Power × Alignment — April 2026 EP Session
    x-axis "Against Key Resolutions" --> "For Key Resolutions"
    y-axis "Low Institutional Power" --> "High Institutional Power"
    quadrant-1 Core Drivers
    quadrant-2 Structural Allies
    quadrant-3 Marginal Opposition
    quadrant-4 Critical Swing
    EPP Group: [0.72, 0.88]
    S&D Group: [0.68, 0.82]
    Renew Europe: [0.74, 0.70]
    Greens/EFA: [0.78, 0.55]
    European Commission: [0.65, 0.92]
    Council Presidency: [0.55, 0.85]
    ECR Group: [0.35, 0.65]
    Patriots for Europe: [0.15, 0.60]
    ESN Group: [0.10, 0.40]
    GUE/NGL: [0.60, 0.45]
    Ukraine Government: [0.80, 0.30]
    Armenian Government: [0.75, 0.25]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","lineColor":"#90CAF9"}}}%%
flowchart TD
    NOW["April 2026 Session\n13 Texts Adopted\nAccountability + Digital + Budget"]
    
    NOW --> S1["Scenario A: Institutional Momentum\n(P=45%)"]
    NOW --> S2["Scenario B: Incremental Progress\n(P=38%)"]
    NOW --> S3["Scenario C: Stalled Implementation\n(P=17%)"]
    
    S1 --> A1["Special Tribunal treaty\nprocess launched Q3 2026"]
    S1 --> A2["DMA enforcement orders\nissued before Q3 deadline"]
    S1 --> A3["Armenia association talks\nformally opened Q2 2026"]
    
    S2 --> B1["Council work-program\nintegrates accountability\nwithout formal treaty"]
    S2 --> B2["DMA progress report\npublished Q4 2026\n(slippage)"]
    S2 --> B3["EaP framework update\npassed without Armenia-specific\nassociation language"]
    
    S3 --> C1["Hungary vetoes Ukraine\naccountability instrument\nat Council"]
    S3 --> C2["Commission delays DMA\nenforcement into 2027"]
    S3 --> C3["EP-Council impasse on\n2027 budget guidelines"]
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#D32F2F","lineColor":"#EF9A9A"}}}%%
graph TD
    NORM["Normal Trajectory\n(Scenarios A-C in forecast)"]
    
    BS1["🦢 Black Swan 1:\nRussian Nuclear Use\nor Ceasefire Collapse"]
    BS2["🦢 Black Swan 2:\nECR/PfE Hostile Merger\nCreates EP Blocking Minority"]
    BS3["🦢 Black Swan 3:\nDMA ECJ Annulment\nSets Back Digital Regulation"]
    BS4["🦢 Black Swan 4:\nHaiti Gang Collapse\nCreates Refugee Crisis"]
    BS5["🌩️ Wildcard 1:\nMajor Cyberattack on\nEP Voting Systems"]
    BS6["🌩️ Wildcard 2:\nHungary Exits EU\nor Is Suspended"]
    BS7["🌩️ Wildcard 3:\nFrench President Dissolves\nNational Assembly — RN Majority"]
    ...
    style BS1 fill:#D32F2F,color:#ffffff
    style BS2 fill:#D32F2F,color:#ffffff
    style BS3 fill:#E53935,color:#ffffff
    style BS4 fill:#FF5252,color:#000000
    style BS5 fill:#B71C1C,color:#ffffff
    style BS6 fill:#B71C1C,color:#ffffff
    style BS7 fill:#D32F2F,color:#ffffff
```
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#7B1FA2","lineColor":"#CE93D8"}}}%%
mindmap
  root((PESTLE April 2026))
    Political
      Ukraine accountability mandate
      Armenia EU orientation
      ECR internal fracture on sovereignty
      PfE consolidation in EP opposition
    Economic
      ReArm EU defence spending
      DMA enforcement Big Tech impact
      2027 Budget baseline set
      Livestock sector transition costs
    Social
      Haiti humanitarian crisis response
      Cyberbullying youth digital safety
      Dog and cat welfare popular mandate
      Refugee flows Armenia context
    Technological
      DMA enforcement: AI ecosystem impact
      Cyberbullying platforms: DSA extension
      ICT supply chain security
    Legal
      Special Tribunal aggression novel instrument
      Immunity waiver Jaki rule of law
      EU-Iceland PNR data transfer
      Performance-based instruments accountability
    Environmental
      Livestock sector sustainability
      2027 Budget 30pct climate earmark
      Farm-to-Fork calibration
```
