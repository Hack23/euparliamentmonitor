---
title: "The four most consequential decisions"
...
The 28 April plenary day delivered **17 adopted texts** spanning budget, justice, environment, trade, and institutional dossiers. The four most consequential decisions: (i) **four immunity waivers in a single session** — Jaki, Obajtek, Buczek (ECR-aligned, Poland) and Şoşoacă (NI, Romania) — a statistically anomalous JURI output volume; (ii) the **MFF 2028–2034 interim report** (TA-10-2026-0111) opening Parliament's negotiating position for the next seven-year budget framework; (iii) the **2027 annual budget guidelines** (TA-10-2026-0112) Section III; (iv) a **consent-based rape resolution** (TA-10-2026-0120) pressing Member States toward harmonised criminal-law definitions where only ~half currently comply. Aggregate signal: a Parliament asserting **simultaneous fiscal, rule-of-law, and rights-based agendas** under an EPP-S&D-Renew working coalition of ~397 seats. *Confidence: HIGH on substance; MODERATE on roll-call (4–6-week EP delay).*

### Three Decisions Riding On This Week

1. **The MFF 2028–2034 interim report is the most strategically consequential vote.** TA-0111 is the EP's formal opening position for the seven-year framework that will dominate EU politics for 2027–2029. Interim reports establish ceilings (likely higher than Commission proposal), inter-heading flexibility, EP oversight enhancements, and climate-proofing — and they cannot be substantially walked back without political cost. The BUDG committee's drafting (EPP and S&D rapporteurs) signals that the negotiating frame is **mainstream-coalition-anchored**, not contested across the spectrum. The leading indicator of trilogue difficulty will be the gap between this report's ceilings and the eventual Council mandate. *Confidence: HIGH.*

2. **Four immunity waivers in one day is a procedural inflection.** The JURI Committee's output density — three Polish ECR-linked MEPs plus a Romanian NI MEP — confirms that the EP's rule-of-law toolkit is operationally aligned with home-country judicial authorities. The Polish case is structurally significant: post-2023 rule-of-law correction processes under the Tusk-led coalition are now visibly flowing through the EP's procedures. Whether the ECR group treats this as a defensive priority or accepts it as the price of EP membership will determine its internal cohesion for the rest of 2026. *Confidence: HIGH on the pattern; MODERATE on ECR response.*

3. **The consent-based rape resolution (TA-0120) pushes a structural Member-State legal-harmonisation agenda.** Only roughly half of EU Member States currently have consent-based legal definitions of rape; the resolution asks the Commission to advance minimum standards under Article 83 TFEU. The political tension is between rights-advocacy momentum (S&D, Renew, Greens, Left, EPP centrists) and subsidiarity-based opposition (ECR, PfE, EPP conservative wing on family-policy matters). The resolution is non-legislative but creates political ammunition for Commission action — and it confirms that gender-rights remains a structural fault line in EP10. *Confidence: HIGH on the political fault line; MODERATE on Commission follow-through.*

### 60-Second Read

The April 28 plenary is operationally one of the heaviest days of the term: 17 texts, four immunity waivers, an MFF interim report, the annual budget cycle opener, a rights-based criminal-law resolution, GSP reform, EIB control, and consumer-protection housekeeping. The composite tells a coherent institutional story: the **EPP-S&D-Renew mainstream coalition is exercising the full toolkit** — fiscal authority, rule-of-law enforcement, rights advancement, trade-policy update.

The political-arithmetic constraint remains unchanged: 719 MEPs, 9 groups, EPP at 25.7 % seat share, no durable supermajority. The bloc of ~397 (EPP + S&D + Renew) is comfortably above 361 majority on procedural, budgetary, and rule-of-law files. It becomes contested on substantive economic-regulatory and environmental files — visible in the next week's livestock and DMA substance votes.

The **MFF interim report** deserves outsized analytical weight because seven-year framework negotiations dominate EU politics for years. If the EP locks in higher ceilings and stronger oversight conditionalities now, the Commission's draft (expected mid-2026) and Council's mandate (expected late-2026 / early-2027) will be evaluated against a Parliament benchmark that already exists. Conversely, if the report is read as a maximalist negotiating position to be moderated, its political weight diminishes proportionally with each compromise.

The **GSP reform** (TA-0114) — preferential tariffs for developing countries with ESG-linked conditionality — is technical but consequential: it is the most concrete EU instrument linking trade access to labour, environment, and human-rights standards, and the renewal cycle defines whether the EU's "fair-trade-plus-free-trade" doctrine has teeth.

### Risk Snapshot (next 12 months)

| # | Risk | Likelihood | Impact | Net |
|---|------|-----------:|------:|----:|
| 1 | MFF 2028–2034 Council mandate diverges sharply from EP interim report | MED–HIGH | VERY HIGH | **Top** |
| 2 | ECR fractures on subsequent immunity-related procedures | MED | MED–HIGH | Watch |
| 3 | Consent-based rape directive blocked at Council on subsidiarity grounds | MED–HIGH | MED–HIGH | **Top** |
| 4 | GSP+ ESG conditionality challenged at WTO | LOW–MED | MED | Watch |
| 5 | 2027 budget conciliation collapses on defence vs. cohesion balance | MED | HIGH | **Top** |

### Forward Triggers (next 4–8 weeks)

- **Commission MFF 2028–2034 proposal (mid-2026):** distance from TA-0111 ceilings is the structural-tension leading indicator.
- **Council 2027 draft budget (July):** see analogous metric against TA-0112.
- **Commission gender-violence directive update:** any proposal text on consent-based definitions converts TA-0120 from political ammunition to operative law.
- **JURI immunity-request inbox:** any new request from Hungary, Italy, or Spain expands precedent beyond Polish-Romanian axis.
- **GSP+ country reviews:** any country graduation or sanction (e.g., on labour or environmental grounds) validates ESG conditionality teeth.

### ACH — Three Competing Readings

| Hypothesis | Supporting evidence | Disconfirming evidence | Assessment |
|---|---|---|---|
| H1: Institutional-mainstream maximisation week | 17 texts, EPP+S&D+Renew working majority on each | Some texts narrowly contested (rape resolution) | **Strongly supported** |
| H2: Politically opportunistic immunity-targeting cluster | Four waivers, same ideological direction | Each waiver originates with national authorities, procedurally separate | **Weakly supported** |
| H3: MFF-anchored strategic positioning ahead of 2027 super-cycle | Simultaneous MFF interim + annual budget + GSP + EIB control | Some files are routine renewal | **Moderately supported** |

### Source Quality (Admiralty grading)

- EP Open Data Portal — adopted texts (TA-10-2026-0105 / 0106 / 0107 / 0108 / 0111 / 0112 / 0113 / 0114 / 0119 / 0120 / 0122): **A1**
- 2024-protest and post-2023 Polish judicial context: **B2** (public official statements + press)
- Coalition-arithmetic (EPP+S&D+Renew = 397 / 361 threshold): **A2**
- Forward 12-month MFF and Council projections: **C3**

### Provenance

- Run: motions analysis for window 2026-04-22 → 2026-04-29
...
- Data currency: 29 April 2026.
- Compliance: EP Open Data Portal feeds only; cohesion figures partly estimated owing to roll-call delay; GDPR-compliant.

---

*Analytical neutrality: every directional claim is hedged with confidence levels and competing-hypothesis treatment.*
...
pie title EP Political Groups — Seat Shares (719 MEPs total)
    "EPP (185)" : 185
    "S&D (135)" : 135
    "PfE (85)" : 85
    "ECR (81)" : 81
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
graph TD
    EP_JURI["EP JURI Committee"] -->|"recommended waiver"| JAKI["Patryk Jaki MEP (ECR/PL)"]
    EP_JURI -->|"recommended waiver"| OBAJTEK["Daniel Obajtek MEP (ECR/PL)"]
    EP_JURI -->|"recommended waiver"| BUCZEK["Tomasz Buczek (PL)"]
    EP_JURI -->|"recommended waiver"| SOSOACD["Diana Şoşoacă MEP (NI/RO)"]
    EP_PLENARY["EP Plenary"] -->|"adopted"| MFF["MFF 2028-2034 Interim Report"]
    EP_PLENARY -->|"adopted"| CONSENT["Consent Legislation Resolution"]
    EP_BUDG["EP BUDG Committee"] -->|"initiated"| MFF
    ECR["ECR Group (81 seats)"] -->|"home group of"| JAKI
    ECR -->|"home group of"| OBAJTEK
    PL_COURTS["Polish Courts"] -->|"requested"| EP_JURI
    RO_COURTS["Romanian Courts"] -->|"requested"| EP_JURI
    EC["European Commission"] -->|"will respond to"| MFF
    ORLEN["PKN Orlen (state-owned)"] -->|"acquisition by Obajtek"| POLSKA_PRESS["Polska Press (media group)"]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
graph LR
    EPP["EPP 185"] -->|"core coalition"| SD["S&D 135"]
    SD -->|"core coalition"| RENEW["Renew 77"]
    EPP -->|"pro-MFF"| MFF_SUPPORT["MFF High-Ceiling Coalition"]
    RENEW -->|"pro-gender rights"| CONSENT_SUP["Consent Resolution Coalition"]
    GREENS["Greens 53"] -->|"joins"| MFF_SUPPORT
    GREENS -->|"joins"| CONSENT_SUP
    LEFT["Left 46"] -->|"joins"| CONSENT_SUP
    ECR["ECR 81"] -->|"opposes"| MFF_SUPPORT
    ECR -->|"opposed"| WAIVER_VOTE["Immunity Waivers for own MEPs"]
    PFE["PfE 85"] -->|"opposes"| CONSENT_SUP
    PFE -->|"opposing bloc"| WAIVER_VOTE
    NI["NI 30"] -.->|"mixed votes"| MFF_SUPPORT
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
xychart-beta
    title Actor Influence vs. Interest
    x-axis ["Low Interest", "Medium Interest", "High Interest"]
    y-axis "Influence Level" 0 --> 10
    bar [2, 5, 9]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
timeline
    title Impact Materialisation Timeline
    section Immediate (0-30 days)
        Polish judicial summons : Jaki / Obajtek proceedings begin
        EP roll-call vote data : Published with 4-6 week delay
        Commission acknowledgment : MFF interim report formally communicated
    section Short-term (1-3 months)
        ECR internal tensions : Visible in voting discipline data
        Commission Work Programme : Whether consent directive included
        Romanian proceedings : Şoşoacă case in national courts
    section Medium-term (3-12 months)
        Commission MFF proposal : Q3-Q4 2026 expected
        Gender directive consultation : Expert hearings if Commission moves
        GSP implementation : Beneficiary notifications
    section Long-term (1-3 years)
        MFF 2028-2034 adoption : Trilogue + EP consent
        EU criminal law evolution : Consent directive (if adopted)
        Rule of law precedents : Polish/Romanian case outcomes
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
graph TD
    MFF["MFF 2028-2034 report"] -->|"shapes"| COHESION["Cohesion Fund levels"]
    MFF -->|"funds"| DEFENCE["EU Defence spending"]
    CONSENT["Consent Legislation"] -->|"creates"| DIRECTIVE["Potential EU directive"]
    CONSENT -->|"pressures"| MEMBER["12 member states to amend codes"]
    IMMUNITY["Immunity waivers"] -->|"triggers"| PROCEEDINGS["Polish/Romanian proceedings"]
    PROCEEDINGS -->|"tests"| RULELAW["EU rule-of-law credibility"]
    RULELAW -->|"affects"| MFF_COND["MFF conditionality strength"]
    MFF_COND -->|"links back to"| MFF
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
xychart-beta
    title Impact Scores by Domain
    x-axis ["Political", "Institutional", "Legal", "Social", "Economic", "International"]
    y-axis "Average Score" 0 --> 5
    bar [3.8, 3.6, 3.7, 3.2, 3.1, 2.5]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
graph TD
    A["EP April 28 Plenary"] --> B["Immunity Waivers ×4"]
    A --> C["MFF 2028-2034 Interim"]
    A --> D["2027 Budget Guidelines"]
    A --> E["Consent Rape Legislation"]
    A --> F["GSP Trade Reform"]
    
    B --> B1["Polish Government (+)"]
    B --> B2["Polish Opposition MEPs (-)"]
    B --> B3["Romanian Judicial System (+)"]
    B --> B4["Press Freedom NGOs (+)"]
    B --> B5["ECR Group (-)"]
    
    C --> C1["Commission (+/-)"]
    C --> C2["Member States Council (-)"]
    C --> C3["EU Cohesion Regions (+)"]
    C --> C4["Defence Industry (+)"]
    
    E --> E1["Women's rights NGOs (+)"]
    E --> E2["Conservative religious groups (-)"]
    E --> E3["National governments MIXED"]
    
    F --> F1["Developing country exporters (+)"]
    F --> F2["EU industry (MIXED)"]
```
...
quadrantChart
    title Risk Matrix — EP Motions April 28 2026
    ...
    quadrant-3 Accept
    quadrant-4 Mitigate
    "Polish ECR fracture": [0.7, 0.65]
    "MFF negotiation failure": [0.85, 0.4]
    "Consent legislation block": [0.65, 0.5]
    "Şoşoacă proceedings disruption": [0.45, 0.7]
    "GSP WTO challenge": [0.5, 0.35]
    "EIB accountability gap": [0.4, 0.35]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
graph LR
    R01["R-01: ECR fracture"] -->|"amplifies"| R05["R-05: Polish politicisation risk"]
    R05 -->|"undermines"| MFF["R-02: MFF negotiations"]
    R01 -->|"affects"| COALITIONS["EP coalition stability"]
    R03["R-03: Consent directive blocked"] -->|"reinforces"| RIGHTS["Rights agenda stall"]
    MFF -->|"resources gap"| R10["R-10: 2027 budget shortfall"]
```
...
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-29/motions/executive-brief.md) | `executive-brief.md` |
