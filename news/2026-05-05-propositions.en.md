...
description: "WEP Probability Band: Assessed findings — Likely (55–79%) to have multi-year policy consequences Published 2026-05-05. for democratic-accountability readers tracking EU…"
keywords: ["EU Parliament", "legislative procedures", "European Parliament", "proposal", "regulation", "Propositions", "2026-05-05", "run propositions-run-1777966984", "Probability", "Band", "Assessed", "findings", "Likely", "have", "multi", "year"]
date: 2026-05-05
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9","secondaryColor":"#2E7D32","tertiaryColor":"#D32F2F"}}}%%
mindmap
  root((Apr 28-30\nPlenary 2026))
    Digital
      DMA Enforcement\nTA-10-2026-0160
      DMA: Commission on notice
      Gatekeeper structural remedies\npending
    Climate
      ETS Market Stability\nReserve TA-0139
      Buildings + Road Transport
      ETS2 timetable accelerated
      CO2 75-110 euro by 2028
    Ukraine
      Claims Commission\nTA-10-2026-0154
      Reparations architecture
      Asset seizure complemented
      Multi-year ratification
    RuleOfLaw
      5 Immunity Waivers\nTA-0105 to 0109
      Poland: Jaki Obajtek Buczek Braun
      Romania: Sosoacă
      Judicial proceedings unblocked
    Budget
      2027 Guidelines TA-0112
      Defence + Competitiveness
      Post-2027 MFF signal
      Parliament Estimates TA-0155
    Institutional
      Proxy Voting TA-0124
      Rules of Procedure TA-0118
      Agency appointments reform
```
...
pie title April 28-30 Texts by Classification
  "Strategic (3)" : 3
  "Significant (6)" : 6
  "Notable (14)" : 14
  "Routine (14)" : 14
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
graph TD
  EP[EP Plenary 719 MEPs] --> EPP[EPP 185]
  EP --> SD[S&D 135]
  EP --> PfE[PfE 85]
  EP --> ECR[ECR 81]
  EP --> Renew[Renew 77]
  ...
  EP --> Left[The Left 46]
  EPP --> DMA_YES[DMA/ETS2/Ukraine YES]
  SD --> DMA_YES
  Renew --> DMA_YES
  Greens --> DMA_YES
  PfE --> NO_BLOC[Opposition Bloc]
  ECR --> NO_BLOC
  EC[Commission] --> DMA_ENF[DMA Enforcement Lead]
  MS[Member States Council] --> CLAIMS[Claims Commission Ratification]
  BIGTECH[Big Tech Apple/Meta/Alphabet/Microsoft] --> DMA_LOBBY[Industry Lobby]
  RU[Russia] --> DISINFO[Disinformation on Claims Commission]
  UA[Ukraine] --> BENEFICIARY[Claims Convention Beneficiary]
```
...
mindmap
  root((Political\nForces))
    Enabling Forces
      EU institutional consensus EPP-SD-Renew
      Public demand for digital accountability
      Ukraine solidarity mandate
      Green transition investment imperative
    Constraining Forces
      US trade retaliation threat on DMA
      Russian vetoes on Claims Commission
      Social cost fears on ETS2
      ECR-PfE obstruction bloc 193 MEPs
    Accelerating Forces
      DMA first enforcement cycle deadlines
      ETS2 2027 compliance requirements
      Ukrainian reconstruction urgency
    Decelerating Forces
      CJEU legal challenges possible
      Member state sovereignty concerns
      Unanimity requirement for Claims Commission
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
graph LR
  DMA_VOTE[DMA Resolution\nAdopted] --> COMMISSION_ACTION[Commission\n90-day enforcement response]
  COMMISSION_ACTION --> COMPLIANCE[Big Tech Compliance\nDemands]
  COMPLIANCE --> US_RESPONSE[US USTR\nTrade Pressure]
  US_RESPONSE --> EU_RESPONSE[EP-Commission\nCoordination Required]
  EU_RESPONSE --> OUTCOME{Enforcement\nor Pause?}
  ETS2_VOTE[ETS2 MSR\nAdopted] --> IMPL_REG[Implementing\nRegulation Draft]
  IMPL_REG --> SCF_PARAMS[SCF Parameters\nPolitical Decision]
  CLAIMS_VOTE[Claims Conv.\nConsent] --> COUNCIL_WG[Council Working\nGroup First Meeting]
  COUNCIL_WG --> RATIF{Ratification\nTrajectory}
  IMMUNITY[Immunity\nWaivers × 5] --> NATIONAL_COURTS[National Court\nActions PL/RO]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
quadrantChart
  title Legislative Impact vs. Implementation Difficulty
  x-axis Low Difficulty --> High Difficulty
  y-axis Low Impact --> High Impact
  quadrant-1 Act Now - High Impact/Low Difficulty
  quadrant-2 Strategic Priority
  quadrant-3 Deprioritize
  quadrant-4 Complex - Manage Carefully
  DMA Enforcement: [0.55, 0.88]
  ETS2 MSR: [0.65, 0.82]
  Ukraine Claims Commission: [0.75, 0.85]
  Budget Guidelines: [0.30, 0.70]
  Immunity Waivers: [0.35, 0.65]
  Budget Discharges: [0.15, 0.45]
  Intl Agreements: [0.45, 0.55]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
flowchart LR
  EPP([EPP 185]) --> Consensus([Pro-EU Majority\n397 MEPs])
  SD([S&D 135]) --> Consensus
  Renew([Renew 77]) --> Consensus
  GrEFA([Greens 53]) --> Extended([Extended Coalition\n450 MEPs])
  Consensus --> Extended
  ECR([ECR 81]) --> Opposition([Opposition Bloc\n193 MEPs])
  PfE([PfE 85]) --> Opposition
  ESN([ESN 27]) --> Opposition
  classDef majority fill:#1565C0,color:#fff
  classDef opposition fill:#B71C1C,color:#fff
  classDef extension fill:#1B5E20,color:#fff
  class Consensus majority
  class Extended extension
  class Opposition opposition
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
quadrantChart
  title Power × Alignment (Apr 28-30 Legislative Agenda)
  x-axis Low Alignment --> High Alignment
  y-axis Low Power --> High Power
  quadrant-1 Powerful Allies
  quadrant-2 Powerful Opponents
  quadrant-3 Weak Opponents
  quadrant-4 Weak Allies
  EPP Group: [0.78, 0.92]
  S&D Group: [0.82, 0.79]
  Renew Europe: [0.76, 0.64]
  European Commission: [0.71, 0.88]
  Greens/EFA: [0.87, 0.52]
  ECR Group: [0.32, 0.61]
  PfE Group: [0.22, 0.58]
  Big Tech Gatekeepers: [0.15, 0.81]
  Poland Government: [0.68, 0.55]
  The Left: [0.83, 0.39]
  ESN Group: [0.18, 0.35]
  Ukraine Government: [0.91, 0.42]
  Climate NGOs: [0.88, 0.28]
  EU Member State Governments: [0.55, 0.72]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
timeline
  title Legislative Velocity Risk — April 28-30 Adopted Texts
  2026-Q2 : ETS2 MSR implementation regulations drafted
           : DMA gatekeeper designation reviews
  2026-Q3 : ETS2 first compliance reports due
           : DMA enforcement first decisions expected
           : Claims Commission ratification national parliaments begin
  2026-Q4 : ETS2 Phase 1 compliance enforcement
           : DMA fines first issuances possible
  2027 : Budget guidelines become binding allocation
        : Social Climate Fund first disbursements
        : Claims Commission operational (if ratified)
  2028 : ETS2 full buildings/transport inclusion
        : DMA framework review
```
...
mindmap
  root((Political\nThreat\nLandscape))
    External State Threats
      Russia disinfo campaigns
      US trade pressure on DMA
      Big Tech lobbying blocs
    Internal EP Threats
      ECR/PfE obstructionism
      Immunity impunity culture
      Rule of law erosion
    Social Pressure Threats
      ETS2 public backlash
      Cost-of-living amplification
      Populist exploitation
    Institutional Threats
      CJEU legal challenges
      Commission enforcement gaps
      Council member state veto
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
quadrantChart
  title Threat Actors: Capability vs. Intent
  x-axis Low Intent --> High Intent
  y-axis Low Capability --> High Capability
  quadrant-1 Critical Threat
  quadrant-2 Watch
  quadrant-3 Low Priority
  quadrant-4 Capable but Restrained
  Russia SVR: [0.85, 0.80]
  US USTR: [0.70, 0.90]
  Big Tech Lobby: [0.75, 0.85]
  Hungary Government: [0.80, 0.60]
  ECR-PfE Bloc: [0.65, 0.50]
  CJEU Challengers: [0.40, 0.70]
  ESN Group: [0.55, 0.30]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
graph TD
  ROOT[April 28-30 Session Outcomes] --> DMA_PATH[DMA Enforcement Path]
  ROOT --> ETS2_PATH[ETS2 MSR Path]
  ROOT --> CLAIMS_PATH[Claims Commission Path]
  ROOT --> IMMUNITY_PATH[Immunity Enforcement Path]

  DMA_PATH --> DMA_A[Commission acts within 90 days\nWEP 60%]
  DMA_PATH --> DMA_B[US retaliates → enforcement pause\nWEP 35%]
  DMA_A --> DMA_A1[Big Tech compliance cascade\nGlobal regulatory adoption]
  DMA_B --> DMA_B1[EU credibility deficit\nEP-Commission tension]

  ETS2_PATH --> ETS2_A[Smooth implementation\nCarbon price stabilizes €65-75\nWEP 55%]
  ETS2_PATH --> ETS2_B[Social protests → ETS2 delay\nWEP 25%]
  ETS2_A --> ETS2_A1[Green jobs, revenue for SCF]
  ETS2_B --> ETS2_B1[Political crisis in EPP centrist flank]

  CLAIMS_PATH --> CLAIMS_A[All 27 MS ratify by 2027\nWEP 30%]
  CLAIMS_PATH --> CLAIMS_B[Hungary/SK block → 2028+ ratification\nWEP 45%]
  CLAIMS_PATH --> CLAIMS_C[Ceasefire → momentum stalls\nWEP 25%]
  CLAIMS_A --> CLAIMS_A1[Commission operational, first claims processed]
  CLAIMS_B --> CLAIMS_B1[Assets remain frozen but legally uncertain]

  IMMUNITY_PATH --> IMM_A[National courts act quickly\nWEP 50%]
  IMMUNITY_PATH --> IMM_B[Prosecution delayed by appeals\nWEP 50%]
  IMM_A --> IMM_A1[Rule of law signal\nECR credibility damaged]
  IMM_B --> IMM_B1[Perceived impunity continues\nEP accountability questioned]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
flowchart LR
  VOTE[April 28-30 Plenary Votes] --> IMPL[Implementation Phase]
  IMPL --> D1{DMA enforcement\n90-day window}
  IMPL --> D2{ETS2 implementation\nregs 2026-H2}
  IMPL --> D3{Claims Convention\nratification}
  D1 --> |DISRUPTION: US tariffs| PAUSE1[Enforcement pause\n6-18 months]
  D3 --> |DISRUPTION: Hungary veto| BLOCK1[Ratification blocked]
  PAUSE1 --> CREDIBILITY[EU regulatory credibility undermined]
  BLOCK1 --> SOLIDARITY[Ukraine solidarity tested]
```
