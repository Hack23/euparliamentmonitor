...
| **Node.js version** | 25 |
| **EP MCP Server** | `european-parliament-mcp-server@1.3.2` (globally installed via `scripts/mcp-setup.sh`, MCP gateway `EP_MCP_GATEWAY_URL=http://host.docker.internal:80/mcp/european-parliament`) |
