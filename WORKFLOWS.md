...
graph TD
    ...
    H --> I[🔗 Install EP MCP Server v1.3.20+]
...
```mermaid
flowchart TD
    subgraph Collection["📡 COLLECTION<br/>(EP MCP Server v1.3.20+)"]
        direction TB
...
flowchart LR
    ...
    subgraph "🔌 MCP Layer"
        MCP["EP MCP Server<br/>v1.3.20+<br/>(180s timeout;<br/>60+ tools, sliding + fixed-window feeds)"]
    end
