...
| **Node.js version** | 26 |
| **EP MCP Server** | `european-parliament-mcp-server@1.3.14` (globally installed via `scripts/mcp-setup.sh`, MCP gateway `EP_MCP_GATEWAY_URL` resolved dynamically from MCP config; default `http://host.docker.internal:8080/mcp/european-parliament`) |
