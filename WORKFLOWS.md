...
graph TD
    ...
    H --> I[🔗 Install EP MCP Server v1.1.2]
...
| **Node.js version** | 24 |
| **EP MCP Server** | `european-parliament-mcp-server@1.1.2` (globally installed) |
...
|-----------|------------------------|
| **Node.js** | 24 |
| **EP MCP Server** | `european-parliament-mcp-server@1.1.2` (global) |
