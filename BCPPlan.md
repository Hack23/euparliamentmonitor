...
| **EP MCP Server (`european-parliament-mcp-server@1.3.15`)** | EU Parliament Data | High | Uniform unavailable envelope + `mcp-retry.ts` backoff; existing articles continue to serve | N/A (graceful degrade) |
