 ...
 * English version.  The AI agent (Opus 4.7) must analyse the article
 ...
 */
export function setAIMetadata(title: string, description: string): void {
  _aiTitle = title;
...
function generateSingleLanguageArticle(
  ...
  //
  // Architecture: The AI agent (Opus 4.7) analyses the content and
