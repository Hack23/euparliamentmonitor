...
export const METHOD_DOCUMENT_ANALYSIS = 'document-analysis' as const;
 ...
 */
export function buildDeepAnalysisMarkdown(
  ...
  const topAdoptedTexts = adoptedTexts
    .slice(0, 20)
    .map((t) => {
      const adoptedText = t as Record<string, unknown>;
 ...
 * @returns Markdown content string
 */
export function buildStakeholderAnalysisMarkdown(
  fetchedData: Record<string, unknown>,
  date: string
): string {
 ...
 * @returns Markdown content string
 */
export function buildCoalitionAnalysisMarkdown(
  fetchedData: Record<string, unknown>,
  date: string
): string {
 ...
 * @returns Markdown content string
 */
export function buildVotingPatternsMarkdown(
  fetchedData: Record<string, unknown>,
  date: string
): string {
 ...
 * @returns Markdown content string
 */
export function buildCrossSessionIntelligenceMarkdown(
  fetchedData: Record<string, unknown>,
  date: string
): string {
 ...
 * @returns Markdown content string
 */
export function buildSynthesisSummaryMarkdown(
  fetchedData: Record<string, unknown>,
  date: string
): string {
 ...
 */
export function buildDocumentAnalysisMarkdown(
  fetchedData: Record<string, unknown>,
  date: string
): string {
