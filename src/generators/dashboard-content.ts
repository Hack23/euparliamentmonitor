 ...
 */
function coalitionShiftClass(shift: CoalitionMetrics['shiftIndicator']): string {
  switch (shift) {
    case 'strengthening':
 ...
 */
export function buildCoalitionPanel(
  coalition: CoalitionMetrics | null | undefined,
  panelIndex: number,
  lang = 'en'
): string {
 ...
 * @returns CSS class string
 */
function pipelineStatusClass(healthScore: number): string {
 ...
 */
export function buildTrendPanel(
  ...
  const sparklineChart: ChartConfig = {
    type: 'line',
 ...
 * @returns CSS class string
 */
function impactDirectionClass(direction: StakeholderMetric['impactDirection']): string {
  switch (direction) {
    case 'positive':
 ...
 */
export function buildStakeholderScorecardPanel(
