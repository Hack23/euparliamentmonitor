 ...
 * Used to emit Google-compliant hreflang blocks inside each `<url>` element
 * so that multilingual variants of the same logical page are cross-linked.
 */
...
const SITEMAP_COPY: Record<string, SitemapCopy> = {
  en: {
    intro:
 ...
 */
function getSitemapCopy(lang: string): SitemapCopy {
