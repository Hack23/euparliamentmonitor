 ...
 * @description Shared private helpers used across multiple bounded-context builder
 * modules. Exports only those utilities needed by sibling domain files; the
 * public API is re-exported through the {@link module:Generators/Builders} barrel.
 */
