...
/**
 * @module Generators/PoliticalIntelligence/Descriptions/References
 * @description Curated descriptions for `analysis/reference/*.md` files and
 * the IMF / World Bank data-pipeline catalog. Split out of the monolithic
 * `political-intelligence-descriptions.ts` (Refactor 8/8).
 */

import type { CuratedDescription } from './types.js';

export const REFERENCE_DESCRIPTIONS: Readonly<Record<string, CuratedDescription>> = {
