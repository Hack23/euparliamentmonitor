...
/**
 * @module Generators/PoliticalIntelligence/Descriptions/Templates
 * @description Curated descriptions for `analysis/templates/*.md` files.
...
export const TEMPLATE_DESCRIPTIONS: Readonly<Record<string, CuratedDescription>> = {
