...
/**
 * @module Generators/PoliticalIntelligence/Descriptions/TitlesTemplatesB
 * @description Curated per-language titles for `analysis/templates/*.md`
 * (second half — `media-framing-analysis.md` through `workflow-audit.md`).
...
export const TEMPLATE_TITLES_B: Readonly<Record<string, TextI18n>> = {
