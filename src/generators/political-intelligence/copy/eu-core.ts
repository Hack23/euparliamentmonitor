...
/**
 * @module Generators/PoliticalIntelligence/Copy/EuCore
 * @description Core EU-language overrides for the Political Intelligence
 * landing-page copy (de, fr, es, nl). Split out of `copy.ts` (Refactor 8/8)
 * so each translator can edit their own language without merge-conflicts
 * on the big shared map.
 */

import type { PICopy } from './types.js';

export const DE_COPY: Partial<PICopy> = {
...
export const FR_COPY: Partial<PICopy> = {
...
export const ES_COPY: Partial<PICopy> = {
...
export const NL_COPY: Partial<PICopy> = {
