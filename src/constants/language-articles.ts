...
export const PROPOSITIONS_STRINGS: LanguageMap<PropositionsStrings> = {
  en: {
    ...
    lede: 'Nghị viện Châu Âu đang tích cực xử lý nhiều đề xuất lập pháp trong các lĩnh vực chính sách quan trọng.',
    proposalsHeading: 'Các quy trình lập pháp gần đây',
    adoptedTextsHeading: 'Các văn bản mới được thông qua',
    pipelineHeading: 'Tổng quan quy trình lập pháp',
    procedureHeading: 'Tình trạng quy trình',
    analysisHeading: 'Đánh giá tác động',
    analysis: 'Hoạt động lập pháp hiện tại phản ánh các ưu tiên của Nghị viện.',
    pipelineHealthLabel: 'Sức khỏe quy trình',
    throughputRateLabel: 'Tỷ lệ thông qua',
    whyThisMatters: 'Các đề xuất lập pháp này ảnh hưởng trực tiếp đến công dân EU.',
  },
  },
  sv: {
...
export const EDITORIAL_STRINGS: LanguageMap<EditorialStrings> = {
  ...
  zh: {
    ...
    keyTakeaway: 'Phát hiện chính',
    parliamentaryContext: 'Bối cảnh Nghị viện',
    sourceAttribution: 'Theo dữ liệu của Nghị viện Châu Âu',
    analysisNote: 'Ghi chú Phân tích',
  },
  },
};
...
export const DEEP_ANALYSIS_STRINGS: LanguageMap<DeepAnalysisStrings> = {
  en: {
    ...
    sectionHeading: 'Phân tích Chính trị Chuyên sâu',
    whatHeading: 'Chuyện gì đã xảy ra',
    whoHeading: 'Các chủ thể chính',
    whenHeading: 'Dòng thời gian',
    whyHeading: 'Tại sao quan trọng — Nguyên nhân gốc rễ',
    stakeholderHeading: 'Bên thắng & Bên thua',
    winnerLabel: 'Bên thắng',
    loserLabel: 'Bên thua',
    neutralLabel: 'Trung lập',
    impactHeading: 'Đánh giá tác động',
    politicalLabel: 'Chính trị',
    economicLabel: 'Kinh tế',
    socialLabel: 'Xã hội',
    legalLabel: 'Pháp lý',
    geopoliticalLabel: 'Địa chính trị',
    consequencesHeading: 'Hành động → Hệ quả',
    actionLabel: 'Hành động',
    consequenceLabel: 'Hệ quả',
    severityColumnLabel: 'Mức độ nghiêm trọng',
    mistakesHeading: 'Sai lầm & Cơ hội bị bỏ lỡ',
    alternativeLabel: 'Lẽ ra nên',
    outlookHeading: 'Triển vọng chiến lược',
    severityLow: 'Thấp',
    severityMedium: 'Trung bình',
    severityHigh: 'Cao',
    severityCritical: 'Chí mạng',
  },
  },
  sv: {
