...
export const PROPOSITIONS_ANALYSIS_CONTENT_STRINGS: LanguageMap<PropositionsAnalysisContentStrings> =
  {
    en: {
      ...
      impactPoliticalStrong:
        'Strong throughput enables coalition-building on priority files.',
      impactPoliticalWeak:
        'Bottleneck pressure may force compromise negotiations.',
      impactEconomic:
        '{throughput} procedures in the pipeline carry potential economic regulatory implications.',
      impactEconomicStrong:
        'Efficient processing supports predictable business planning horizons.',
      impactEconomicWeak:
        'Delayed procedures create regulatory uncertainty for affected sectors.',
      impactSocial:
    ...
    sv: {
      ...
      impactPoliticalWeak:
        'Flaskhalstryck kan tvinga fram kompromissförhandlingar.',
      impactEconomic:
        '{throughput} förfaranden i pipelinen medför potentiella ekonomiska regleringskonsekvenser.',
      impactEconomicStrong:
        'Effektiv bearbetning stödjer förutsägbara affärsplaneringshorisoner.',
      impactEconomicWeak:
    ...
    da: {
      ...
      outlookConcern:
        'Pipelinesundhed på {pct}% kræver opmærksomhed fra lovgivningskoordinatorer.',
