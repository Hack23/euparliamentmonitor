...
/** Localized site header subtitle displayed on every article page */
export const HEADER_SUBTITLE_LABELS: LanguageMap = {
  en: 'European Parliament Intelligence',
  sv: 'EU-parlamentets nyhetsanalys',
  da: 'EU-parlamentets nyhedsanalyse',
  no: 'EU-parlamentets nyhetsanalyse',
  fi: 'EU-parlamentin uutisanalyysi',
  de: 'EU-Parlaments-Nachrichtenanalyse',
  fr: "Analyse d'intelligence du Parlement européen",
  es: 'Análisis de inteligencia del Parlamento Europeo',
  nl: 'EU-parlements nieuwsanalyse',
  ar: 'استخبارات البرلمان الأوروبي',
  he: 'מודיעין הפרלמנט האירופי',
  ja: '欧州議会インテリジェンス',
  ko: '유럽의회 인텔리전스',
  zh: '欧洲议会情报分析',
};

/* ─── Article footer section headings ───────────────────────────── */

/** Shared Scandinavian (sv/da/no) translation for "About EU Parliament Monitor" */
const OM_EU_PARLIAMENT_MONITOR = 'Om EU Parliament Monitor';

/** Localized footer "About" section heading per language */
export const FOOTER_ABOUT_HEADING_LABELS: LanguageMap = {
  en: 'About EU Parliament Monitor',
  sv: OM_EU_PARLIAMENT_MONITOR,
  da: OM_EU_PARLIAMENT_MONITOR,
  no: OM_EU_PARLIAMENT_MONITOR,
  fi: 'Tietoja EU Parliament Monitorista',
  de: 'Über EU Parliament Monitor',
  fr: "À propos d'EU Parliament Monitor",
  es: 'Acerca de EU Parliament Monitor',
...
/** Localized footer "About" section body text per language */
export const FOOTER_ABOUT_TEXT_LABELS: LanguageMap = {
  ...
  sv: 'EU-parlamentets intelligensplattform — bevakar politisk aktivitet med systematisk transparens. Drivs av Europaparlamentets öppna data.',
  da: 'EU-parlamentets efterretningsplatform — overvåger politisk aktivitet med systematisk gennemsigtighed. Drevet af Det Europæiske Parlaments åbne data.',
  no: 'EU-parlamentets etterretningsplattform — overvåker politisk aktivitet med systematisk åpenhet. Drevet av Europaparlamentets åpne data.',
  fi: 'EU-parlamentin tiedusteluplatformi — seuraa poliittista toimintaa systemaattisella avoimuudella. Euroopan parlamentin avoimilla tiedoilla.',
  de: 'EU-Parlaments-Intelligence-Plattform — überwacht politische Aktivitäten mit systematischer Transparenz. Betrieben mit offenen Daten des Europäischen Parlaments.',
  fr: "Plateforme d'intelligence du Parlement européen — surveillance de l'activité politique avec une transparence systématique. Propulsé par les données ouvertes du Parlement européen.",
  es: 'Plataforma de inteligencia del Parlamento Europeo — monitoreo de la actividad política con transparencia sistemática. Impulsado por datos abiertos del Parlamento Europeo.',
  nl: 'EU-parlements intelligentieplatform — politieke activiteit monitoren met systematische transparantie. Aangedreven door open data van het Europees Parlement.',
  ar: 'منصة استخبارات البرلمان الأوروبي — رصد النشاط السياسي بشفافية منهجية. مدعومة ببيانات البرلمان الأوروبي المفتوحة.',
  he: 'פלטפורמת מודיעין הפרלמנט האירופי — ניטור פעילות פוליטית עם שקיפות שיטתית. מונעת על ידי נתונים פתוחים של הפרלמנט האירופי.',
  ja: '欧州議会インテリジェンスプラットフォーム — 系統的な透明性で政治活動を監視。欧州議会のオープンデータで動作。',
  ko: '유럽의회 인텔리전스 플랫폼 — 체계적인 투명성으로 정치 활동 모니터링. 유럽의회 공개 데이터로 운영.',
  zh: '欧洲议会情报平台 — 以系统化透明度监测政治活动。由欧洲议会开放数据驱动。',
};

/** Localized footer "Quick Links" section heading per language */
...
/** Localized footer "Built by Hack23 AB" section heading per language */
export const FOOTER_BUILT_BY_LABELS: LanguageMap = {
  ...
  fi: 'Hack23 AB:n rakentama',
  de: 'Erstellt von Hack23 AB',
  fr: 'Construit par Hack23 AB',
  es: 'Desarrollado por Hack23 AB',
  nl: 'Gebouwd door Hack23 AB',
  ar: 'من إنشاء Hack23 AB',
...
/** Localized footer "Languages" section heading per language */
