...
/**
 * @module Constants/Seo/ContextLabels
 * @description Localized labels used to enrich short or duplicate-prone meta
 * descriptions and to strip reader-context boilerplate from candidate
 * descriptions. Lives in `constants/seo/` (a neutral zone) so both
 * `aggregator/metadata/` and `generators/news-indexes/` can import it
 * without triggering the cross-context drift-guard.
 */
