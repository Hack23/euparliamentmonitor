...
/**
 * @module Constants/Articles/BreakingStringsWest
 * @description West breaking-news strings.
 */
...
export const BREAKING_STRINGS_WEST: Pick<LanguageMap<BreakingStrings>, 'es' | 'nl' | 'ar'> = {
  es: {
