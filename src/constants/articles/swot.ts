...
/**
 * @module Constants/Articles/SWOT
 * @description SWOT article strings and SWOT builder strings (14 languages).
 *
...
import type { LanguageMap, SwotStrings, SwotBuilderStrings } from '../../types/index.js';
