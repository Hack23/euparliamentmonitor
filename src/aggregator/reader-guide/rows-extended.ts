...
/**
 * @module Aggregator/ReaderGuide/RowsExtended
 * @description Per-section translated reader-need / what-you'll-get rows
 * for the **extended / appendix sections** of the Reader Intelligence
 * Guide — PESTLE, Continuity, Deep Analysis, Documents, Extended
 * Intelligence, MCP Reliability, Quality Reflection, and the
 * Supplementary Intelligence appendix. Pure data. Paired with
 * `./rows-core.ts`.
 */

import type { GuideRowData } from './rows-types.js';

export const READER_GUIDE_ROWS_EXTENDED: Readonly<Record<string, GuideRowData>> = {
