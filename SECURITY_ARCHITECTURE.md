...
- Node.js version pinned (25.x, upgrading to 26.x)
...
| **2** | 2.2 | Ensure authorized software is supported | Dependabot updates, Node.js 25 Current (upgrading to Node.js 26 LTS) | IG1 | ✅ |
