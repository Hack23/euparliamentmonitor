...
// Uniform unavailable envelope — EP v1.3.6+
...
export interface AnalysisManifest {
  ...
  epMcpVersion: "1.3.6";                // Pinned EP MCP Server version
