...
// Uniform unavailable envelope — EP v1.3.9+
...
export interface AnalysisManifest {
  ...
  epMcpVersion: "1.3.9";                // Pinned EP MCP Server version
