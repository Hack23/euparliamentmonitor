...
// Uniform unavailable envelope — EP v1.3.4+
...
export interface AnalysisManifest {
  ...
  epMcpVersion: "1.3.4";                // Pinned EP MCP Server version
