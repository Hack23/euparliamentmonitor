...
// Uniform unavailable envelope — EP v1.3.1+
...
export interface AnalysisManifest {
  ...
  epMcpVersion: "1.3.1";                // Pinned EP MCP Server version
