...
mcp-servers:
  european-parliament:
    ...
    entrypoint: "npx"
    entrypointArgs: ["-y", "european-parliament-mcp-server@1.3.1", "--timeout", "180000"]
    env:
...
|---|---|---|
| `european-parliament` | `european-parliament-mcp-server@1.3.1` | 63 EP tools (see `.github/prompts/07-mcp-reference.md`) |
