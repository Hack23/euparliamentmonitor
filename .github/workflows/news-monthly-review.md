...
When the monthly review covers legislation with economic, trade, employment, defence, or environmental impact, use the `world-bank` MCP server to contextualize legislative achievements. 
