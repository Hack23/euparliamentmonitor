---
name: "News: EU Parliament Weekly Review — Analysis"
...
concurrency:
  group: "news-analysis-week-in-review"
...
safe-outputs:
  ...
  create-pull-request:
    ...
    labels: [agentic-analysis, analysis-data, "type:week-in-review"]
    draft: false
    expires: 14d
...
(article drafting) happens in the paired `news-weekly-review-article.md` workflow
...
| Family | Split: **analysis-only** (paired with `news-weekly-review-article.md`) |
...
Stage D happens in the paired `news-weekly-review-article.md` workflow.
...
- `base: "main"`
- `head: "analysis/${TODAY}-week-in-review-${RUN_ID}"`
- `title: "[analysis] week-in-review — ${TODAY} (run ${RUN_ID})"`
