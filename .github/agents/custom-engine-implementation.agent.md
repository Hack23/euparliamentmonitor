...
| Claude | Anthropic | `engine: { id: copilot, model: claude-sonnet-4 }` | Complex analysis, long context, deep reasoning |
...
This project's gh-aw workflows primarily use **Copilot with Claude model** (`engine: { id: copilot, model: claude-sonnet-4 }`) for news generation tasks.
