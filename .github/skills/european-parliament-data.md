...
| **Future / Preview** | `get_events({ limit: 50 })`, `get_plenary_sessions({ dateFrom, dateTo })` | Events have no date filtering (v1.2.10); plenary sessions support dateFrom/dateTo |
