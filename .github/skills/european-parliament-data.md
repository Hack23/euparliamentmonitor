...
- [`analysis/methodologies/imf-indicator-mapping.md`](../../analysis/methodologies/imf-indicator-mapping.md) (primary economic) + [`worldbank-indicator-mapping.md`](../../analysis/methodologies/worldbank-indicator-mapping.md) (non-economic) — indicator maps. **(April 2026): Economic = IMF (mandatory primary); WB = non-economic domains only** (health, education, social, environment, demographics, defence, agriculture, innovation, governance)
