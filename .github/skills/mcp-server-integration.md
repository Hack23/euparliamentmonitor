...
**Version**: `european-parliament-mcp-server@1.3.17` | **Tools**: 63 | **Source**: `src/mcp/ep-mcp-client.ts`
...
mcp-servers:
  european-parliament:
    ...
    entrypoint: "npx"
    entrypointArgs: ["-y", "european-parliament-mcp-server@1.3.17", "--timeout", "90000"]
    env:
...
```json
{
  "mcpServers": {
    "european-parliament": {
      "type": "local",
      "command": "npx",
      "args": ["-y", "european-parliament-mcp-server@1.3.17", "--timeout", "90000"],
