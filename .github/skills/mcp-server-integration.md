...
**Version**: `european-parliament-mcp-server@1.2.18` | **Tools**: 62 | **Source**: `src/mcp/ep-mcp-client.ts`
...
mcp-servers:
  european-parliament:
    ...
    entrypoint: "npx"
    entrypointArgs: ["-y", "european-parliament-mcp-server@1.2.18", "--timeout", "90000"]
    env:
...
```json
{
  "mcpServers": {
    "european-parliament": {
      "type": "local",
      "command": "npx",
      "args": ["-y", "european-parliament-mcp-server@1.2.18", "--timeout", "90000"],
