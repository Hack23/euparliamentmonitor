...
|---|---|---|
| `get_committee_documents_feed` returns 404/error envelope | Upstream feed instability in `european-parliament-mcp-server@1.3.17` | Fallback to `get_committee_documents({ limit: 20 })` and mark source as degraded |
