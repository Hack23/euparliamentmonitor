...
| `get_procedures_feed` returns historical-tail data | Upstream stale ordering (max year < 2020) | Reject as stale, set `recessMode: true`, fallback to `get_procedures`/`track_legislation` |
