...
**Server:** `european-parliament-mcp-server@1.3.12`
...
### DOCEO Near-Realtime Vote Data (v1.3.12+)
...
> **✅ v1.3.7 – v1.3.12 OSINT upgrades (active on the pinned `v1.3.12` server):**
...
> pinned to `v1.3.12`); explicit dates remain the required Stage-A pattern
