...
| `INTERNAL_ERROR` | MCP server internal failure — verify `european-parliament-mcp-server@1.4.30` installed; check DNS for `data.europarl.europa.eu`. |
