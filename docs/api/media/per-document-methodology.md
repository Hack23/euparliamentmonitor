...
>
> This is an upstream contract that is **active on the pinned `v1.3.6` server**. Stage-B
...
> on the pinned v1.3.6 server), the MCP server applies a **server-side post-filter** on
