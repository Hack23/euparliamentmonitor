...
artifactId: synthesis-summary
methodology: ../methodologies/per-artifact-methodologies.md#synthesis-summary
catalogRow: ../methodologies/artifact-catalog.md
depthFloorBreaking: 205
mermaidType: mindmap + flowchart
...
**📋 Document Owner:** CEO | **📄 Version:** 1.5 | **📅 Last Updated:** 2026-04-25 (UTC)
...
- **Version:** 1.5
- **What's New in 1.5:** Top-Findings table gains WEP Band + Admiralty Grade columns (per [`osint-tradecraft-standards.md`](../methodologies/osint-tradecraft-standards.md) §2 + §3.1). Every synthesis headline judgement must now express probability as a WEP band and cite the primary source with an Admiralty grade.
