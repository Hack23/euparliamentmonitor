...
**Server:** `european-parliament-mcp-server@1.3.18`
...
### DOCEO Near-Realtime Vote Data (v1.3.18+)
...
> **✅ v1.3.7 – v1.3.12 OSINT upgrades (active on the pinned `v1.3.18` server):**
...
> pinned to `v1.3.18`); explicit dates remain the required Stage-A pattern
