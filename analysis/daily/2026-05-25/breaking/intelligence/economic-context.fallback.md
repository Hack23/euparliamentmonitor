# Economic Context Fallback — EP Breaking News 2026-05-25
**Mode**: Fallback analysis using IMF WEO April 2026 (primary) + World Bank (secondary)
**Trigger**: EP economic data feeds degraded; full EP-linked economic database unavailable
