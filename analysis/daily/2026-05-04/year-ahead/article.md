...
```mermaid
%%{init: {"theme": "dark"}}%%
pie title EP Year-Ahead Dossier Significance Distribution
    "Tier 1 — Transformative" : 2
    "Tier 2 — Major" : 4
    "Tier 3 — Significant" : 7
    "Tier 4 — Administrative" : 6
```
...
%%{init: {"theme": "dark", "themeVariables": {"primaryColor": "#1565C0"}}}%%
graph TB
    subgraph EP["European Parliament EP10"]
        EPP["EPP 185 seats\nRoberta Metsola (President)"]
        SD["S&D 135 seats"]
        PfE["PfE 85 seats"]
        ECR["ECR 81 seats"]
        Renew["Renew 77 seats"]
        GEFA["Greens/EFA 53 seats"]
    ...
    subgraph COM["European Commission"]
        VDL["Von der Leyen\nPresident"]
        VP["Executive VPs\n(Sejourne, Ribera, Šefčovič)"]
    end
    subgraph COUNCIL["Council of EU"]
        PL["Polish Presidency\nJan-Jun 2026"]
        DK["Danish Presidency\nJul-Dec 2026"]
        CY["Cypriot Presidency\nJan-Jun 2027"]
    end
    subgraph COURT["CJEU"]
        CJEU_TEXT["EU-Mercosur\nopinion pending"]
    end
...
%%{init: {"theme": "dark"}}}%%
quadrantChart
    title EP Legislative Year Risk Matrix 2026-2027
    ...
    CJEU-Mercosur: [0.30, 0.85]
    Green-Deal-Rollback: [0.25, 0.80]
    Budget-Conciliation-Fail: [0.15, 0.70]
    AI-Act-Controversy: [0.40, 0.50]
    Ukraine-Escalation: [0.20, 0.90]
    EPP-PfE-Alliance: [0.25, 0.75]
    US-Tariff-Escalation: [0.35, 0.70]
    Parliamentary-Paralysis: [0.10, 0.85]
```
...
%%{init: {"theme": "dark"}}%%
sankey-beta
EPP, Grand Coalition, 50
S&D, Grand Coalition, 40
Renew, Grand Coalition, 30
Grand Coalition, Legislative Outcomes, 120
EPP, EPP-ECR Alliance, 30
ECR, EPP-ECR Alliance, 30
EPP-ECR Alliance, Conditional Legislation, 60
EPP, Informal PfE Cooperation, 10
PfE, Informal PfE Cooperation, 20
Informal PfE Cooperation, Rollback Legislation, 30
```
...
%%{init: {"theme": "dark"}}%%
quadrantChart
    title Legislative Velocity Risk Matrix
    x-axis Low Controversy --> High Controversy
    y-axis Low Urgency --> High Urgency
    quadrant-1 Fast Track
    quadrant-2 High Priority Stuck
    quadrant-3 Routine
    quadrant-4 Delayed Priority
    Ukraine Support: [0.15, 0.90]
    Digital Governance: [0.30, 0.65]
    Strategic Autonomy: [0.40, 0.70]
    Green Deal Rollback: [0.85, 0.55]
    Migration Pact: [0.90, 0.75]
    Budget 2027: [0.50, 0.85]
    EU-Mercosur Ratification: [0.80, 0.40]
    Defence Union Framework: [0.45, 0.80]
```
...
%%{init: {"theme": "dark"}}%%
flowchart TD
    ROOT["Green Deal rollback legislation adopted\n(2035 CE date revised, NRL suspended)"]
    ROOT --> A["EU climate credibility internationally undermined"]
    ROOT --> B["Investor confidence in EU green transition shifts"]
    ROOT --> C["S&D/Greens progressive base voter demobilization"]
    ROOT --> D["National renewable energy investment uncertainty"]
    A --> A1["Paris Agreement partners challenge EU\nleadership role at COP"]
    A --> A2["US/China point to EU backsliding\nin WTO/trade negotiations"]
    B --> B1["Green bond market: EU premium narrows\nas credibility questioned"]
    B --> B2["Automakers cancel EV investment commitments\nbased on 2035 reversal"]
    C --> C1["2029 EP election Greens/Left surge\nas opposition beneficiary"]
    C --> C2["Young voter turnout drop → EP10 legitimacy\nquestions in academic literature"]
    D --> D1["Offshore wind: financing delays\nas regulatory certainty reduces"]
```
...
%%{init: {"theme": "dark"}}%%
flowchart TD
    ROOT["US-EU Comprehensive Trade Deal agreed\n(tariffs eliminated; digital market access concession)"]
    ROOT --> A["DMA enforcement scope questioned\nby US companies"]
    ROOT --> B["EU GDP boost estimated +0.3–0.5%\n(trade modelling)"]
    ROOT --> C["S&D/Greens demand labour standards chapter\nbefore EP consent vote"]
    ROOT --> D["US tech giants re-enter EU market\nwith reduced regulatory exposure"]
    A --> A1["Apple/Google/Meta challenge DMA rulings\nciting trade agreement"]
    A --> A2["Commission forced to narrow enforcement\nor risk trade dispute"]
    B --> B1["German auto, French agriculture,\nDutch logistics sectors benefit"]
    C --> C1["EP consent vote uncertain:\nS&D+Greens+GUE = 235 seats could block\nif EPP fragments"]
```
...
%%{init: {"theme": "dark"}}%%
flowchart TD
    ROOT["Russia-Ukraine ceasefire announced\n(US-brokered, terms TBD)"]
    ROOT --> A["EU reconstruction facility vote required\n(€200B+ debate)"]
    ROOT --> B["Ukraine EU accession timeline\nbecomes primary EP focus"]
    ROOT --> C["Security guarantee debates:\nwhat EU role in monitoring?"]
    ROOT --> D["PfE/ESN demand reduced Ukraine\nbudgetary commitments"]
    A --> A1["EPP+S&D+Renew maintain reconstruction\nmajority — funding approved"]
    A --> A2["PfE 'peace without payment' narrative\ngains traction in some member states"]
    B --> B1["Accession negotiations require\nTreaty amendment procedures"]
    B --> B2["Enlargement EP majority exists\nbut Council unanimous harder"]
```
...
%%{init: {"theme": "dark"}}%%
flowchart TD
    GOAL["🎯 GOAL: Substantively weaken\nEU Green Deal commitments\n(probability 25%)"]
    GOAL --> A["Path A: Legislative majority\nfor rollback acts"]
    GOAL --> B["Path B: Block implementation\nfunds/delegated acts"]
    GOAL --> C["Path C: Member state\nnon-implementation coalition"]
    A --> A1["EPP abandons Grand Coalition\non climate dossiers"]
    A --> A2["ECR+PfE provide\nworking majority"]
    A1 --> A1a["EPP national party pressure\nmounts (auto, steel, energy)"]
    B --> B1["Committee majority\nrejects implementing acts"]
    B --> B2["EP adopts resolution\ncalling for moratorium"]
    C --> C1["Council blocks Commission\nimplementation proposals"]
```
...
```mermaid
%%{init: {"theme": "dark"}}%%
pie title EP Legislative Year Scenario Probabilities 2026-2027
    "Scenario 1 — Managed Centre-Right Consolidation" : 50
    "Scenario 2 — Right-Wing Majority Materialises" : 25
    "Scenario 3 — Progressive Recovery" : 15
    "Scenario 4 — External Shock Disruption" : 10
```
...
%%{init: {"theme": "dark"}}%%
gantt
    title EP Legislative Year Forward Projection 2026-2027
    dateFormat YYYY-MM-DD
    section Plenary Calendar
    May Strasbourg         :2026-05-18, 4d
    June Strasbourg        :2026-06-15, 4d
    July Strasbourg        :2026-07-06, 4d
    September Strasbourg   :2026-09-14, 4d
    October Session 1      :2026-10-05, 4d
    October Session 2      :2026-10-19, 4d
    November Brussels mini :2026-11-11, 2d
    November Strasbourg    :2026-11-23, 4d
    section Key Milestones
    GPAI compliance deadline :milestone, 2026-11-01, 0d
    Budget 2027 adoption    :milestone, 2026-12-15, 0d
    MFF mid-term review     :2027-01-01, 30d
    Cypriot Presidency      :2027-01-01, 180d
```
...
%%{init: {"theme": "dark"}}%%
flowchart TD
    A["CJEU EU-Mercosur Opinion\n(Q2-Q3 2026 expected)"] --> B["EP INTA Ratification Debate\n(if compatible: Q4 2026)"]
    C["Commission AI Act GPAI\nDelegated Acts (Q2 2026)"] --> D["EP IMCO Scrutiny\n(Q3 2026)"]
    E["Commission Housing\nLegislative Proposal\n(Q3 2026)"] --> F["Committee REGI+IMCO\nFirst Reading (Q4 2026)"]
    G["Budget 2027\nGuidelines (Apr 2026 ✅)"] --> H["Commission Preliminary\nDraft Budget (May 2026)"] --> I["EP First Reading\n(Oct 2026)"] --> J["Budget Adopted\n(Dec 2026)"]
    K["European Defence Fund\nCommission Proposal (2026)"] --> L["AFET+BUDG Committee\n(Q4 2026)"] --> M["EP Plenary Vote\n(Q1 2027)"]
```
...
%%{init: {"theme": "dark"}}%%
graph LR
    A["Calendar Risks\nMay 2026–May 2027"] --> B["External Shock\n(Ukraine/Trade)"]
    A --> C["Budget Conciliation\nFailure/Delay"]
    A --> D["CJEU Timing\nUncertainty"]
    A --> E["AI Act\nCompliance Crisis"]
    A --> F["Coalition\nBreakdown\non Major Vote"]
    B --> G["Emergency\nSpecial Session"]
...
%%{init: {"theme": "dark"}}%%
gantt
    title EU Council Presidency Windows & EP Legislative Opportunities
    dateFormat YYYY-MM
    section Poland Presidency
    Ukraine/Security Legislation :active, 2026-01, 2026-06
    Migration Framework :2026-02, 2026-06
    section Danish Presidency
    Digital Governance Acceleration :2026-07, 2026-12
    Social/Labour Legislation :2026-07, 2026-12
    Green Competitiveness Package :2026-07, 2026-12
    MFF Preliminary Work :2026-10, 2026-12
    section Cyprus Presidency (partial)
    Regional Security Focus :2027-01, 2027-05
```
