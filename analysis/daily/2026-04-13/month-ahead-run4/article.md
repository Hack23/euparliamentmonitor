...
keywords: ["EU Parliament", "European Parliament", "political intelligence", "Month Ahead Run4", "2026-04-13", "run 07c000a5-e613-4ca8-98c7-cae22b3eb835", "EP10", "Month", "Ahead", "April", "Three", "convergent", "crises", "define", "window", "from"]
date: 2026-04-13
...
```mermaid
quadrantChart
    title Risk Heatmap — Month-Ahead 2026-04-13
    ...
    "Tariff spiral": [0.85, 0.90]
    "SRMR3 Council block": [0.50, 0.85]
    "Pipeline jam": [0.70, 0.65]
    "Anti-Corruption transposition delay": [0.60, 0.55]
    "Renew-ECR realignment": [0.45, 0.80]
    "EPP fracture on trade": [0.30, 0.85]
```
...
pie title Stakeholder Impact Distribution
...
quadrantChart
    title Risk Assessment: Month-Ahead April-May 2026
    x-axis "Low Impact" --> "High Impact"
    y-axis "Low Likelihood" --> "High Likelihood"
    quadrant-1 "Critical Zone"
    quadrant-2 "Monitor Zone"
    quadrant-3 "Acceptable Zone"
    quadrant-4 "Mitigation Zone"
    "R1 Tariff Escalation": [0.95, 0.85]
    "R2 Banking Deadlock": [0.75, 0.55]
    "R3 Pipeline Bottleneck": [0.55, 0.75]
    "R4 Transposition Delay": [0.35, 0.75]
    "R5 Coalition Fracture": [0.55, 0.55]
    "R6 Digital Policy Split": [0.45, 0.45]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","primaryBorderColor":"#0A3F7F","lineColor":"#90CAF9","secondaryColor":"#2E7D32","secondaryTextColor":"#ffffff","secondaryBorderColor":"#0F3F00","tertiaryColor":"#FF9800","tertiaryTextColor":"#000000","tertiaryBorderColor":"#7F4F00","mainBkg":"#1565C0","secondBkg":"#2E7D32","tertiaryBkg":"#FF9800","noteBkgColor":"#FFC107","noteTextColor":"#000000","noteBorderColor":"#7F6000","errorBkgColor":"#D32F2F","errorTextColor":"#ffffff","fontFamily":"Inter, Helvetica, Arial, sans-serif","pie1":"#1565C0","pie2":"#2E7D32","pie3":"#FF9800","pie4":"#D32F2F","pie5":"#FFC107","pie6":"#7B1FA2","pie7":"#9E9E9E","pie8":"#0288D1","pie9":"#388E3C","pie10":"#F57C00","pie11":"#C62828","pie12":"#FBC02D","pieTitleTextSize":"18px","pieSectionTextSize":"14px","pieLegendTextSize":"13px","pieStrokeColor":"#1e1e1e","pieOuterStrokeColor":"#1e1e1e","git0":"#1565C0","git1":"#2E7D32","git2":"#FF9800","git3":"#D32F2F","gitBranchLabel0":"#ffffff","gitBranchLabel1":"#ffffff","gitBranchLabel2":"#000000","gitBranchLabel3":"#ffffff","cScale0":"#1565C0","cScale1":"#2E7D32","cScale2":"#FF9800","cScale3":"#D32F2F","cScale4":"#FFC107","cScale5":"#7B1FA2","cScale6":"#9E9E9E","cScale7":"#0288D1","xyChart":{"backgroundColor":"#1e1e1e","plotColorPalette":"#1565C0,#2E7D32,#FF9800,#D32F2F,#FFC107,#7B1FA2,#9E9E9E"}}}}%%
mindmap
  root((Month-Ahead Threats))
    External
      US Trade Escalation
        April 15 Deadline
        Retaliation Risk
        Supply Chain Disruption
      Geopolitical Overload
        Ukraine Situation
        Georgia Democracy
        Iran Sanctions
        Syria Ceasefire
    ...
    Coalition
      ECR Trade Defection
        ...
        EPP Alliance Strain
        Policy Coherence
      Digital Policy Fractures
        Copyright AI Division
        Tech Regulation Split
        Cross-Party Lines
    Transposition
      Anti-Corruption 27 MS
        Criminal Code Reform
        Implementation Gap
        Rule of Law Variance
...
quadrantChart
    title SWOT Strategic Position: April-May 2026
    ...
    quadrant-4 "Threats"
    "Record Pace": [0.3, 0.85]
    "Trade Unity": [0.7, 0.75]
    "Anti-Corruption": [0.4, 0.7]
    "Crisis Cohesion": [0.75, 0.8]
    "Pipeline Jam": [0.25, 0.3]
    "Narrow Margin": [0.35, 0.2]
    "Recess Gap": [0.2, 0.15]
    "Tariff Spiral": [0.85, 0.25]
    "Council Block": [0.65, 0.35]
    "Enlargement": [0.8, 0.65]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","primaryBorderColor":"#0A3F7F","lineColor":"#90CAF9","secondaryColor":"#2E7D32","secondaryTextColor":"#ffffff","secondaryBorderColor":"#0F3F00","tertiaryColor":"#FF9800","tertiaryTextColor":"#000000","tertiaryBorderColor":"#7F4F00","mainBkg":"#1565C0","secondBkg":"#2E7D32","tertiaryBkg":"#FF9800","noteBkgColor":"#FFC107","noteTextColor":"#000000","noteBorderColor":"#7F6000","errorBkgColor":"#D32F2F","errorTextColor":"#ffffff","fontFamily":"Inter, Helvetica, Arial, sans-serif","pie1":"#1565C0","pie2":"#2E7D32","pie3":"#FF9800","pie4":"#D32F2F","pie5":"#FFC107","pie6":"#7B1FA2","pie7":"#9E9E9E","pie8":"#0288D1","pie9":"#388E3C","pie10":"#F57C00","pie11":"#C62828","pie12":"#FBC02D","pieTitleTextSize":"18px","pieSectionTextSize":"14px","pieLegendTextSize":"13px","pieStrokeColor":"#1e1e1e","pieOuterStrokeColor":"#1e1e1e","git0":"#1565C0","git1":"#2E7D32","git2":"#FF9800","git3":"#D32F2F","gitBranchLabel0":"#ffffff","gitBranchLabel1":"#ffffff","gitBranchLabel2":"#000000","gitBranchLabel3":"#ffffff","cScale0":"#1565C0","cScale1":"#2E7D32","cScale2":"#FF9800","cScale3":"#D32F2F","cScale4":"#FFC107","cScale5":"#7B1FA2","cScale6":"#9E9E9E","cScale7":"#0288D1","xyChart":{"backgroundColor":"#1e1e1e","plotColorPalette":"#1565C0,#2E7D32,#FF9800,#D32F2F,#FFC107,#7B1FA2,#9E9E9E"}}}}%%
flowchart LR
    A["Adopted Texts: 51"] --> D
    B["Precomputed Stats: 85KB"] --> D
    C["Political Landscape: 8 groups"] --> D
    E["Prior Analysis: 7 runs"] --> D
    F["Adopted Texts Feed: 216 items"] --> D
    D{"Synthesis Engine"} --> G["Month-Ahead Article"]
...
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-13/month-ahead-run4/executive-brief.md) | `executive-brief.md` |
