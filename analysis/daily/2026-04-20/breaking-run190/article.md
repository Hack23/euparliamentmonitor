---
title: "Run 190 is the 11th consecutive ANALYSIS_ONLY run of the"
...
source_folder: analysis/daily/2026-04-20/breaking-run190
...
|---|------|-----------:|------:|
| 1 | API outage extends past 25 April Tier-2 empirical window | MED | MED |
| 2 | USTR action this week without EU pre-positioned response | MED | HIGH |
| 3 | Coalition signal reverses from STABLE during recess | LOW | MED–HIGH |
...
![API](https://img.shields.io/badge/EP_API-Degraded_Day_10-red?style=flat-square)
...
![Democratic](https://img.shields.io/badge/Democratic_Health-STABLE-green?style=flat-square)
...
![API](https://img.shields.io/badge/API-Day_10_Degraded-red?style=flat-square)
...
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-20/breaking-run190/executive-brief.md) | `executive-brief.md` |
...
| section-quality-reflection | [analysis-index](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-20/breaking-run190/intelligence/analysis-index.md) | `intelligence/analysis-index.md` |
