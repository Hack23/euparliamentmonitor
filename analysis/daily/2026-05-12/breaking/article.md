...
source_folder: analysis/daily/2026-05-12/breaking
...
```mermaid
graph LR
    Thread1[Digital Sovereignty] --> Convergence{April 2026 Plenary}
    Thread2[Ukraine Accountability] --> Convergence
    Thread3[Institutional Legitimacy Stress] --> Convergence
    Convergence --> DMA[DMA Enforcement Resolution]
    Convergence --> Tribunal[Ukraine Tribunal Call]
    Convergence --> PfEChallenge[PfE Institutional Debate]
    DMA --> Outcome1[Big Tech Regulatory Pressure]
    Tribunal --> Outcome2[International Justice Architecture]
    PfEChallenge --> Outcome3[EP Legitimacy Contestation]
```
...
```mermaid
graph TD
    S1[DMA Enforcement] -->|Score 8/10| T1[Tier 1: High Priority]
    S2[Ukraine Accountability] -->|Score 9/10| T1
    S3[Armenia Resolution] -->|Score 7/10| T2[Tier 2: Significant]
    S4[Cyberbullying] -->|Score 7/10| T2
    S5[PfE Debate] -->|Score 7/10| T2
    T1 -->|Lead coverage| Coverage[EU Parliament Monitor Article]
    T2 -->|Supporting context| Coverage
```
...
```mermaid
graph TD
    DF1[Digital Sovereignty Consensus] -->|drives| Action[EP Legislative Action]
    DF2[Ukraine Accountability Imperative] -->|drives| Action
    DF3[Democratic Values Coalition 494 seats] -->|drives| Action
    DF4[US Tech Regulatory Pressure] -->|drives| Action
    DF5[Plenary Majority Stability 396+] -->|drives| Action
    DF6[Antisemitism/Rights Crisis] -->|drives| Action
    Action -->|produces| Resolutions[4 Adopted Resolutions]
```
...
```mermaid
graph TD
    TA160[DMA Resolution] -->|High negative| BigTech[Big Tech Market Position]
    TA160 -->|High positive| SMEs[European Small Businesses]
    TA160 -->|Moderate negative| USEU[US-EU Trade Relations]
    TA161[Ukraine Tribunal] -->|Very high positive| Ukraine[Ukrainian War Victims]
    TA161 -->|High negative| Russia[Russian Government]
    TA161 -->|High positive| IntLaw[International Rule of Law]
    TA162[Armenia Resolution] -->|High positive| Armenia[Armenian Democratic Development]
    TA162 -->|High negative| Azerbaijan[Azerbaijani Influence]
    PfE[PfE Debate] -->|Negative| InstLeg[EP Institutional Legitimacy]
    PfE -->|Positive narrative| EuroscepticNarrative[Eurosceptic Political Narrative]
```
...
```mermaid
quadrantChart
    title Impact Heat Map (Severity vs Probability of Materialization)
    x-axis Low Probability --> High Probability
    y-axis Low Severity --> High Severity
    quadrant-1 Monitor Closely
    quadrant-2 Critical Priority
    quadrant-3 Low Priority
    quadrant-4 Watch and Prepare
    DMA Big Tech compliance: [0.85, 0.9]
    Ukraine tribunal progress: [0.45, 0.95]
    US trade retaliation: [0.40, 0.80]
    Armenia EU integration: [0.60, 0.65]
    EP legitimacy erosion: [0.55, 0.70]
    PfE narrative amplification: [0.80, 0.55]
```
...
```mermaid
graph TD
    EPP[EPP 183 seats] --> |votes with| SD[S&D 136 seats]
    EPP --> |occasional| Renew[Renew 77 seats]
    SD --> |progressive coalition| Greens[Greens/EFA 53 seats]
    SD --> |progressive coalition| Left[Left 45 seats]
    PfE[PfE 85 seats] --> |aligned| ECR[ECR 81 seats]
    ECR --> |aligned| ESN[ESN 27 seats]
    EPP --> |constructive majority| MajThreshold{360 majority}
    SD --> MajThreshold
    Renew --> MajThreshold
    PfE --> |opposition| MajThreshold
    ECR --> |opposition| MajThreshold
    NI[NI 30 seats] --> |variable| MajThreshold
```
...
```mermaid
graph LR
    EPP[EPP 183] --> |Grand Coalition| MAJ{360 threshold}
    SD[S&D 136] --> MAJ
    Renew[Renew 77] --> MAJ
    MAJ --> |+36 margin| PASS[PASS]
    PfE[PfE 85] --> AGAINST[AGAINST]
    ESN[ESN 27] --> AGAINST
    ECR[ECR 81] --> SPLIT[SPLIT]
    Greens[Greens 53] --> COND[CONDITIONAL]
    Left[Left 45] --> ABSTAIN[ABSTAIN/AGAINST]
```
...
```mermaid
graph TD
    EPP[EPP Group 183] -->|constructive| Action[EP Legislative Action]
    SD[S&D Group 136] -->|strongly supports| Action
    Renew[Renew 77] -->|supports| Action
    Greens[Greens 53] -->|supports| Action
    Left[Left 45] -->|supports Ukraine| Action
    PfE[PfE 85] -->|opposes institutionally| Action
    ECR[ECR 81] -->|opposes on sovereignty| Action
    Commission[EU Commission] -->|implements| Action
    Council[Council of EU] -->|must also act| Action
    BigTech[Big Tech Companies] -->|resists DMA| Action
    Ukraine[Ukrainian Government] -->|supports tribunal call| Action
    Armenia[Armenian Government] -->|welcomes resolution| Action
```
...
```mermaid
graph TD
    MFF[MFF 2021-2027] --> |1.05% GNI| EU_Budget[EU Annual Budget ~€170B]
    EP_Demand[EP Demand 1.5% GNI] --> |Target| MFF_2028[MFF 2028-2034]
    Own_Resources[Own Resources Reform] --> MFF_2028
    Defence_Window[Defence Integration] --> MFF_2028
    Social_Cohesion[Social Cohesion] --> MFF_2028
    EU_Budget --> Cohesion[Cohesion Funds ~€40B/yr]
    EU_Budget --> Agriculture[Agriculture ~€50B/yr]
    EU_Budget --> Research[Horizon Europe ~€10B/yr]
    EU_Budget --> Foreign[External Action ~€15B/yr]
```
...
```mermaid
quadrantChart
    title Risk Matrix (Likelihood 1-5 vs Impact 1-5)
    x-axis Low Likelihood --> High Likelihood
    y-axis Low Impact --> High Impact
    quadrant-1 HIGH RISK - Priority
    quadrant-2 CRITICAL - Monitor
    quadrant-3 LOW RISK - Watch
    quadrant-4 MODERATE - Prepare
    Ukraine Tribunal failure: [0.50, 0.90]
    DMA US retaliation: [0.36, 0.80]
    EP legitimacy erosion: [0.50, 0.64]
    PfE narrative escalation: [0.72, 0.48]
    MFF deadlock: [0.42, 0.56]
    Armenia backslide: [0.28, 0.60]
```
...
```mermaid
graph TD
    S[Strengths] -->|EPP+S&D+Renew 396 seats| Net
    S -->|Ukraine values coalition 494| Net
    S -->|DMA regulatory leadership| Net
    W[Weaknesses] -->|No voting data 4-6 week lag| Net
    W -->|PfE institutional challenge| Net
    O[Opportunities] -->|DMA enforcement acceleration| Net
    O -->|Ukraine tribunal legal architecture| Net
    T[Threats] -->|US trade retaliation| Net
    T -->|Russian information operations| Net
    Net{Net SWOT Score +8} -->|Moderately positive| Assessment[Positive Political Outlook]
```
...
```mermaid
quadrantChart
    title Political Threat Severity vs Probability
    x-axis Low Probability --> High Probability
    y-axis Low Severity --> High Severity
    quadrant-1 Watch
    quadrant-2 Critical
    quadrant-3 Low priority
    quadrant-4 Manage
    Russia-Ukraine: [0.95, 0.9]
    Hungary Rule of Law: [0.8, 0.7]
    PfE Delegitimisation: [0.9, 0.5]
    China Trade: [0.6, 0.65]
    MFF Governance: [0.4, 0.6]
```
...
```mermaid
graph TD
    IT1[Procedure Weaponisation] -->|Near-term HIGH| EP[EP Institutional Integrity]
    IT2[Government Coordination PfE] -->|Medium HIGH| EP
    GT1[Ukraine Fatigue] -->|Medium HIGH| Security[EU Security Order]
    GT2[Russia Escalation] -->|Medium HIGH| Security
    RT1[DMA Legal Challenge] -->|Medium| Regulatory[EU Regulatory Power]
    RT2[US Trade War] -->|Medium| Regulatory
    IE1[Russian Narratives] -->|Ongoing HIGH| InfoEnv[Information Environment]
    ST1[Antisemitism Wave] -->|Immediate HIGH| Rights[Fundamental Rights]
    EP -->|If weakened| Crisis[EU Governance Crisis]
    Security -->|If deteriorated| Geopolitical[Geopolitical Realignment]
    Rights -->|If unchecked| Social[Societal Fragmentation]
```
...
```mermaid
pie title 3-Month Scenario Probability Distribution
    "Scenario A: DMA enforcement wins" : 35
    "Scenario B: Ukraine tribunal breakthrough" : 25
    "Scenario C: Far-right strategy intensification" : 30
    "Scenario D: Status quo persistence" : 10
```
...
```mermaid
quadrantChart
    title Wildcard/Black Swan Risk Assessment
    x-axis Low Probability --> High Probability
    y-axis Low Impact --> High Impact
    quadrant-1 Monitor
    quadrant-2 Act
    quadrant-3 Ignore
    quadrant-4 Prepare
    Banking Crisis: [0.1, 0.9]
    MFF Breakdown: [0.15, 0.7]
    China Trade War: [0.3, 0.5]
    Far-right 2029: [0.35, 0.6]
    Russia Ceasefire: [0.2, 0.55]
    US Ukraine Pivot: [0.25, 0.8]
```
...
```mermaid
graph LR
    P[Political 8/10] -->|High impact| Analysis[April 2026 Context]
    E[Economic 7/10] -->|High impact| Analysis
    S[Social 7/10] -->|High impact| Analysis
    T[Technology 8/10] -->|High impact| Analysis
    L[Legal 9/10] -->|Very high| Analysis
    E2[Environmental 5/10] -->|Moderate| Analysis
    Analysis -->|Integrated score| Score[PESTLE Weighted Average: 7.3/10]
```
...
```mermaid
xychart-beta
    title EP Annual Adopted Texts by Term
    x-axis ["EP5 avg", "EP6 avg", "EP7 avg", "EP8 avg", "EP9 avg", "EP10 (2yr pace)"]
    y-axis "Adopted texts" 0 --> 900
    bar [620, 680, 710, 750, 800, 820]
```
