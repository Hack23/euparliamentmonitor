...
keywords: ["EU Parliament", "breaking news", "European Parliament", "legislation", "plenary vote", "Breaking", "2026-04-17", "run 180", "April", "recess", "probe", "DEGRADED", "mode", "server", "health", "endpoint"]
date: 2026-04-17
...
quadrantChart
    title Defence Threat Mitigation Matrix
    x-axis Low Mitigation Capacity --> High Mitigation Capacity
    y-axis Low Threat Severity --> High Threat Severity
    quadrant-1 Monitor
    quadrant-2 Priority Action
    quadrant-3 Accept
    quadrant-4 Manage
    Hungarian veto: [0.2, 0.8]
    ECR fragmentation: [0.5, 0.55]
    US retaliation: [0.35, 0.5]
    Russian IW: [0.4, 0.75]
    Democratic legitimacy: [0.7, 0.45]
    Implementation capacity: [0.65, 0.5]
```
...
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-17/breaking-run180/executive-brief.md) | `executive-brief.md` |
