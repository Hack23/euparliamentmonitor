...
source_folder: analysis/daily/2026-04-26/month-in-review
generated_at: 2026-04-26T00:00:00.000Z
language: en
layout: article
---
# Month In Review — 2026-04-26
...
> - **Run date:** 2026-04-26
> - **Run id:** `month-in-review-run-1777207349`
> - **Gate result:** `PENDING`
> - **Analysis tree:** [analysis/daily/2026-04-26/month-in-review](https://github.com/Hack23/euparliamentmonitor/tree/main/analysis/daily/2026-04-26/month-in-review)
> - **Manifest:** [manifest.json](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/manifest.json)
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/executive-brief.md" rel="noopener">View source: <code>executive-brief.md</code></a></p>
...
quadrantChart
    title Top Risk Items: Probability vs Impact
    x-axis "Low Probability" --> "High Probability"
    y-axis "Low Impact" --> "High Impact"
    quadrant-1 Act Now
    quadrant-2 High Attention
    quadrant-3 Watch
    quadrant-4 Monitor
    Banking CRE Stress: [0.45, 0.90]
    US Trade War: [0.75, 0.75]
    Germany Crisis: [0.55, 0.80]
    Coalition Fracture: [0.35, 0.75]
    Migration Summer: [0.65, 0.55]
    AI Governance Incident: [0.35, 0.60]
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/synthesis-summary.md" rel="noopener">View source: <code>intelligence/synthesis-summary.md</code></a></p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
flowchart LR
    A[March-April 2026\nLegislative Sprint] --> B{Outcome Distribution}
    B --> C[Banking Union 9.5/10\n✅ Achieved]
    B --> D[AI Governance 8.5/10\n✅ Achieved]
    B --> E[Defence Integration 6/10\n⚠️ Non-binding]
    C & D & E --> F[Legislative Period\nGrade: A-]
    G[Economic Context\nGermany -0.5%] --> H{Risk Distribution}
    H --> I[Banking Stress 🔴 Elevated]
    H --> J[US Trade War 🔴 High prob]
    H --> K[Coalition Fragility 🟡 Medium]
    I & J & K --> L[Risk Environment\nGrade: C+]
    F & L --> M[Overall Period\nAssessment: B-\nStrong output, worsening context]
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/classification/significance-classification.md" rel="noopener">View source: <code>classification/significance-classification.md</code></a></p>
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
pie title Legislative Output by Significance Tier (March 27 – April 26, 2026)
    "Tier 1 Transformative" : 2
    "Tier 2 Highly Significant" : 5
    "Tier 3 Significant" : 7
    "Tier 4 Routine" : 25
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/classification/actor-mapping.md" rel="noopener">View source: <code>classification/actor-mapping.md</code></a></p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
flowchart TD
    EC[European Commission\nLegislative initiative] -->|Proposes| EP[European Parliament\nAmends + Adopts]
    EC -->|Implements| ECB[ECB / SSM / SRB\nBanking supervision]
    EP -->|Monitors| EC
    ECB -->|Technical input| EP
    US[US Administration\nTariff actions] -->|Trade pressure| EC
    US -->|EP response| EP
    RU[Russia\nSecurity threat] -->|Defence urgency| EP
    CN[China\nAI + trade competition] -->|AI Act pressure| EC
    EBF[Banking Federation\nFinancial lobby] -->|ECON Committee| EP
    ETUC[European Trade Unions\nWorker rights lobby] -->|S&D + EMPL| EP
    EP -->|Accountability| EU_Citizens[705M EU Citizens\nUltimate principals]
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/classification/forces-analysis.md" rel="noopener">View source: <code>classification/forces-analysis.md</code></a></p>
...
flowchart LR
    subgraph Driving Forces
        D1[Banking CRE stress\ndrives BRRD3 urgency]
        D2[Ukraine war\ndrives defence integration]
        D3[AI regulation gap\ndrives AI Act completion]
        D4[German recession\ndrives economic reform]
    end
    subgraph Restraining Forces
        R1[German fiscal conservatism\nblocks EDIS mutualization]
        R2[Coalition arithmetic\nlimits ambition scope]
        R3[US tariff pressure\ndiverts legislative energy]
        R4[Implementation capacity\nlimits new obligations]
    end
    D1 & D2 & D3 & D4 -->|Net change| EP_OUTCOME[EP Legislative\nOutput Q1 2026]
    R1 & R2 & R3 & R4 -->|Resistance| EP_OUTCOME
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/classification/impact-matrix.md" rel="noopener">View source: <code>classification/impact-matrix.md</code></a></p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
timeline
    title Impact Cascade: March 2026 Legislation
    section Q2 2026
        April-June : BRRD3 implementing acts drafted
        May : ECB FSR tests banking stability
        June : AI Act Omnibus enters partial force
    section Q3 2026
        July-Sept : DGSD2 national transposition begins (18-month clock)
        August : EU Talent Pool operational
        Sept : European Semester Country Specific Recommendations
    section 2027
        Jan : AI Act high-risk category full enforcement
        Q2 : SRMR3 resolution fund targets revised
        Q3 : First DGSD2 cross-border case test
    section 2028-2030
        2028 : First decade of Banking Union operational assessment
        2029 : AI Act 5-year review clause
        2030 : EU Talent Pool pool 100,000 worker milestone target
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/coalition-dynamics.md" rel="noopener">View source: <code>intelligence/coalition-dynamics.md</code></a></p>
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/stakeholder-map.md" rel="noopener">View source: <code>intelligence/stakeholder-map.md</code></a></p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
flowchart TD
    A[EPP Group] -->|Coalition anchor| B[Banking Union Package]
    C[S&D Group] -->|Social conditionality| B
    D[Commission FISMA] -->|Trilogue proposals| B
    E[ECB/SSM] -->|Supervisory framework| B
    F[National Govts] -->|Council position| B
    
    G[EPP/Renew] -->|Competitiveness| H[AI Governance]
    I[Greens/Left] -->|Rights protection| H
    J[Tech Industry] -->|Simplification lobbying| H
    K[Civil Society] -->|Rights advocacy| H
    
    B -->|Financial stability| L[EU Citizens — savers, borrowers]
    H -->|Digital rights| M[EU Citizens — data subjects]
    N[Housing Resolution] -->|Affordability| O[EU Citizens — renters]
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/pestle-analysis.md" rel="noopener">View source: <code>intelligence/pestle-analysis.md</code></a></p>
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/historical-baseline.md" rel="noopener">View source: <code>intelligence/historical-baseline.md</code></a></p>
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/economic-context.md" rel="noopener">View source: <code>intelligence/economic-context.md</code></a></p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
xychart-beta
    title "Big Four GDP Growth Rate (%)"
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
pie title Banking Union Coverage Expansion (DGSD2)
    "Previously covered deposits" : 72
    "New DGSD2 covered deposits" : 12
    "Still uncovered (EDIS gap)" : 16
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
flowchart LR
    A[Germany Recession\n-0.5% 2024] -->|Fiscal constraint| B[Limited EU\ncross-subsidization capacity]
    C[Spain Growth\n+3.5% 2024] -->|New growth driver| D[EU economic\ndivergence narrative]
    E[Banking CRE\nStress] -->|Resolution risk| F[BRRD3 urgency]
    G[US Tariffs\n25% automotive] -->|Export cost| H[Growth headwind]
    B -->|Political pressure| I[DGSD2 implementation risk]
    D -->|Economic divergence| J[Semester social floor critical]
    F -->|Backstop needed| K[Banking Union completion]
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/risk-scoring/risk-matrix.md" rel="noopener">View source: <code>risk-scoring/risk-matrix.md</code></a></p>
...
quadrantChart
    ...
    quadrant-4 Monitor
    CRE Banking Stress: [0.40, 0.95]
    German Recession: [0.65, 0.80]
    US Trade War: [0.60, 0.80]
    Coalition Fracture: [0.35, 0.80]
    AI Act Failure: [0.55, 0.55]
    DGSD2 Non-Compliance: [0.40, 0.75]
    France Destabilization: [0.35, 0.80]
    Migration Surge: [0.65, 0.55]
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/risk-scoring/quantitative-swot.md" rel="noopener">View source: <code>risk-scoring/quantitative-swot.md</code></a></p>
...
xychart-beta
    ...
    y-axis "Weighted Score" -20 --> 25
    bar [22.0, -15.0, 17.0, -16.0]
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/risk-scoring/political-capital-risk.md" rel="noopener">View source: <code>risk-scoring/political-capital-risk.md</code></a></p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
quadrantChart
    title Political Capital Risk by Actor
    x-axis "Low Risk Exposure" --> "High Risk Exposure"
    y-axis "Low Capital Base" --> "High Capital Base"
    quadrant-1 High stakes, high resilience
    quadrant-2 Vulnerable
    quadrant-3 Low stakes
    quadrant-4 Protected
    EPP: [0.55, 0.80]
    Commission: [0.50, 0.85]
    S&D: [0.40, 0.55]
    Renew: [0.45, 0.45]
    ECR: [0.35, 0.30]
    Greens-EFA: [0.30, 0.35]
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/risk-scoring/legislative-velocity-risk.md" rel="noopener">View source: <code>risk-scoring/legislative-velocity-risk.md</code></a></p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
timeline
    title EP Legislative Pipeline Q2-Q3 2026
    section May 2026
        European Semester CSRs : Commission proposes Country Specific Recommendations
        ECB FSR : Financial Stability Review; may trigger BRRD3 discussion
    section June 2026
        AI Act implementing acts : DG CONNECT drafts first implementing regulations
        DGSD2 transposition clock : 18-month national transposition deadline begins
    section July-August 2026
        Summer recess : Minimal plenary activity
        Defence legislative proposals : Commission expected to follow up on EP resolutions
    section September 2026
        EP resumed plenary : Autumn session begins; new dossiers
        Banking Union review : First SSM assessment under BRRD3 regime
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/threat-model.md" rel="noopener">View source: <code>intelligence/threat-model.md</code></a></p>
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/threat-assessment/actor-threat-profiles.md" rel="noopener">View source: <code>threat-assessment/actor-threat-profiles.md</code></a></p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
flowchart LR
    R[Russia\nINFO OPS\nHigh-High-Medium] -->|Delegitimize| EP[EP Effectiveness]
    US[US Trade\nECONOMIC COERCION\nHigh-High-High] -->|Trade shock| EU_ECON[EU Economy]
    POP[Populist-Right\nINTERNAL\nMedium-Medium-High] -->|Coalition stress| EP
    EU_ECON -->|Political pressure| EP
    EP -->|Resilience response| AC[Anti-Corruption\nWTO MC14\nTariff Adjustment]
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/threat-assessment/consequence-trees.md" rel="noopener">View source: <code>threat-assessment/consequence-trees.md</code></a></p>
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/threat-assessment/legislative-disruption.md" rel="noopener">View source: <code>threat-assessment/legislative-disruption.md</code></a></p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
timeline
    title Banking Union Legislative Velocity
    section 2012
        EU Summit : Banking Union announced
    section 2014
        BRRD1 + DGSD1 : Foundation package 2 years
    section 2015
        SRM operational : 3 years total
    section 2019
        BRRD2 minor revision : 5 years total
    section 2026
        BRRD3 + SRMR3 + DGSD2 : 12 years total
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/threat-assessment/political-threat-landscape.md" rel="noopener">View source: <code>threat-assessment/political-threat-landscape.md</code></a></p>
...
flowchart TD
    subgraph External Threats
        ET1[Russia — Information ops\nSeverity: HIGH\nLikelihood: ONGOING]
        ET2[US — Trade war escalation\nSeverity: HIGH\nLikelihood: MEDIUM]
        ET3[China — AI/trade competition\nSeverity: MEDIUM\nLikelihood: ONGOING]
    end
    subgraph Internal Threats
        IT1[EPP-right coalition drift\nSeverity: MEDIUM\nLikelihood: INCREASING]
        IT2[Banking CRE stress\nSeverity: VERY HIGH\nLikelihood: LOW-MEDIUM]
        IT3[Renew fragmentation\nSeverity: MEDIUM\nLikelihood: LOW-MEDIUM]
    end
    ET1 & ET2 & ET3 -->|External| EP[EP Effectiveness\nand Legitimacy]
    IT1 & IT2 & IT3 -->|Internal| EP
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/scenario-forecast.md" rel="noopener">View source: <code>intelligence/scenario-forecast.md</code></a></p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
flowchart LR
    A[April 2026 State] --> B{Key Decision Points}
    B --> C[🟢 Scenario 1: Reform Consolidation]
    B --> D[🟡 Scenario 2: Constrained Implementation]
    B --> E[🔴 Scenario 3: Regression and Fragmentation]
    
    C --> F[Banking union fully operational Q4 2026\nAI Act Omnibus reduces compliance burden\nDefence integration proceeds]
    D --> G[Banking union delayed by EBA technical disputes\nAI governance litigation stalls progress\nUS tariffs escalate but managed]
    E --> H[Germany recession deepens → austerity demands\nBanking union DGSD2 pooling challenged\nRight-populist surge threatens reform agenda]
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/wildcards-blackswans.md" rel="noopener">View source: <code>intelligence/wildcards-blackswans.md</code></a></p>
...
quadrantChart
    ...
    y-axis "Low Impact" --> "High Impact"
    quadrant-1 Monitor Closely
    quadrant-2 Critical Wildcards
    quadrant-3 Background Noise
    quadrant-4 Manageable Risks
    US Trade War Escalation: [0.75, 0.75]
    German Economic Crisis: [0.55, 0.8]
    France Constitutional Crisis: [0.40, 0.85]
    Migration Summer Surge: [0.65, 0.55]
    Banking Stress Event: [0.45, 0.9]
    AI Governance Incident: [0.35, 0.60]
    Turkey-Greece Incident: [0.30, 0.70]
    Enlargement Disruption: [0.45, 0.50]
```
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/documents/document-analysis-index.md" rel="noopener">View source: <code>documents/document-analysis-index.md</code></a></p>
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/mcp-reliability-audit.md" rel="noopener">View source: <code>intelligence/mcp-reliability-audit.md</code></a></p>
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/workflow-audit.md" rel="noopener">View source: <code>intelligence/workflow-audit.md</code></a></p>
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/methodology-reflection.md" rel="noopener">View source: <code>intelligence/methodology-reflection.md</code></a></p>
...
<p class="artifact-source"><a href="https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/analysis-index.md" rel="noopener">View source: <code>intelligence/analysis-index.md</code></a></p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","lineColor":"#90CAF9"}}}%%
timeline
    title EU Parliament — March 27 to April 26, 2026
    section Early March
        March 10-12 : Housing crisis resolution
                    : AI governance (copyright + CoE Convention)
                    : Defence integration resolutions
                    : EU Talent Pool
    section Mid-March
        March 11 : EU enlargement strategy
                 : Gender pay gap report
                 : European Semester package
                 : WTO MC14 position
    section Late March
        March 26 : BANKING UNION PACKAGE (SRMR3/BRRD3/DGSD2)
                 : AI Act Omnibus simplification
                 : US tariff adjustment
                 : Anti-corruption directive
    section April
        April 1-26 : Post-legislative consolidation
                   : Inter-institutional negotiations continue
```
...
Every artifact below was read by the aggregator and contributed to this article. The raw [manifest.json](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/manifest.json) carries the full machine-readable list, including gate-result history.

| Section | Artifact | Path |
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/executive-brief.md) | `executive-brief.md` |
| section-synthesis | [synthesis-summary](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/synthesis-summary.md) | `intelligence/synthesis-summary.md` |
| section-significance | [significance-classification](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/classification/significance-classification.md) | `classification/significance-classification.md` |
| section-actors-forces | [actor-mapping](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/classification/actor-mapping.md) | `classification/actor-mapping.md` |
| section-actors-forces | [forces-analysis](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/classification/forces-analysis.md) | `classification/forces-analysis.md` |
...
| section-risk | [political-capital-risk](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/risk-scoring/political-capital-risk.md) | `risk-scoring/political-capital-risk.md` |
| section-risk | [legislative-velocity-risk](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/risk-scoring/legislative-velocity-risk.md) | `risk-scoring/legislative-velocity-risk.md` |
| section-threat | [threat-model](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/threat-model.md) | `intelligence/threat-model.md` |
| section-threat | [actor-threat-profiles](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/threat-assessment/actor-threat-profiles.md) | `threat-assessment/actor-threat-profiles.md` |
| section-threat | [consequence-trees](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/threat-assessment/consequence-trees.md) | `threat-assessment/consequence-trees.md` |
| section-threat | [legislative-disruption](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/threat-assessment/legislative-disruption.md) | `threat-assessment/legislative-disruption.md` |
...
| section-quality-reflection | [workflow-audit](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/workflow-audit.md) | `intelligence/workflow-audit.md` |
| section-quality-reflection | [methodology-reflection](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/methodology-reflection.md) | `intelligence/methodology-reflection.md` |
| section-supplementary-intelligence | [analysis-index](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-26/month-in-review/intelligence/analysis-index.md) | `intelligence/analysis-index.md` |
