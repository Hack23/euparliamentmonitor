...
keywords: ["EU Parliament Monitor", "European Parliament", "European Commission", "political intelligence", "Riksdagsmonitor", "Riksdag", "Regeringen", "EU Parliament", "legislative procedures", "proposal", "regulation", "Propositions", "2026-05-29", "European", "Parliament", "Advances"]
date: 2026-05-29
...
```mermaid
graph TD
    AI_DOCTRINE["AI-Trade Doctrine<br/>TA-10-2026-0183<br/>🔴 CRITICAL"] --> DIGITAL_ARCH["EU Digital Policy<br/>Architecture"]
    DMA_ENF["DMA Enforcement<br/>TA-10-2026-0160<br/>🔴 CRITICAL"] --> DIGITAL_ARCH
    DIGITAL_ARCH --> BRUSSELS_EFFECT["Brussels Effect<br/>Global Standard<br/>Setting"]
    INTL_CLUSTER["INTL Agreements ×7<br/>TA-10-2026-0177–0182<br/>🟠 HIGH"] --> EU_ACTOR["EU as International<br/>Actor at Scale"]
    EU_ACTOR --> NORM_POWER["Normative Power<br/>Projection"]
    EU_ACTOR --> HARD_POWER["Hard Power<br/>Integration"]
    HOUSING_RES["Housing Resolution<br/>TA-10-2026-0064<br/>🟠 HIGH"] --> SOCIAL_EU["Social EU<br/>Competence Expansion"]
    BUDGET_2027["Budget Guidelines<br/>TA-10-2026-0112<br/>🟠 HIGH"] --> FISCAL_FRAME["MFF 2028–34<br/>Pre-Negotiation<br/>Positioning"]
    FOREST["Forest Regulation<br/>TA-10-2026-0168<br/>🟡 MEDIUM"] --> GREEN_DEAL["Green Deal<br/>Implementation<br/>Completion"]
    DIGITAL_ARCH -->|"reinforces"| EU_ACTOR
    SOCIAL_EU -->|"fiscal pressure"| FISCAL_FRAME
    GREEN_DEAL -->|"embedded in"| FISCAL_FRAME
    style AI_DOCTRINE fill:#ff4444,color:#fff
    style DMA_ENF fill:#ff4444,color:#fff
    style INTL_CLUSTER fill:#ff8800,color:#fff
    style HOUSING_RES fill:#ff8800,color:#fff
    style BUDGET_2027 fill:#ff8800,color:#fff
    style BRUSSELS_EFFECT fill:#4488ff,color:#fff
```
...
*Synthesis by: EU Parliament Monitor intelligence engine · Degraded-feeds mode · 2026-05-29*
...
*Run ID*: propositions-run289-1780040667 · *Data sources*: 51 EP adopted texts (A1 grade), degraded-feeds fallback
...
```mermaid
graph LR
    EPP["EPP 26.4%"] -->|"lead rapporteur"| AI["AI-Trade TA-183"]
    EPP -->|"co-sponsor"| DMA["DMA Enforcement"]
    SD["S&D 19.1%"] -->|"shadow"| AI
    SD -->|"primary driver"| HOUSING["Housing Resolution"]
    SD -->|"INTA chair"| INTL["INTL Agreements ×7"]
    RENEW["Renew 10.8%"] -->|"co-sponsor"| AI
    RENEW -->|"ITRE lead"| DMA
    GREENS["Greens/EFA 8.3%"] -->|"amendments"| HOUSING
    GREENS -->|"amendments"| FOREST["Forest Material"]
    ECR["ECR 11.3%"] -->|"opposition"| HOUSING
    PfE["PfE 7.2%"] -->|"objections"| INTL
    COM["EC DG TRADE"] -->|"proposal"| AI
    COM -->|"proposal"| DMA
    COUNCIL["Council (PL Pres)"] -->|"ratification"| INTL
    style AI fill:#ff4444,color:#fff
    style DMA fill:#ff4444,color:#fff
    style HOUSING fill:#ff8800,color:#fff
    style INTL fill:#ff8800,color:#fff
...
```mermaid
graph LR
    EQUIL["Legislative<br/>Equilibrium<br/>Point"]

    AI_FORCE["🟢 AI Geopolitical<br/>Competition (+5)"] -->|"drives"| EQUIL
    DIGITAL["🟢 Digital Market<br/>Contestability (+4)"] -->|"drives"| EQUIL
    HOUSING_FORCE["🟢 Housing Stress<br/>(+4)"] -->|"drives"| EQUIL
    INTL_FORCE["🟢 FP Consolidation<br/>(+4)"] -->|"drives"| EQUIL
    ENV["🟢 Environmental<br/>Framework (+3)"] -->|"drives"| EQUIL

    EQUIL -->|"restrained by"| BLOC["🔴 Right-Nationalist<br/>Blocking (-4)"]
    EQUIL -->|"restrained by"| COUNCIL_DELAY["🔴 Council Ratification<br/>Delays (-3)"]
    EQUIL -->|"restrained by"| FISCAL["🔴 Fiscal Constraints<br/>(-3)"]
    EQUIL -->|"restrained by"| AI_GAP["🔴 AI Liability Gap<br/>(-3)"]
    EQUIL -->|"restrained by"| SUBS["🔴 Subsidiarity<br/>Objections (-3)"]

    style EQUIL fill:#4488ff,color:#fff
    style AI_FORCE fill:#00aa00,color:#fff
    style DIGITAL fill:#00aa00,color:#fff
    style HOUSING_FORCE fill:#00aa00,color:#fff
    style INTL_FORCE fill:#00aa00,color:#fff
    style ENV fill:#00aa00,color:#fff
    style BLOC fill:#aa0000,color:#fff
    style COUNCIL_DELAY fill:#aa0000,color:#fff
    style FISCAL fill:#aa0000,color:#fff
    style AI_GAP fill:#aa0000,color:#fff
    style SUBS fill:#aa0000,color:#fff
```
...
```mermaid
graph TD
    AI183["AI-Trade Strategy<br/>(TA-10-2026-0183)"]
    DMA160["DMA Enforcement<br/>(TA-10-2026-0160)"]
    INTL["INTL Agreements<br/>×7"]
    HOUSING["Housing Resolution"]
    BUDGET["Budget 2027"]

    AI183 -->|"reinforces"| DMA160
    AI183 -->|"enables"| INTL
    DMA160 -->|"constrains"| AI183
    HOUSING -->|"fiscal pressure on"| BUDGET
    BUDGET -->|"funds"| HOUSING
    INTL -->|"generates revenue for"| BUDGET

    AI183 -.->|"labour impact"| HOUSING
    DMA160 -.->|"market income"| BUDGET
...
```mermaid
graph TD
    EP["European Parliament<br/>(primary legislator)"] --> EPP_GRP["EPP Group<br/>26.4% · Pro-digital"]
    EP --> SD_GRP["S&D Group<br/>19.1% · Pro-social"]
    EP --> RENEW_GRP["Renew Group<br/>10.8% · Pro-market"]
    EP --> ECR_GRP["ECR Group<br/>11.3% · Deregulatory"]
    EP --> GREENS_GRP["Greens/EFA<br/>8.3% · Environmental"]
    COM["European Commission<br/>(executive)"] -->|"proposals"| EP
    COUNCIL["Council of EU<br/>(co-legislator)"] -->|"co-decision"| EP
    GAFA["Digital Gatekeepers<br/>(GAFA et al.)"] -->|"lobbying"| COM
    GAFA -->|"litigation"| CJEU["Court of Justice<br/>(arbitration)"]
    SMES["EU SMEs/Startups<br/>(digital sector)"] -->|"advocacy"| EP
    CIVIL["Civil Society<br/>(Housing Europe, FEANTSA)"] -->|"advocacy"| EP
    TRADE_PARTNERS["Trade Partners<br/>(Brazil, ASEAN, Gulf...)"] -->|"consultation"| COM
    style EP fill:#003399,color:#fff
    style COM fill:#ffcc00
    style COUNCIL fill:#003399,color:#fff
    style GAFA fill:#ff4444,color:#fff
```
...
```mermaid
graph TD
    S1["Strength: EU Regulatory<br/>Standard-Setting Power"] -->|"builds on"| O1["Opportunity: Global<br/>AI Governance Leadership"]
    S2["Strength: Coalition<br/>Majority Stability"] -->|"enables"| O2["Opportunity: DMA<br/>Enforcement Credibility"]
    W1["Weakness: Degraded<br/>EP API Feeds"] -->|"limits"| O3["Opportunity: INTL<br/>Agreement Monitoring"]
    W2["Weakness: Fiscal<br/>Constraints"] -->|"threatens"| O4["Opportunity: Housing<br/>Resolution Implementation"]
    T1["Threat: Coalition<br/>Fracture Risk"] -->|"exploits"| W3["Weakness: EPP Internal<br/>Tension"]
    T2["Threat: AI Governance<br/>Divergence"] -->|"reduces"| S1
    style S1 fill:#00aa00,color:#fff
    style S2 fill:#00aa00,color:#fff
    style O1 fill:#4488ff,color:#fff
    style O2 fill:#4488ff,color:#fff
    style W1 fill:#ff8800,color:#fff
    style W2 fill:#ff8800,color:#fff
    style T1 fill:#ff4444,color:#fff
    style T2 fill:#ff4444,color:#fff
```
...
```mermaid
graph TD
    T1["T1: Coalition Fracture<br/>Probability: MEDIUM<br/>Impact: HIGH"] --> T2["T2: DMA Non-Enforcement<br/>Probability: LOW-MED<br/>Impact: HIGH"]
    T3["T3: AI Governance Divergence<br/>Probability: MEDIUM<br/>Impact: HIGH"] -->|"accelerates"| T1
    T4["T4: INTL Agreement Ratification Failure<br/>Probability: LOW-MED<br/>Impact: MEDIUM"] -.->|"may trigger"| T1
    T5["T5: Budget 2027 Deadlock<br/>Probability: MEDIUM<br/>Impact: HIGH"] -->|"stress test for"| T1
    T2 -->|"undermines"| T3
    T5 -->|"constrains resources for"| T4
    style T1 fill:#ff4444,color:#fff
...
```mermaid
graph TD
    NOW["Current State<br/>2026-05-29<br/>AI-Trade + DMA Adopted"] --> S1["Scenario 1<br/>Brussels Effect 2.0<br/>P=50%"]
    NOW --> S2["Scenario 2<br/>Fragmented Governance<br/>P=35%"]
    NOW --> S3["Scenario 3<br/>Regulatory Retrenchment<br/>P=15%"]
    S1 --> S1A["EU becomes global<br/>AI governance standard<br/>by 2028"]
    S1 --> S1B["DMA delivers<br/>€45bn SME dividend<br/>by 2029"]
    S2 --> S2A["US–EU AI governance<br/>divergence hardens<br/>trade friction"]
    S2 --> S2B["Housing resolution<br/>fails to trigger<br/>directive"]
    S3 --> S3A["EPP–ECR–PfE coalition<br/>rolls back AI Trade<br/>provisions"]
    S3 --> S3B["DMA enforcement<br/>stalls under<br/>legal challenges"]
    style NOW fill:#4488ff,color:#fff
    style S1 fill:#00aa00,color:#fff
...
```mermaid
graph TD
    P["Political<br/>AI governance + INTL agreements<br/>coalition dynamics"] --> E["Economic<br/>Digital trade €2.4tn<br/>DMA contestability"]
    P --> S["Social<br/>Housing affordability<br/>AI labour displacement"]
    E --> T["Technological<br/>AI Act implementation<br/>DMA enforcement"]
    T --> L["Legal<br/>AI liability gap<br/>housing competence"]
    L --> EN["Environmental<br/>Forest regulation<br/>Green Deal completion"]
    EN -->|"co-constitutive"| E
    S -->|"political pressure"| P
    T -->|"enables"| P
    style P fill:#003399,color:#fff
    style E fill:#004400,color:#fff
    style S fill:#880000,color:#fff
    style T fill:#444400,color:#fff
    style L fill:#440044,color:#fff
    style EN fill:#004444,color:#fff
```
...
```mermaid
xychart-beta
    title "EP Legislative Output by Term (Adopted Texts per Month)"
    x-axis ["EP6-2008", "EP6-2012", "EP7-2016", "EP8-2019", "EP9-2024", "EP10-2026"]
    y-axis "Avg Texts/Month" 0 --> 40
    bar [22, 24, 28, 31, 35, 38]
    line [22, 24, 28, 31, 35, 38]
```
...
```mermaid
graph TD
    EVENT["AI-Trade Strategy<br/>TA-10-2026-0183<br/>2026-05-20"] --> DE["🇩🇪 German Media<br/>Frame: Industrial<br/>Competitiveness"]
    EVENT --> FR["🇫🇷 French Media<br/>Frame: Digital<br/>Sovereignty"]
    EVENT --> SE["🇸🇪 Swedish Media<br/>Frame: Innovation<br/>Ecosystem"]
    EVENT --> PL["🇵🇱 Polish Media<br/>Frame: Tech<br/>Industry Opportunity"]
    EVENT --> HU["🇭🇺 Hungarian Media<br/>Frame: Brussels<br/>Overreach"]
    DE -->|"emphasis"| AUTO["Automotive AI<br/>applications"]
    FR -->|"emphasis"| STRAT["Strategic autonomy<br/>from US/China"]
    SE -->|"emphasis"| STARTUPS["Nordic startup<br/>ecosystem benefits"]
    HU -->|"counter-frame"| SOVER["National sovereign<br/>tech decisions"]
    style EVENT fill:#003399,color:#fff
    style HU fill:#ff4444,color:#fff
```
...
*Run context: propositions · 2026-05-29 · dataMode: degraded-feeds · Adminstrative source B2*
...
---
*Audit generated by: EU Parliament Monitor · Run ID: propositions-run289-1780040667 · dataMode: degraded-feeds · Audit grade: B2 (reliable assessment of data limitations)*
...
> - **Run id:** `propositions-run289-1780040667`
> - **Gate result:** `GREEN`
> - **Analysis tree:** [analysis/daily/2026-05-29/propositions](https://github.com/Hack23/euparliamentmonitor/tree/main/analysis/daily/2026-05-29/propositions)
> - **Manifest:** [manifest.json](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/manifest.json)
...
Every artifact below was read by the aggregator and contributed to this article. The raw [manifest.json](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/manifest.json) carries the full machine-readable list, including gate-result history.

| Section | Artifact | Path |
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/executive-brief.md) | `executive-brief.md` |
| section-synthesis | [synthesis-summary](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/intelligence/synthesis-summary.md) | `intelligence/synthesis-summary.md` |
| section-significance | [significance-classification](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/classification/significance-classification.md) | `classification/significance-classification.md` |
| section-actors-forces | [actor-mapping](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/classification/actor-mapping.md) | `classification/actor-mapping.md` |
| section-actors-forces | [forces-analysis](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/classification/forces-analysis.md) | `classification/forces-analysis.md` |
| section-actors-forces | [impact-matrix](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/classification/impact-matrix.md) | `classification/impact-matrix.md` |
| section-coalitions-voting | [coalition-dynamics](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/intelligence/coalition-dynamics.md) | `intelligence/coalition-dynamics.md` |
| section-stakeholder-map | [stakeholder-map](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/intelligence/stakeholder-map.md) | `intelligence/stakeholder-map.md` |
| section-economic-context | [economic-context](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/intelligence/economic-context.md) | `intelligence/economic-context.md` |
| section-risk | [risk-matrix](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/risk-scoring/risk-matrix.md) | `risk-scoring/risk-matrix.md` |
| section-risk | [quantitative-swot](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/risk-scoring/quantitative-swot.md) | `risk-scoring/quantitative-swot.md` |
| section-threat | [threat-model](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/intelligence/threat-model.md) | `intelligence/threat-model.md` |
| section-scenarios | [scenario-forecast](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/intelligence/scenario-forecast.md) | `intelligence/scenario-forecast.md` |
| section-scenarios | [wildcards-blackswans](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/intelligence/wildcards-blackswans.md) | `intelligence/wildcards-blackswans.md` |
| section-pestle-context | [pestle-analysis](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/intelligence/pestle-analysis.md) | `intelligence/pestle-analysis.md` |
| section-pestle-context | [historical-baseline](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/intelligence/historical-baseline.md) | `intelligence/historical-baseline.md` |
| section-extended-intel | [media-framing-analysis](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/extended/media-framing-analysis.md) | `extended/media-framing-analysis.md` |
| section-mcp-reliability | [mcp-reliability-audit](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/intelligence/mcp-reliability-audit.md) | `intelligence/mcp-reliability-audit.md` |
| section-quality-reflection | [analysis-index](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-29/propositions/intelligence/analysis-index.md) | `intelligence/analysis-index.md` |
