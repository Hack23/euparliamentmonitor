# Procedures Proxy Analysis — Breaking News 2026-05-29
...
The EP `/procedures/feed` endpoint returned HTTP 404 on both run #1 and run #2 of the 2026-05-29 breaking news workflow. This is the expected degraded-feeds mode. This artifact documents the compensating proxy analysis.
