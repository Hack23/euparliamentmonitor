---
title: "KJ-1: Digital Regulation Enforcement Has — Run 1778828850"
...
graph LR
    subgraph DRIVING["Driving Forces →"]
        F1["Tech Resistance\n7/10"]
        F2["Ukraine Solidarity\n8.5/10"]
        F3["Commission Incentive\n5/10"]
        F4["Polish Presidency\n7/10"]
        F5["EP Assertiveness\n6/10"]
    end
    subgraph RESTRAINING["← Restraining Forces"]
        ...
        R2["US Trade Risk\n6.5/10"]
        R3["Rural Coalition\n5/10"]
        R4["Non-binding Limits\n4.5/10"]
        R5["Attention Fragment\n3.5/10"]
    end
    
    DRIVING -->|"Net Driving: 33.5"| BALANCE["⚖️ Net Force\n+5 toward change\n(DMA/Ukraine/Armenia)"]
    RESTRAINING -->|"Net Restraining: 28.5"| BALANCE
```
...
```mermaid
quadrantChart
    title Political Capital Risk (Loss Probability vs. Magnitude)
    x-axis Low Loss Probability --> High Loss Probability
    y-axis Low Capital Magnitude --> High Capital Magnitude
    quadrant-1 "Manage Actively"
    quadrant-2 "Watch Closely"
    quadrant-3 "Low Priority"
    quadrant-4 "Communicate Proactively"
    Commission DMA: [0.65, 0.80]
    EPP-Fidesz: [0.55, 0.70]
    Renew Trade Risk: [0.50, 0.55]
    SD Rural Split: [0.60, 0.45]
    PfE Narrative: [0.70, 0.40]
    EP Credibility: [0.35, 0.75]
    Poland Presidency: [0.25, 0.70]
```
...
```mermaid
gantt
    title Legislative Disruption Risk Timeline (April 2026 – April 2028)
    dateFormat YYYY-MM
    axisFormat %Y-%m

    section DMA Enforcement
    EP motion pressure :milestone, 2026-05, 0d
    Commission response window :2026-05, 3M
    USTR Section 301 risk :active, 2026-06, 12M
    CJEU challenge filing risk :2026-09, 18M

    section Ukraine Tribunal
    Poland Presidency window :2026-05, 2M
    Council stall/veto :active, 2026-07, 24M
    QMV workaround negotiations :2027-01, 12M

    section Armenia
    Commission candidacy decision :2026-08, 2M
    Association Agreement Council veto :active, 2026-10, 36M
    Bilateral sub-unanimity track :2027-01, 24M

    section Livestock
    Commission proposal window :2027-06, 6M
    Council agricultural resistance :2027-12, 18M
```
...
```mermaid
graph TD
    subgraph IMM["Immediate (0-6 months)"]
        T1["T1: Commission DMA Delay\n40% | HIGH"]
        T2["T2: HU/RU Info Ops on Armenia\n55% | MEDIUM"]
        T3["T3: US DMA Pressure\n60% | MEDIUM-HIGH"]
    end
    subgraph MED["Medium-term (6-18 months)"]
        T4["T4: EP Accountability Fatigue\n50% | MEDIUM"]
        T5["T5: Denmark De-Prioritisation\n35% | HIGH"]
        T6["T6: DMA CJEU Challenge\n45% | HIGH"]
    end
    subgraph LONG["Long-term (18-36 months)"]
        T7["T7: EPP Electoral Shift\n25% | HIGH"]
        T8["T8: Russia-Ukraine Settlement\n20% | TRANSFORMATIVE"]
    end
...
quadrantChart
    title Scenario Space: Commission Enforcement × Council Cohesion
    x-axis Slow Enforcement --> Fast Enforcement
    y-axis Council Fragmented --> Council United
    quadrant-1 "Scenario A: Full Breakthrough"
    quadrant-2 "Scenario C: Political Only"
    quadrant-3 "Scenario D: Institutional Stall"
    quadrant-4 "Scenario B: Enforcement-Led"
    "Current position (May 2026)": [0.4, 0.55]
    "Scenario A": [0.8, 0.8]
    "Scenario B": [0.75, 0.35]
    "Scenario C": [0.25, 0.75]
    "Scenario D": [0.25, 0.3]
```
