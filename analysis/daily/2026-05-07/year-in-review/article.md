---
title: "EP10 Year 2 is the most consequential parliamentary"
...
keywords: ["EU Parliament Monitor", "European Parliament", "European Commission", "political intelligence", "Riksdagsmonitor", "Riksdag", "Regeringen", "EU Parliament", "year in review", "annual summary", "legislative achievements", "2026-05-07", "EP10", "Year", "most", "consequential"]
date: 2026-05-07
article_type: year-in-review
slug: 2026-05-07-year-in-review
source_folder: analysis/daily/2026-05-07/year-in-review
...
mindmap
    root((EP10 Year 2))
        ...
        Sustainability Retreat
            ...
            HGV delay
            Greens at EP5 low
            No binding climate text
        Coalition Fragmentation
            6.55 effective parties
            EPP oscillation strategy
            PfE institutionalising
            Grand coalition still available
        Rule of Law Stall
            Hungary Art7 7 years no enforcement
            Anti-corruption directive passed
            ECtHR backstop weakened
```
...
<!-- mermaid block deduplicated: identical to earlier occurrence (hash=c6a9f4f5) -->
...
```mermaid
flowchart TD
    Score[14/20 Composite Score] --> T2[Tier 2: Historically Significant]
    T2 -->|characteristics| C1[Major institutional firsts]
    T2 -->|characteristics| C2[Lasting structural changes]
    T2 -->|limits| L1[Not transformative: mixed legacies]
    T2 -->|limits| L2[Sustainability reversals limit final verdict]
    
    subgraph Tier Reference
        T1[Tier 1 ≥18/20: Transformative EP — e.g. EP5 Eurozone]
        T2
        T3[Tier 3 10-13/20: Productive Normal Term]
        T4[Tier 4 <10/20: Stagnant/Crisis Term]
    end
```
...
```mermaid
graph LR
    A[Geopolitical Crisis] -->|creates| B[Cross-party urgency frame]
    B -->|enables| C[EPP + S&D + Renew + ECR coalition]
    C -->|produces| D[Defence/Trade/Ukraine legislation]
    D -->|strengthens| E[EU institutional credibility]
```
...
```mermaid
quadrantChart
    title EP10 Year 2 Impact Assessment
    x-axis Low Magnitude --> High Magnitude
    y-axis Negative Impact --> Positive Impact
    quadrant-1 High Impact / Positive
    quadrant-2 Low Impact / Positive
    quadrant-3 Low Impact / Negative
    quadrant-4 High Impact / Negative
    Ukraine Enhanced Loan: [0.85, 0.90]
    Defence Industrial Strategy: [0.80, 0.75]
    DMA Enforcement: [0.75, 0.70]
    InvestEU Simplification: [0.65, 0.65]
    CSRD Rollback: [0.75, 0.20]
    Housing Crisis Response: [0.50, 0.60]
    HGV Emissions Delay: [0.60, 0.25]
    Hungary Art7 Blocked: [0.70, 0.15]
    Budget FY2026: [0.70, 0.55]
    Mercosur Safeguard: [0.55, 0.55]
```
...
```mermaid
pie title Impact Event Heat by Domain (Year 2)
    "Defence/Security" : 35
    "Digital Governance" : 25
    "Trade/Economic" : 20
    "Rule of Law" : 10
    "Environmental" : 5
    "Social" : 5
...
graph TD
    subgraph CRITICAL Threats
        T1[Rule of Law Erosion<br/>Probability: Highly Likely<br/>Impact: CRITICAL]
        T2[Right-Bloc Consolidation<br/>Probability: Likely<br/>Impact: HIGH]
    end
    
    subgraph HIGH Threats
        T3[US Tariff War Escalation<br/>Probability: Likely<br/>Impact: HIGH]
        T4[Ukraine War Stalemate<br/>Probability: Highly Likely<br/>Impact: HIGH]
        T5[Green Deal Abandonment<br/>Probability: Likely<br/>Impact: HIGH]
    end
    
    subgraph MEDIUM Threats
        T6[EP Institutional Fatigue<br/>Probability: Even Chance<br/>Impact: MEDIUM]
        T7[Chinese Trade Pressure<br/>Probability: Even Chance<br/>Impact: MEDIUM]
        T8[Banking System Stress<br/>Probability: Unlikely<br/>Impact: HIGH]
    end
```
...
```mermaid
gantt
    title EP10 Year 3 Legislative Pipeline
    dateFormat  YYYY-MM
    section Banking
    SRMR3 Second Reading        :active, 2026-05, 2026-09
    section Digital
    AI Act Enforcement Expansion :2026-06, 2026-12
    DMA Phase 2 Review           :2026-07, 2027-02
    section Trade
    EU-Mercosur Ratification     :2026-05, 2027-03
    US Tariff Rebalancing Measures :2026-05, 2026-10
    section Defence
    EDIP Year 2 Budget           :2026-09, 2027-01
    section Social
    Housing Directive            :2026-06, 2027-06
```
...
```mermaid
xychart-beta
    title "EP10 Mandate Fulfilment Trajectory (Projected)"
    x-axis ["Year 1 (2024)", "Year 2 (2025-26)", "Year 3 (2026-27)", "Year 4 (2027-28)", "Year 5 (2028-29)"]
    y-axis "Mandate Score (0-100)" 0 --> 100
    line [45, 53, 60, 62, 63]
```
...
```mermaid
gantt
    title Presidency Trio EP10 Year 2
    dateFormat  YYYY-MM
    section Poland (H1 2025)
    Defence Industrial Partnership  : 2025-01, 2025-06
    Ukraine Enhanced Loan First Reading : 2025-01, 2025-04
    Eastern Neighbourhood Initiative : 2025-01, 2025-06
    section Denmark (H2 2025)
    DMA Enforcement Phase 2 : 2025-07, 2025-12
    Budget FY2026 : 2025-07, 2025-12
    Anti-Money Laundering : 2025-07, 2025-12
    section Cyprus (H1 2026)
    SRMR3 Banking Reform : 2026-01, 2026-06
    Migration Framework : 2026-01, 2026-06
    US Tariff Response : 2026-03, 2026-06
```
...
```mermaid
graph LR
    subgraph Commission Priorities 2025-26
        A[Defence Integration]
        B[Digital Sovereignty]
        C[Competitiveness / Draghi]
        D[Green Deal 2.0 revised]
        E[Rule of Law / Enlargement]
        F[Social Economy]
    end
    
    subgraph Parliament Delivery
        A -->|✅ FULL| P1[EDIP, Defence Fund, Ukraine Loan]
        B -->|✅ FULL| P2[DMA enforcement, AI Act, Tech Sovereignty]
        C -->|✅ PARTIAL| P3[CSRD rollback, InvestEU, HGV delay]
        D -->|🔴 BLOCKED| P4[Sustainability reversals dominate]
        E -->|🔴 BLOCKED| P5[Hungary Art.7 stalled, SRMR3 partial]
        F -->|🟡 PARTIAL| P6[Housing resolution, EGF mobilisations]
    end
```
...
```mermaid
graph TD
    P1[EPP: 25.7% Hub] -->|controls| P2[Coalition selection]
    P3[Right bloc growth: PfE+ECR=166] -->|provides| P4[Blocking minority capacity]
    P5[Greens: historical low 7.4%] -->|signals| P6[Green policy resistance]
    P7[Fragmentation 6.55] -->|requires| P8[Multi-coalition every vote]
    
    P2 & P4 & P6 & P8 -->|produces| P9[Conservative-pivot legislative pattern]
```
...
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-07/year-in-review/executive-brief.md) | `executive-brief.md` |
