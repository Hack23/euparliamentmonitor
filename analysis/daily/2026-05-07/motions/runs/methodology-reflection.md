...
| SAT Technique | Application in This Run | Location |
|---------------|------------------------|----------|
| **Key Assumptions Check (KAC)** | Assumption that structural coalition analysis reflects actual voting behavior; assumption that EP speech positions align with group voting discipline | `intelligence/coalition-dynamics.md` §Assumptions |
| **Analysis of Competing Hypotheses (ACH)** | Three hypotheses on DMA enforcement trajectory (fast, slow, confrontational) | `intelligence/scenario-forecast.md` §H1-H3 |
| **Cone of Plausibility** | Six scenario pathways across 3 timeframes | `intelligence/scenario-forecast.md` |
| **Devil's Advocacy** | Counter-thesis on PfE institutional threat level (may be overstated) | `intelligence/wildcards-blackswans.md` §Adversarial review |
| **Indicators and Warnings (I&W)** | Monitoring triggers for each scenario pathway | `intelligence/scenario-forecast.md` §Indicators |
| **WEP (Words of Estimative Probability)** | Applied to all probability assessments in executive-brief and synthesis-summary | `executive-brief.md` §WEP, `intelligence/synthesis-summary.md` §WEP |
| **Admiralty Source Grading** | Applied to all data sources in executive-brief and synthesis-summary | `executive-brief.md` §Admiralty, `intelligence/synthesis-summary.md` §Admiralty |
