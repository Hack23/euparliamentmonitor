...
Clean Industrial Deal (Competitiveness Compass) representerar ett hanterat tillbakadragande från Green Deal:s regulatoriska ambitioner. Koldioxidgränsanpassningsmekanismer, stöd för dekarboniseringsindustrin och säkerhet för kritiska råmaterial definieras nu som ekonomiska konkurrenskraftsfrågor — inte miljöfrågor. Denna omramning, konstruerad av EPP, har säkrat ECR:s acquiescence och låst in en hållbar majoritet åtminstone till 2027.
