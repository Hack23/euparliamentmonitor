...
description: "The week of 6–13 May 2026 marks a pivotal inflection point in EP10's legislative trajectory. The committee system is simultaneously managing the largest ever EU defence…"
keywords: ["EU Parliament", "committee activity", "European Parliament", "committee report", "legislation", "Committee Reports", "2026-05-13", "run committee-reports-run249-1778650040", "Parliament", "Committee", "Activity", "week", "marks", "pivotal", "inflection", "point"]
date: 2026-05-13
...
```mermaid
graph LR
    EC[European Commission] -->|Proposal| EP[EP Committees]
    EP -->|Mandate| TRIL[Trilogue]
    COUNCIL[Council/Presidency] -->|GA| TRIL
    TRIL -->|Agreed text| PLENARY[EP Plenary Vote]
    
    EPP[EPP 183] -->|Controls chairs| EP
    SD[S&D 136] -->|Key shadows| EP
    RENEW[Renew 77] -->|Swing vote| EP
    GREENS[Greens/EFA 53] -->|Block| EP
    
    BusinessEU[Business Europe] -->|Lobby| EPP
    BusinessEU -->|Lobby| RENEW
    EEB[EEB/CAN-E] -->|Lobby| SD
    EEB -->|Lobby| GREENS
    
    ECB[ECB] -->|Institutional interest| COUNCIL
    HU[Hungary+Poland] -->|Blocking minority| COUNCIL
```
