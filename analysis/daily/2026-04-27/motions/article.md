...
|-------|-------|---|----------------|
| EPP | 185 | 25.7% | Lead coalition anchor |
| S&D | 135 | 18.8% | Centre-left anchor |
| PfE | 85 | 11.8% | Conditional support / opposition |
| ECR | 81 | 11.3% | Right-nationalist opposition |
| Renew | 77 | 10.7% | Liberal centre, swing vote |
| Greens/EFA | 53 | 7.4% | Progressive opposition/swing |
| The Left | 46 | 6.4% | Hard-left opposition |
| NI | 30 | 4.2% | Non-attached, fragmented |
| ESN | 27 | 3.8% | Hard-right, systematic opposition |
...
```mermaid
graph LR
    GEO[Geopolitical urgency\nRussia + US tariffs]
    DEF[Defence motions\n→ EU autonomy]
    UKR[Ukraine motions\n→ continuity]
    TRD[Trade motions\n→ US response]
    DIG[AI motions\n→ regulatory posture]
    BANK[Banking motions\n→ union completion]
    POL[Political stability\nEPP+S&D+Renew intact]

    GEO -->|drives urgency| DEF
    GEO -->|sustains| UKR
    GEO -->|creates mandate| TRD
    POL -->|enables passage| DEF
    POL -->|enables passage| DIG
    POL -->|enables passage| BANK
```
...
```mermaid
graph TD
    subgraph EP Leadership
        RAD[Roberta Metsola\nPresident EPP/Malta]
        VK[Valerie Hayer\nRenew Group Chair]
        IDP[Iratxe Garcia Perez\nS&D Group Chair]
        MT[Manfred Weber\nEPP Group Chair]
        OL[Nicolas Bay\nPfE Group Co-Chair]
    end

    subgraph Key Rapporteurs/Floor Leaders
        DM[David McAllister\nEPP — AFET/Defence]
        NH[Nathalie Loiseau\nRenew — SEDE]
        SW[Sven Simon\nEPP — INTA]
        PB[Pedro Marques\nS&D — ECON]
    ...
    subgraph National Delegation Anchors
        CDU[CDU/CSU delegation\nGermany EPP — 29 seats]
        SPD[SPD delegation\nGermany S&D — 14 seats]
        FN[RN delegation\nFrance PfE — 30 seats]
        PN[PO delegation\nPoland EPP — 22 seats]
    end
...
graph LR
    subgraph External Actors
        US[US Administration\nTariff pressure / NATO]
        UA[Ukraine Government\nZelensky lobbying]
        COM[European Commission\nUrsula von der Leyen]
        IND[EU Defence Industry\nLeonardo / KNDS / Rheinmetall]
        NGO[Civil Society NGOs\nTransparency / Human rights]
    end

    subgraph EP Decision Points
        VOTE[Plenary Vote\nMajority required]
    end

    US -->|Tariff pressure → trade motions| VOTE
    UA -->|Diplomatic pressure → Ukraine motions| VOTE
    COM -->|Legislative proposals + political briefings| VOTE
    IND -->|Lobbying EPP/ECR → defence motions| VOTE
    NGO -->|Greens/Left pressure → accountability clauses| VOTE
```
...
graph LR
    subgraph Driving Forces
        GEO[Geopolitical pressure\nRussia war / US tariffs]
        INS[Institutional momentum\n104 texts in Q1 2026]
        DIG[Digital transformation\nAI Act implementation]
        DEF[Defence emergency\nNATO 2% gap]
        ECO[Economic resilience\nCompetitiveness agenda]
    end

    subgraph EP Coalition Anchors
        EPP[EPP 185 seats\nMarket + defence]
        SD[S&D 135 seats\nSocial + Ukraine]
        REN[Renew 77 seats\nLiberal + digital]
    end
...
graph RL
    subgraph Restraining Forces
        SOV[Sovereignty concerns\nPfE + ECR + ESN]
        AUS[Fiscal austerity\nGerman/Dutch net contributors]
        PAC[Peace movement\nLeft + Greens on defence]
        CAP[Institutional capacity\nNational admin overload]
        LEG[Legal uncertainty\nTreaty base disputes]
    end
...
```mermaid
quadrantChart
    title Impact Matrix: EU Parliament April 2026 Motions
    ...
    quadrant-4 "Procedural/technical"
    Defence motions: [0.75, 0.80]
    Trade tariffs: [0.65, 0.72]
    Ukraine support: [0.60, 0.78]
    AI Digital Omnibus: [0.45, 0.65]
    Banking union: [0.40, 0.70]
    Anti-corruption: [0.55, 0.60]
    Human rights urgency: [0.50, 0.55]
```
...
```mermaid
graph TD
    DEF[Defence Motions\n+++ EU Defence Industry\n+++ Eastern EU States\n-- Fiscal Burden\n- US Contractors] -->|Coalition 390-420| PASS1[LIKELY PASS]
    TRADE[Trade Motions\n++ EU Exporters\n+ DG Trade Mandate\n- US Importers] -->|Coalition 370-400| PASS2[PROBABLE PASS]
    UKR[Ukraine Motions\n+++ Ukraine\n+++ Baltic States\n-- PfE/ESN blocks] -->|Coalition 440-470| PASS3[HIGHLY LIKELY PASS]
    AI[AI/Digital Motions\n++ EU AI Startups\n+ Big Tech\n- Regulators] -->|Coalition 400-430| PASS4[LIKELY PASS]
    BANK[Banking Union\n++ Depositors\n+++ Systemic Banks\n- Small Banks] -->|Coalition 380-410| PASS5[LIKELY PASS]
```
...
```mermaid
graph TD
    subgraph Primary Stakeholders Formal
        EP_PRES[EP President\nMetsola]
        EP_GROUPS[9 Political Groups\n719 MEPs]
        COM[European Commission\nvon der Leyen]
        COUNCIL[Council of the EU\nRotating Presidency]
    end

    subgraph Primary Stakeholders Informal
        INDUSTRY[EU Defence/Tech Industry\nLeonardo/Rheinmetall/Airbus]
        CIVIL[Civil Society\nNGOs/Transparency]
        MEDIA[European Media\nEUobserver/Politico Europe]
    end

    subgraph Affected Populations
        CITIZENS[502M EU Citizens\nUltimate beneficiaries]
        UA_POP[43M Ukrainians\nUkraine motions direct impact]
        FIRMS[EU SMEs/Exporters\nTrade + AI motions]
    end
...
quadrantChart
    ...
    quadrant-2 "Key partners"
    quadrant-3 "Monitor"
    quadrant-4 "Keep informed"
    EU Commission: [0.80, 0.85]
    Defence Industry: [0.75, 0.70]
    Banking Sector: [0.65, 0.65]
    Ukraine Government: [0.80, 0.50]
    Political Groups: [0.95, 0.95]
    EU Citizens: [0.55, 0.30]
    Civil Society: [0.60, 0.40]
    Tech Industry: [0.70, 0.65]
    Media: [0.50, 0.55]
```
...
```mermaid
flowchart TD
    EP[EP Motions\nApril 2026] --> DEF[Defence Industry\nHigh positive]
    EP --> FIN[Financial Sector\nMixed - banking union costs]
    EP --> TECH[Tech Sector\nPositive - AI simplification]
    EP --> UKR[Ukraine\nPositive - continued support]
    EP --> CIT[EU Citizens\nMedium-term positive]
    EP --> CS[Civil Society\nPositive - transparency]
    DEF --> SME[EU Defence SMEs\nHigh positive]
    DEF --> NATO[NATO Partners\nNeutral-positive]
    FIN --> BANK[Large Banks\nPositive - resolution clarity]
    FIN --> SBANK[Small Banks\nNegative - compliance cost]
    TECH --> BTECH[Big Tech US\nMixed - short-term relief]
    TECH --> ETECH[EU AI Startups\nPositive - investment]
```
...
quadrantChart
    ...
    quadrant-2 "Critical — mitigation required"
    quadrant-3 "Accept/monitor"
    quadrant-4 "Contingency plan"
    R-01 ECR split: [0.35, 0.70]
    R-02 PfE blocking: [0.30, 0.45]
    R-03 US tariffs: [0.20, 0.75]
    R-04 Data delay: [0.90, 0.30]
    R-05 AI amendments: [0.40, 0.45]
    R-06 German brake: [0.35, 0.50]
    R-07 Ukraine ceasefire: [0.10, 0.90]
    R-08 Disruption: [0.05, 0.70]
```
...
graph TD
    subgraph Capital Sources
        ...
        MARG[Large margins\n= mandate legitimacy]
        CROSS[Cross-party deals\n= alliance credibility]
    end

    subgraph Capital Drains
        FAIL[Text failures\n= credibility cost]
        SPLIT[Internal splits\n= group weakness signal]
        PROC[Procedural defeats\n= agenda control loss]
    end

    subgraph Current Holders
        EPP2[EPP Weber\nCapital: HIGH]
        SD2[S&D Garcia Perez\nCapital: MEDIUM-HIGH]
        REN2[Renew Hayer\nCapital: MEDIUM]
        ECR2[ECR Chair\nCapital: MEDIUM]
        PFE2[PfE Bay/Orbán\nCapital: MEDIUM - oppositional accumulation]
    end
...
```mermaid
gantt
    title April 2026 EP Plenary Velocity Model (Apr 27–30)
    dateFormat YYYY-MM-DD
    section High Priority
    Defence motions (SAFE/EDIP)     :2026-04-27, 1d
    Ukraine support continuity       :2026-04-28, 1d
    Trade/tariff resolutions         :2026-04-28, 1d
    section Medium Priority
    AI Digital Omnibus               :2026-04-29, 1d
    Banking Union (SRMR3)            :2026-04-29, 1d
    Anti-corruption (Rule of Law)    :2026-04-29, 1d
    section Lower Priority
    Urgency resolutions (3x likely)  :2026-04-30, 1d
    Human rights cases               :2026-04-30, 1d
```
...
graph LR
    subgraph Threats
        PFE_PROC[PfE procedural tactics\nThreat Level: MEDIUM]
        ECR_FRAC[ECR fragmentation\nThreat Level: MEDIUM]
        SD_LEFT[S&D left-flank pressure\nThreat Level: LOW-MEDIUM]
        PRES_PROC[Presidency procedural challenges\nThreat Level: LOW]
    end

    subgraph Affected Motions
        DEF_M[Defence/EDIP]
        AI_M[AI Omnibus]
        UKR_M[Ukraine Support]
        BANK_M[Banking Union]
        TRADE_M[Trade/Tariffs]
    end
...
```mermaid
graph TD
    subgraph Tier 1 Existential Threats
        T1A[Majority coalition collapse\nProbability: <5%]
        T1B[Constitutional/Treaty challenge\nProbability: <2%]
    end

    subgraph Tier 2 Material Threats
        T2A[ECR fragmentation reducing margins\nProbability: 35%]
        T2B[PfE procedural disruption\nProbability: 30-40%]
        T2C[External shock restructuring agenda\nProbability: 10-15%]
    end

    subgraph Tier 3 Nuisance Threats
        T3A[Rollcall/quorum tactics\nProbability: 40%]
        T3B[Amendment flood on AI/trade texts\nProbability: 40%]
        T3C[Media narrative disruption\nProbability: 25%]
    end

    T1A -.->|Would trigger| T2A
    T2A -->|Feeds into| T3A
    T2B -->|Produces| T3A
    T2C -->|Can escalate to| T1A
```
...
graph TD
    subgraph Primary Threats
        ...
        ESN_T[ESN 27 seats\nHard right bloc\nThreat Level: LOW-MEDIUM]
        ECR_S[ECR internal split\nSwing factor\nThreat Level: MEDIUM]
    end

    subgraph External Threats
        HUN[Hungary government\nOrbán veto threats\nThreat Level: HIGH in Council]
        US_T[US Administration\nTariff escalation\nThreat Level: MEDIUM]
    end

    subgraph Procedural Threats
        PROC_T[PfE procedural tactics\nRollcall/quorum/split votes\nThreat Level: MEDIUM]
        AMEND[Greens/Left amendments\nAI/Digital dilution risk\nThreat Level: LOW-MEDIUM]
    end
...
```mermaid
graph TD
    D_PASS[Defence Motions PASS\nwith large majority]
    D_PASS --> D1[1st Order: Commission\nDG DEFIS mandate confirmed]
    D_PASS --> D2[1st Order: EU defence\nbudget commitment +€10bn]
    D1 --> D3[2nd Order: Procurement\nrules trigger — EU-preference clause]
    D2 --> D4[2nd Order: US defence\ncontractors face EU market exclusion]
    D3 --> D5[3rd Order: EU defence\nindustrial base consolidation]
    D4 --> D6[3rd Order: NATO\ninteroperability tension]

    D_FAIL[Defence Motions FAIL\nor marginal majority]
    D_FAIL --> DF1[1st Order: Commission\nDG DEFIS mandate contested]
    D_FAIL --> DF2[1st Order: Political signal\nof EU defence division]
    DF1 --> DF3[2nd Order: Member states\nbilateral deals accelerate]
    DF2 --> DF4[3rd Order: EU defence\nautonomy agenda delayed 12-24 months]
```
...
```mermaid
graph TD
    T_PASS[Trade Resolution PASS]
    T_PASS --> T1[1st Order: DG Trade\nmandated to negotiate reciprocal access]
    T_PASS --> T2[1st Order: WTO\ncomplaint filing pathway opened]
    T1 --> T3[2nd Order: EU-US\ntrade negotiation format set]
    T2 --> T4[2nd Order: US faces\nretaliation threat]
    T3 --> T5[3rd Order: EU-US relations\nstabilize if trade deal achieved]
    T4 --> T6[3rd Order: Escalation cycle\nif US does not respond]
```
...
```mermaid
graph TD
    U_PASS[Ukraine Resolution PASS\n440-470 votes]
    U_PASS --> U1[1st Order: Zelensky\nmessaging amplified]
    U_PASS --> U2[1st Order: Hungarian\nblocking narrative countered]
    U1 --> U3[2nd Order: EU financial\nfacility disbursement track confirmed]
    U2 --> U4[2nd Order: Council\nQMV track preferred over unanimity]
    U3 --> U5[3rd Order: Ukraine\nresilience maintained]
    U4 --> U6[3rd Order: Hungary\nisolation in EU deepens]
```
...
graph TD
    ...
    PROC --> AM[Amendment flood\n→ voting extension]
    
    POL --> ECRC[ECR fracture\n→ majority recalculation]
    POL --> UC[Ukraine ceasefire\n→ emergency plenary]
...
| Scenario | Disruption Magnitude | Recovery Time | Probability | Net Risk |
|----------|---------------------|---------------|-------------|---------|
| D-1 Rollcall overload | Agenda slip, 1–2 hours | Same session | 30% | 🟡 Medium |
| D-2 ECR fracture | Text withdrawal risk | 1–4 weeks | 15% | 🟡 Medium |
| D-3 Ukraine emergency | Full agenda restructure | Same or next week | 10% | 🟡 Medium |
| D-4 US tariff shock | Text revision risk | Hours–1 day | 20% | 🟢 Low-Medium |
...
pie title Scenario Probability Distribution
    "Scenario 1 Strong Consensus (50%)" : 50
    "Scenario 2 Contested Majority (40%)" : 40
    "Scenario 3 Disrupted Session (10%)" : 10
```
...
quadrantChart
    ...
    quadrant-1 "Scenario planning required"
    quadrant-2 "Prepare for contingency"
    quadrant-3 "Monitor"
    quadrant-4 "Routine risk management"
    Ukraine ceasefire: [0.05, 0.95]
    US-EU trade war: [0.15, 0.80]
    EPP-S&D split: [0.03, 0.98]
    PfE majority reversal: [0.02, 0.99]
    Metsola resignation: [0.01, 0.75]
    Mass MEP absence: [0.05, 0.60]
    EP building incident: [0.02, 0.80]
    ECR dissolution: [0.04, 0.70]
```
...
| ANALYSIS_DIR | analysis/daily/2026-04-27/motions |
| Plenary session in scope | April 27–30, 2026 (Strasbourg) |
| Data window | 2026-04-20 to 2026-04-27 |
| Political groups (count) | 9 |
| Total MEP seats | 719 |
| Coalition majority threshold | 361 |
| Grand coalition (EPP+S&D+Renew) | 397 seats |
| Early warning stability score | 84/100 |
| Adopted texts Q1 2026 | 104 |

### Data Availability Baseline

| Data Type | Status | Notes |
|-----------|--------|-------|
| Roll-call votes (Apr 20–27) | 🔴 Empty | EP publishes with 4–6 week delay |
| Adopted texts feed (one-week) | 🟢 119 items | Full dataset |
| MEPs feed (one-week) | 🟢 Available | Large payload |
| Plenary sessions (year=2026) | 🟢 21 sessions | Complete |
| Political landscape | 🟢 Full data | 9 groups, 719 seats |
| Meeting decisions (Apr 27) | 🔴 404 | Session not yet closed |
| Foreseen activities (Apr 28) | 🟢 31 items | Titles blank in API |
| Foreseen activities (Apr 29) | 🟢 31 items | Titles blank in API |
| Procedures feed | 🟡 Recess mode | Historical archive only |
| Coalition cohesion metrics | 🔴 Null | Per-MEP voting data unavailable |

### Coalition Baseline (This Run)

| Group | Seats | Q1 2026 Activity |
|-------|-------|-----------------|
| EPP | 185 | Dominant — Competitiveness, Defence |
| S&D | 135 | Active — Ukraine, Banking |
| PfE | 85 | Oppositional |
| ECR | 81 | Swing — Defence/Ukraine support |
| Renew | 77 | Active — Digital, Trade |
| Greens/EFA | 53 | Conditionality — AI, Climate |
| Left | 46 | Conditionality — Social |
| NI | 30 | Fragmented |
| ESN | 27 | Oppositional |
...
Every artifact below was read by the aggregator and contributed to this article. The raw [manifest.json](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/manifest.json) carries the full machine-readable list, including gate-result history.

| Section | Artifact | Path |
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/executive-brief.md) | `executive-brief.md` |
| section-synthesis | [synthesis-summary](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/intelligence/synthesis-summary.md) | `intelligence/synthesis-summary.md` |
| section-actors-forces | [actor-mapping](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/classification/actor-mapping.md) | `classification/actor-mapping.md` |
| section-actors-forces | [forces-analysis](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/classification/forces-analysis.md) | `classification/forces-analysis.md` |
| section-actors-forces | [impact-matrix](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/classification/impact-matrix.md) | `classification/impact-matrix.md` |
| section-stakeholder-map | [stakeholder-map](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/intelligence/stakeholder-map.md) | `intelligence/stakeholder-map.md` |
| section-stakeholder-map | [stakeholder-impact](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/existing/stakeholder-impact.md) | `existing/stakeholder-impact.md` |
| section-risk | [risk-matrix](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/risk-scoring/risk-matrix.md) | `risk-scoring/risk-matrix.md` |
| section-risk | [political-capital-risk](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/risk-scoring/political-capital-risk.md) | `risk-scoring/political-capital-risk.md` |
| section-risk | [legislative-velocity-risk](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/risk-scoring/legislative-velocity-risk.md) | `risk-scoring/legislative-velocity-risk.md` |
| section-threat | [political-threat-landscape](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/intelligence/political-threat-landscape.md) | `intelligence/political-threat-landscape.md` |
| section-threat | [threat-model](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/intelligence/threat-model.md) | `intelligence/threat-model.md` |
| section-threat | [actor-threat-profiles](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/threat-assessment/actor-threat-profiles.md) | `threat-assessment/actor-threat-profiles.md` |
| section-threat | [consequence-trees](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/threat-assessment/consequence-trees.md) | `threat-assessment/consequence-trees.md` |
| section-threat | [legislative-disruption](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/threat-assessment/legislative-disruption.md) | `threat-assessment/legislative-disruption.md` |
| section-scenarios | [scenario-forecast](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/intelligence/scenario-forecast.md) | `intelligence/scenario-forecast.md` |
| section-scenarios | [wildcards-blackswans](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-27/motions/intelligence/wildcards-blackswans.md) | `intelligence/wildcards-blackswans.md` |
