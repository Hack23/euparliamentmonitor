...
keywords: ["EU Parliament", "legislative procedures", "European Parliament", "proposal", "regulation", "Propositions", "2026-05-20", "run propositions-run263-1779258514", "Legislative", "European", "Parliament", "April", "Strasbourg", "plenary", "produced", "eight"]
date: 2026-05-20
...
mindmap
    root((EP Propositions\nApril 2026))
        DMA Enforcement
            WEP: HIGH
            Impact: VERY HIGH
            Timeline: June 2026 action
        Armenia Candidacy
            WEP: HIGH
            Impact: HIGH
            Treaty: Association path
        2027 Budget
            WEP: HIGH
            Impact: VERY HIGH
            IMF: 1.3% growth context
        SAFE Regulation
            WEP: MEDIUM-HIGH
            Impact: HIGH
            Defence: €800bn gap
...
```mermaid
pie title Significance Classification Distribution (April 2026)
    "LEGISLATIVE_MAJOR" : 3
    "LEGISLATIVE_MINOR" : 2
    "SYMBOLIC" : 3
    "ADMINISTRATIVE" : 0
...
```mermaid
graph LR
    EP["European Parliament\n(Grand Center 401)"] --> DMA["DMA Enforcement\nDemand"]
    EP --> ARM["Armenia Candidacy\nSupport"]
    COM["Commission\n(enforcement)"] --> BIGTECH["Big Tech\nGatekeepers"]
    COM --> ARM
    EPP["EPP 188"] --> EP
    SD["S&D 136"] --> EP
    RENEW["Renew 77"] --> EP
    COUNCIL["Council of EU\n(unanimity)"] -.->|"blocks on NLE"| ARM
```
...
```mermaid
xychart-beta
    title "Net Force Pressure Score"
    x-axis ["Digital Sovereignty", "Enlargement", "Defence", "Welfare", "Budget"]
    y-axis "Net Score (Driving minus Restraining)" 0 --> 10
    bar [8, 6, 7, 6, 7]
```
...
```mermaid
graph LR
    DMA["DMA Enforcement\n(TA-0160)"] --> CLEANIND["Clean Industrial Deal\n(signals: enforcement > growth)"]
    DMA --> OMNIBUS["Omnibus Simplification\n(counterpressure)"]
    ARMENIA["Armenia Candidacy\n(TA-0162)"] --> ENLARGED["EU Enlargement Pipeline\n(Western Balkans + Moldova)"]
    UKRAINE["Ukraine Accountability\n(TA-0161)"] --> TRIBUNAL["Special Tribunal\nDiplomacy"]
    BUDGET["2027 Budget\n(TA-0112)"] --> MFF["MFF 2028-2034\nNegotiation Anchor"]
    BUDGET --> SAFE["SAFE Regulation\nDefence Funding"]
```
...
```mermaid
graph TD
    EPP["EPP 188"] --> MAJORITY["361 Majority Threshold"]
    SD["S&D 136"] --> MAJORITY
    RENEW["Renew 77"] --> MAJORITY
    ECR["ECR 78 — selective"] -.-> MAJORITY
    GREENS["Greens 53 — selective"] -.-> MAJORITY
    MAJORITY --> DMA["DMA Enforcement ✅"]
    MAJORITY --> ARMENIA["Armenia Candidacy ✅"]
    MAJORITY --> BUDGET["2027 Budget Guidelines ✅"]
```
...
```mermaid
xychart-beta
    title "EU Key Economic Indicators 2024-2026 (IMF WEO April 2026)"
...
```mermaid
quadrantChart
    title SWOT Quadrant: Impact vs. Feasibility
    x-axis Low Feasibility --> High Feasibility
    y-axis Low Impact --> High Impact
    quadrant-1 Strategic priorities
    quadrant-2 Challenging but impactful
    quadrant-3 Low priority
    quadrant-4 Quick wins
    "DMA Enforcement" : [0.75, 0.9]
    "Armenia Candidacy" : [0.6, 0.7]
    "Clean Industrial Deal" : [0.55, 0.85]
    "Omnibus Simplification" : [0.8, 0.65]
    "2027 Budget Expansion" : [0.5, 0.7]
    "SAFE Regulation" : [0.65, 0.75]
```
...
mindmap
    root((Threat Model\nEP Propositions 2026))
        ...
        Internal Threats
            EP Coalition Fragility
                ECR selective defection
                Renew fiscal split
            Commission Enforcement Delay
                DMA non-implementation
...
```mermaid
xychart-beta
    title "Scenario Probability Evolution (Q2-Q4 2026)"
    x-axis ["May 2026", "July 2026", "Oct 2026", "Dec 2026"]
...
```mermaid
xychart-beta
    title "EP9 vs EP10 Legislative Activity Comparison"
    x-axis ["COD files/year", "NLE resolutions/year", "Avg vote margin (%)", "Committee amendments/file"]
    y-axis "Index (EP9=100)" 0 --> 150
    bar [100, 100, 100, 100]
    line [85, 130, 95, 110]
```
