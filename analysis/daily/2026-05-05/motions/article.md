...
description: "Two immunity waivers against Polish MEPs within five weeks represents an acceleration of the pattern established in EP10. It signals that: (1) Poland's judicial authority is…"
keywords: ["EU Parliament Monitor", "European Parliament", "European Commission", "political intelligence", "Riksdagsmonitor", "Riksdag", "Regeringen", "EU Parliament", "plenary votes", "resolutions", "voting record", "Motions", "2026-05-05", "Strategic", "significance", "immunity"]
date: 2026-05-05
...
```mermaid
pie title Session Significance Distribution
    "Tier 1 - Critical" : 2
    "Tier 2 - High" : 2
    "Tier 3 - Medium" : 2
    "Tier 4 - Routine" : 1
...
```mermaid
graph TD
    EPP[EPP 185\nGoverning Anchor] --> VM[Von der Leyen\nCommission]
    SD[S&D 135\nGoverning Partner] --> EPP
    RENEW[Renew 77\nGoverning Partner] --> EPP
    GREENS[Greens 53\nSupporting] --> EPP
    LEFT[Left 46\nSelective] --> EPP
    ECR[ECR 81\nVariable] -->|Budget/Ukraine| EPP
    PFE[PfE 85\nOpposition] -->|Opposition| EPP
    ESN[ESN 27\nOpposition] -->|Opposition| EPP
    NI[NI 30\nUnpredictable] -.->|Varies| EPP
    JAKI[Jaki MEP\nECR/PiS] -->|Immunity case| ECR
    BRAUN[Braun MEP\nECR/United Right] -->|Immunity case| ECR
```
...
```mermaid
graph LR
    A[Driving Forces] --> B{Policy\nEquilibrium}
    C[Restraining Forces] --> B
    A --> D[Rule-of-Law\nenforcement]
    A --> E[DMA digital\nsovereignty]
    A --> F[Ukraine\nsolidarity]
    A --> G[Humanitarian\nconsensus]
...
```mermaid
quadrantChart
    title Impact vs. Probability Matrix
    x-axis Low Probability --> High Probability
    y-axis Low Impact --> High Impact
    quadrant-1 Monitor Closely
    quadrant-2 Key Strategic Events
    quadrant-3 Low Priority
    quadrant-4 Routine Management
    Jaki Immunity: [0.95, 0.75]
    Braun Context: [0.90, 0.65]
    DMA Enforcement: [0.92, 0.70]
    Ukraine Accountability: [0.93, 0.72]
    Armenia Partnership: [0.90, 0.45]
    Haiti Urgency: [0.97, 0.35]
    Budget Guidelines: [0.88, 0.60]
```
...
graph LR
    ...
    SD --- Renew[Renew 77]
    EPP --- Renew
    EPP -.->|sometimes| ECR[ECR 81]
    EPP -.->|sometimes| Greens[Greens 53]
    ECR -.->|sometimes| PfE[PfE 85]
    Total["Majority: 361/719"]
...
```mermaid
xychart-beta
    title "Estimated Vote Margins by Motion (April 2026)"
    x-axis ["Jaki Waiver", "Braun Waiver", "DMA Enforcement", "Ukraine Accountability", "Armenia Resilience", "Haiti Urgency", "Budget Guidelines"]
    y-axis "Estimated Votes in Favour" 0 --> 700
    bar [440, 420, 400, 505, 475, 620, 410]
    line [361, 361, 361, 361, 361, 361, 361]
```
...
mindmap
  root((April 2026\nEP Session))
    EP Institutions
      ...
      S&D Group Garcia
      Renew Group Hayer
      Greens Group Reintke
      ECR Group Procaccini
      PfE Group Bardella
      JURI Committee
      IMCO Committee
      AFET Committee
    ...
    Subject MEPs
      Michał Jaki ECR/PiS
      Grzegorz Braun ECR/United Right
    National Actors
      Donald Tusk Poland PM
      Polish Prosecutors ABW
      Meloni Italy PM FdI
      Orbán Hungary FM Fidesz
    Tech Platforms
      Alphabet Google
      Apple
      Meta
...
```mermaid
flowchart LR
    A[EU Budget 2027\n~€189bn commitments] --> B[Cohesion 38%]
    A --> C[Agriculture 29%]
    A --> D[Research 6%]
    A --> E[Digital/Climate 12%]
    F[ReArm Europe] -.->|off-budget €150bn loans| A
    G[Ukraine Facility\n€50bn 2024-2027] -.->|external instrument| A
```
...
quadrantChart
    ...
    Coalition Majority: [0.85, 0.80]
    Rule-of-Law Posture: [0.80, 0.75]
    Ukraine Momentum: [0.90, 0.85]
    IMF Data Gap: [0.20, 0.70]
    ECR Cohesion Risk: [0.25, 0.65]
    Roll-call Lag: [0.15, 0.60]
    DMA Sovereignty: [0.85, 0.30]
    Armenia EU Path: [0.75, 0.25]
    Far-right Narrative: [0.20, 0.25]
    US Trade Tension: [0.15, 0.35]
```
...
```mermaid
graph TD
  R1[Polish Immunity Escalation\nLikelihood: High\nImpact: Medium] --> M1[Monitor JURI committee]
  R2[DMA Enforcement Failure\nLikelihood: Medium\nImpact: High] --> M2[Track Commission decisions]
  R3[Coalition Fragmentation\nLikelihood: Low\nImpact: Very High] --> M3[Monitor EPP-SD-Renew alignment]
  R4[Ukraine Framework Delay\nLikelihood: Medium\nImpact: Medium] --> M4[BUDG committee tracking]
```
...
```mermaid
flowchart TD
    A[Political Threats] --> B[Institutional Capture]
    A --> C[Coalition Fracture]
    A --> D[Procedural Obstruction]
    A --> E[External Pressure]
    A --> F[Disinformation]
    A --> G[Legitimacy Erosion]
    B --> H[Committee obstruction]
    C --> I[EPP DMA split]
    C --> J[ECR Ukraine divide]
    D --> K[Quorum challenges]
    E --> L[US trade pressure]
    E --> M[Azerbaijani lobbying]
    F --> N[Persecution narrative]
    G --> O[Non-binding fatigue]
```
...
graph LR
  ...
  subgraph External Threats
    T7[Russian interference\nnarratives]
    T8[US tech lobbying\nagainst DMA]
    T9[Economic pressure\non EU states]
  end
  T1 --> |amplifies| T3
  T2 --> |feeds| T1
  T7 --> |exploits| T3
...
```mermaid
graph TD
    A[April Session Outcomes] --> B[Scenario 1: Baseline\nGoverning Coalition Stable]
    A --> C[Scenario 2: ECR Splits\nPolish Right Fractured]
    A --> D[Scenario 3: PfE–ECR Fusion\nFar-Right Consolidation]
    A --> E[Scenario 4: Ukraine Fatigue\nConsensus Erodes]
    B --> F[65% probability]
    C --> G[15% probability]
    D --> H[10% probability]
    E --> I[10% probability]
...
```mermaid
graph TD
    A[Base Scenario] --> B{Wildcard Events}
    B --> C[WC-1: Geopolitical Shock\nRussian escalation]
    B --> D[WC-2: EU Legal Crisis\nCourt ruling against EP immunity decision]
    B --> E[WC-3: Scandal Cascade\nAdditional Polish MEP corruption]
    B --> F[WC-4: Tech Platform Retaliation\nDMA enforcement counter-attack]
    B --> G[BS-1: Black Swan\nEP Group Realignment]
    C --> H[Probability: 8%]
    D --> I[Probability: 6%]
    E --> J[Probability: 12%]
    F --> K[Probability: 7%]
...
mindmap
  root((PESTLE\nApril 2026))
    Political
      Poland normalisation
      EP10 coalition
      Far-right ceiling
      US-EU friction
    Economic
      DMA gatekeeper revenues
      Ukraine Facility €50bn
      Budget 2027 €189bn
      Defence off-budget
    Social
    ...
    Legal
      Protocol 7 immunity
      DMA Article 26 sanctions
      ICC arrest warrants
      EU CRA cyber resilience
    Environmental
      Green Deal budget pressure
      Just transition spending
      Climate diplomacy linkages
```
...
```mermaid
timeline
    title EP Immunity and Rule-of-Law Timeline
    2019 : EP9 begins
         : Fidesz suspended from EPP
    2020 : Article 7 Poland/Hungary
    2021 : Rule of Law Conditionality Regulation
    2022 : Russian invasion of Ukraine
         : EP adopts first Ukraine solidarity resolution
    2023 : Polish election - Tusk wins
         : Braun extinguisher incident
    2024 : EP10 elections
         : DMA enforcement begins
         : Jaki immunity request filed
    2025 : Ukraine Special Tribunal debate
    2026 : Jaki+Braun waivers approved
         : DMA enforcement resolution
```
...
```mermaid
graph TD
    A[April 2026 Session] --> B[March 2026\nBraun Waiver]
    A --> C[February 2026\nDMA First Signal]
    A --> D[January 2026\nUkraine Aid Package]
    B --> E[Pattern: Polish ECR\nunder systematic pressure]
    C --> F[Pattern: DMA enforcement\nbuilding consensus]
    D --> G[Pattern: Ukraine majority\nstable above 500]
    E --> H[Intelligence Signal:\nECR Polish delegation\ncohesion declining]
    F --> I[Intelligence Signal:\nEPP-Renew-S&D coalition\non digital regulation]
    G --> J[Intelligence Signal:\nUkraine remains\nsupermajority issue]
```
...
| section-quality-reflection | [methodology-reflection](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-05-05/motions/methodology-reflection.md) | `methodology-reflection.md` |
