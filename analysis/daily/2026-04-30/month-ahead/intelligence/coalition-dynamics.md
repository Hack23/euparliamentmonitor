...
# Coalition Dynamics — EU Parliament: April-May 2026

**Framework:** CIA Coalition Analysis Methodology (CAM) — Cohesion + Bridging + Defection  
**Data source:** EP MCP analyze_coalition_dynamics, early_warning_system, generate_political_landscape  
**NOTE:** Vote-level cohesion data is UNAVAILABLE from EP Open Data Portal (known gap). This analysis uses seat-share proxy methods and historical coalition pattern analysis.
