...
description: "Reference: TA-10-2026-0112 | Procedure: 2025/2246(BUI) | dateAdopted: 2026-04-28 Published 2026-04-30 · analysis run breaking-run-1777532537, with source-linked voting…"
...
source_folder: analysis/daily/2026-04-30/breaking
...
```mermaid
graph TD
    A[April 28-30 EP Plenary Outputs] --> B[CRITICAL Tier]
    A --> C[HIGH Tier]
    A --> D[MEDIUM Tier]
    A --> E[LOW Tier]
    B --> B1[MFF 2028-2034 Interim Report - Score 8.2]
    C --> C1[2027 Budget Guidelines - Score 7.6]
    C --> C2[Dog/Cat Welfare Regulation - Score 6.6]
    C --> C3[Rule of Law 2025 Debate - Score 6.6]
    C --> C4[EU-Iceland PNR Agreement - Score 6.4]
    C --> C5[Armenia Democratic Resilience Debate - Score 6.0]
    D --> D1[Jaki Immunity Waiver - Score 5.0]
    E --> E1[EIB Annual Report - Score 4.2]
    E --> E2[Performance-based Instruments Transparency]
```
