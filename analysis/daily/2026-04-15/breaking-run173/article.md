...
source_folder: analysis/daily/2026-04-15/breaking-run173
...
Run 173 marks **Tariff T-0 — the activation of TA-10-2026-0096** as the EU's first autonomous trade-defence action under the current US-EU geopolitical framework. The 21-day compliance window from the 26 March plenary adoption has now expired and the legal instrument is operative. The post-recess convergence frame anchors three streams: (i) the legal-operational activation; (ii) Commission readiness to deploy the instrument; (iii) the pre-plenary political signalling cycle ahead of 27 April. *Confidence: MEDIUM-HIGH; Admiralty: B2.*

### Three Decisions

1. **Document 15 April as Tariff T-0 — the EU's first autonomous trade-defence operational date.** This date is the institutional-memory anchor for the entire 2026 trade-defence cycle. Every subsequent EU-US trade interaction will be benchmarked against this activation. *Confidence: HIGH.*
2. **Stage Commission deployment readiness as the binary readiness question for the next 14 days.** TA-0096 is now operative but unused; Commission's first deployment decision (or non-decision) is the strategic signal. *Confidence: HIGH.*
3. **Frame 15 April as post-recess convergence: legal activation + Commission readiness + pre-plenary politics converge on a single date.** Three streams aligned creates a non-trivial signalling event. *Confidence: MEDIUM-HIGH.*

### 60-Second Read

Tariff T-0 is the **operational pivot point** of EP10's 2026 trade-defence cycle. The 21-day compliance window from 26 March (adoption) to 15 April (activation) is the EU's standard legal-operationalisation interval. The fact that the EU now has an autonomous trade-defence instrument operating in legal force — without the need for new authorisation — fundamentally changes the EU-US trade-tit-for-tat dynamic.

### Risk Snapshot

| Risk | Likelihood | Impact |
|---|---:|---:|
| Commission first deployment within 14 days of T-0 | MED | HIGH |
| US response escalation following any Commission deployment | MED–HIGH | HIGH |
| TA-0096 left unused through plenary return | MED | MED |

### Source Quality

- 21-day compliance window calculation: **A1** (statutory)
- TA-10-2026-0096 activation status: **A1**
- Commission readiness assessment: **C3**

### Provenance

- Run: `breaking-run173` (2026-04-15, T-0)
- Compliance: EP Open Data Portal + statutory window only. GDPR-compliant.

---
*Analytical neutrality: activation reading anchored on statutory dates.*
...
graph LR
    subgraph "TA-10-2026-0096 Classification"
        A["🏛️ Policy: Trade/External"] --> B["📜 Type: Regulation"]
        B --> C["⚖️ Alignment: 5.5/10<br/>Centre-broad coalition"]
        C --> D["🇪🇺 Integration: 8/10<br/>Strong EU-level action"]
        D --> E["⏰ Urgency: 5/5<br/>CRITICAL — T-0 today"]
        E --> F["🏗️ Institutional: 5/5<br/>Precedent-setting"]
        F --> G["👥 Salience: 4/5<br/>High public visibility"]
    end
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","primaryBorderColor":"#0A3F7F","lineColor":"#90CAF9","secondaryColor":"#2E7D32","secondaryTextColor":"#ffffff","secondaryBorderColor":"#0F3F00","tertiaryColor":"#FF9800","tertiaryTextColor":"#000000","tertiaryBorderColor":"#7F4F00","mainBkg":"#1565C0","secondBkg":"#2E7D32","tertiaryBkg":"#FF9800","noteBkgColor":"#FFC107","noteTextColor":"#000000","noteBorderColor":"#7F6000","errorBkgColor":"#D32F2F","errorTextColor":"#ffffff","fontFamily":"Inter, Helvetica, Arial, sans-serif","pie1":"#1565C0","pie2":"#2E7D32","pie3":"#FF9800","pie4":"#D32F2F","pie5":"#FFC107","pie6":"#7B1FA2","pie7":"#9E9E9E","pie8":"#0288D1","pie9":"#388E3C","pie10":"#F57C00","pie11":"#C62828","pie12":"#FBC02D","pieTitleTextSize":"18px","pieSectionTextSize":"14px","pieLegendTextSize":"13px","pieStrokeColor":"#1e1e1e","pieOuterStrokeColor":"#1e1e1e","git0":"#1565C0","git1":"#2E7D32","git2":"#FF9800","git3":"#D32F2F","gitBranchLabel0":"#ffffff","gitBranchLabel1":"#ffffff","gitBranchLabel2":"#000000","gitBranchLabel3":"#ffffff","cScale0":"#1565C0","cScale1":"#2E7D32","cScale2":"#FF9800","cScale3":"#D32F2F","cScale4":"#FFC107","cScale5":"#7B1FA2","cScale6":"#9E9E9E","cScale7":"#0288D1","xyChart":{"backgroundColor":"#1e1e1e","plotColorPalette":"#1565C0,#2E7D32,#FF9800,#D32F2F,#FFC107,#7B1FA2,#9E9E9E"}}}}%%
pie title "Documents by Policy Domain"
    "Trade/External" : 2
    "Economic/Finance" : 3
    "Justice/Rule of Law" : 1
    "Digital/Industrial" : 1
    "Environment" : 1
    "Development" : 1
    "Institutional" : 1
```
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","primaryBorderColor":"#0A3F7F","lineColor":"#90CAF9","secondaryColor":"#2E7D32","secondaryTextColor":"#ffffff","secondaryBorderColor":"#0F3F00","tertiaryColor":"#FF9800","tertiaryTextColor":"#000000","tertiaryBorderColor":"#7F4F00","mainBkg":"#1565C0","secondBkg":"#2E7D32","tertiaryBkg":"#FF9800","noteBkgColor":"#FFC107","noteTextColor":"#000000","noteBorderColor":"#7F6000","errorBkgColor":"#D32F2F","errorTextColor":"#ffffff","fontFamily":"Inter, Helvetica, Arial, sans-serif","pie1":"#1565C0","pie2":"#2E7D32","pie3":"#FF9800","pie4":"#D32F2F","pie5":"#FFC107","pie6":"#7B1FA2","pie7":"#9E9E9E","pie8":"#0288D1","pie9":"#388E3C","pie10":"#F57C00","pie11":"#C62828","pie12":"#FBC02D","pieTitleTextSize":"18px","pieSectionTextSize":"14px","pieLegendTextSize":"13px","pieStrokeColor":"#1e1e1e","pieOuterStrokeColor":"#1e1e1e","git0":"#1565C0","git1":"#2E7D32","git2":"#FF9800","git3":"#D32F2F","gitBranchLabel0":"#ffffff","gitBranchLabel1":"#ffffff","gitBranchLabel2":"#000000","gitBranchLabel3":"#ffffff","cScale0":"#1565C0","cScale1":"#2E7D32","cScale2":"#FF9800","cScale3":"#D32F2F","cScale4":"#FFC107","cScale5":"#7B1FA2","cScale6":"#9E9E9E","cScale7":"#0288D1","xyChart":{"backgroundColor":"#1e1e1e","plotColorPalette":"#1565C0,#2E7D32,#FF9800,#D32F2F,#FFC107,#7B1FA2,#9E9E9E"}}}}%%
pie title "Documents by Urgency Level"
    "CRITICAL (5/5)" : 1
    "MODERATE (3/5)" : 3
    "LOW (2/5)" : 3
    "MINIMAL (1/5)" : 1
...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/Article_Type-Breaking-red?style=for-the-badge" alt="Article Type"/></a>
  <a href="#"><img src="https://img.shields.io/badge/Run-173-blue?style=for-the-badge" alt="Run"/></a>
  <a href="#"><img src="https://img.shields.io/badge/Date-2026--04--15-green?style=for-the-badge" alt="Date"/></a>
</p>
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","primaryBorderColor":"#0A3F7F","lineColor":"#90CAF9","secondaryColor":"#2E7D32","secondaryTextColor":"#ffffff","secondaryBorderColor":"#0F3F00","tertiaryColor":"#FF9800","tertiaryTextColor":"#000000","tertiaryBorderColor":"#7F4F00","mainBkg":"#1565C0","secondBkg":"#2E7D32","tertiaryBkg":"#FF9800","noteBkgColor":"#FFC107","noteTextColor":"#000000","noteBorderColor":"#7F6000","errorBkgColor":"#D32F2F","errorTextColor":"#ffffff","fontFamily":"Inter, Helvetica, Arial, sans-serif","pie1":"#1565C0","pie2":"#2E7D32","pie3":"#FF9800","pie4":"#D32F2F","pie5":"#FFC107","pie6":"#7B1FA2","pie7":"#9E9E9E","pie8":"#0288D1","pie9":"#388E3C","pie10":"#F57C00","pie11":"#C62828","pie12":"#FBC02D","pieTitleTextSize":"18px","pieSectionTextSize":"14px","pieLegendTextSize":"13px","pieStrokeColor":"#1e1e1e","pieOuterStrokeColor":"#1e1e1e","git0":"#1565C0","git1":"#2E7D32","git2":"#FF9800","git3":"#D32F2F","gitBranchLabel0":"#ffffff","gitBranchLabel1":"#ffffff","gitBranchLabel2":"#000000","gitBranchLabel3":"#ffffff","cScale0":"#1565C0","cScale1":"#2E7D32","cScale2":"#FF9800","cScale3":"#D32F2F","cScale4":"#FFC107","cScale5":"#7B1FA2","cScale6":"#9E9E9E","cScale7":"#0288D1","xyChart":{"backgroundColor":"#1e1e1e","plotColorPalette":"#1565C0,#2E7D32,#FF9800,#D32F2F,#FFC107,#7B1FA2,#9E9E9E"}}}}%%
xychart-beta
    title "TA-10-2026-0096 Significance Profile"
    x-axis ["Political", "Legis Scope", "Timeliness", "Economic", "Institutional", "Cross-Party", "Public", "International", "Precedent", "Media"]
    y-axis "Score (1-10)" 0 --> 10
    bar [9, 8, 10, 10, 8, 9, 7, 10, 9, 10]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","primaryBorderColor":"#0A3F7F","lineColor":"#90CAF9","secondaryColor":"#2E7D32","secondaryTextColor":"#ffffff","secondaryBorderColor":"#0F3F00","tertiaryColor":"#FF9800","tertiaryTextColor":"#000000","tertiaryBorderColor":"#7F4F00","mainBkg":"#1565C0","secondBkg":"#2E7D32","tertiaryBkg":"#FF9800","noteBkgColor":"#FFC107","noteTextColor":"#000000","noteBorderColor":"#7F6000","errorBkgColor":"#D32F2F","errorTextColor":"#ffffff","fontFamily":"Inter, Helvetica, Arial, sans-serif","pie1":"#1565C0","pie2":"#2E7D32","pie3":"#FF9800","pie4":"#D32F2F","pie5":"#FFC107","pie6":"#7B1FA2","pie7":"#9E9E9E","pie8":"#0288D1","pie9":"#388E3C","pie10":"#F57C00","pie11":"#C62828","pie12":"#FBC02D","pieTitleTextSize":"18px","pieSectionTextSize":"14px","pieLegendTextSize":"13px","pieStrokeColor":"#1e1e1e","pieOuterStrokeColor":"#1e1e1e","git0":"#1565C0","git1":"#2E7D32","git2":"#FF9800","git3":"#D32F2F","gitBranchLabel0":"#ffffff","gitBranchLabel1":"#ffffff","gitBranchLabel2":"#000000","gitBranchLabel3":"#ffffff","cScale0":"#1565C0","cScale1":"#2E7D32","cScale2":"#FF9800","cScale3":"#D32F2F","cScale4":"#FFC107","cScale5":"#7B1FA2","cScale6":"#9E9E9E","cScale7":"#0288D1","xyChart":{"backgroundColor":"#1e1e1e","plotColorPalette":"#1565C0,#2E7D32,#FF9800,#D32F2F,#FFC107,#7B1FA2,#9E9E9E"}}}}%%
xychart-beta
    title "Top Documents by Weighted Significance Score"
    x-axis ["TA-0096 Tariff", "TA-0092 SRMR3", "TA-0094 Anti-Corr", "TA-0090 DGSD2", "TA-0098 AI", "TA-0104 Gateway", "TA-0093 Water", "TA-0075 Semester"]
    y-axis "Score (0-10)" 0 --> 10
    bar [9.2, 8.1, 7.6, 7.4, 7.1, 6.8, 6.5, 6.3]
```
...
quadrantChart
    title "EP10 Post-Recess Strategic Position"
    ...
    Committee Capacity: [0.3, 0.75]
    MEP Stability: [0.2, 0.7]
    Rapid Response: [0.4, 0.65]
    Coalition Deficit: [0.3, 0.25]
    Fragmentation: [0.2, 0.2]
    Session Gap: [0.4, 0.3]
    Backlog: [0.35, 0.35]
    Crisis Catalyst: [0.7, 0.8]
    Banking Union: [0.65, 0.75]
    Agenda Reset: [0.75, 0.7]
    Trade Escalation: [0.7, 0.2]
    ECR Fracture: [0.65, 0.3]
    Right Bloc Test: [0.8, 0.25]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","primaryBorderColor":"#0A3F7F","lineColor":"#90CAF9","secondaryColor":"#2E7D32","secondaryTextColor":"#ffffff","secondaryBorderColor":"#0F3F00","tertiaryColor":"#FF9800","tertiaryTextColor":"#000000","tertiaryBorderColor":"#7F4F00","mainBkg":"#1565C0","secondBkg":"#2E7D32","tertiaryBkg":"#FF9800","noteBkgColor":"#FFC107","noteTextColor":"#000000","noteBorderColor":"#7F6000","errorBkgColor":"#D32F2F","errorTextColor":"#ffffff","fontFamily":"Inter, Helvetica, Arial, sans-serif","pie1":"#1565C0","pie2":"#2E7D32","pie3":"#FF9800","pie4":"#D32F2F","pie5":"#FFC107","pie6":"#7B1FA2","pie7":"#9E9E9E","pie8":"#0288D1","pie9":"#388E3C","pie10":"#F57C00","pie11":"#C62828","pie12":"#FBC02D","pieTitleTextSize":"18px","pieSectionTextSize":"14px","pieLegendTextSize":"13px","pieStrokeColor":"#1e1e1e","pieOuterStrokeColor":"#1e1e1e","git0":"#1565C0","git1":"#2E7D32","git2":"#FF9800","git3":"#D32F2F","gitBranchLabel0":"#ffffff","gitBranchLabel1":"#ffffff","gitBranchLabel2":"#000000","gitBranchLabel3":"#ffffff","cScale0":"#1565C0","cScale1":"#2E7D32","cScale2":"#FF9800","cScale3":"#D32F2F","cScale4":"#FFC107","cScale5":"#7B1FA2","cScale6":"#9E9E9E","cScale7":"#0288D1","xyChart":{"backgroundColor":"#1e1e1e","plotColorPalette":"#1565C0,#2E7D32,#FF9800,#D32F2F,#FFC107,#7B1FA2,#9E9E9E"}}}}%%
flowchart TD
    subgraph "Strengths → Opportunities"
        S1_O1["S1 Legislative Velocity<br/>enables<br/>O2 Banking Union Completion"]
        S4_O1["S4 Rapid Response<br/>enables<br/>O1 Crisis Catalyst"]
    end
    
    subgraph "Weaknesses × Threats"
        W1_T1["W1 Coalition Deficit<br/>amplified by<br/>T1 Trade Escalation"]
        W3_T2["W3 Session Gap<br/>amplified by<br/>T2 ECR Fracture"]
    end
    
    subgraph "Strengths vs Threats"
        S1_T1["S1 Legislative Velocity<br/>mitigates<br/>T1 Trade Escalation<br/>(quick response once plenary resumes)"]
    end
    
    style S1_O1 fill:#28a745,color:white
    style S4_O1 fill:#28a745,color:white
    style W1_T1 fill:#dc3545,color:white
    style W3_T2 fill:#fd7e14,color:white
    style S1_T1 fill:#ffc107,color:black
```
...
graph TD
    subgraph "📊 EP Political Intelligence Dashboard 15 April 2026"
        ...
        subgraph "⚖️ Risk"
            RSK["Overall Risk: HIGH<br/>Composite 16.5/25<br/>Top: RSK-001 Trade Crisis 25/25"]
            style RSK fill:#dc3545,color:white
        end
        subgraph "🎭 Threat"
            THR["Threat Level: HIGH<br/>Tariff T-0 + Fragmentation<br/>Framework: Multi-dimensional"]
            style THR fill:#fd7e14,color:white
        end
        subgraph "📈 Significance"
            SIG["Significance: 7.8/10<br/>Analysis-Only<br/>No today-dated EP items"]
    ...
    subgraph "📝 Editorial Decision"
        ...
        DEC -->|No today events| ANA["Analysis-Only PR"]
...
|---|---|---|
| section-executive-brief | [executive-brief](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-15/breaking-run173/executive-brief.md) | `executive-brief.md` |
| section-supplementary-intelligence | [executive-brief_ko](https://github.com/Hack23/euparliamentmonitor/blob/main/analysis/daily/2026-04-15/breaking-run173/executive-brief_ko.md) | `executive-brief_ko.md` |
