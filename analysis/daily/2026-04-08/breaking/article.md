...
graph LR
    subgraph "January"
        J1["Economic foundations"]
        J2["External relations"]
        J3["Democracy monitoring"]
    end
    subgraph "February"
        F1["Social policy emergence"]
        F2["ECB oversight"]
        F3["Migration friction"]
    end
    subgraph "March"
        M1["Banking Union reform"]
        M2["Trade crisis response"]
        M3["Anti-corruption"]
        M4["Housing and AI"]
    end
    ...
    style J1 fill:#003399,color:#fff
    style J2 fill:#003399,color:#fff
    style J3 fill:#003399,color:#fff
    style F1 fill:#cc0000,color:#fff
    style F2 fill:#cc0000,color:#fff
    style F3 fill:#cc0000,color:#fff
    style M1 fill:#FFD700,color:#333
    style M2 fill:#FFD700,color:#333
    style M3 fill:#FFD700,color:#333
    style M4 fill:#FFD700,color:#333
```
...
quadrantChart
    title EP Political Risk Matrix — April 8-23, 2026
    x-axis Low Likelihood --> High Likelihood
    y-axis Low Impact --> High Impact
    quadrant-1 Critical Risks
    quadrant-2 Strategic Risks
    quadrant-3 Low Priority
    quadrant-4 Operational Risks
    US tariff response: [0.80, 0.60]
    ECB rate decision: [0.60, 0.80]
    Banking reform delay: [0.60, 0.60]
    Coalition realignment: [0.40, 0.60]
    Legislative backlog: [0.60, 0.40]
    Small group quorum: [0.30, 0.20]
    Eurosceptic coordination: [0.35, 0.50]
    Implementation gap: [0.50, 0.35]
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","primaryBorderColor":"#0A3F7F","lineColor":"#90CAF9","secondaryColor":"#2E7D32","secondaryTextColor":"#ffffff","secondaryBorderColor":"#0F3F00","tertiaryColor":"#FF9800","tertiaryTextColor":"#000000","tertiaryBorderColor":"#7F4F00","mainBkg":"#1565C0","secondBkg":"#2E7D32","tertiaryBkg":"#FF9800","noteBkgColor":"#FFC107","noteTextColor":"#000000","noteBorderColor":"#7F6000","errorBkgColor":"#D32F2F","errorTextColor":"#ffffff","fontFamily":"Inter, Helvetica, Arial, sans-serif","pie1":"#1565C0","pie2":"#2E7D32","pie3":"#FF9800","pie4":"#D32F2F","pie5":"#FFC107","pie6":"#7B1FA2","pie7":"#9E9E9E","pie8":"#0288D1","pie9":"#388E3C","pie10":"#F57C00","pie11":"#C62828","pie12":"#FBC02D","pieTitleTextSize":"18px","pieSectionTextSize":"14px","pieLegendTextSize":"13px","pieStrokeColor":"#1e1e1e","pieOuterStrokeColor":"#1e1e1e","git0":"#1565C0","git1":"#2E7D32","git2":"#FF9800","git3":"#D32F2F","gitBranchLabel0":"#ffffff","gitBranchLabel1":"#ffffff","gitBranchLabel2":"#000000","gitBranchLabel3":"#ffffff","cScale0":"#1565C0","cScale1":"#2E7D32","cScale2":"#FF9800","cScale3":"#D32F2F","cScale4":"#FFC107","cScale5":"#7B1FA2","cScale6":"#9E9E9E","cScale7":"#0288D1","xyChart":{"backgroundColor":"#1e1e1e","plotColorPalette":"#1565C0,#2E7D32,#FF9800,#D32F2F,#FFC107,#7B1FA2,#9E9E9E"}}}}%%
graph TD
    subgraph "🏛️ EP Political Risk Categories — April 2026"
        direction TB
        GCS["Grand Coalition Stability<br/>🟡 MEDIUM (Score 6)<br/>Post-recess realignment risk"]
        PI["Policy Implementation<br/>🟡 MEDIUM (Scores 9+6+4)<br/>Banking reform + backlog"]
        II["Institutional Integrity<br/>🟡 MEDIUM (Scores 6+2)<br/>Eurosceptic coordination + quorum"]
        EG["Economic Governance<br/>🟠 HIGH (Score 12)<br/>ECB April 17 impact"]
        SC["Social Cohesion<br/>🟢 LOW<br/>No active indicators"]
        GS["Geopolitical Standing<br/>🟠 HIGH (Score 12)<br/>US tariff response gap"]
    end

    style GCS fill:#ffc107,stroke:#333,stroke-width:2px,color:#333
    style PI fill:#ffc107,stroke:#333,stroke-width:2px,color:#333
    style II fill:#ffc107,stroke:#333,stroke-width:2px,color:#333
    style EG fill:#fd7e14,stroke:#333,stroke-width:2px,color:#fff
    style SC fill:#28a745,stroke:#333,stroke-width:2px,color:#fff
    style GS fill:#fd7e14,stroke:#333,stroke-width:2px,color:#fff
```
...
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","primaryBorderColor":"#0A3F7F","lineColor":"#90CAF9","secondaryColor":"#2E7D32","secondaryTextColor":"#ffffff","secondaryBorderColor":"#0F3F00","tertiaryColor":"#FF9800","tertiaryTextColor":"#000000","tertiaryBorderColor":"#7F4F00","mainBkg":"#1565C0","secondBkg":"#2E7D32","tertiaryBkg":"#FF9800","noteBkgColor":"#FFC107","noteTextColor":"#000000","noteBorderColor":"#7F6000","errorBkgColor":"#D32F2F","errorTextColor":"#ffffff","fontFamily":"Inter, Helvetica, Arial, sans-serif","pie1":"#1565C0","pie2":"#2E7D32","pie3":"#FF9800","pie4":"#D32F2F","pie5":"#FFC107","pie6":"#7B1FA2","pie7":"#9E9E9E","pie8":"#0288D1","pie9":"#388E3C","pie10":"#F57C00","pie11":"#C62828","pie12":"#FBC02D","pieTitleTextSize":"18px","pieSectionTextSize":"14px","pieLegendTextSize":"13px","pieStrokeColor":"#1e1e1e","pieOuterStrokeColor":"#1e1e1e","git0":"#1565C0","git1":"#2E7D32","git2":"#FF9800","git3":"#D32F2F","gitBranchLabel0":"#ffffff","gitBranchLabel1":"#ffffff","gitBranchLabel2":"#000000","gitBranchLabel3":"#ffffff","cScale0":"#1565C0","cScale1":"#2E7D32","cScale2":"#FF9800","cScale3":"#D32F2F","cScale4":"#FFC107","cScale5":"#7B1FA2","cScale6":"#9E9E9E","cScale7":"#0288D1","xyChart":{"backgroundColor":"#1e1e1e","plotColorPalette":"#1565C0,#2E7D32,#FF9800,#D32F2F,#FFC107,#7B1FA2,#9E9E9E"}}}}%%
graph TD
    subgraph "📊 EP Political Intelligence Dashboard — 2026-04-08"
        direction TB
        subgraph "🔒 Sensitivity"
            CLS["Sensitivity<br/>🟢 PUBLIC<br/>Routine recess monitoring"]
        end
        subgraph "⚖️ Risk"
            RSK["Overall Risk<br/>🟡 MEDIUM<br/>Post-recess legislative backlog"]
        end
        subgraph "🎭 Threat"
            THR["Threat Level<br/>🟢 LOW<br/>No active institutional threats"]
        end
        subgraph "📈 Significance"
            SIG["Top Significance<br/>3.5/10<br/>📋 Analysis Only"]
        end
    end
    ...
    style CLS fill:#28a745,stroke:#333,stroke-width:2px,color:#fff
    style RSK fill:#ffc107,stroke:#333,stroke-width:2px,color:#333
    style THR fill:#28a745,stroke:#333,stroke-width:2px,color:#fff
    style SIG fill:#6c757d,stroke:#333,stroke-width:2px,color:#fff
    style DEC fill:#17a2b8,stroke:#333,stroke-width:2px,color:#fff
    style MON fill:#6c757d,stroke:#333,stroke-width:2px,color:#fff
```
...
|--------|---------------|------------|-------------|
| **Plenary Activity** | None | Easter recess — next plenary April 20-23 | ![Status](https://img.shields.io/badge/-Inactive-6c757d?style=flat-square) |
| **Legislative Pipeline** | Low | 18 texts adopted March 26 entering implementation | ![Status](https://img.shields.io/badge/-Monitoring-28a745?style=flat-square) |
| **Committee Work** | None | Restart April 14-17 | ![Status](https://img.shields.io/badge/-Inactive-6c757d?style=flat-square) |
| **Political Dynamics** | Low | Renew-ECR alliance strengthening signal | ![Status](https://img.shields.io/badge/-Watch-ffc107?style=flat-square) |
| **External Context** | Medium | US tariff escalation during parliamentary gap | ![Status](https://img.shields.io/badge/-Elevated-fd7e14?style=flat-square) |
...
```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","primaryBorderColor":"#0A3F7F","lineColor":"#90CAF9","secondaryColor":"#2E7D32","secondaryTextColor":"#ffffff","secondaryBorderColor":"#0F3F00","tertiaryColor":"#FF9800","tertiaryTextColor":"#000000","tertiaryBorderColor":"#7F4F00","mainBkg":"#1565C0","secondBkg":"#2E7D32","tertiaryBkg":"#FF9800","noteBkgColor":"#FFC107","noteTextColor":"#000000","noteBorderColor":"#7F6000","errorBkgColor":"#D32F2F","errorTextColor":"#ffffff","fontFamily":"Inter, Helvetica, Arial, sans-serif","pie1":"#1565C0","pie2":"#2E7D32","pie3":"#FF9800","pie4":"#D32F2F","pie5":"#FFC107","pie6":"#7B1FA2","pie7":"#9E9E9E","pie8":"#0288D1","pie9":"#388E3C","pie10":"#F57C00","pie11":"#C62828","pie12":"#FBC02D","pieTitleTextSize":"18px","pieSectionTextSize":"14px","pieLegendTextSize":"13px","pieStrokeColor":"#1e1e1e","pieOuterStrokeColor":"#1e1e1e","git0":"#1565C0","git1":"#2E7D32","git2":"#FF9800","git3":"#D32F2F","gitBranchLabel0":"#ffffff","gitBranchLabel1":"#ffffff","gitBranchLabel2":"#000000","gitBranchLabel3":"#ffffff","cScale0":"#1565C0","cScale1":"#2E7D32","cScale2":"#FF9800","cScale3":"#D32F2F","cScale4":"#FFC107","cScale5":"#7B1FA2","cScale6":"#9E9E9E","cScale7":"#0288D1","xyChart":{"backgroundColor":"#1e1e1e","plotColorPalette":"#1565C0,#2E7D32,#FF9800,#D32F2F,#FFC107,#7B1FA2,#9E9E9E"}}}}%%
pie title EP10 Political Group Seat Distribution (720 MEPs)
    "EPP" : 185
    "S&D" : 135
    "PfE" : 84
    "ECR" : 79
...
quadrantChart
    title Post-Recess Political Risk Matrix
    x-axis Low Likelihood --> High Likelihood
    y-axis Low Impact --> High Impact
    quadrant-1 Critical Risks
    quadrant-2 Strategic Risks
    quadrant-3 Low Priority
    quadrant-4 Operational Risks
    US tariff response delay: [0.8, 0.6]
    ECB decision impact: [0.6, 0.8]
    Legislative backlog: [0.6, 0.4]
    Coalition realignment: [0.4, 0.6]
    Banking reform delay: [0.6, 0.6]
    Small group quorum: [0.3, 0.2]
```
...
|:-:|------|----------|:--------:|
| S1 | **Pre-recess legislative sprint success** — 18 texts adopted in single March 26 sitting | TA-10-2026-0087 through TA-10-2026-0104 (adopted texts feed) | ![High](https://img.shields.io/badge/-High-28a745?style=flat-square) |
| S2 | **Stable MEP composition** — 737 active MEPs, turnover rate 5.6%, institutional memory risk LOW | MEPs feed data, generated stats (mepStabilityIndex: 0.944) | ![High](https://img.shields.io/badge/-High-28a745?style=flat-square) |
| S3 | **Flexible majority system working** — EPP successfully building ad-hoc coalitions per dossier | 2026 legislative output 46.2% higher than 2025 (generated stats) | ![Medium](https://img.shields.io/badge/-Medium-ffc107?style=flat-square) |

#### Weaknesses
| # | Item | Evidence | Severity |
|:-:|------|----------|:--------:|
| W1 | **No two-party majority possible** — minimum 3 groups required for every legislative majority | EPP 185 + S&D 135 = 320 < 361 majority threshold (political landscape) | ![High](https://img.shields.io/badge/-High-28a745?style=flat-square) |
| W2 | **Democratic accountability gap during recess** — 18-day gap with no parliamentary oversight | Events/procedures feeds returning 404 during Easter recess | ![Medium](https://img.shields.io/badge/-Medium-ffc107?style=flat-square) |
| W3 | **Data transparency limitations** — per-MEP voting statistics unavailable from EP API | Coalition dynamics tool reports null cohesion/defection/attendance for all groups | ![Medium](https://img.shields.io/badge/-Medium-ffc107?style=flat-square) |

#### Opportunities
| # | Item | Evidence | Severity |
|:-:|------|----------|:--------:|
| O1 | **Committee restart (April 14) — fresh legislative cycle** | EP calendar: committee week April 14-17, plenary April 20-23 | ![High](https://img.shields.io/badge/-High-28a745?style=flat-square) |
| O2 | **Renew-ECR convergence** on economic dossiers may create stable centre-right working majority | Coalition dynamics: 0.95 cohesion score (strengthening trend) | ![Medium](https://img.shields.io/badge/-Medium-ffc107?style=flat-square) |
| O3 | **Implementation monitoring role** — oversight of 18 recently adopted texts | Q1 2026 output: 104 adopted texts, 114 legislative acts projected | ![Medium](https://img.shields.io/badge/-Medium-ffc107?style=flat-square) |

#### Threats
| # | Item | Evidence | Severity |
|:-:|------|----------|:--------:|
| T1 | **US tariff escalation** during parliamentary silence — no response mechanism until April 14 | Editorial context; INTA committee restart required | ![High](https://img.shields.io/badge/-High-dc3545?style=flat-square) |
| T2 | **ECB April 17 rate decision** may pressure Banking Union implementation timeline | SRMR3/BRRD3 adopted pre-recess (TA-10-2026-0092, TA-10-2026-0094) | ![Medium](https://img.shields.io/badge/-Medium-ffc107?style=flat-square) |
| T3 | **Eurosceptic bloc growth** — 15.6% seat share, highest in EP history | Generated stats: euroscepticShare 15.6%, ESN 28 seats + PfE 84 seats | ![Medium](https://img.shields.io/badge/-Medium-ffc107?style=flat-square) |

```mermaid
%%{init: {"theme":"dark","themeVariables":{"primaryColor":"#1565C0","primaryTextColor":"#ffffff","primaryBorderColor":"#0A3F7F","lineColor":"#90CAF9","secondaryColor":"#2E7D32","secondaryTextColor":"#ffffff","secondaryBorderColor":"#0F3F00","tertiaryColor":"#FF9800","tertiaryTextColor":"#000000","tertiaryBorderColor":"#7F4F00","mainBkg":"#1565C0","secondBkg":"#2E7D32","tertiaryBkg":"#FF9800","noteBkgColor":"#FFC107","noteTextColor":"#000000","noteBorderColor":"#7F6000","errorBkgColor":"#D32F2F","errorTextColor":"#ffffff","fontFamily":"Inter, Helvetica, Arial, sans-serif","pie1":"#1565C0","pie2":"#2E7D32","pie3":"#FF9800","pie4":"#D32F2F","pie5":"#FFC107","pie6":"#7B1FA2","pie7":"#9E9E9E","pie8":"#0288D1","pie9":"#388E3C","pie10":"#F57C00","pie11":"#C62828","pie12":"#FBC02D","pieTitleTextSize":"18px","pieSectionTextSize":"14px","pieLegendTextSize":"13px","pieStrokeColor":"#1e1e1e","pieOuterStrokeColor":"#1e1e1e","git0":"#1565C0","git1":"#2E7D32","git2":"#FF9800","git3":"#D32F2F","gitBranchLabel0":"#ffffff","gitBranchLabel1":"#ffffff","gitBranchLabel2":"#000000","gitBranchLabel3":"#ffffff","cScale0":"#1565C0","cScale1":"#2E7D32","cScale2":"#FF9800","cScale3":"#D32F2F","cScale4":"#FFC107","cScale5":"#7B1FA2","cScale6":"#9E9E9E","cScale7":"#0288D1","xyChart":{"backgroundColor":"#1e1e1e","plotColorPalette":"#1565C0,#2E7D32,#FF9800,#D32F2F,#FFC107,#7B1FA2,#9E9E9E"}}}}%%
mindmap
  root((EP Recess<br/>Intelligence))
    Legislative Pipeline
      ...
      Implementation phase
        ...
        Technical standards
    Political Dynamics
      EPP flexible majorities
        Centre-right option
        Grand coalition fallback
      Renew-ECR convergence
        Economic policy
        Defence spending
      Eurosceptic consolidation
        PfE 84 seats
        ESN 28 seats
    External Pressures
    ...
    Post-Recess Outlook
      Committee week April 14
        INTA trade response
        ECON banking oversight
      Plenary April 20-23
        Strasbourg session
