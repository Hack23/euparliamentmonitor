...
source_folder: analysis/daily/2026-05-09/year-in-review
...
```mermaid
quadrantChart
    title EP10 Year 1 — Outcomes vs Expectations
    x-axis Low Expectations --> High Expectations
    y-axis Low Delivery --> High Delivery
    quadrant-1 Overachieved
    quadrant-2 Pleasant Surprises
    quadrant-3 Underperformed
    quadrant-4 Delivered as Expected
    Ukraine Financial Support: [0.85, 0.95]
    Defence Legislation: [0.7, 0.85]
    Competitiveness Reform: [0.6, 0.75]
    AI Act Enforcement: [0.5, 0.65]
    Climate Ambition: [0.65, 0.25]
    Tax Justice: [0.4, 0.15]
    Social Policy: [0.4, 0.20]
    Rule of Law: [0.75, 0.45]
```
...
```mermaid
pie title Legislative Output by Significance Tier (EP10 Year 1)
    "Tier 1 - Constitutional/Treaty-level" : 3
    "Tier 2 - Major policy" : 15
    "Tier 3 - Regulatory/Technical" : 40
    "Tier 4 - Resolutions" : 42
```
...
graph LR
    ...
    ECR --> EPP
    COM --> COUNCIL
    MS[Member States] --> COUNCIL
    COUNCIL --> EP[EP Plenary]
    EPP --> EP
    SD --> EP
```
...
graph TD
    subgraph Driving Forces
        D1[Ukraine geopolitical urgency]
        D2[Competitiveness economic pressure]
        D3[Defence industrialisation imperative]
        D4[AI governance necessity]
    end
    subgraph Restraining Forces
        R1[Sovereignty concerns - migration]
        R2[Budget constraints - MFF]
        R3[EPP-left climate disagreement]
        R4[Council unanimity - tax]
    end
    D1 --> POLICY[EP10 Legislative Output]
    D2 --> POLICY
    D3 --> POLICY
    D4 --> POLICY
    R1 -.-> POLICY
...
```mermaid
quadrantChart
    title EP10 Legislative Impact Matrix
    x-axis Low Probability --> High Probability
    y-axis Low Impact --> High Impact
    quadrant-1 Monitor Closely
    quadrant-2 Manage Actively
    quadrant-3 Low Priority
    quadrant-4 Achieved/Delivered
    Ukraine Financial Support: [0.95, 0.95]
    Defence Industrialisation: [0.85, 0.88]
    Competitiveness Reform: [0.78, 0.72]
    Migration Package: [0.82, 0.70]
    AI Act Enforcement: [0.65, 0.80]
    Climate Rollback: [0.75, 0.65]
    Enlargement Progress: [0.55, 0.90]
    Tax Harmonisation: [0.15, 0.70]
```
...
```mermaid
pie title EP10 Coalition Breakdown (717 seats)
    "EPP (183)" : 183
    "S&D (136)" : 136
    "PfE (85)" : 85
    "ECR (81)" : 81
...
```mermaid
graph TD
    EP[European Parliament] --> EPP[EPP Coalition]
    EP --> SD[S&D]
    EP --> Renew[Renew Europe]
    EPP --> COM[European Commission]
    COM --> COUNCIL[EU Council]
    COUNCIL --> MS[Member States]
    EP --> CSO[Civil Society]
    EP --> MEDIA[European Media]
    COUNCIL --> NATO[NATO/Transatlantic]
    COM --> UKR[Ukraine Government]
```
...
quadrantChart
    ...
    quadrant-2 High Impact Risks
    quadrant-3 Low Priority
    quadrant-4 Monitor
    Ukraine Escalation: [0.25, 0.95]
    Defence Gap: [0.55, 0.88]
    Climate Reversal: [0.65, 0.72]
    AI Governance: [0.45, 0.78]
    Coalition Break: [0.18, 0.85]
```
...
```mermaid
pie title SWOT Distribution (EP10 Year 1)
    "Strengths" : 4
    "Weaknesses" : 4
    "Opportunities" : 4
    "Threats" : 4
...
```mermaid
graph TD
    T[EP10 Threat Landscape] --> A[Institutional Threats]
    T --> B[Coalition Threats]
    T --> C[External Threats]
    T --> D[Legal Threats]
    A --> A1[Corruption/Qatargate sequel]
    A --> A2[Immunity cascade]
    A --> A3[Transparency deficit]
    B --> B1[Renew fragmentation]
    B --> B2[EPP-PfE formalisation]
    B --> B3[S&D migration red line breach]
    C --> C1[Ukraine military reversal]
    C --> C2[US NATO withdrawal]
    C --> C3[Foreign information operations]
    D --> D1[Migration ECHR/CJEU challenge]
    D --> D2[AI Act enforcement failure]
    D --> D3[EU-Mercosur CJEU block]
```
...
```mermaid
graph TD
    RUS[Russia - State Actor] --> EP_COHESION[EP Solidarity Cohesion]
    ILL[Illiberal MS - Insider] --> RoL[Rule of Law Enforcement]
    US[US Administration] --> TRADE[EU Trade Policy]
    AI[AI Governance Risk] --> DIGITAL[Digital Regulation Credibility]
    EP_COHESION --> UKRAINE_VOTE[Ukraine Support Votes]
    RoL --> HU_PL[Hungary/Poland Proceedings]
    TRADE --> MFF[MFF Negotiations]
    DIGITAL --> AI_ACT[AI Act Enforcement]
```
...
pie title Scenario Probability Distribution
    "Baseline Continuity (55%)" : 55
    "Accelerated Security Pivot (20%)" : 20
    "Competitiveness Crisis (15%)" : 15
    "Coalition Collapse (10%)" : 10
```
...
```mermaid
pie title Wildcard Risk Distribution by Domain
    "Geopolitical (Ukraine/Russia)" : 40
    "Institutional (EU fragmentation)" : 25
    "Economic (financial crisis)" : 20
    "Technology (AI governance)" : 15
```
...
```mermaid
gantt
    title EP10 Legislative Pipeline Forecast 2026-2027
    dateFormat YYYY-MM
    section High Priority
    MFF 2028-34 Preliminary    :2026-06, 2026-12
    AI Act Enforcement Cases   :2026-08, 2027-05
    Ukraine Accession Progress :2026-09, 2026-12
    section Medium Priority
    REACH Revision             :2026-10, 2027-03
    Platform Workers Review    :2026-07, 2026-12
    DMA Enforcement Actions    :2026-06, 2027-06
    section Low Priority / Blocked
    FTT / Tax Harmonisation    :2026-06, 2027-05
    Climate Acceleration       :2026-06, 2027-05
```
...
```mermaid
gantt
    title EP10 Legislative Term Arc (2024-2029)
    dateFormat YYYY-MM
    section Phase 1 Foundation
    EP10 inaugurated                :milestone, 2024-07, 0d
    Commission confirmation         :2024-10, 1M
    MFF 2021-27 implementation      :2024-07, 2025-12
    section Phase 2 Security-First (Current)
    Ukraine financial architecture  :active, 2025-01, 2026-06
    Defence industrialisation       :active, 2025-06, 2026-12
    Migration restrictionism        :active, 2026-01, 2026-12
    section Phase 3 MFF Negotiation
    MFF 2028-34 preliminary work    :2026-07, 2027-06
    MFF 2028-34 Council-EP trilogue :2027-07, 2027-12
    section Phase 4 Consolidation
    Enlargement accession progress  :2027-01, 2029-06
    AI Act full enforcement         :2027-01, 2029-06
    section Phase 5 Pre-Election
    EP10 legacy assessment          :2028-06, 2029-06
    Next EP election preparation    :2029-01, 2029-06
```
...
```mermaid
gantt
    title EU Council Presidency Trio 2025-2026
    dateFormat YYYY-MM
    section Trio Rotation
    Poland (Security)    :2025-01, 2025-06
    Denmark (Competitiveness)  :2025-07, 2025-12
    Cyprus (Rule of Law)  :2026-01, 2026-06
```
...
```mermaid
quadrantChart
    title Commission WP vs EP Alignment 2025-2026
    x-axis Commission Priority Low --> High
    y-axis EP Support Low --> High
    quadrant-1 Full Alignment
    quadrant-2 EP-Led Additions
    quadrant-3 Misalignment / Stalled
    quadrant-4 Commission-Led / EP Passive
    Ukraine Financial Support: [0.9, 0.95]
    Defence Industrialisation: [0.85, 0.8]
    Competitiveness Agenda: [0.75, 0.78]
    AI Act Enforcement: [0.7, 0.75]
    DMA Enforcement: [0.65, 0.7]
    Migration Restriction: [0.6, 0.72]
    Climate Acceleration: [0.3, 0.3]
    Tax Harmonisation: [0.4, 0.25]
    Social Policy Expansion: [0.35, 0.4]
```
