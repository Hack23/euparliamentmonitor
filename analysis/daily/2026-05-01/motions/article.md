...
keywords: ["EU Parliament Monitor", "European Parliament", "European Commission", "political intelligence", "Riksdagsmonitor", "Riksdag", "Regeringen", "EU Parliament", "plenary votes", "resolutions", "voting record", "Motions", "2026-05-01", "Short", "term", "weeks"]
date: 2026-05-01
...
```mermaid
graph LR
    A[Big Tech Lobby] -->|Anti-DMA enforcement| Commission
    B[US Trade Office USTR] -->|Trade threat 301 investigation| Commission
    C[Polish Judiciary Ministry] -->|Jaki prosecution context| EP_PRIV[EP PRIV/JURI]
    D[PiS Opposition Network] -->|Frame as persecution| ECR_PL[ECR Polish delegation]
    E[Kremlin info-ops] -->|Undermine Ukraine motion| PfE_ESN[PfE + ESN]
    F[Armenia govt / EU delegation] -->|Supportive lobbying| AFET[EP AFET Committee]
    G[ICC Prosecutor] -->|Ukraine accountability signal| UCQ[Pro-Ukraine coalition]
    H[NGOs Haiti] -->|Emergency trafficking signal| DEVE[EP DEVE Committee]
```
...
```mermaid
xychart-beta
    title "Estimated Vote Margins — April 28-30 Plenary"
    x-axis ["Jaki Immunity", "Ukraine Acc.", "DMA Enforce", "Armenia", "Haiti", "Budget"]
    y-axis "Estimated Votes For" 0 --> 600
    bar [574, 534, 480, 470, 440, 420]
```
...
```mermaid
graph LR
    EPP -->|Coalition lead| Outcome[Vote Outcomes]
    SD -->|Grand coalition partner| Outcome
    Renew -->|Balance| Outcome
    ECR -->|Swing / fracture risk| Outcome

    Commission -->|Enforcement execution| DMA_Follow[DMA Follow-up]
    Council -->|Budget trilogue| Budget_Follow[Budget Outcomes]
    USTR -->|Trade pressure| Commission

    PiS -->|Narrative pressure| ECR
    Kremlin -->|PfE/ESN proxy| UA_Narrative[Ukraine Fatigue Narrative]
    BigTech -->|Direct lobbying| Commission
    Armenia -->|Partnership signal| AFET[EP AFET Committee]
```
...
```mermaid
quadrantChart
    title Political Threat Assessment — EP Motions May 2026
    ...
    DMA Trade War: [0.65, 0.90]
    ECR Fragmentation: [0.70, 0.85]
    Ukraine Sanctions Fatigue: [0.55, 0.75]
    Budget Breakdown: [0.50, 0.70]
    Immunity Precedent: [0.30, 0.65]
    Armenia Blowback: [0.25, 0.45]
```
