---
title: "The European Parliament's 10th term entered its most consequential legislative phase of Spring 2026 during the week under review. 104…"
description: "The European Parliament's 10th term entered its most consequential legislative phase of Spring 2026 during the week under review. 104 legislative texts have been adopted since…"
keywords: ["EU Parliament", "legislative procedures", "European Parliament", "proposal", "regulation", "Propositions", "2026-04-28", "run propositions-run-1777356258", "European", "Parliament", "10th", "term", "entered", "most", "consequential", "legislative"]
date: 2026-04-28
...
```mermaid
quadrantChart
    title Legislative Impact Matrix (Q1 2026)
    x-axis Low Scope --> High Scope
    y-axis Low Impact --> High Impact
    quadrant-1 Strategic Priority
    quadrant-2 Watch List
    quadrant-3 Routine
    quadrant-4 Implementation Focus
    Banking Union Trilogy: [0.85, 0.95]
    2040 Climate Target: [0.90, 0.90]
    AI Act Omnibus: [0.80, 0.85]
    Safe Countries Migration: [0.70, 0.80]
    CO2 Heavy Duty Vehicles: [0.60, 0.75]
    EU Housing Resolution: [0.55, 0.65]
    Ukraine Support Loan: [0.50, 0.70]
    US Tariffs Retaliation: [0.45, 0.60]
    EGF Applications x3: [0.30, 0.40]
    WTO MC14 Resolution: [0.35, 0.50]
    Anti-Poverty Strategy: [0.40, 0.60]
    Global Gateway: [0.65, 0.55]
```
...
```mermaid
xychart-beta
    title "Political Capital Risk by Policy Area (April 2026)"
    x-axis ["Banking Union", "AI/Digital", "Climate", "Migration", "Trade", "Housing", "Defence"]
...
mindmap
    root((Legislative\nThreat Actors))
        Internal EP Actors
            PfE Group
                Migration veto threat
                Ukraine funding blockage
                Coalition instability
            ECR Group
                Climate rollback pressure
                Rule of law resistance
                Anti-federalism
            NI/ESN bloc
                Procedural disruption
                Quorum manipulation risk
        External Institutional
            CJEU
                Judicial annulment
                Preliminary ruling delays
                Proportionality scrutiny
            US Government
                Trade war escalation
                NATO pressure
                Tech regulation interference
        ...
        Economic Actors
            Banking Lobby EBF
                MREL calibration pressure
                Level 2 resistance
            Agricultural COPA-COGECA
                CAP reform resistance
                Nature Restoration resistance
            Big Tech
                AI Omnibus lobbying
