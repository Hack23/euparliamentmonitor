...
**Document Control:** `/analysis/daily/{date}/{type}-run{N}/{existing|intelligence}/session-baseline.md` · Template v1.0 · Depth floor: 200 lines (motions / month-in-review), 150 lines (weekly / breaking).
