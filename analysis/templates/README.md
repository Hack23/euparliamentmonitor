...
| `provenance/` | [cross-reference-map](cross-reference-map.md) · [data-download-manifest](data-download-manifest.md) |
| `electoral/` | [coalition-mathematics](coalition-mathematics.md) · [voter-segmentation](voter-segmentation.md) |
| `domain-specific/` | [implementation-feasibility](implementation-feasibility.md) · [media-framing-analysis](media-framing-analysis.md) |
