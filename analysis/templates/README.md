...
| `pestle-context` → PESTLE & Context | [pestle-analysis](pestle-analysis.md) · [historical-baseline](historical-baseline.md) · [historical-parallels](historical-parallels.md) · [comparative-international](comparative-international.md) |
...
| `electoral-arc` → Electoral Arc & Mandate | [term-arc](term-arc.md) · [seat-projection](seat-projection.md) · [mandate-fulfilment-scorecard](mandate-fulfilment-scorecard.md) · [presidency-trio-context](presidency-trio-context.md) · [commission-wp-alignment](commission-wp-alignment.md) · [voter-segmentation](voter-segmentation.md) |
...
| `deep-analysis` → Deep Analysis | [deep-analysis](deep-analysis.md) · [intelligence-assessment](intelligence-assessment.md) · [implementation-feasibility](implementation-feasibility.md) · [media-framing-analysis](media-framing-analysis.md) |
...
| `extended-intel` → Extended Intelligence | All [`extended/`](#-per-artifact-templates-25--one-per-mandatory-artifact-under-analysisdailyrun) templates not consumed elsewhere |
