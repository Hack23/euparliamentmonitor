...
| `imf-native` (REST) — `[series]` | `[REQUIRED: role in Wave-2 OR-gate]` | `[✅/⚠️/❌]` | `[🟢/🟡/🔴]` |
...
| World Bank / IMF data vintage update | `intelligence/economic-context.md` | Monthly |
...
**Document Control:** `/analysis/daily/{date}/{type}-run{N}/intelligence/methodology-reflection.md` · Template v1.0 · Depth floor: 220 lines (breaking) / 180 lines (other article types) · Produced as the **last** artifact of each run, after `workflow-audit.md`.
