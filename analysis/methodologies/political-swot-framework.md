...
| **HIGH** | Eurostat / IMF (sole authoritative economic source) / World Bank (non-economic — health, education, social, environment, demographics, defence, agriculture, innovation, governance) official statistics | IMF SDMX REST + World Bank MCP tools |
