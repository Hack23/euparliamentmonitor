...
|---|---|---:|---:|---:|
| `breaking` | claude-opus-5 | 12 | 8 | ≤ 42 min |
| `committee-reports` | claude-opus-5 | 12 | 8 | ≤ 42 min |
| `motions` | claude-opus-5 | 12 | 8 | ≤ 42 min |
| `propositions` | claude-opus-5 | 12 | 8 | ≤ 42 min |
| `week-ahead` / `month-ahead` | claude-opus-5 | 12 | 8 | ≤ 42 min |
| `week-in-review` / `month-in-review` | claude-opus-5 | 15 | 10 | ≤ 45 min |
| `quarter-in-review` / `year-in-review` | claude-opus-5 | 18 | 12 | ≤ 45 min |
| `quarter-ahead` / `year-ahead` | claude-opus-5 | 18 | 12 | ≤ 45 min |
| `term-outlook` / `election-cycle` | claude-opus-5 | 22 | 15 | ≤ 47 min |
| `deep-analysis` | claude-opus-5 | 22 | 15 | ≤ 45 min |
