...
| **AI Agent** (Opus 4.7) | ALL political analysis, ALL narrative prose, ALL SWOT content, ALL stakeholder reasoning, ALL risk assessment, ALL coalition dynamics, World Bank data interpretation, chart data selection | Analysis .md files, every `AI_MARKER` field, article body prose |
