...
<p align="center">
  ...
  <em>📁 Current scope: 24 methodology <code>.md</code> files + 2 JSON config files (style + reference-quality-thresholds) governing 61 templates — <code>ls analysis/methodologies/</code> and <code>ls analysis/templates/</code> are the source of truth; hand-written counts in prose are deprecated.</em>
</p>
