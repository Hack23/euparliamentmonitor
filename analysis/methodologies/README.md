...
- **Mandates AI-driven metadata:** All article titles, descriptions, and SEO keywords MUST be produced by the AI agent (Opus 4.6) analysing the content — NEVER by script code or template strings. The AI agent passes `--title` and `--description` CLI flags to the generator.
