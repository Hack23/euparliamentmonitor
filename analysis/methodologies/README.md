...
| **18** | **[Political Style Guide (machine-readable)](political-style-guide.json)** | Machine-readable style enforcement rules — WEP bands, Admiralty grades, named-actor discipline, no-neutral-media doctrine, EU-specific constants (720 seats, 361 majority, 27 MS). | JSON schema; 7 WEP bands; 6×6 Admiralty; prohibited terms; citation formats | **Validation** — consumed by validation scripts and AI agents for automated style compliance checking |
