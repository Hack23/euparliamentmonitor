...
| `extended/media-framing-analysis.md` | Media framing & influence-operations analysis — Entman functions, DISARM TTPs, CIB signals, narrative-laundering chains, counter-resilience, frame lifecycle, RRPA composite across EU-27 + global audience. | [analytical-supplementary-methodology.md §media-framing](analytical-supplementary-methodology.md#as4--media-framing-deep-dive) + [electoral-domain-methodology.md §Part 4](electoral-domain-methodology.md) | [media-framing-analysis.md](../templates/media-framing-analysis.md) | 270 | graph LR (outlet × frame) + xychart-beta (lifecycle) |
